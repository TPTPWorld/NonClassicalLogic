%------------------------------------------------------------------------------
% File     : LAW004#1 : TPTP v8.0.0. Released v8.0.0.
% Domain   : GDPR
% Problem  : ?
% Version  : ?
...
thf(con,conjecture,
    ( ( $dia_int @ 0 @ ( communicate_within_time @ second_processing_time__const @ controller__const @ subject__const @ day__const @ ( purpose_of_processing__fun @ purpose__const @ data__const ) ) )
    & ( $dia_int @ 1

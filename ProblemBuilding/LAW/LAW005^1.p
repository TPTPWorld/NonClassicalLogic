...
thf(axiom_7,axiom,(
    mactual @ ( mnot @ article1_condition_smoke__const ) )).

thf(axiom_8,axiom,(
    mactual @ article_b1_punishment_notice__const )).

thf(axiom_9,axiom,(
    mactual @ article_b6_condition_before_expiry__const )).

thf(con,conjecture,(
    mactual @ ( mand @ ( mdia_int_0 @ article_b6_contest_hearing__const ) @ ( mdia_int_1 @ ( mnot @ article_b6_contest_hearing__const ) ) ) )).

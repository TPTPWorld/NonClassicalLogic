%------------------------------------------------------------------------------
% File     : LAW008^1 : TPTP v8.0.0. Released v8.0.0.
% Domain   : ?
% Problem  : ?
% Version  : ?
% English  : A person was driving a car on the main street while smoking with 
%            a child in it. The car was designed as home car but not used as 
%            one at the time of offence. We expect the person to be liable for 
%            a fine.
...
thf(axiom_8,axiom,(
    mactual @ article1_condition_public_space__const )).
...
thf(axiom_11,axiom,(
    mactual @ article1_condition_designed_homecar__const )).

thf(axiom_12,axiom,(
    mactual @ ( mnot @ article1_condition_used_homecar__const ) )).

thf(con,conjecture,(
    mactual @ ( mand @ ( mdia_int_0 @ punishment_fine__const ) @ ( mdia_int_1 @ ( mnot @ punishment_fine__const ) ) ) )).

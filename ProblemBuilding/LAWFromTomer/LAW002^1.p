%------------------------------------------------------------------------------
% File     : LAW002#1 : TPTP v8.0.0. Released v8.0.0.
% Domain   : Article 13 of the GDPR
% Problem  : ?
% Version  : ?
% English  : Is it compliant to have in the policy: We will update you about 
%            the purpose of the processing at the time of collecting the data.
...
thf(con,conjecture,
    ( ( {$dia(#0)} @ ( communicate_at_time @ controller__const @ subject__const @ collection_time__const @ ( purpose_of_processing__fun @ purpose__const @ data__const ) ) )
    & ( {$dia(#1)}
      @ ~ ( communicate_at_time @ controller__const @ subject__const @ collection_time__const @ ( purpose_of_processing__fun @ purpose__const @ data__const ) ) ) )).

%------------------------------------------------------------------------------
% File     : LAW002^1 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Law
% Problem  : Article 13 of the GDPR, policy 2
% Version  : Especial.
...
% Status   : Theorem
% Rating   : ? v9.0.0
% Syntax   : Number of formulae    :   76 (  14 unt;  55 typ;   0 def)
%            Number of atoms       : 1245 (   0 equ;   0 cnn)
%            Maximal formula atoms :  525 (  59 avg)
%            Number of connectives : 4546 ( 180   ~;   0   |; 931   &;3142   @)
%                                         (   0 <=>;  59  =>;   0  <=;   0 <~>)
%                                         ( 234 {.}; 234 {#})
%            Maximal formula depth :   59 (  12 avg)
%            Number of types       :    2 (   0 usr)
%            Number of type conns  :   93 (  93   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   59 (  55 usr;  20 con; 0-5 aty)

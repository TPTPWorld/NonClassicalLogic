%------------------------------------------------------------------------------
% File     : LAW004^1 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Law
% Problem  : Article 13 of the GDPR, policy 4
% Version  : Especial.
% English  : Is it compliant to have in the policy: We will update you about 
%            the purpose of the processing no longer than 24 hours after the 
%            time of processing.

% Refs     : [Lib20] Libal (2020), Towards Automated GDPR Compliance Checki
%          : [Lib20a] Libal (2020), Email to Geoff Sutcliffe
% Source   : [Lib20a]
% Names    : LEG104 [Lib20a]

% Status   : CounterSatisfiable
% Rating   : ? v9.0.0
% Syntax   : Number of formulae    :   77 (  14 unt;  56 typ;   0 def)
%            Number of atoms       : 1245 (   0 equ;   0 cnn)
%            Maximal formula atoms :  525 (  59 avg)
%            Number of connectives : 4548 ( 180   ~;   0   |; 931   &;3144   @)
%                                         (   0 <=>;  59  =>;   0  <=;   0 <~>)
%                                         ( 234 {.}; 234 {#})
%            Maximal formula depth :   59 (  12 avg)
%            Number of types       :    2 (   0 usr)
%            Number of type conns  :   93 (  93   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   60 (  56 usr;  21 con; 0-5 aty)
...
thf(con,conjecture,
    ( ( {$dia(#0)} @ ( communicate_within_time @ second_processing_time__const @ controller__const @ subject__const @ day__const @ ( purpose_of_processing__fun @ purpose__const @ data__const ) ) )
    & ( {$dia(#1)}
      @ ~ ( communicate_within_time @ second_processing_time__const @ controller__const @ subject__const @ day__const @ ( purpose_of_processing__fun @ purpose__const @ data__const ) ) ) ) ).

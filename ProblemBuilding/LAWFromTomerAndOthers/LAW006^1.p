%------------------------------------------------------------------------------
% File     : LAW006^1 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Law
% Problem  : Scottish smoking law, question 2
% Version  : Especial
...
% Status   : Theorem
% Rating   : ? v9.0.0
% Syntax   : Number of formulae    :   27 (   5 unt;  15 typ;   0 def)
%            Number of atoms       :  121 (   0 equ;   0 cnn)
%            Maximal formula atoms :   36 (  10 avg)
%            Number of connectives :  190 (  39   ~;   0   |;  54   &;  42   @)
%                                         (   1 <=>;  12  =>;   0  <=;   0 <~>)
%                                         (  42 {.};  42 {#})

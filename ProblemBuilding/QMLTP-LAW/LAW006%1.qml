...
% Problem  : ?
% Version  : ?
% English  : A person was sitting in a car while smoking with a child in it. The car was parked in the garage. We expect the person not to be liable for a fine
%
...
qmf(axiom_8,axiom,article1_condition_smoke__const).

qmf(axiom_9,axiom,article1_condition_child__const).

qmf(axiom_10,axiom,(~ article1_condition_public_space__const)).

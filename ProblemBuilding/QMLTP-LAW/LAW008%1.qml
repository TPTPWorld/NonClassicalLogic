...
% Problem  : ?
% Version  : ?
% English  : A person was driving a car on the main street while smoking with a child in it. The car was designed as home car but not used as one at the time of offence. We expect the person to be liable for a fine
%

...
% Problem  : ?
% Version  : ?
% English  : A person was driving a car on the street while smoking with a child in it. The car was designed and used as a living accommodation. We expect the person not to be liable for a fine
%
...
qmf(axiom_12,axiom,article1_condition_used_homecar__const).

qmf(con,conjecture,(((#box(i) : (~ punishment_fine__const)) & (#box(a) : ~ (~ punishment_fine__const))))).

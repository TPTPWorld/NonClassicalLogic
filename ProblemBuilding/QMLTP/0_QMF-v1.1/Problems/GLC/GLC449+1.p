...
qmf(make_subs_of_equiv,axiom,
( #box : (( ( #box : ( ! [X] : ( #box : (is_a_theorem(equiv(X, X)))))) & ( ( #box : ( ! [X] : ( #box : ( ! [Y] : ( #box : (( #box : (is_a_theorem(equiv(X, Y)))) => ( #box : (is_a_theorem(equiv(not(X), not(Y))))) )))))) & ( ( #box : ( ! [X1] : ( #box : ( ! [X2] : ( #box : ( ! [Y1] : ( #box : ( ! [Y2] : ( #box : (( ( #box : (is_a_theorem(equiv(X1, X2)))) & ( #box : (is_a_theorem(equiv(Y1, Y2)))) ) => ( #box : (is_a_theorem(equiv(and(X1, Y1), and(X2, Y2))))) )))))))))) & ( #box : ( ! [X] : ( #box : ( ! [Y] : ( #box : (( ( #box : (is_a_theorem(X))) & ( #box : (is_a_theorem(equiv(X, Y)))) ) => ( #box : (is_a_theorem(Y))) )))))) ) ) ) => ( #box : ( ! [X] : ( #box : ( ! [Y] : ( #box : (( #box : (is_a_theorem(equiv(X, Y)))) => ( #box : (qmltpeq(X, Y))) )))))) ))).

qmf(subs_of_equiv,conjecture,
( #box : ( ! [X] : ( #box : ( ! [Y] : ( #box : (( #box : (is_a_theorem(equiv(X, Y)))) => ( #box : (qmltpeq(X, Y))) ))))))).

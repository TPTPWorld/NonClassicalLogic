...
qmf(x2133,conjecture,
( #box : (( ( #box : ( ! [X] : ( #box : (( ? [Y] : ( #box : (big_q(X, Y)))) => ( #box : (big_p(X))) )))) & ( ( #box : ( ! [V] : ( ? [U] : ( #box : (big_q(U, V)))))) & ( #box : ( ! [W] : ( #box : ( ! [Z] : ( #box : (( #box : (big_q(W, Z))) => ( ( #box : (big_q(Z, W))) | ( #box : (big_q(Z, Z))) ) )))))) ) ) => ( #box : ( ! [Z] : ( #box : (big_p(Z))))) ))).

...
% Comments :
%--------------------------------------------------------------------------
thf(law1,axiom-local,( {$box} @ ( ( ( dest @ paris ) & ( class @ first ) ) => ( price @ ninetyfive ) ) ) ).
thf(law2,axiom-local,( {$box} @ ( ( ( dest @ paris ) & ( class @ second ) ) => ( price @ seventy ) ) ) ).
thf(law3,axiom-local,( {$box} @ ( ~ ( ( ( class @ first ) & ( class @ second ) ) ) ) ) ).
thf(law4,axiom-local,( {$box} @ ( ~ ( ( ( price @ ninetyfive ) & ( price @ seventy ) ) ) ) ) ).
thf(belief1,axiom-local,( {$box} @ ( ( dest @ paris ) ) ) ).
thf(belief2,axiom-local,( {$box} @ ( ( class @ second ) ) ) ).

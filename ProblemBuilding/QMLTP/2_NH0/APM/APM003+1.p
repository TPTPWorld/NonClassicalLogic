...
%--------------------------------------------------------------------------
thf(ax1,axiom-local,( {$box} @ ( ? [ I :$i ] : ( {$box} @ ( ( userid @ u @ I ) & ( string @ I ) ) ) ) ) ).
thf(ax2,axiom-local,( ? [ B :$i ] : ( {$box} @ ( ( entry_box @ B ) & ( number @ B @ one ) ) ) ) ).
thf(ax3,axiom-local,( {$box} @ ( ! [ S :$i,I :$i,B :$i ] : ( ( ( string @ I ) & ( entry_box @ B ) ) => ( ? [ A :$i ] : ( {$box} @ ( ! [ S2 :$i ] : ( ( do @ S @ A @ S2 ) => ( in @ I @ B @ S2 ) ) ) ) ) ) ) ) ).

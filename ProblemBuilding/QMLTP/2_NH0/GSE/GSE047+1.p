...
%--------------------------------------------------------------------------
thf(pel43_1,axiom-local,( {$box} @ ( ! [ X :$i ] : ( {$box} @ ( ! [ Y :$i ] : ( ( {$box} @ ( ( {$box} @ ( ( set_equal @ X @ Y ) ) ) => ( {$box} @ ( ! [ Z :$i ] : ( ( {$box} @ ( ( {$box} @ ( ( element @ Z @ X ) ) ) => ( {$box} @ ( ( element @ Z @ Y ) ) ) ) ) & ( {$box} @ ( ( {$box} @ ( ( element @ Z @ Y ) ) ) => ( {$box} @ ( ( element @ Z @ X ) ) ) ) ) ) ) ) ) ) & ( {$box} @ ( ( {$box} @ ( ! [ Z :$i ] : ( ( {$box} @ ( ( {$box} @ ( ( element @ Z @ X ) ) ) => ( {$box} @ ( ( element @ Z @ Y ) ) ) ) ) & ( {$box} @ ( ( {$box} @ ( ( element @ Z @ Y ) ) ) => ( {$box} @ ( ( element @ Z @ X ) ) ) ) ) ) ) ) => ( {$box} @ ( ( set_equal @ X @ Y ) ) ) ) ) ) ) ) ) ) ).

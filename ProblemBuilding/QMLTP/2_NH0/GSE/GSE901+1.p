...
thf(l46_zfmisc_1,axiom-local,( {$box} @ ( ! [ A :$i ] : ( {$box} @ ( ! [ B :$i ] : ( {$box} @ ( ! [ C :$i ] : ( ( {$box} @ ( ( {$box} @ ( ( subset @ A @ ( unordered_pair @ B @ C ) ) ) ) => ( {$box} @ ( ~ ( ( ( {$box} @ ( ~ ( ( {$box} @ ( ( qmltpeq @ A @ empty_set ) ) ) ) ) ) & ( ( {$box} @ ( ~ ( ( {$box} @ ( ( qmltpeq @ A @ ( singleton @ B ) ) ) ) ) ) ) & ( ( {$box} @ ( ~ ( ( {$box} @ ( ( qmltpeq @ A @ ( singleton @ C ) ) ) ) ) ) ) & ( {$box} @ ( ~ ( ( {$box} @ ( ( qmltpeq @ A @ ( unordered_pair @ B @ C ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) & ( {$box} @ ( ( {$box} @ ( ~ ( ( ( {$box} @ ( ~ ( ( {$box} @ ( ( qmltpeq @ A @ empty_set ) ) ) ) ) ) & ( ( {$box} @ ( ~ ( ( {$box} @ ( ( qmltpeq @ A @ ( singleton @ B ) ) ) ) ) ) ) & ( ( {$box} @ ( ~ ( ( {$box} @ ( ( qmltpeq @ A @ ( singleton @ C ) ) ) ) ) ) ) & ( {$box} @ ( ~ ( ( {$box} @ ( ( qmltpeq @ A @ ( unordered_pair @ B @ C ) ) ) ) ) ) ) ) ) ) ) ) ) => ( {$box} @ ( ( subset @ A @ ( unordered_pair @ B @ C ) ) ) ) ) ) ) ) ) ) ) ) ) ).

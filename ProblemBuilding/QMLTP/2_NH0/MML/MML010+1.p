...
% Comments :
%--------------------------------------------------------------------------
thf(aciom_1,axiom-local,(![D:$i]:(![P:$i]:(({$box(#bs)}@({$box(#wu)}@((printedon@D@P))))=>({$box(#bs)}@({$box(#bu)}@((printableon@D@P)))))))).
thf(axiom_2_1,axiom-local,(![D:$i]:(![P:$i]:((({$box(#bs)}@({$box(#wu)}@((printed@D))))&({$box(#bs)}@({$box(#bu)}@((printed@D)=>((printedon@D@P))))))=>({$box(#bs)}@({$box(#wu)}@((printedon@D@P)))))))).
thf(axiom_2_2,axiom-local,(![D:$i]:(![P:$i]:((({$box(#bs)}@({$box(#wu)}@((printedon@D@P))))&({$box(#bs)}@({$box(#bu)}@((printedon@D@P)=>((printedable@D@P))))))=>({$box(#bs)}@({$box(#wu)}@((printedable@D@P)))))))).
thf(axiom_3,axiom-local,({$box(#bs)}@({$box(#wu)}@((printed@userdoc))))).
thf(axiom_4,axiom-local,({$box(#bs)}@({$box(#bu)}@(![D:$i]:((printed@D)=>(printedon@D@lw)))))).

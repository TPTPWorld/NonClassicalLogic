...
thf(l46_zfmisc_1,axiom-local,( ! [ A :$i,B :$i,C :$i ] : ( ( subset @ A @ ( unordered_pair @ B @ C ) ) <=> ~ ( ( ~ ( ( qmltpeq @ A @ empty_set ) ) & ~ ( ( qmltpeq @ A @ ( singleton @ B ) ) ) & ~ ( ( qmltpeq @ A @ ( singleton @ C ) ) ) & ~ ( ( qmltpeq @ A @ ( unordered_pair @ B @ C ) ) ) ) ) ) ) ).
%------------------------------------------------------------------------------

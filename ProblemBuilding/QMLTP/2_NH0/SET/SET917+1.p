...
thf(l28_zfmisc_1,axiom-local,( ! [ A :$i,B :$i ] : ( ~ ( ( in @ A @ B ) ) => ( disjoint @ ( singleton @ A ) @ B ) ) ) ).
thf(l32_zfmisc_1,axiom-local,( ! [ A :$i,B :$i ] : ( ( in @ A @ B ) => ( qmltpeq @ ( set_intersection2 @ B @ ( singleton @ A ) ) @ ( singleton @ A ) ) ) ) ).

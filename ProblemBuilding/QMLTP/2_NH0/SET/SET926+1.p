...
thf(set_difference_substitution_1,axiom-local,( ! [ A :$i,B :$i,C :$i ] : ( ( qmltpeq @ A @ B ) => ( qmltpeq @ ( set_difference @ A @ C ) @ ( set_difference @ B @ C ) ) ) ) ).
thf(set_difference_substitution_2,axiom-local,( ! [ A :$i,B :$i,C :$i ] : ( ( qmltpeq @ A @ B ) => ( qmltpeq @ ( set_difference @ C @ A ) @ ( set_difference @ C @ B ) ) ) ) ).
...
thf(l34_zfmisc_1,axiom-local,( ! [ A :$i,B :$i ] : ( ( qmltpeq @ ( set_difference @ ( singleton @ A ) @ B ) @ ( singleton @ A ) ) <=> ~ ( ( in @ A @ B ) ) ) ) ).
thf(l36_zfmisc_1,axiom-local,( ! [ A :$i,B :$i ] : ( ( qmltpeq @ ( set_difference @ ( singleton @ A ) @ B ) @ empty_set ) <=> ( in @ A @ B ) ) ) ).

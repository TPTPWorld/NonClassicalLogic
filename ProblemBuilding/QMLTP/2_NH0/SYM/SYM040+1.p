...
% converted problem
%--------------------------------------------------------------------------
% File     : SYM040+1 : QMLTP v1.1
% Domain   : Syntactic (modal)
% Problem  :
% Version  : Especial.
% English  : "each actual entity is material at every world at which it
%            exists" does not entail "each actual entity is material at
%            each world"
...
% Comments :
%--------------------------------------------------------------------------
thf(con,conjecture,( ~ ( ( ( ! [ X :$i ] : ( {$box} @ ( ( ( e @ X ) ) => ( m @ X ) ) ) ) => ( ! [ X :$i ] : ( {$box} @ ( ( m @ X ) ) ) ) ) ) ) ).

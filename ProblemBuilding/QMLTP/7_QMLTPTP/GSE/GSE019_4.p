%------------------------------------------------------------------------------
% File     : GSE019_4 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Set Theory
% Problem  : Two sets that contain one another are equal
% Version  : [QMLTP] axioms.
% English  : Goedel encoding of the TPTP SET019+4 problem

% Refs     : [Goe69] Goedel (1969), An Interpretation of the Intuitionistic
%          : [RO12]  Raths & Otten (2012), The QMLTP Problem Library for Fi
% Source   : [QMLTP]
% Names    : GSE019+1 [QMLTP]
...
%            Number of connectives :  321 (   3   ~;   4   |;  26   &)
%                                         (   0 <=>;  45  =>;   0  <=;   0 <~>)
%                                         ( 243 {}@;   0 {#};   0 {.})
%            Maximal formula depth :    2 (   2 avg)
%            Maximal term depth    :    2 (   1 avg)
%            Number of FOOLs       :  243 ( 243 fml;   0 var)

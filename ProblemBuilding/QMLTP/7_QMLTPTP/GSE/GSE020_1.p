%------------------------------------------------------------------------------
% File     : GSE020_1 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Set Theory
% Problem  : Uniqueness of 1st and 2nd when X is an ordered pair of sets
% Version  : [QMLTP] axioms.
% English  : Goedel encoding of the TPTP SET020+1 problem
...
%            Number of atoms       : 1318 (   0 equ)
%            Maximal formula atoms :    6 (  15 avg)
%            Number of connectives :  706 (   8   ~;   5   |;  70   &)
%                                         (   0 <=>;  87  =>;   0  <=;   0 <~>)
%                                         ( 536 {}@;   0 {#};   0 {.})
%            Maximal formula depth :    5 (   2 avg)
%            Maximal term depth    :    4 (   1 avg)
%            Number of FOOLs       :  536 ( 536 fml;   0 var)
...
%            Number of variables   :  200 (; 195   !;   5   ?; 200   :)
...
tff(unique_1st_and_2nd_in_pair_of_sets1,conjecture,
    ( {$box}
    @ (! [U: $i] :
         ( {$box}
         @ (! [V: $i] :
              ...
              @ (! [X: $i] :
                   ( {$box}
                   @ (( ( ( {$box} @ (member(U,universal_class)) )
                        & ( {$box} @ (member(V,universal_class)) )
                        & ( {$box} @ (qmltpeq(X,ordered_pair(U,V))) ) )
                     => ( ( {$box} @ (qmltpeq(first(X),U)) )
                        & ( {$box} @ (qmltpeq(second(X),V)) ) ) )) )) )) )) ) ).

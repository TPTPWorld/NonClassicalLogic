%------------------------------------------------------------------------------
% File     : GSE054_1 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Set Theory
% Problem  : Reflexivity of subclass
% Version  : [QMLTP] axioms.
% English  : Goedel encoding of the TPTP SET054+1 problem
...
%            Number of connectives :  695 (   8   ~;   5   |;  67   &)
%                                         (   0 <=>;  86  =>;   0  <=;   0 <~>)
%                                         ( 529 {}@;   0 {#};   0 {.})
%            Maximal formula depth :    5 (   2 avg)
%            Maximal term depth    :    4 (   1 avg)
%            Number of FOOLs       :  529 ( 529 fml;   0 var)
...
%            Number of variables   :  198 (; 193   !;   5   ?; 198   :)
...
tff(reflexivity_of_subclass,conjecture,
    ( {$box}
    @ (! [X: $i] : ( {$box} @ (subclass(X,X)) )) ) ).

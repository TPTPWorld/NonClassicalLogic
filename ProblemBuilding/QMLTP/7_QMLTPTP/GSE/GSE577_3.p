%------------------------------------------------------------------------------
% File     : GSE577_3 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Set Theory
% Problem  : Trybulec's 18th Boolean property of sets
% Version  : [QMLTP] axioms.
% English  : Goedel encoding of the TPTP SET577+3 problem

% Refs     : [Goe69] Goedel (1969), An Interpretation of the Intuitionistic
%          : [RO12]  Raths & Otten (2012), The QMLTP Problem Library for Fi
% Source   : [QMLTP]
% Names    : GSE577+1 [QMLTP]
...
%            Number of connectives :  171 (   0   ~;   4   |;  14   &)
%                                         (   0 <=>;  25  =>;   0  <=;   0 <~>)
%                                         ( 128 {}@;   0 {#};   0 {.})

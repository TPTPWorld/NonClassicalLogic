%------------------------------------------------------------------------------
% File     : GSE583_3 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Set Theory
% Problem  : Extensionality
% Version  : [QMLTP] axioms.
% English  : Goedel encoding of the TPTP SET583+3 problem

% Refs     : [Goe69] Goedel (1969), An Interpretation of the Intuitionistic
%          : [RO12]  Raths & Otten (2012), The QMLTP Problem Library for Fi
% Source   : [QMLTP]
% Names    : GSE583+1 [QMLTP]

% Status   : Theorem
% Rating   : ? v9.0.0
% Syntax   : Number of formulae    :   14 (   0 unt;   3 typ;   0 def)
%            Number of atoms       :  182 (   0 equ)
%            Maximal formula atoms :    2 (  16 avg)
%            Number of connectives :   97 (   0   ~;   0   |;  10   &)
%                                         (   0 <=>;  13  =>;   0  <=;   0 <~>)
%                                         (  74 {}@;   0 {#};   0 {.})

%------------------------------------------------------------------------------
% File     : GSE902_1 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Set Theory
% Problem  : Basic properties of sets, theorem 43
% Version  : [QMLTP] axioms.
% English  : Goedel encoding of the TPTP SET902+1 problem

% Refs     : [Goe69] Goedel (1969), An Interpretation of the Intuitionistic
%          : [RO12]  Raths & Otten (2012), The QMLTP Problem Library for Fi
% Source   : [QMLTP]
% Names    : GSE902+1 [QMLTP]
...
%            Number of connectives :  143 (  10   ~;   2   |;  11   &)
%                                         (   0 <=>;  12  =>;   0  <=;   0 <~>)
%                                         ( 108 {}@;   0 {#};   0 {.})
...
tff(l1_zfmisc_1,axiom-local,
    ...
    @ (! [A: $i] :
         ( {$box}
         @ (~ ( {$box} @ (qmltpeq(singleton(A),empty_set)) )) )) ) ).
...
tff(t7_xboole_1,axiom-local,
    ...
    @ (! [A: $i] :
         ( {$box}
         @ (! [B: $i] : ( {$box} @ (subset(A,set_union2(A,B))) )) )) ) ).

%------------------------------------------------------------------------------
% File     : GSE906_1 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Set Theory
% Problem  : subset(set_union2(unordered_pair(A,B),C),C) => in(A,C)
% Version  : [QMLTP] axioms.
% English  : Goedel encoding of the TPTP SET906+1 problem
...
% Status   : Unknown
% Rating   : ? v9.0.0
% Syntax   : Number of formulae    :   31 (   0 unt;   6 typ;   0 def)
%            Number of atoms       :  431 (   0 equ)
%            Maximal formula atoms :    2 (  17 avg)
%            Number of connectives :  235 (   6   ~;   8   |;  13   &)
%                                         (   0 <=>;  31  =>;   0  <=;   0 <~>)
%                                         ( 177 {}@;   0 {#};   0 {.})
%            Maximal formula depth :    3 (   2 avg)
%            Maximal term depth    :    3 (   1 avg)
%            Number of FOOLs       :  177 ( 177 fml;   0 var)
%            Number of types       :    2 (   0 usr)
%            Number of type conns  :   11 (   6   >;   5   *;   0   +;   0  <<)
%            Number of predicates  :    5 (   4 usr;   0 prp; 1-2 aty)
%            Number of functors    :    2 (   2 usr;   0 con; 2-2 aty)
%            Number of variables   :   65 (;  63   !;   2   ?;  65   :)
...
tff(t47_zfmisc_1,conjecture,
    ...
    @ (! [A: $i] :
         ...
         @ (! [B: $i] :
              ...
              @ (! [C: $i] :
                   ( {$box}
                   @ (( ( {$box} @ (subset(set_union2(unordered_pair(A,B),C),C)) )
                     => ( {$box} @ (in(A,C)) ) )) )) )) )) ) ).

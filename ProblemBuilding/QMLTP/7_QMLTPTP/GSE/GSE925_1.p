%------------------------------------------------------------------------------
% File     : GSE925_1 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Set Theory
% Problem  : difference(singleton(A),B) = empty_set <=> in(A,B)
% Version  : [QMLTP] axioms.
% English  : Goedel encoding of the TPTP SET925+1 problem

% Refs     : [Goe69] Goedel (1969), An Interpretation of the Intuitionistic
%          : [RO12]  Raths & Otten (2012), The QMLTP Problem Library for Fi
% Source   : [QMLTP]
% Names    : GSE925+1 [QMLTP]

% Status   : Theorem
% Rating   : ? v9.0.0
% Syntax   : Number of formulae    :   21 (   0 unt;   6 typ;   0 def)
%            Number of atoms       :  188 (   0 equ)
%            Maximal formula atoms :    2 (  12 avg)
%            Number of connectives :   98 (   2   ~;   0   |;   6   &)
%                                         (   0 <=>;  13  =>;   0  <=;   0 <~>)
%                                         (  77 {}@;   0 {#};   0 {.})

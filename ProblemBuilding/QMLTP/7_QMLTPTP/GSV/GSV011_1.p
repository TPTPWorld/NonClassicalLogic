%------------------------------------------------------------------------------
% File     : GSV011_1 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Software Verification
% Problem  : Fact 2 of the Neumann-Stubblebine analysis
% Version  : [QMLTP] axioms.
% English  : Goedel encoding of the TPTP SWV011+1 problem

% Refs     : [Goe69] Goedel (1969), An Interpretation of the Intuitionistic
%          : [RO12]  Raths & Otten (2012), The QMLTP Problem Library for Fi
% Source   : [QMLTP]
% Names    : GSV011+1 [QMLTP]
%          : GSV011_1.001_k_constant_rigid.p [QMLTP/4_NX0_SEMs]

% Status   : Theorem
% Rating   : ? v9.0.0
% Syntax   : Number of formulae    :   40 (   0 unt;  23 typ;   0 def)
%            Number of atoms       :   54 (   0 equ)
%            Maximal formula atoms :    4 (   3 avg)
%            Number of connectives :   19 (   0   ~;   0   |;   1   &)
%                                         (   0 <=>;   0  =>;   0  <=;   0 <~>)
%                                         (  18 {}@;   0 {#};   0 {.})

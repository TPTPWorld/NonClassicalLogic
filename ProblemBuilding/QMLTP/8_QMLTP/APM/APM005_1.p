%------------------------------------------------------------------------------
% File     : APM005_1 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Planning
...
% Comments : It is not clear from [Sto98] what the logic should be. I did the
%            best I can, based on reading [Sto98] and results I have.
%------------------------------------------------------------------------------

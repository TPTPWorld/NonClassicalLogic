%------------------------------------------------------------------------------
% File     : SYM337_1 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Syntactic
...
% Source   : [TPTP]
% Names    : SYM337+1 [QMLTP]

% Status   : Unknown
% Rating   : ? v9.0.0
% Syntax   : Number of formulae    :   42 (   1 unt;  20 typ;   0 def)
%            Number of atoms       :  847 (   0 equ)
%            Maximal formula atoms :    4 (  38 avg)
%            Number of connectives :  502 (  46   ~;  60   |;  27   &)
%                                         (   0 <=>;   0  =>;   0  <=;   0 <~>)
%                                         ( 369 {}@;   0 {#};   0 {.})
%            Maximal formula depth :    3 (   2 avg)
%            Maximal term depth    :    0 (   0 avg)
%            Number of FOOLs       :  369 ( 369 fml;   0 var)

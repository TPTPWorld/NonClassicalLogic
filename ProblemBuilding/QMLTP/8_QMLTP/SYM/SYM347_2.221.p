%------------------------------------------------------------------------------
% File     : SYM347_1 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Syntactic
...
% Source   : [TPTP]
% Names    : SYM347+1 [QMLTP]

% Status   : Unknown
% Rating   : ? v9.0.0
% Syntax   : Number of formulae    :   62 (   1 unt;  20 typ;   0 def)
%            Number of atoms       : 1667 (   0 equ)
%            Maximal formula atoms :    4 (  39 avg)
%            Number of connectives :  975 (  89   ~; 120   |;  27   &)
%                                         (   0 <=>;   0  =>;   0  <=;   0 <~>)
%                                         ( 739 {}@;   0 {#};   0 {.})
%            Maximal formula depth :    3 (   2 avg)
%            Maximal term depth    :    0 (   0 avg)
%            Number of FOOLs       :  739 ( 739 fml;   0 var)

%------------------------------------------------------------------------------
% File     : SYM348_1 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Syntactic
...
% Source   : [TPTP]
% Names    : SYM348+1 [QMLTP]

% Status   : Unknown
% Rating   : ? v9.0.0
% Syntax   : Number of formulae    :   70 (   1 unt;  28 typ;   0 def)
%            Number of atoms       : 2171 (   0 equ)
%            Maximal formula atoms :    4 (  51 avg)
%            Number of connectives : 1243 (  99   ~; 120   |;  39   &)
%                                         (   0 <=>;   0  =>;   0  <=;   0 <~>)
%                                         ( 985 {}@;   0 {#};   0 {.})
%            Maximal formula depth :    3 (   2 avg)
%            Maximal term depth    :    0 (   0 avg)
%            Number of FOOLs       :  985 ( 985 fml;   0 var)

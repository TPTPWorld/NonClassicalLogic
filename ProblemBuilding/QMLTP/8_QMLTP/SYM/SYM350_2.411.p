%------------------------------------------------------------------------------
% File     : SYM350_1 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Syntactic
...
% Source   : [TPTP]
% Names    : SYM350+1 [QMLTP]

% Status   : Unknown
% Rating   : ? v9.0.0
% Syntax   : Number of formulae    :   70 (   1 unt;  28 typ;   0 def)
%            Number of atoms       : 2113 (   0 equ)
%            Maximal formula atoms :    4 (  50 avg)
%            Number of connectives : 1211 (  96   ~; 120   |;  39   &)
%                                         (   0 <=>;   0  =>;   0  <=;   0 <~>)
%                                         ( 956 {}@;   0 {#};   0 {.})
%            Maximal formula depth :    3 (   2 avg)
%            Maximal term depth    :    0 (   0 avg)
%            Number of FOOLs       :  956 ( 956 fml;   0 var)

%------------------------------------------------------------------------------
% File     : SYM358_1 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Syntactic
...
% Source   : [TPTP]
% Names    : SYM358+1 [QMLTP]

% Status   : Unknown
% Rating   : ? v9.0.0
% Syntax   : Number of formulae    :   72 (   1 unt;  20 typ;   0 def)
%            Number of atoms       : 1917 (   0 equ)
%            Maximal formula atoms :    4 (  36 avg)
%            Number of connectives : 1137 ( 116   ~; 150   |;  27   &)
%                                         (   0 <=>;   0  =>;   0  <=;   0 <~>)
%                                         ( 844 {}@;   0 {#};   0 {.})

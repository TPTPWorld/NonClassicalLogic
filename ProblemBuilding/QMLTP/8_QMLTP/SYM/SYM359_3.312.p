%------------------------------------------------------------------------------
% File     : SYM359_1 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Syntactic
...
% Source   : [TPTP]
% Names    : SYM359+1 [QMLTP]

% Status   : Unknown
% Rating   : ? v9.0.0
% Syntax   : Number of formulae    :   72 (   1 unt;  20 typ;   0 def)
%            Number of atoms       : 1955 (   0 equ)
%            Maximal formula atoms :    4 (  37 avg)
%            Number of connectives : 1153 ( 113   ~; 150   |;  27   &)
%                                         (   0 <=>;   0  =>;   0  <=;   0 <~>)
%                                         ( 863 {}@;   0 {#};   0 {.})
%            Maximal formula depth :    3 (   2 avg)
%            Maximal term depth    :    0 (   0 avg)
%            Number of FOOLs       :  863 ( 863 fml;   0 var)

%------------------------------------------------------------------------------
% File     : SYM368_1 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Syntactic
...
% Source   : [TPTP]
% Names    : SYM368+1 [QMLTP]

% Status   : Unknown
% Rating   : ? v9.0.0
% Syntax   : Number of formulae    :   92 (   1 unt;  40 typ;   0 def)
%            Number of atoms       : 3589 (   0 equ)
%            Maximal formula atoms :    4 (  69 avg)
%            Number of connectives : 1995 ( 124   ~; 150   |;  55   &)
%                                         (   0 <=>;   0  =>;   0  <=;   0 <~>)
%                                         (1666 {}@;   0 {#};   0 {.})
%            Maximal formula depth :    3 (   2 avg)
%            Maximal term depth    :    0 (   0 avg)
%            Number of FOOLs       : 1666 (1666 fml;   0 var)

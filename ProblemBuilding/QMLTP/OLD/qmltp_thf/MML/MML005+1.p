...
% Comments :
%--------------------------------------------------------------------------
thf(i_always_praise_1_1,axiom,((({$box(#always)}@(dropped@cheese))=>({$box(#praise)}@({$box(#always)}@(dropped@cheese)))))).
thf(i_always_praise_2_2,axiom,(({$box(#always)}@(~((dropped@cheese))))=>({$box(#praise)}@({$box(#always)}@(~((dropped@cheese))))))).
thf(i_always_praise_1_3,axiom,((({$box(#always)}@(charmed@raven))=>({$box(#praise)}@({$box(#always)}@(charmed@raven)))))).
thf(i_always_praise_2_4,axiom,(({$box(#always)}@(~((charmed@cheese))))=>({$box(#praise)}@({$box(#always)}@(~((charmed@raven))))))).
thf(i_always_praise_1_5,axiom,((({$box(#always)}@(dropped@cheese))=>({$box(#sing)}@({$box(#always)}@(dropped@cheese)))))).
thf(i_always_praise_2_6,axiom,(({$box(#always)}@(~((dropped@cheese))))=>({$box(#sing)}@({$box(#always)}@(~((dropped@cheese))))))).
thf(i_always_praise_1_7,axiom,((({$box(#always)}@(charmed@raven))=>({$box(#sing)}@({$box(#always)}@(charmed@raven)))))).
thf(i_always_praise_2_8,axiom,(({$box(#always)}@(~((charmed@cheese))))=>({$box(#sing)}@({$box(#always)}@(~((charmed@raven))))))).
thf(axiom_1,axiom,({$box(#fox)}@({$box(#praise)}@(charmed@raven)))).
thf(axiom_2,axiom,({$box(#fox)}@({$box(#always)}@((charmed@raven)=>({$box(#sing)}@(dropped@cheese)))))).

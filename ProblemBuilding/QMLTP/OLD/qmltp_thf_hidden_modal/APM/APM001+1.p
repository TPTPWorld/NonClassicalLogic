...
% Comments :
%--------------------------------------------------------------------------
thf ( law1 , axiom , ( bBox @ ( ( ( dest @ paris ) & ( class @ first ) ) => ( price @ ninetyfive ) ) ) ) .
thf ( law2 , axiom , ( bBox @ ( ( ( dest @ paris ) & ( class @ second ) ) => ( price @ seventy ) ) ) ) .
thf ( law3 , axiom , ( bBox @ ( ~ ( ( ( class @ first ) & ( class @ second ) ) ) ) ) ) .
thf ( law4 , axiom , ( bBox @ ( ~ ( ( ( price @ ninetyfive ) & ( price @ seventy ) ) ) ) ) ) .
thf ( belief1 , axiom , ( bBox @ ( ( dest @ paris ) ) ) ) .
thf ( belief2 , axiom , ( bBox @ ( ( class @ second ) ) ) ) .
thf ( con , conjecture , ( bBox @ ( ( price @ seventy ) ) ) ) .

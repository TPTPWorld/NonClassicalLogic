...
thf ( left_cancellation , conjecture , ( ! [ X :$i , Y :$i , Z :$i ] : ( ( ( member @ Y @ universal_class ) & ( member @ Z @ universal_class ) & ( qmltpeq @ ( unordered_pair @ X @ Y ) @ ( unordered_pair @ X @ Z ) ) ) => ( qmltpeq @ Y @ Z ) ) ) ) .
%------------------------------------------------------------------------------
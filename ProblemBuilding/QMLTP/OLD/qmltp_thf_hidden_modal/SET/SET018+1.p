...
thf ( ordered_pair_determines_components2 , conjecture , ( ! [ W :$i , X :$i , Y :$i , Z :$i ] : ( ( ( qmltpeq @ ( ordered_pair @ W @ X ) @ ( ordered_pair @ Y @ Z ) ) & ( member @ X @ universal_class ) ) => ( qmltpeq @ X @ Z ) ) ) ) .
%------------------------------------------------------------------------------
...
thf(d7_xboole_0,axiom,({$box}@(![A:$i]:({$box}@(![B:$i]:(({$box}@(({$box}@((disjoint@A@B)))=>({$box}@(((set_intersection2@A@B)=empty_set)))))&({$box}@(({$box}@(((set_intersection2@A@B)=empty_set)))=>({$box}@((disjoint@A@B))))))))))).

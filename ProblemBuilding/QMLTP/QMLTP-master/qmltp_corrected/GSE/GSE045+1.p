...
qmf(pel41_1,axiom,
( #box : ( ! [Z] : ( ? [Y] : ( #box : ( ! [X] : (( #box : (( #box : (element(X, Y))) => ( ( #box : (element(X, Z))) & ( #box : (~ ( #box : (element(X, X))) )) ) )) & (#box : (( ( #box : (element(X, Z))) & ( #box : (~ ( #box : (element(X, X))) )) ) => ( #box : (element(X, Y))) ))))))))).

qmf(pel41,conjecture,
( #box : (~ ( ? [Z] : ( #box : ( ! [X] : ( #box : (element(X, Z)))))) ))).

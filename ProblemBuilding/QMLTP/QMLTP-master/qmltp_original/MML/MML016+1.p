...
qmf(axiom_1,axiom,
 (#box(b(s)) : ((dest(paris) & class(first)) => price(ninetyfive)))).

qmf(axiom_2,axiom,
 (#box(b(s)) : ((dest(paris) & class(second)) => price(seventy)))).

qmf(axiom_3_s,axiom,
 (#box(b(s)) : (~ (class(first) & class(second))))).

qmf(axiom_3_u,axiom,
 (#box(b(u)) : (~ (class(first) & class(second))))).

qmf(axiom_4_s,axiom,
 (#box(b(s)) : (~ (price(seventy) & price(ninetyfive))))).

qmf(axiom_4_u,axiom,
 (#box(b(u)) : (~ (price(seventy) & price(ninetyfive))))).

qmf(axiom_5,axiom,
 (#box(b(s)) : (dest(paris) & class(second)))).

qmf(con,conjecture,
 (#box(b(s)) : (price(seventy)))).

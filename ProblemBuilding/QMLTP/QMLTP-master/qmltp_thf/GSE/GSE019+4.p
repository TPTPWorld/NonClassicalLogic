...
% converted problem
%--------------------------------------------------------------------------
% File     : GSE019+4 : QMLTP v1.1
% Domain   : GSE (Goedel translation of Set Theory)
% Problem  : Goedel translation of SET019+4 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
thf ( thI02 , conjecture , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ( ( $box @ ( ( subset @ A @ B ) ) ) & ( $box @ ( ( subset @ B @ A ) ) ) ) => ( $box @ ( ( equal_set @ A @ B ) ) ) ) ) ) ) ) ) ) .
...
% File     : GLC448+1 : QMLTP v1.1

% Domain   : GLC (Goedel translation of Logic Calculi)

% Problem  : Goedel translation of LCL448+1 (from TPTP-v5.0.0)
...
thf(principia_op_implies_or,axiom,($box@(op_implies_or))).
thf(principia_op_and,axiom,($box@(op_and))).
thf(principia_op_equiv,axiom,($box@(op_equiv))).
thf(principia_modus_ponens,axiom,($box@(modus_ponens))).
thf(principia_r1,axiom,($box@(r1))).
thf(principia_r2,axiom,($box@(r2))).
thf(principia_r3,axiom,($box@(r3))).
thf(principia_r5,axiom,($box@(r5))).
thf(substitution_of_equivalents_1,axiom,($box@(substitution_of_equivalents))).
thf(principia_r4,conjecture,($box@(r4))).
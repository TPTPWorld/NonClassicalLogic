...
% File     : GLC450+1 : QMLTP v1.1

% Domain   : GLC (Goedel translation of Logic Calculi)

% Problem  : Goedel translation of LCL450+1 (from TPTP-v5.0.0)
...
% removed axiom and_substitution_1
% removed axiom and_substitution_2
% removed axiom equiv_substitution_1
% removed axiom equiv_substitution_2
% removed axiom implies_substitution_1
% removed axiom implies_substitution_2
% removed axiom not_substitution_1
% removed axiom or_substitution_1
% removed axiom or_substitution_2
% removed axiom is_a_theorem_substitution_1
...
thf(substitution_of_equivalents_0,axiom,(($box@(($box@(substitution_of_equivalents))=>($box@(![X:$i]:($box@(![Y:$i]:($box@(($box@((is_a_theorem@(equiv@X@Y))))=>($box@((X=Y)))))))))))&($box@(($box@(![X:$i]:($box@(![Y:$i]:($box@(($box@((is_a_theorem@(equiv@X@Y))))=>($box@((X=Y)))))))))=>($box@(substitution_of_equivalents)))))).
...
thf(op_or_0,axiom,($box@(($box@(op_or))=>($box@(![X:$i]:($box@(![Y:$i]:($box@(((or@X@Y)=(not@(and@(not@X)@(not@Y))))))))))))).
thf(op_and_0,axiom,($box@(($box@(op_and))=>($box@(![X:$i]:($box@(![Y:$i]:($box@(((and@X@Y)=(not@(or@(not@X)@(not@Y))))))))))))).
thf(op_implies_and_0,axiom,($box@(($box@(op_implies_and))=>($box@(![X:$i]:($box@(![Y:$i]:($box@(((implies@X@Y)=(not@(and@X@(not@Y))))))))))))).
thf(op_implies_or_0,axiom,($box@(($box@(op_implies_or))=>($box@(![X:$i]:($box@(![Y:$i]:($box@(((implies@X@Y)=(or@(not@X)@Y))))))))))).
thf(op_equiv_0,axiom,($box@(($box@(op_equiv))=>($box@(![X:$i]:($box@(![Y:$i]:($box@(((equiv@X@Y)=(and@(implies@X@Y)@(implies@Y@X)))))))))))).
...
thf(equiv_congruence,conjecture,(($box@(![X:$i]:($box@((is_a_theorem@(equiv@X@X))))))&(($box@(![X:$i]:($box@(![Y:$i]:($box@(($box@((is_a_theorem@(equiv@X@Y))))=>($box@((is_a_theorem@(equiv@(not@X)@(not@Y)))))))))))&(($box@(![X1:$i]:($box@(![X2:$i]:($box@(![Y1:$i]:($box@(![Y2:$i]:($box@((($box@((is_a_theorem@(equiv@X1@X2))))&($box@((is_a_theorem@(equiv@Y1@Y2)))))=>($box@((is_a_theorem@(equiv@(and@X1@Y1)@(and@X2@Y2)))))))))))))))&($box@(![X:$i]:($box@(![Y:$i]:($box@((($box@((is_a_theorem@X)))&($box@((is_a_theorem@(equiv@X@Y)))))=>($box@((is_a_theorem@Y))))))))))))).
...
thf(ordered_pair_determines_components2,conjecture,($box@(![W:$i]:($box@(![X:$i]:($box@(![Y:$i]:($box@(![Z:$i]:($box@((($box@(((ordered_pair@W@X)=(ordered_pair@Y@Z))))&($box@((member@X@universal_class))))=>($box@((X=Z)))))))))))))).
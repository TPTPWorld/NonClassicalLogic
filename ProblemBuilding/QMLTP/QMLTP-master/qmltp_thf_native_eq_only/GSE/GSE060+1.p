...
% File     : GSE060+1 : QMLTP v1.1

% Domain   : GSE (Goedel translation of Set Theory)

% Problem  : Goedel translation of SET060+1 (from TPTP-v5.0.0)
...
thf(special_classes_lemma,conjecture,($box@(![X:$i]:($box@(![Y:$i]:($box@(~(($box@((member@Y@(intersection@(complement@X)@X)))))))))))).
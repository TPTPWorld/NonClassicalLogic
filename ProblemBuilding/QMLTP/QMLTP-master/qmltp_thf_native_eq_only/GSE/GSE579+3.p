...
thf(prove_th20,conjecture,($box@(![B:$i]:($box@(![C:$i]:($box@(![D:$i]:($box@(($box@(![E:$i]:(($box@(($box@((member@E@B)))=>(($box@((member@E@C)))&($box@(~(($box@((member@E@D)))))))))&($box@((($box@((member@E@C)))&($box@(~(($box@((member@E@D)))))))=>($box@((member@E@B))))))))=>($box@((B=(difference@C@D))))))))))))).
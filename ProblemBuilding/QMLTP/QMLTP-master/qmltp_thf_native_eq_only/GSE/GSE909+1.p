...
thf(d1_xboole_0,axiom,($box@(![A:$i]:(($box@(($box@((A=empty_set)))=>($box@(![B:$i]:($box@(~(($box@((in@B@A))))))))))&($box@(($box@(![B:$i]:($box@(~(($box@((in@B@A))))))))=>($box@((A=empty_set))))))))).
...
thf(d2_xboole_0,axiom,($box@(![A:$i]:($box@(![B:$i]:($box@(![C:$i]:(($box@(($box@((C=(set_union2@A@B))))=>($box@(![D:$i]:(($box@(($box@((in@D@C)))=>(($box@((in@D@A)))|($box@((in@D@B))))))&($box@((($box@((in@D@A)))|($box@((in@D@B))))=>($box@((in@D@C))))))))))&($box@(($box@(![D:$i]:(($box@(($box@((in@D@C)))=>(($box@((in@D@A)))|($box@((in@D@B))))))&($box@((($box@((in@D@A)))|($box@((in@D@B))))=>($box@((in@D@C))))))))=>($box@((C=(set_union2@A@B)))))))))))))).
...
thf(t50_zfmisc_1,conjecture,($box@(![A:$i]:($box@(![B:$i]:($box@(![C:$i]:($box@(~(($box@(((set_union2@(unordered_pair@A@B)@C)=empty_set))))))))))))).
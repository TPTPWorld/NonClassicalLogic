...
% converted problem
%--------------------------------------------------------------------------
% File     : GLC450+2 : QMLTP v1.1
% Domain   : GLC (Goedel translation of Logic Calculi)
% Problem  : Goedel translation of LCL450+2 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
thf(equiv_congruence,conjecture,( ( {$box} @ ( ! [ X :$i ] : ( {$box} @ ( ( is_a_theorem @ ( equiv @ X @ X ) ) ) ) ) ) & ( ( {$box} @ ( ! [ X :$i ] : ( {$box} @ ( ! [ Y :$i ] : ( {$box} @ ( ( {$box} @ ( ( is_a_theorem @ ( equiv @ X @ Y ) ) ) ) => ( {$box} @ ( ( is_a_theorem @ ( equiv @ ( not @ X ) @ ( not @ Y ) ) ) ) ) ) ) ) ) ) ) & ( ( {$box} @ ( ! [ X1 :$i ] : ( {$box} @ ( ! [ X2 :$i ] : ( {$box} @ ( ! [ Y :$i ] : ( {$box} @ ( ( {$box} @ ( ( is_a_theorem @ ( equiv @ X1 @ X2 ) ) ) ) => ( {$box} @ ( ( is_a_theorem @ ( equiv @ ( and @ X1 @ Y ) @ ( and @ X2 @ Y ) ) ) ) ) ) ) ) ) ) ) ) ) & ( ( {$box} @ ( ! [ X1 :$i ] : ( {$box} @ ( ! [ X2 :$i ] : ( {$box} @ ( ! [ Y :$i ] : ( {$box} @ ( ( {$box} @ ( ( is_a_theorem @ ( equiv @ X1 @ X2 ) ) ) ) => ( {$box} @ ( ( is_a_theorem @ ( equiv @ ( and @ Y @ X1 ) @ ( and @ Y @ X2 ) ) ) ) ) ) ) ) ) ) ) ) ) & ( {$box} @ ( ! [ X :$i ] : ( {$box} @ ( ! [ Y :$i ] : ( {$box} @ ( ( ( {$box} @ ( ( is_a_theorem @ X ) ) ) & ( {$box} @ ( ( is_a_theorem @ ( equiv @ X @ Y ) ) ) ) ) => ( {$box} @ ( ( is_a_theorem @ Y ) ) ) ) ) ) ) ) ) ) ) ) ) ).

...
% converted problem
%--------------------------------------------------------------------------
% File     : GSE011+3 : QMLTP v1.1
% Domain   : GSE (Goedel translation of Set Theory)
% Problem  : Goedel translation of SET011+3 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
thf(prove_difference_difference_intersection,conjecture,( {$box} @ ( ! [ B :$i ] : ( {$box} @ ( ! [ C :$i ] : ( {$box} @ ( ( qmltpeq @ ( difference @ B @ ( difference @ B @ C ) ) @ ( intersection @ B @ C ) ) ) ) ) ) ) ) ).

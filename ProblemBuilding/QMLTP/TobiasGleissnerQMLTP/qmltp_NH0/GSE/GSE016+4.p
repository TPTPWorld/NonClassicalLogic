...
% converted problem
%--------------------------------------------------------------------------
% File     : GSE016+4 : QMLTP v1.1
% Domain   : GSE (Goedel translation of Set Theory)
% Problem  : Goedel translation of SET016+4 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
thf(thI50a,conjecture,( {$box} @ ( ! [ A :$i ] : ( {$box} @ ( ! [ B :$i ] : ( {$box} @ ( ! [ U :$i ] : ( {$box} @ ( ! [ V :$i ] : ( {$box} @ ( ( {$box} @ ( ( equal_set @ ( unordered_pair @ ( singleton @ A ) @ ( unordered_pair @ A @ B ) ) @ ( unordered_pair @ ( singleton @ U ) @ ( unordered_pair @ U @ V ) ) ) ) ) => ( {$box} @ ( ( qmltpeq @ A @ U ) ) ) ) ) ) ) ) ) ) ) ) ) ).

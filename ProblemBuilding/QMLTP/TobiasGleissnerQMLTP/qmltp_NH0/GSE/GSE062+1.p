...
% converted problem
%--------------------------------------------------------------------------
% File     : GSE062+1 : QMLTP v1.1
% Domain   : GSE (Goedel translation of Set Theory)
% Problem  : Goedel translation of SET062+1 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
thf(null_class_is_subclass,conjecture,( {$box} @ ( ! [ X :$i ] : ( {$box} @ ( ( subclass @ null_class @ X ) ) ) ) ) ).

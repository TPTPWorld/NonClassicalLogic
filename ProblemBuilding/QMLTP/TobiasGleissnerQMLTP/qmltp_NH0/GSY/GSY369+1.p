...
% converted problem
%--------------------------------------------------------------------------
% File     : GSY369+1 : QMLTP v1.1
% Domain   : GSY (Goedel translation of Syntactic)
% Problem  : Goedel translation of SYN369+1 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
%--------------------------------------------------------------------------
thf(x2120,conjecture,( {$box} @ ( ( {$box} @ ( ! [ U :$i ] : ( {$box} @ ( ! [ V :$i ] : ( {$box} @ ( ! [ W :$i ] : ( ( {$box} @ ( ( big_p @ U @ V ) ) ) | ( {$box} @ ( ( big_p @ V @ W ) ) ) ) ) ) ) ) ) ) => ( ? [ X :$i ] : ( {$box} @ ( ! [ Y :$i ] : ( {$box} @ ( ( big_p @ X @ Y ) ) ) ) ) ) ) ) ).
%--------------------------------------------------------------------------

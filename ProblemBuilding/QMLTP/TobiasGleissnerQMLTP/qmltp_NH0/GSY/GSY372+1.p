...
% converted problem
%--------------------------------------------------------------------------
% File     : GSY372+1 : QMLTP v1.1
% Domain   : GSY (Goedel translation of Syntactic)
% Problem  : Goedel translation of SYN372+1 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
%--------------------------------------------------------------------------
thf(x2123,conjecture,( {$box} @ ( ! [ X :$i ] : ( {$box} @ ( ( ? [ Y :$i ] : ( {$box} @ ( ( {$box} @ ( ( big_p @ Y ) ) ) => ( {$box} @ ( ( big_q @ X ) ) ) ) ) ) => ( ? [ Y :$i ] : ( {$box} @ ( ( {$box} @ ( ( big_p @ Y ) ) ) => ( {$box} @ ( ( big_q @ Y ) ) ) ) ) ) ) ) ) ) ).
%--------------------------------------------------------------------------

...
thf(axiom_t_for_fool_1,axiom,(![X:$i]:(({$box(#fool)}@(ws@X))=>(ws@X)))).
thf(axiom_t_for_fool_2,axiom,(![X:$i]:(({$box(#fool)}@(~(((ws@X)))))=>(~(((ws@X))))))).
thf(axiom_4_for_fool_1,axiom,(![X:$i]:(({$box(#fool)}@(ws@X))=>({$box(#fool)}@({$box(#fool)}@((ws@X))))))).
thf(axiom_4_for_fool_2,axiom,(![X:$i]:(({$box(#fool)}@(~(((ws@X)))))=>({$box(#fool)}@({$box(#fool)}@(~(((ws@X))))))))).

...
qmf(quaternion_ds1_inuse_0005,conjecture,
( #box : (( (#box : (a_select2(rho_defuse, n0) = use)) & ( (#box : (a_select2(rho_defuse, n1) = use)) & ( (#box : (a_select2(rho_defuse, n2) = use)) & ( (#box : (a_select2(sigma_defuse, n0) = use)) & ( (#box : (a_select2(sigma_defuse, n1) = use)) & ( (#box : (a_select2(sigma_defuse, n2) = use)) & ( (#box : (a_select2(sigma_defuse, n3) = use)) & ( (#box : (a_select2(sigma_defuse, n4) = use)) & ( (#box : (a_select2(sigma_defuse, n5) = use)) & ( (#box : (a_select3(u_defuse, n0, n0) = use)) & ( (#box : (a_select3(u_defuse, n1, n0) = use)) & ( (#box : (a_select3(u_defuse, n2, n0) = use)) & ( (#box : (a_select2(xinit_defuse, n3) = use)) & ( (#box : (a_select2(xinit_defuse, n4) = use)) & ( (#box : (a_select2(xinit_defuse, n5) = use)) & ( (#box : (a_select2(xinit_mean_defuse, n0) = use)) & ( (#box : (a_select2(xinit_mean_defuse, n1) = use)) & ( (#box : (a_select2(xinit_mean_defuse, n2) = use)) & ( (#box : (a_select2(xinit_mean_defuse, n3) = use)) & ( (#box : (a_select2(xinit_mean_defuse, n4) = use)) & ( (#box : (a_select2(xinit_mean_defuse, n5) = use)) & ( (#box : (a_select2(xinit_noise_defuse, n0) = use)) & ( (#box : (a_select2(xinit_noise_defuse, n1) = use)) & ( (#box : (a_select2(xinit_noise_defuse, n2) = use)) & ( (#box : (a_select2(xinit_noise_defuse, n3) = use)) & ( (#box : (a_select2(xinit_noise_defuse, n4) = use)) & ( (#box : (a_select2(xinit_noise_defuse, n5) = use)) & ( ( #box : (leq(n0, pv5))) & ( ( #box : (leq(n0, pv41))) & ( ( #box : (leq(pv5, minus(n999, n1)))) & ( ( #box : (leq(pv41, minus(n6, n1)))) & ( ( #box : ( ! [A] : ( #box : ( ! [B] : ( #box : (( ( #box : (leq(n0, A))) & ( ( #box : (leq(n0, B))) & ( ( #box : (leq(A, n2))) & ( #box : (leq(B, pv5))) ) ) ) => ( (#box : (a_select3(u_defuse, A, B) = use)) & (#box : (a_select3(z_defuse, A, B) = use)) ) )))))) & ( #box : ( ! [C] : ( #box : ( ! [D] : ( #box : (( ( #box : (leq(n0, C))) & ( ( #box : (leq(n0, D))) & ( ( #box : (leq(C, n2))) & ( #box : (leq(D, minus(pv5, n1)))) ) ) ) => ( (#box : (a_select3(u_defuse, C, D) = use)) & (#box : (a_select3(z_defuse, C, D) = use)) ) )))))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) => ( (#box : (a_select2(rho_defuse, n0) = use)) & ( (#box : (a_select2(rho_defuse, n1) = use)) & ( (#box : (a_select2(rho_defuse, n2) = use)) & ( (#box : (a_select2(sigma_defuse, n0) = use)) & ( (#box : (a_select2(sigma_defuse, n1) = use)) & ( (#box : (a_select2(sigma_defuse, n2) = use)) & ( (#box : (a_select2(sigma_defuse, n3) = use)) & ( (#box : (a_select2(sigma_defuse, n4) = use)) & ( (#box : (a_select2(sigma_defuse, n5) = use)) & ( (#box : (a_select3(u_defuse, n0, n0) = use)) & ( (#box : (a_select3(u_defuse, n1, n0) = use)) & ( (#box : (a_select3(u_defuse, n2, n0) = use)) & ( (#box : (a_select2(xinit_defuse, n3) = use)) & ( (#box : (a_select2(xinit_defuse, n4) = use)) & ( (#box : (a_select2(xinit_defuse, n5) = use)) & ( (#box : (a_select2(xinit_mean_defuse, n0) = use)) & ( (#box : (a_select2(xinit_mean_defuse, n1) = use)) & ( (#box : (a_select2(xinit_mean_defuse, n2) = use)) & ( (#box : (a_select2(xinit_mean_defuse, n3) = use)) & ( (#box : (a_select2(xinit_mean_defuse, n4) = use)) & ( (#box : (a_select2(xinit_mean_defuse, n5) = use)) & ( (#box : (a_select2(xinit_noise_defuse, n0) = use)) & ( (#box : (a_select2(xinit_noise_defuse, n1) = use)) & ( (#box : (a_select2(xinit_noise_defuse, n2) = use)) & ( (#box : (a_select2(xinit_noise_defuse, n3) = use)) & ( (#box : (a_select2(xinit_noise_defuse, n4) = use)) & ( (#box : (a_select2(xinit_noise_defuse, n5) = use)) & ( ( #box : (leq(n0, pv5))) & ( ( #box : (leq(pv5, minus(n999, n1)))) & ( ( #box : ( ! [E] : ( #box : ( ! [F] : ( #box : (( ( #box : (leq(n0, E))) & ( ( #box : (leq(n0, F))) & ( ( #box : (leq(E, n2))) & ( #box : (leq(F, pv5))) ) ) ) => ( (#box : (a_select3(u_defuse, E, F) = use)) & (#box : (a_select3(z_defuse, E, F) = use)) ) )))))) & ( #box : ( ! [G] : ( #box : ( ! [H] : ( #box : (( ( #box : (leq(n0, G))) & ( ( #box : (leq(n0, H))) & ( ( #box : (leq(G, n2))) & ( #box : (leq(H, minus(pv5, n1)))) ) ) ) => ( (#box : (a_select3(u_defuse, G, H) = use)) & (#box : (a_select3(z_defuse, G, H) = use)) ) )))))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ))).
...
qmf(gt_6_tptp_minus_1,axiom,
( #box : (gt(n6, tptp_minus_1)))).

qmf(gt_999_tptp_minus_1,axiom,
...
qmf(finite_domain_6,axiom,
( #box : ( ! [X] : ( #box : (( ( #box : (leq(n0, X))) & ( #box : (leq(X, n6))) ) => ( (#box : (X = n0)) | ( (#box : (X = n1)) | ( (#box : (X = n2)) | ( (#box : (X = n3)) | ( (#box : (X = n4)) | ( (#box : (X = n5)) | (#box : (X = n6)) ) ) ) ) ) ) ))))).
...
qmf(successor_6,axiom,
(#box : (succ(succ(succ(succ(succ(succ(n0)))))) = n6))).

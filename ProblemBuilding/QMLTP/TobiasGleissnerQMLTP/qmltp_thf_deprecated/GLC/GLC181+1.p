...
% converted problem
%--------------------------------------------------------------------------
% File     : GLC181+1 : QMLTP v1.1
% Domain   : GLC (Goedel translation of Logic Calculi)
% Problem  : Goedel translation of LCL181+1 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
% Comments :
%--------------------------------------------------------------------------
thf ( pel4 , conjecture , ( ( $box @ ( ( $box @ ( ( $box @ ( ~ ( ( $box @ ( p ) ) ) ) ) => ( $box @ ( q ) ) ) ) => ( $box @ ( ( $box @ ( ~ ( ( $box @ ( q ) ) ) ) ) => ( $box @ ( p ) ) ) ) ) ) & ( $box @ ( ( $box @ ( ( $box @ ( ~ ( ( $box @ ( q ) ) ) ) ) => ( $box @ ( p ) ) ) ) => ( $box @ ( ( $box @ ( ~ ( ( $box @ ( p ) ) ) ) ) => ( $box @ ( q ) ) ) ) ) ) ) ) .
%--------------------------------------------------------------------------
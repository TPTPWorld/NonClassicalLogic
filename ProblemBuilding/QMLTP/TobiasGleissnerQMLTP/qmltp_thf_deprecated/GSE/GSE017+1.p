...
% converted problem
%--------------------------------------------------------------------------
% File     : GSE017+1 : QMLTP v1.1
% Domain   : GSE (Goedel translation of Set Theory)
% Problem  : Goedel translation of SET017+1 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
thf ( left_cancellation , conjecture , ( $box @ ( ! [ X :$i ] : ( $box @ ( ! [ Y :$i ] : ( $box @ ( ! [ Z :$i ] : ( $box @ ( ( ( $box @ ( ( member @ Y @ universal_class ) ) ) & ( ( $box @ ( ( member @ Z @ universal_class ) ) ) & ( $box @ ( ( qmltpeq @ ( unordered_pair @ X @ Y ) @ ( unordered_pair @ X @ Z ) ) ) ) ) ) => ( $box @ ( ( qmltpeq @ Y @ Z ) ) ) ) ) ) ) ) ) ) ) ) .
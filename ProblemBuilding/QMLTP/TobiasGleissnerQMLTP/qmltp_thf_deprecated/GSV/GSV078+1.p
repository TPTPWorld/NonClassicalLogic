...
thf(cl5_nebula_array_0019,conjecture,($box@((($box@((leq@n0@pv31)))&($box@((leq@pv31@(minus@n5@n1)))))=>(($box@(($box@(~(($box@((customqmltpeq@n0@pv70))))))=>(($box@((leq@n0@pv31)))&($box@((leq@pv31@(minus@n5@n1)))))))&($box@(($box@((customqmltpeq@n0@pv70)))=>($box@(true)))))))).

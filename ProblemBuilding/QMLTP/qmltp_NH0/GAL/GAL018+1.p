...
% converted problem
%--------------------------------------------------------------------------
% File     : GAL018+1 : QMLTP v1.1
% Domain   : GAL (Goedel translation of Algebra)
% Problem  : Goedel translation of ALG018+1 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
thf(ax3,axiom,( ? [ U :$i ] : ( ( {$box} @ ( ( sorti1 @ U ) ) ) & ( {$box} @ ( ! [ V :$i ] : ( {$box} @ ( ( {$box} @ ( ( sorti1 @ V ) ) ) => ( {$box} @ ( ( qmltpeq @ ( op1 @ V @ V ) @ U ) ) ) ) ) ) ) ) ) ).
thf(ax4,axiom,( {$box} @ ( ~ ( ( ? [ U :$i ] : ( ( {$box} @ ( ( sorti2 @ U ) ) ) & ( {$box} @ ( ! [ V :$i ] : ( {$box} @ ( ( {$box} @ ( ( sorti2 @ V ) ) ) => ( {$box} @ ( ( qmltpeq @ ( op2 @ V @ V ) @ U ) ) ) ) ) ) ) ) ) ) ) ) ).

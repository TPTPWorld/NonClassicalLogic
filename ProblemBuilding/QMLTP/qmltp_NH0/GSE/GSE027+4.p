...
% converted problem
%--------------------------------------------------------------------------
% File     : GSE027+4 : QMLTP v1.1
% Domain   : GSE (Goedel translation of Set Theory)
% Problem  : Goedel translation of SET027+4 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
thf(thI03,conjecture,( {$box} @ ( ! [ A :$i ] : ( {$box} @ ( ! [ B :$i ] : ( {$box} @ ( ! [ C :$i ] : ( {$box} @ ( ( ( {$box} @ ( ( subset @ A @ B ) ) ) & ( {$box} @ ( ( subset @ B @ C ) ) ) ) => ( {$box} @ ( ( subset @ A @ C ) ) ) ) ) ) ) ) ) ) ) ).

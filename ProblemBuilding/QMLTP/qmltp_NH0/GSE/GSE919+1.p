...
thf(t60_zfmisc_1,conjecture,( {$box} @ ( ! [ A :$i ] : ( {$box} @ ( ! [ B :$i ] : ( {$box} @ ( ! [ C :$i ] : ( {$box} @ ( ( {$box} @ ( ( in @ A @ B ) ) ) => ( ( ( {$box} @ ( ( in @ C @ B ) ) ) & ( {$box} @ ( ~ ( ( {$box} @ ( ( qmltpeq @ A @ C ) ) ) ) ) ) ) | ( {$box} @ ( ( qmltpeq @ ( set_intersection2 @ ( unordered_pair @ A @ C ) @ B ) @ ( singleton @ A ) ) ) ) ) ) ) ) ) ) ) ) ) ).

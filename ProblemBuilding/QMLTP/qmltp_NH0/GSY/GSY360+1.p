...
% converted problem
%--------------------------------------------------------------------------
% File     : GSY360+1 : QMLTP v1.1
% Domain   : GSY (Goedel translation of Syntactic)
% Problem  : Goedel translation of SYN360+1 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
%--------------------------------------------------------------------------
thf(x2111,conjecture,( {$box} @ ( ( ( {$box} @ ( ! [ X :$i ] : ( {$box} @ ( ( ? [ Y :$i ] : ( {$box} @ ( ( big_p @ X @ Y ) ) ) ) => ( {$box} @ ( ! [ Y :$i ] : ( {$box} @ ( ( big_q @ X @ Y ) ) ) ) ) ) ) ) ) & ( {$box} @ ( ! [ Z :$i ] : ( ? [ Y :$i ] : ( {$box} @ ( ( big_p @ Z @ Y ) ) ) ) ) ) ) => ( {$box} @ ( ! [ Y :$i ] : ( {$box} @ ( ! [ X :$i ] : ( {$box} @ ( ( big_q @ X @ Y ) ) ) ) ) ) ) ) ) ).
%--------------------------------------------------------------------------

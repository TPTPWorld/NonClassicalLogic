...
thf(ordered_pair_determines_components1,conjecture,( ! [ W :$i,X :$i,Y :$i,Z :$i ] : ( ( ( qmltpeq @ ( ordered_pair @ W @ X ) @ ( ordered_pair @ Y @ Z ) ) & ( member @ W @ universal_class ) ) => ( qmltpeq @ W @ Y ) ) ) ).
%------------------------------------------------------------------------------

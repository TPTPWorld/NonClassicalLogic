...
%             D   0.50         0.33         0.33          v1.1
%             T   0.50         0.33         0.33          v1.1
%             S4  0.50         0.33         0.33          v1.1
...
thf(thI02,conjecture,( ! [ A :$i,B :$i ] : ( ( ( subset @ A @ B ) & ( subset @ B @ A ) ) => ( equal_set @ A @ B ) ) ) ).
%------------------------------------------------------------------------------

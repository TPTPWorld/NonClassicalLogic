...
thf(apply_substitution_1,axiom,( ! [ A :$i,B :$i,C :$i ] : ( ( qmltpeq @ A @ B ) => ( qmltpeq @ ( apply @ A @ C ) @ ( apply @ B @ C ) ) ) ) ).
thf(apply_substitution_2,axiom,( ! [ A :$i,B :$i,C :$i ] : ( ( qmltpeq @ A @ B ) => ( qmltpeq @ ( apply @ C @ A ) @ ( apply @ C @ B ) ) ) ) ).
thf(complement_substitution_1,axiom,( ! [ A :$i,B :$i ] : ( ( qmltpeq @ A @ B ) => ( qmltpeq @ ( complement @ A ) @ ( complement @ B ) ) ) ) ).
thf(compose_substitution_1,axiom,( ! [ A :$i,B :$i,C :$i ] : ( ( qmltpeq @ A @ B ) => ( qmltpeq @ ( compose @ A @ C ) @ ( compose @ B @ C ) ) ) ) ).
thf(compose_substitution_2,axiom,( ! [ A :$i,B :$i,C :$i ] : ( ( qmltpeq @ A @ B ) => ( qmltpeq @ ( compose @ C @ A ) @ ( compose @ C @ B ) ) ) ) ).
thf(cross_product_substitution_1,axiom,( ! [ A :$i,B :$i,C :$i ] : ( ( qmltpeq @ A @ B ) => ( qmltpeq @ ( cross_product @ A @ C ) @ ( cross_product @ B @ C ) ) ) ) ).
thf(cross_product_substitution_2,axiom,( ! [ A :$i,B :$i,C :$i ] : ( ( qmltpeq @ A @ B ) => ( qmltpeq @ ( cross_product @ C @ A ) @ ( cross_product @ C @ B ) ) ) ) ).
thf(domain_of_substitution_1,axiom,( ! [ A :$i,B :$i ] : ( ( qmltpeq @ A @ B ) => ( qmltpeq @ ( domain_of @ A ) @ ( domain_of @ B ) ) ) ) ).
thf(first_substitution_1,axiom,( ! [ A :$i,B :$i ] : ( ( qmltpeq @ A @ B ) => ( qmltpeq @ ( first @ A ) @ ( first @ B ) ) ) ) ).
thf(flip_substitution_1,axiom,( ! [ A :$i,B :$i ] : ( ( qmltpeq @ A @ B ) => ( qmltpeq @ ( flip @ A ) @ ( flip @ B ) ) ) ) ).
thf(image_substitution_1,axiom,( ! [ A :$i,B :$i,C :$i ] : ( ( qmltpeq @ A @ B ) => ( qmltpeq @ ( image @ A @ C ) @ ( image @ B @ C ) ) ) ) ).
thf(image_substitution_2,axiom,( ! [ A :$i,B :$i,C :$i ] : ( ( qmltpeq @ A @ B ) => ( qmltpeq @ ( image @ C @ A ) @ ( image @ C @ B ) ) ) ) ).
...
thf(inverse_substitution_1,axiom,( ! [ A :$i,B :$i ] : ( ( qmltpeq @ A @ B ) => ( qmltpeq @ ( inverse @ A ) @ ( inverse @ B ) ) ) ) ).
thf(ordered_pair_substitution_1,axiom,( ! [ A :$i,B :$i,C :$i ] : ( ( qmltpeq @ A @ B ) => ( qmltpeq @ ( ordered_pair @ A @ C ) @ ( ordered_pair @ B @ C ) ) ) ) ).
thf(ordered_pair_substitution_2,axiom,( ! [ A :$i,B :$i,C :$i ] : ( ( qmltpeq @ A @ B ) => ( qmltpeq @ ( ordered_pair @ C @ A ) @ ( ordered_pair @ C @ B ) ) ) ) ).
thf(power_class_substitution_1,axiom,( ! [ A :$i,B :$i ] : ( ( qmltpeq @ A @ B ) => ( qmltpeq @ ( power_class @ A ) @ ( power_class @ B ) ) ) ) ).
thf(range_of_substitution_1,axiom,( ! [ A :$i,B :$i ] : ( ( qmltpeq @ A @ B ) => ( qmltpeq @ ( range_of @ A ) @ ( range_of @ B ) ) ) ) ).
thf(restrict_substitution_1,axiom,( ! [ A :$i,B :$i,C :$i,D :$i ] : ( ( qmltpeq @ A @ B ) => ( qmltpeq @ ( restrict @ A @ C @ D ) @ ( restrict @ B @ C @ D ) ) ) ) ).
thf(restrict_substitution_2,axiom,( ! [ A :$i,B :$i,C :$i,D :$i ] : ( ( qmltpeq @ A @ B ) => ( qmltpeq @ ( restrict @ C @ A @ D ) @ ( restrict @ C @ B @ D ) ) ) ) ).
thf(restrict_substitution_3,axiom,( ! [ A :$i,B :$i,C :$i,D :$i ] : ( ( qmltpeq @ A @ B ) => ( qmltpeq @ ( restrict @ C @ D @ A ) @ ( restrict @ C @ D @ B ) ) ) ) ).
thf(rotate_substitution_1,axiom,( ! [ A :$i,B :$i ] : ( ( qmltpeq @ A @ B ) => ( qmltpeq @ ( rotate @ A ) @ ( rotate @ B ) ) ) ) ).
thf(second_substitution_1,axiom,( ! [ A :$i,B :$i ] : ( ( qmltpeq @ A @ B ) => ( qmltpeq @ ( second @ A ) @ ( second @ B ) ) ) ) ).
thf(singleton_substitution_1,axiom,( ! [ A :$i,B :$i ] : ( ( qmltpeq @ A @ B ) => ( qmltpeq @ ( singleton @ A ) @ ( singleton @ B ) ) ) ) ).
thf(successor_substitution_1,axiom,( ! [ A :$i,B :$i ] : ( ( qmltpeq @ A @ B ) => ( qmltpeq @ ( successor @ A ) @ ( successor @ B ) ) ) ) ).
thf(sum_class_substitution_1,axiom,( ! [ A :$i,B :$i ] : ( ( qmltpeq @ A @ B ) => ( qmltpeq @ ( sum_class @ A ) @ ( sum_class @ B ) ) ) ) ).
...
thf(function_substitution_1,axiom,( ! [ A :$i,B :$i ] : ( ( ( qmltpeq @ A @ B ) & ( function @ A ) ) => ( function @ B ) ) ) ).
thf(inductive_substitution_1,axiom,( ! [ A :$i,B :$i ] : ( ( ( qmltpeq @ A @ B ) & ( inductive @ A ) ) => ( inductive @ B ) ) ) ).
...
thf(subclass_substitution_1,axiom,( ! [ A :$i,B :$i,C :$i ] : ( ( ( qmltpeq @ A @ B ) & ( subclass @ A @ C ) ) => ( subclass @ B @ C ) ) ) ).
thf(subclass_substitution_2,axiom,( ! [ A :$i,B :$i,C :$i ] : ( ( ( qmltpeq @ A @ B ) & ( subclass @ C @ A ) ) => ( subclass @ C @ B ) ) ) ).
...
thf(extensionality,axiom,( ! [ X :$i,Y :$i ] : ( ( qmltpeq @ X @ Y ) <=> ( ( subclass @ X @ Y ) & ( subclass @ Y @ X ) ) ) ) ).
thf(unordered_pair_defn,axiom,( ! [ U :$i,X :$i,Y :$i ] : ( ( member @ U @ ( unordered_pair @ X @ Y ) ) <=> ( ( member @ U @ universal_class ) & ( ( qmltpeq @ U @ X ) | ( qmltpeq @ U @ Y ) ) ) ) ) ).
thf(unordered_pair_0,axiom,( ! [ X :$i,Y :$i ] : ( member @ ( unordered_pair @ X @ Y ) @ universal_class ) ) ).
thf(singleton_set_defn,axiom,( ! [ X :$i ] : ( qmltpeq @ ( singleton @ X ) @ ( unordered_pair @ X @ X ) ) ) ).
thf(ordered_pair_defn,axiom,( ! [ X :$i,Y :$i ] : ( qmltpeq @ ( ordered_pair @ X @ Y ) @ ( unordered_pair @ ( singleton @ X ) @ ( unordered_pair @ X @ ( singleton @ Y ) ) ) ) ) ).
thf(cross_product_defn,axiom,( ! [ U :$i,V :$i,X :$i,Y :$i ] : ( ( member @ ( ordered_pair @ U @ V ) @ ( cross_product @ X @ Y ) ) <=> ( ( member @ U @ X ) & ( member @ V @ Y ) ) ) ) ).
thf(cross_product_0,axiom,( ! [ X :$i,Y :$i,Z :$i ] : ( ( member @ Z @ ( cross_product @ X @ Y ) ) => ( qmltpeq @ Z @ ( ordered_pair @ ( first @ Z ) @ ( second @ Z ) ) ) ) ) ).
...
thf(restrict_defn,axiom,( ! [ X :$i,XR :$i,Y :$i ] : ( qmltpeq @ ( restrict @ XR @ X @ Y ) @ ( intersection @ XR @ ( cross_product @ X @ Y ) ) ) ) ).
thf(null_class_defn,axiom,( ! [ X :$i ] : ~ ( ( member @ X @ null_class ) ) ) ).
thf(domain_of_0,axiom,( ! [ X :$i,Z :$i ] : ( ( member @ Z @ ( domain_of @ X ) ) <=> ( ( member @ Z @ universal_class ) & ~ ( ( qmltpeq @ ( restrict @ X @ ( singleton @ Z ) @ universal_class ) @ null_class ) ) ) ) ) ).
...
thf(successor_defn,axiom,( ! [ X :$i ] : ( qmltpeq @ ( successor @ X ) @ ( union @ X @ ( singleton @ X ) ) ) ) ).
thf(successor_relation_defn1,axiom,( ( subclass @ successor_relation @ ( cross_product @ universal_class @ universal_class ) ) ) ).
thf(successor_relation_defn2,axiom,( ! [ X :$i,Y :$i ] : ( ( member @ ( ordered_pair @ X @ Y ) @ successor_relation ) <=> ( ( member @ X @ universal_class ) & ( member @ Y @ universal_class ) & ( qmltpeq @ ( successor @ X ) @ Y ) ) ) ) ).
thf(inverse_defn,axiom,( ! [ Y :$i ] : ( qmltpeq @ ( inverse @ Y ) @ ( domain_of @ ( flip @ ( cross_product @ Y @ universal_class ) ) ) ) ) ).
thf(range_of_defn,axiom,( ! [ Z :$i ] : ( qmltpeq @ ( range_of @ Z ) @ ( domain_of @ ( inverse @ Z ) ) ) ) ).
thf(image_defn,axiom,( ! [ X :$i,XR :$i ] : ( qmltpeq @ ( image @ XR @ X ) @ ( range_of @ ( restrict @ XR @ X @ universal_class ) ) ) ) ).
...
thf(regularity,axiom,( ! [ X :$i ] : ( ~ ( ( qmltpeq @ X @ null_class ) ) => ? [ U :$i ] : ( ( member @ U @ universal_class ) & ( member @ U @ X ) & ( disjoint @ U @ X ) ) ) ) ).
thf(apply_defn,axiom,( ! [ XF :$i,Y :$i ] : ( qmltpeq @ ( apply @ XF @ Y ) @ ( sum_class @ ( image @ XF @ ( singleton @ Y ) ) ) ) ) ).
thf(choice,axiom,( ? [ XF :$i ] : ( ( function @ XF ) & ! [ Y :$i ] : ( ( member @ Y @ universal_class ) => ( ( qmltpeq @ Y @ null_class ) | ( member @ ( apply @ XF @ Y ) @ Y ) ) ) ) ) ).
thf(unique_1st_and_2nd_in_pair_of_sets1,conjecture,( ! [ U :$i,V :$i,X :$i ] : ( ( ( member @ U @ universal_class ) & ( member @ V @ universal_class ) & ( qmltpeq @ X @ ( ordered_pair @ U @ V ) ) ) => ( ( qmltpeq @ ( first @ X ) @ U ) & ( qmltpeq @ ( second @ X ) @ V ) ) ) ) ).
%------------------------------------------------------------------------------

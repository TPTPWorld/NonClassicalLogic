...
qmf(d3_tarski,axiom,
( #box : ( ! [A] : ( #box : ( ! [B] : (( #box : (( #box : (subset(A, B))) => ( #box : ( ! [C] : ( #box : (( #box : (in(C, A))) => ( #box : (in(C, B))) )))) )) & (#box : (( #box : ( ! [C] : ( #box : (( #box : (in(C, A))) => ( #box : (in(C, B))) )))) => ( #box : (subset(A, B))) )))))))).
...
qmf(t47_zfmisc_1,conjecture,
( #box : ( ! [A] : ( #box : ( ! [B] : ( #box : ( ! [C] : ( #box : (( #box : (subset(set_union2(unordered_pair(A, B), C), C))) => ( #box : (in(A, C))) ))))))))).

...
qmf(x2107,conjecture,
( #box : (( ( #box : (big_r(a, b))) & ( ( #box : ( ! [X] : ( #box : ( ! [Y] : ( #box : (( #box : (big_r(X, Y))) => ( ( #box : (big_r(Y, X))) & ( #box : (big_q(X, Y))) ) )))))) & ( #box : ( ! [U] : ( #box : ( ! [V] : ( #box : (( #box : (big_q(U, V))) => ( #box : (big_q(U, U))) )))))) ) ) => ( ( #box : (big_q(a, a))) & ( #box : (big_q(b, b))) ) ))).

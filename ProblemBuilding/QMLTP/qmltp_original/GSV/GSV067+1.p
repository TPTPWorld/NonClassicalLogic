...
qmf(cl5_nebula_array_0008,conjecture,
( #box : (( ( #box : (leq(n0, pv10))) & ( ( #box : (leq(n1, pv63))) & ( ( #box : (leq(pv10, minus(n135300, n1)))) & ( #box : (leq(pv63, minus(n5, n1)))) ) ) ) => ( ( #box : (leq(n0, pv10))) & ( ( #box : (leq(n0, pv63))) & ( ( #box : (leq(pv10, minus(n135300, n1)))) & ( ( #box : (leq(pv63, minus(n5, n1)))) & ( ( #box : (( #box : (~ ( #box : (gt(a_select3(q, pv10, pv63), pv78))) )) => ( ( #box : (leq(n0, pv10))) & ( #box : (leq(pv10, minus(n135300, n1)))) ) )) & ( #box : (( #box : (gt(a_select3(q, pv10, pv63), pv78))) => ( ( #box : (leq(n0, pv10))) & ( #box : (leq(pv10, minus(n135300, n1)))) ) )) ) ) ) ) ) ))).

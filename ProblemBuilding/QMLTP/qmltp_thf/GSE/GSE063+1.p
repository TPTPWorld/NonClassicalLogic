...
% converted problem
%--------------------------------------------------------------------------
% File     : GSE063+1 : QMLTP v1.1
% Domain   : GSE (Goedel translation of Set Theory)
% Problem  : Goedel translation of SET063+1 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
thf ( corollary_of_null_class_is_subclass , conjecture , ( $box @ ( ! [ X :$i ] : ( $box @ ( ( $box @ ( ( subclass @ X @ null_class ) ) ) => ( $box @ ( ( qmltpeq @ X @ null_class ) ) ) ) ) ) ) ) .
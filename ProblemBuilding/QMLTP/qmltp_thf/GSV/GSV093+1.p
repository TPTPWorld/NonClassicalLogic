...
thf(true_type,type,(true:($o))).% individual constants
...
thf(xinit_mean_defuse_type,type,(xinit_mean_defuse:($i))).% predicates
...
thf(finite_domain_6,axiom,($box@(![X:$i]:($box@((($box@((leq@n0@X)))&($box@((leq@X@n6))))=>(($box@((customqmltpeq@X@n0)))|(($box@((customqmltpeq@X@n1)))|(($box@((customqmltpeq@X@n2)))|(($box@((customqmltpeq@X@n3)))|(($box@((customqmltpeq@X@n4)))|(($box@((customqmltpeq@X@n5)))|($box@((customqmltpeq@X@n6)))))))))))))).
...
thf(successor_6,axiom,($box@((customqmltpeq@(succ@(succ@(succ@(succ@(succ@(succ@n0))))))@n6)))).

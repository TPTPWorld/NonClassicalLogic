...
% converted problem
%--------------------------------------------------------------------------
% File     : GSY394+1 : QMLTP v1.1
% Domain   : GSY (Goedel translation of Syntactic)
% Problem  : Goedel translation of SYN394+1 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
%--------------------------------------------------------------------------
thf ( kalish201 , conjecture , ( $box @ ( ( $box @ ( ! [ X :$i ] : ( $box @ ( ( $box @ ( ( f @ X ) ) ) => ( $box @ ( ( g @ X ) ) ) ) ) ) ) => ( $box @ ( ( $box @ ( ! [ Y :$i ] : ( $box @ ( ( f @ Y ) ) ) ) ) => ( $box @ ( ! [ Z :$i ] : ( $box @ ( ( g @ Z ) ) ) ) ) ) ) ) ) ) .
%--------------------------------------------------------------------------
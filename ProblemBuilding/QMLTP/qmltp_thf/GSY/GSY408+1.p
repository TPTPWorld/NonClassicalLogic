...
% converted problem
%--------------------------------------------------------------------------
% File     : GSY408+1 : QMLTP v1.1
% Domain   : GSY (Goedel translation of Syntactic)
% Problem  : Goedel translation of SYN408+1 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
%--------------------------------------------------------------------------
thf ( kalish244 , conjecture , ( $box @ ( ( $box @ ( ~ ( ( ? [ X :$i ] : ( $box @ ( ( f @ X ) ) ) ) ) ) ) => ( $box @ ( ! [ Y :$i ] : ( $box @ ( ( $box @ ( ( f @ Y ) ) ) => ( $box @ ( ( g @ Y ) ) ) ) ) ) ) ) ) ) .
%--------------------------------------------------------------------------
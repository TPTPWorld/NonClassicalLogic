...
thf(axiom_t_for_fool_1,axiom,(![X:$i]:(($box@index_type@fool@(ws@X))=>(ws@X)))).
thf(axiom_t_for_fool_2,axiom,(![X:$i]:(($box@index_type@fool@(~(((ws@X)))))=>(~(((ws@X))))))).
thf(axiom_4_for_fool_1,axiom,(![X:$i]:(($box@index_type@fool@(ws@X))=>($box@index_type@fool@($box@index_type@fool@((ws@X))))))).
thf(axiom_4_for_fool_2,axiom,(![X:$i]:(($box@index_type@fool@(~(((ws@X)))))=>($box@index_type@fool@($box@index_type@fool@(~(((ws@X))))))))).

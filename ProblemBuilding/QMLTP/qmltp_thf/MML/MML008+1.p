...
%
%--------------------------------------------------------------------------
thf(axiom_1,axiom,({$box(#fool)}@((succ@n0@n1)))).
thf(axiom_2,axiom,({$box(#fool)}@((succ@n1@n2)))).
thf(axiom_3,axiom,({$box(#fool)}@((succ@n2@n3)))).
thf(axiom_4,axiom,({$box(#fool)}@((succ@n3@n4)))).
thf(axiom_5,axiom,({$box(#fool)}@((succ@n4@n5)))).
thf(axiom_6,axiom,({$box(#fool)}@((succ@n5@n6)))).
thf(axiom_7,axiom,({$box(#fool)}@(?[X:$i]:(?[Y:$i]:((a@X)&(b@Y)&((succ@X@Y)|(succ@Y@X))))))).
thf(axiom_8,axiom,(![X:$i]:((a@X)=>({$box(#bill)}@(a@X))))).
thf(axiom_9,axiom,(![X:$i]:((b@X)=>({$box(#bill)}@(b@X))))).
thf(axiom_i_for_fool_a_1,axiom,(![X:$i]:(({$box(#fool)}@((a@X)))=>({$box(#anne)}@((a@X)))))).
thf(axiom_i_for_fool_a_2,axiom,(![X:$i]:(({$box(#fool)}@(~(((a@X)))))=>({$box(#anne)}@(~((a@X))))))).
thf(axiom_i_for_fool_a_3,axiom,(![X:$i]:(({$box(#fool)}@((b@X)))=>({$box(#anne)}@((b@X)))))).
thf(axiom_i_for_fool_a_4,axiom,(![X:$i]:(({$box(#fool)}@(~(((b@X)))))=>({$box(#anne)}@(~((b@X))))))).
thf(axiom_i_for_fool_b_1,axiom,(![X:$i]:(({$box(#fool)}@((a@X)))=>({$box(#bill)}@((a@X)))))).
thf(axiom_i_for_fool_b_2,axiom,(![X:$i]:(({$box(#fool)}@(~(((a@X)))))=>({$box(#bill)}@(~((a@X))))))).
thf(axiom_i_for_fool_b_3,axiom,(![X:$i]:(({$box(#fool)}@((b@X)))=>({$box(#bill)}@((b@X)))))).
thf(axiom_i_for_fool_b_4,axiom,(![X:$i]:(({$box(#fool)}@(~(((b@X)))))=>({$box(#bill)}@(~((b@X))))))).

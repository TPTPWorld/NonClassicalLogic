...
thf(luka_op_or,axiom,($box@(op_or))).
thf(luka_op_implies,axiom,($box@(op_implies))).
thf(luka_op_equiv,axiom,($box@(op_equiv))).
thf(luka_modus_ponens,axiom,($box@(modus_ponens))).
thf(luka_cn1,axiom,($box@(cn1))).
thf(luka_cn2,axiom,($box@(cn2))).
thf(luka_cn3,axiom,($box@(cn3))).

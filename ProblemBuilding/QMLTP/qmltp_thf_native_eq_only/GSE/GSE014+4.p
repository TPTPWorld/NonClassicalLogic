...
% File     : GSE014+4 : QMLTP v1.1

% Domain   : GSE (Goedel translation of Set Theory)

% Problem  : Goedel translation of SET014+4 (from TPTP-v5.0.0)
...
thf(thI45,conjecture,($box@(![A:$i]:($box@(![X:$i]:($box@(![Y:$i]:(($box@((($box@((subset@X@A)))&($box@((subset@Y@A))))=>($box@((subset@(union@X@Y)@A)))))&($box@(($box@((subset@(union@X@Y)@A)))=>(($box@((subset@X@A)))&($box@((subset@Y@A)))))))))))))).
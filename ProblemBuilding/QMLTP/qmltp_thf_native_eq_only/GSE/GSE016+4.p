...
thf(thI50a,conjecture,($box@(![A:$i]:($box@(![B:$i]:($box@(![U:$i]:($box@(![V:$i]:($box@(($box@((equal_set@(unordered_pair@(singleton@A)@(unordered_pair@A@B))@(unordered_pair@(singleton@U)@(unordered_pair@U@V)))))=>($box@((A=U)))))))))))))).
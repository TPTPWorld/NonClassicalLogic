...
thf(left_cancellation,conjecture,($box@(![X:$i]:($box@(![Y:$i]:($box@(![Z:$i]:($box@((($box@((member@Y@universal_class)))&(($box@((member@Z@universal_class)))&($box@(((unordered_pair@X@Y)=(unordered_pair@X@Z))))))=>($box@((Y=Z)))))))))))).
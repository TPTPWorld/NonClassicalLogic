...
thf(t28_xboole_1,axiom,($box@(![A:$i]:($box@(![B:$i]:($box@(($box@((subset@A@B)))=>($box@(((set_intersection2@A@B)=A)))))))))).
...
thf(t53_zfmisc_1,conjecture,($box@(![A:$i]:($box@(![B:$i]:($box@(![C:$i]:($box@((($box@((in@A@B)))&($box@((in@C@B))))=>($box@(((set_intersection2@(unordered_pair@A@C)@B)=(unordered_pair@A@C))))))))))))).
...
% removed axiom f_substitution_1
thf(kalish317,conjecture,(($box@(((?[X:$i]:($box@((f@X))))&($box@(![Y:$i]:($box@(![Z:$i]:($box@((($box@((f@Y)))&($box@((f@Z))))=>($box@((Y=Z))))))))))=>(?[U:$i]:(($box@((f@U)))&($box@(![V:$i]:($box@(($box@((f@V)))=>($box@((U=V)))))))))))&($box@((?[U:$i]:(($box@((f@U)))&($box@(![V:$i]:($box@(($box@((f@V)))=>($box@((U=V)))))))))=>((?[X:$i]:($box@((f@X))))&($box@(![Y:$i]:($box@(![Z:$i]:($box@((($box@((f@Y)))&($box@((f@Z))))=>($box@((Y=Z)))))))))))))).
%--------------------------------------------------------------------------
...
thf(t51_zfmisc_1,conjecture,({$box}@(![A:$i]:({$box}@(![B:$i]:({$box}@(({$box}@(((set_intersection2@A@(singleton@B))=(singleton@B))))=>({$box}@((in@B@A)))))))))).
thf(l30_zfmisc_1,axiom,({$box}@(![A:$i]:({$box}@(![B:$i]:({$box}@(({$box}@(((set_intersection2@A@(singleton@B))=(singleton@B))))=>({$box}@((in@B@A)))))))))).
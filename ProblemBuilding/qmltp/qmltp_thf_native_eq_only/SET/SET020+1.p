...
thf(unique_1st_and_2nd_in_pair_of_sets1,conjecture,(![U:$i,V:$i,X:$i]:(((member@U@universal_class)&(member@V@universal_class)&(X=(ordered_pair@U@V)))=>(((first@X)=U)&((second@X)=V))))).
%------------------------------------------------------------------------------
...
% Problem  : ?
% Version  : ?
% English  : The client has not smoked in the car but got a penalty and it has not yet expired. Should we ask for a hearing?
%
...
qmf(axiom_7,axiom,(~ article1_condition_smoke__const)).

qmf(axiom_8,axiom,article_b1_punishment_notice__const).

qmf(axiom_9,axiom,article_b6_condition_before_expiry__const).

qmf(con,conjecture,(((#dia(i) : article_b6_contest_hearing__const) & (#dia(a) : ~ article_b6_contest_hearing__const)))).

...
( #box : ( ! [A] : ( #box : ( ! [B] : (( #box : (( #box : (disjoint(A, B))) => ( #box : (qmltpeq(set_intersection2(A, B), empty_set))) )) & (#box : (( #box : (qmltpeq(set_intersection2(A, B), empty_set))) => ( #box : (disjoint(A, B))) )))))))).
...
( #box : ( ! [A] : ( #box : ( ! [B] : ( #box : ( ! [C] : ( #box : (~ ( ( #box : (disjoint(unordered_pair(A, B), C))) & ( #box : (in(A, C))) ) ))))))))).

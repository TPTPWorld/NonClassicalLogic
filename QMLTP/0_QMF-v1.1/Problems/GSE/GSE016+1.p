...
qmf(ordered_pair_determines_components1,conjecture,
( #box : ( ! [W] : ( #box : ( ! [X] : ( #box : ( ! [Y] : ( #box : ( ! [Z] : ( #box : (( ( #box : (qmltpeq(ordered_pair(W, X), ordered_pair(Y, Z)))) & ( #box : (member(W, universal_class))) ) => ( #box : (qmltpeq(W, Y))) ))))))))))).

...
( #box : ( ! [B] : ( #box : ( ! [C] : ( #box : ( ! [D] : ( #box : (( #box : ( ! [E] : (( #box : (( #box : (member(E, B))) => ( ( #box : (member(E, C))) & ( #box : (~ ( #box : (member(E, D))) )) ) )) & (#box : (( ( #box : (member(E, C))) & ( #box : (~ ( #box : (member(E, D))) )) ) => ( #box : (member(E, B))) ))))) => ( #box : (qmltpeq(B, difference(C, D)))) ))))))))).

...
( #box : ( ! [A] : ( #box : ( ! [B] : (( #box : (( #box : (subset(A, singleton(B)))) => ( ( #box : (qmltpeq(A, empty_set))) | ( #box : (qmltpeq(A, singleton(B)))) ) )) & (#box : (( ( #box : (qmltpeq(A, empty_set))) | ( #box : (qmltpeq(A, singleton(B)))) ) => ( #box : (subset(A, singleton(B)))) )))))))).
...
( #box : ( ! [A] : ( #box : ( ! [B] : (( #box : (( #box : (qmltpeq(set_difference(A, B), empty_set))) => ( #box : (subset(A, B))) )) & (#box : (( #box : (subset(A, B))) => ( #box : (qmltpeq(set_difference(A, B), empty_set))) )))))))).

qmf(t66_zfmisc_1,conjecture,
( #box : ( ! [A] : ( #box : ( ! [B] : ( #box : (~ ( ( #box : (qmltpeq(set_difference(A, singleton(B)), empty_set))) & ( ( #box : (~ ( #box : (qmltpeq(A, empty_set))) )) & ( #box : (~ ( #box : (qmltpeq(A, singleton(B)))) )) ) ) ))))))).

...
qmf(cl5_nebula_array_0028,conjecture,
( #box : (( #box : (geq(pv65, tptp_float_0_001))) => ( ( #box : (( #box : (~ ( #box : (gt(plus(n1, loopcounter), n1))) )) => ( #box : (true)) )) & ( #box : (( #box : (gt(plus(n1, loopcounter), n1))) => ( #box : (true)) )) ) ))).

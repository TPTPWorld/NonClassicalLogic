...
qmf(equiv_congruence,conjecture,
( ( #box : ( ! [X] : ( #box : (is_a_theorem(equiv(X, X)))))) & ( ( #box : ( ! [X] : ( #box : ( ! [Y] : ( #box : (( #box : (is_a_theorem(equiv(X, Y)))) => ( #box : (is_a_theorem(equiv(not(X), not(Y))))) )))))) & ( ( #box : ( ! [X1] : ( #box : ( ! [X2] : ( #box : ( ! [Y] : ( #box : (( #box : (is_a_theorem(equiv(X1, X2)))) => ( #box : (is_a_theorem(equiv(and(X1, Y), and(X2, Y))))) )))))))) & ( ( #box : ( ! [X1] : ( #box : ( ! [X2] : ( #box : ( ! [Y] : ( #box : (( #box : (is_a_theorem(equiv(X1, X2)))) => ( #box : (is_a_theorem(equiv(and(Y, X1), and(Y, X2))))) )))))))) & ( #box : ( ! [X] : ( #box : ( ! [Y] : ( #box : (( ( #box : (is_a_theorem(X))) & ( #box : (is_a_theorem(equiv(X, Y)))) ) => ( #box : (is_a_theorem(Y))) )))))) ) ) ) )).

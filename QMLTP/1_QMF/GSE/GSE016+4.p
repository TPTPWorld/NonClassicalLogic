...
qmf(thI50a,conjecture,
( #box : ( ! [A] : ( #box : ( ! [B] : ( #box : ( ! [U] : ( #box : ( ! [V] : ( #box : (( #box : (equal_set(unordered_pair(singleton(A), unordered_pair(A, B)), unordered_pair(singleton(U), unordered_pair(U, V))))) => ( #box : (qmltpeq(A, U))) ))))))))))).

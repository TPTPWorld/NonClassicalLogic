...
qmf(left_cancellation,conjecture,
( #box : ( ! [X] : ( #box : ( ! [Y] : ( #box : ( ! [Z] : ( #box : (( ( #box : (member(Y, universal_class))) & ( ( #box : (member(Z, universal_class))) & ( #box : (qmltpeq(unordered_pair(X, Y), unordered_pair(X, Z)))) ) ) => ( #box : (qmltpeq(Y, Z))) ))))))))).

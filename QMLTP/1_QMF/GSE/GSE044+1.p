...
( #box : (( ? [Y] : ( #box : ( ! [X] : (( #box : (( #box : (element(X, Y))) => ( #box : (element(X, X))) )) & (#box : (( #box : (element(X, X))) => ( #box : (element(X, Y))) )))))) => ( #box : (~ ( #box : ( ! [X1] : ( ? [Y1] : ( #box : ( ! [Z] : (( #box : (( #box : (element(Z, Y1))) => ( #box : (~ ( #box : (element(Z, X1))) )) )) & (#box : (( #box : (~ ( #box : (element(Z, X1))) )) => ( #box : (element(Z, Y1))) )))))))) )) ))).

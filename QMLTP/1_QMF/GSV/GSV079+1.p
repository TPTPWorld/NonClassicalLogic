...
qmf(cl5_nebula_array_0020,conjecture,
( #box : (( ( #box : (leq(n0, pv51))) & ( #box : (leq(pv51, minus(n5, n1)))) ) => ( ( #box : (leq(n0, n0))) & ( ( #box : (leq(n0, pv51))) & ( ( #box : (leq(n0, uniform_int_rnd(n1, minus(minus(n135300, n1), n0))))) & ( ( #box : (leq(pv51, minus(n5, n1)))) & ( #box : (leq(uniform_int_rnd(n1, minus(minus(n135300, n1), n0)), minus(n135300, n1)))) ) ) ) ) ))).

qmf(gt_5_4,axiom,
( #box : (gt(n5, n4)))).

qmf(gt_135300_4,axiom,
( #box : (gt(n135300, n4)))).

qmf(gt_135300_5,axiom,
( #box : (gt(n135300, n5)))).
...
qmf(gt_135300_tptp_minus_1,axiom,

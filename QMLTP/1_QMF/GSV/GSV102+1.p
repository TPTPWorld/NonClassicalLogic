...
qmf(quaternion_ds1_inuse_0014,conjecture,
( #box : (( (#box : (a_select2(sigma_defuse, n0) = use)) & ( (#box : (a_select2(sigma_defuse, n1) = use)) & ( (#box : (a_select2(sigma_defuse, n2) = use)) & ( (#box : (a_select2(sigma_defuse, n3) = use)) & ( (#box : (a_select2(sigma_defuse, n4) = use)) & ( (#box : (a_select2(sigma_defuse, n5) = use)) & ( (#box : (a_select3(u_defuse, n0, n0) = use)) & ( (#box : (a_select3(u_defuse, n1, n0) = use)) & ( (#box : (a_select3(u_defuse, n2, n0) = use)) & ( (#box : (a_select2(xinit_defuse, n3) = use)) & ( (#box : (a_select2(xinit_defuse, n4) = use)) & (#box : (a_select2(xinit_defuse, n5) = use)) ) ) ) ) ) ) ) ) ) ) ) => ( (#box : (a_select2(sigma_defuse, n0) = use)) & ( (#box : (a_select2(sigma_defuse, n1) = use)) & ( (#box : (a_select2(sigma_defuse, n2) = use)) & ( (#box : (a_select2(sigma_defuse, n3) = use)) & ( (#box : (a_select2(sigma_defuse, n4) = use)) & ( (#box : (a_select2(sigma_defuse, n5) = use)) & ( (#box : (a_select3(u_defuse, n0, n0) = use)) & ( (#box : (a_select3(u_defuse, n1, n0) = use)) & ( (#box : (a_select3(u_defuse, n2, n0) = use)) & ( (#box : (a_select2(xinit_defuse, n3) = use)) & ( (#box : (a_select2(xinit_defuse, n4) = use)) & ( (#box : (a_select2(xinit_defuse, n5) = use)) & ( (#box : (a_select2(tptp_update2(tptp_update2(tptp_update2(rho_defuse, n0, use), n1, use), n2, use), n0) = use)) & ( (#box : (a_select2(tptp_update2(tptp_update2(tptp_update2(rho_defuse, n0, use), n1, use), n2, use), n1) = use)) & (#box : (a_select2(tptp_update2(tptp_update2(tptp_update2(rho_defuse, n0, use), n1, use), n2, use), n2) = use)) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ))).

...
qmf(quaternion_ds1_inuse_0016,conjecture,
( #box : (( (#box : (a_select3(u_defuse, n0, n0) = use)) & ( (#box : (a_select3(u_defuse, n1, n0) = use)) & ( (#box : (a_select3(u_defuse, n2, n0) = use)) & ( (#box : (a_select2(xinit_defuse, n3) = use)) & ( (#box : (a_select2(xinit_defuse, n4) = use)) & (#box : (a_select2(xinit_defuse, n5) = use)) ) ) ) ) ) => ( (#box : (a_select3(u_defuse, n0, n0) = use)) & ( (#box : (a_select3(u_defuse, n1, n0) = use)) & ( (#box : (a_select3(u_defuse, n2, n0) = use)) & ( (#box : (a_select2(tptp_update2(tptp_update2(tptp_update2(xinit_defuse, n3, use), n4, use), n5, use), n3) = use)) & ( (#box : (a_select2(tptp_update2(tptp_update2(tptp_update2(xinit_defuse, n3, use), n4, use), n5, use), n4) = use)) & (#box : (a_select2(tptp_update2(tptp_update2(tptp_update2(xinit_defuse, n3, use), n4, use), n5, use), n5) = use)) ) ) ) ) ) ))).

...
qmf(x2116,conjecture,
( #box : (( ( #box : ( ! [X] : ( ? [Y] : ( #box : (( #box : (big_p(X))) => ( ( #box : (big_r(X, g(h(Y))))) & ( #box : (big_p(Y))) ) ))))) & ( #box : ( ! [W] : ( #box : (( #box : (big_p(W))) => ( ( #box : (big_p(g(W)))) & ( #box : (big_p(h(W)))) ) )))) ) => ( #box : ( ! [X] : ( #box : (( #box : (big_p(X))) => ( ? [Y] : ( ( #box : (big_r(X, Y))) & ( #box : (big_p(Y))) )) )))) ))).

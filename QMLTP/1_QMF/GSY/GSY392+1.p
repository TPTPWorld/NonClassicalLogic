...
qmf(pel14,conjecture,
(( #box : ((( #box : (( #box : (p1)) => ( #box : (p2)) )) & (#box : (( #box : (p2)) => ( #box : (p1)) ))) => ( ( ( #box : (p2)) | ( #box : (~ ( #box : (p1)) )) ) & ( ( #box : (~ ( #box : (p2)) )) | ( #box : (p1)) ) ) )) & (#box : (( ( ( #box : (p2)) | ( #box : (~ ( #box : (p1)) )) ) & ( ( #box : (~ ( #box : (p2)) )) | ( #box : (p1)) ) ) => (( #box : (( #box : (p1)) => ( #box : (p2)) )) & (#box : (( #box : (p2)) => ( #box : (p1)) ))) )))).

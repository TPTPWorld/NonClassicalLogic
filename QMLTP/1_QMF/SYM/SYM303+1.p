...
qmf(persat7,axiom,
    (v3 | (#box : v3) | (#box : (#box : (~ v2))) | (#box : (#box : (~ v4))))
    ).
...
qmf(persat13,axiom,
    (v4 | (#box : (#box : v2)) | (#box : (#box : (~ v2))) | (#box : (#box : (~ v4))))
    ).

qmf(persat14,axiom,
    ((~ v1) | (#box : v3) | (#box : (~ v2)) | (#box : (#box : (~ v3))))
    ).
...
qmf(persat17,axiom,
    ((~ v3) | (#box : v4) | (#box : (~ v4)) | (#box : (#box : v4)))
    ).

qmf(persat18,axiom,
    ((~ v4) | (#box : v2) | (#box : v3) | (#box : (#box : v3)))
    ).

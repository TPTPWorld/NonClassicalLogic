...
% Comments :
%--------------------------------------------------------------------------
thf(schema1,axiom-local,( ( ( ~ ( ( r @ a ) ) ) | ( r @ b ) ) & ( ( r @ c ) <=> ( r @ a ) ) & ( ( r @ a ) => ( {$dia} @ ( ( r @ b ) ) ) ) & ( ( ~ ( ( ( r @ a ) ) ) ) => ( {$dia} @ ( ( ~ ( ( r @ b ) ) ) & ( ~ ( ( r @ c ) ) ) ) ) ) ) ).
thf(schema2,axiom-local,( ( ( p @ a ) => ( p @ b ) ) & ( ( p @ c ) | ( ~ ( ( p @ b ) ) ) ) & ( ( ( p @ a ) & ( p @ b ) ) => ( {$dia} @ ( ~ ( ( p @ b ) ) ) ) ) ) ).
thf(integration_assertion,axiom-local,( ! [ X :$i ] : ( ( p @ X ) <=> ( r @ X ) ) ) ).

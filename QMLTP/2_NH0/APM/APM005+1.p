...
%--------------------------------------------------------------------------
thf(ax1,axiom-local,( {$box} @ ( ! [ S :$i,V :$i ] : ( ? [ O :$i ] : ( ( {$box} @ ( ( ( closed @ S ) & ( combo @ S @ V ) & ( h @ O ) ) => ( {$box} @ ( ( open @ S ) ) ) ) ) & ( {$box} @ ( ( ( closed @ S ) & ( ~ ( ( combo @ S @ V ) ) ) & ( h @ o ) ) => ( {$box} @ ( ( closed @ S ) ) ) ) ) ) ) ) ) ).
thf(ax2,axiom-local,( {$box} @ ( ( closed @ d ) ) ) ).
thf(ax3,axiom-local,( {$box} @ ( ( combo @ d @ n ) | ( ~ ( ( combo @ d @ n ) ) ) ) ) ).
thf(ax4,axiom-local,( {$box} @ ( ! [ S :$i ] : ( ~ ( ( ( open @ S ) & ( closed @ S ) ) ) ) ) ) ).
thf(ax5,axiom-local,( ? [ V :$i ] : ( {$box} @ ( ( combo @ d @ V ) ) ) ) ).

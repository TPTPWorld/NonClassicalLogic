...
% Comments :
%--------------------------------------------------------------------------
thf(pour_ab_make_axiom_1,axiom-local,(({$box(#pour_a)}@({$box(#pour_b)}@acid))=>({$box(#make_c)}@acid))).
thf(pour_ab_make_axiom_2,axiom-local,(({$box(#pour_a)}@({$box(#pour_b)}@(~(acid))))=>({$box(#make_c)}@(~(acid))))).
thf(pour_ba_make_axiom_1,axiom-local,(({$box(#pour_b)}@({$box(#pour_a)}@acid))=>({$box(#make_c)}@acid))).
thf(pour_ba_make_axiom_2,axiom-local,(({$box(#pour_b)}@({$box(#pour_a)}@(~(acid))))=>({$box(#make_c)}@(~(acid))))).
thf(pour_a_acid,axiom-local,({$box(#pour_a)}@(~(acid)))).
thf(make_c_acid,axiom-local,({$dia(#make_c)}@acid)).

...
% Comments :
%--------------------------------------------------------------------------
thf(axiom_1,axiom-local,(![X:$i]:({$box(#ticket)}@((usemachine@X)|(usewindow@X))))).
thf(axiom_2,axiom-local,(![X:$i]:({$box(#ticket)}@((usemachine@X)=>(getticket@X))))).
thf(axiom_3,axiom-local,(![X:$i]:({$box(#ticket)}@((usewindow@X)=>(getticket@X))))).
thf(axiom_4,axiom-local,(![X:$i]:({$box(#coffee)}@((visitdonuts@X)|(visitstarbucks@X))))).
thf(axiom_5,axiom-local,(![X:$i]:({$box(#coffee)}@((visitdonuts@X)=>(getcoffee@X))))).
thf(axiom_6,axiom-local,(![X:$i]:({$box(#coffee)}@((visitstarbuck@X)=>(getcoffee@X))))).
thf(axiom_7,axiom-local,(![X:$i]:((({$box(#ticket)}@((getticket@X)))&({$box(#coffee)}@((getcoffee@X))))=>((takejourney@X))))).

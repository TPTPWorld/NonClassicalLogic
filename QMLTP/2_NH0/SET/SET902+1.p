...
thf(fc1_xboole_0,axiom-local,( ( empty @ empty_set ) ) ).
...
thf(l1_zfmisc_1,axiom-local,( ! [ A :$i ] : ~ ( ( qmltpeq @ ( singleton @ A ) @ empty_set ) ) ) ).
thf(l4_zfmisc_1,axiom-local,( ! [ A :$i,B :$i ] : ( ( subset @ A @ ( singleton @ B ) ) <=> ( ( qmltpeq @ A @ empty_set ) | ( qmltpeq @ A @ ( singleton @ B ) ) ) ) ) ).
...
thf(t7_xboole_1,axiom-local,( ! [ A :$i,B :$i ] : ( subset @ A @ ( set_union2 @ A @ B ) ) ) ).
%------------------------------------------------------------------------------

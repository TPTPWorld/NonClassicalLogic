...
thf(t43_zfmisc_1,axiom-local,( ! [ A :$i,B :$i,C :$i ] : ~ ( ( ( qmltpeq @ ( singleton @ A ) @ ( set_union2 @ B @ C ) ) & ~ ( ( ( qmltpeq @ B @ ( singleton @ A ) ) & ( qmltpeq @ C @ ( singleton @ A ) ) ) ) & ~ ( ( ( qmltpeq @ B @ empty_set ) & ( qmltpeq @ C @ ( singleton @ A ) ) ) ) & ~ ( ( ( qmltpeq @ B @ ( singleton @ A ) ) & ( qmltpeq @ C @ empty_set ) ) ) ) ) ) ).

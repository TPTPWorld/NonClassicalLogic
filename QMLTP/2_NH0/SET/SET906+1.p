...
thf(set_union2_substitution_1,axiom-local,( ! [ A :$i,B :$i,C :$i ] : ( ( qmltpeq @ A @ B ) => ( qmltpeq @ ( set_union2 @ A @ C ) @ ( set_union2 @ B @ C ) ) ) ) ).
thf(set_union2_substitution_2,axiom-local,( ! [ A :$i,B :$i,C :$i ] : ( ( qmltpeq @ A @ B ) => ( qmltpeq @ ( set_union2 @ C @ A ) @ ( set_union2 @ C @ B ) ) ) ) ).
...
thf(commutativity_k2_xboole_0,axiom-local,( ! [ A :$i,B :$i ] : ( qmltpeq @ ( set_union2 @ A @ B ) @ ( set_union2 @ B @ A ) ) ) ).
thf(d2_tarski,axiom-local,( ! [ A :$i,B :$i,C :$i ] : ( ( qmltpeq @ C @ ( unordered_pair @ A @ B ) ) <=> ! [ D :$i ] : ( ( in @ D @ C ) <=> ( ( qmltpeq @ D @ A ) | ( qmltpeq @ D @ B ) ) ) ) ) ).
thf(d2_xboole_0,axiom-local,( ! [ A :$i,B :$i,C :$i ] : ( ( qmltpeq @ C @ ( set_union2 @ A @ B ) ) <=> ! [ D :$i ] : ( ( in @ D @ C ) <=> ( ( in @ D @ A ) | ( in @ D @ B ) ) ) ) ) ).
thf(d3_tarski,axiom-local,( ! [ A :$i,B :$i ] : ( ( subset @ A @ B ) <=> ! [ C :$i ] : ( ( in @ C @ A ) => ( in @ C @ B ) ) ) ) ).
thf(fc2_xboole_0,axiom-local,( ! [ A :$i,B :$i ] : ( ~ ( ( empty @ A ) ) => ~ ( ( empty @ ( set_union2 @ A @ B ) ) ) ) ) ).
thf(fc3_xboole_0,axiom-local,( ! [ A :$i,B :$i ] : ( ~ ( ( empty @ A ) ) => ~ ( ( empty @ ( set_union2 @ B @ A ) ) ) ) ) ).
thf(idempotence_k2_xboole_0,axiom-local,( ! [ A :$i,B :$i ] : ( qmltpeq @ ( set_union2 @ A @ A ) @ A ) ) ).
...
thf(t47_zfmisc_1,conjecture,( ! [ A :$i,B :$i,C :$i ] : ( ( subset @ ( set_union2 @ ( unordered_pair @ A @ B ) @ C ) @ C ) => ( in @ A @ C ) ) ) ).
%------------------------------------------------------------------------------

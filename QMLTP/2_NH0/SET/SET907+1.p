...
thf(t12_xboole_1,axiom-local,( ! [ A :$i,B :$i ] : ( ( subset @ A @ B ) => ( qmltpeq @ ( set_union2 @ A @ B ) @ B ) ) ) ).
thf(t38_zfmisc_1,axiom-local,( ! [ A :$i,B :$i,C :$i ] : ( ( subset @ ( unordered_pair @ A @ B ) @ C ) <=> ( ( in @ A @ C ) & ( in @ B @ C ) ) ) ) ).
thf(t48_zfmisc_1,conjecture,( ! [ A :$i,B :$i,C :$i ] : ( ( ( in @ A @ B ) & ( in @ C @ B ) ) => ( qmltpeq @ ( set_union2 @ ( unordered_pair @ A @ C ) @ B ) @ B ) ) ) ).
%------------------------------------------------------------------------------

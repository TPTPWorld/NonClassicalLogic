...
thf(d1_xboole_0,axiom-local,( ! [ A :$i ] : ( ( qmltpeq @ A @ empty_set ) <=> ! [ B :$i ] : ~ ( ( in @ B @ A ) ) ) ) ).
thf(d2_tarski,axiom-local,( ! [ A :$i,B :$i,C :$i ] : ( ( qmltpeq @ C @ ( unordered_pair @ A @ B ) ) <=> ! [ D :$i ] : ( ( in @ D @ C ) <=> ( ( qmltpeq @ D @ A ) | ( qmltpeq @ D @ B ) ) ) ) ) ).
thf(d3_xboole_0,axiom-local,( ! [ A :$i,B :$i,C :$i ] : ( ( qmltpeq @ C @ ( set_intersection2 @ A @ B ) ) <=> ! [ D :$i ] : ( ( in @ D @ C ) <=> ( ( in @ D @ A ) & ( in @ D @ B ) ) ) ) ) ).
thf(d7_xboole_0,axiom-local,( ! [ A :$i,B :$i ] : ( ( disjoint @ A @ B ) <=> ( qmltpeq @ ( set_intersection2 @ A @ B ) @ empty_set ) ) ) ).
...
thf(symmetry_r1_xboole_0,axiom-local,( ! [ A :$i,B :$i ] : ( ( disjoint @ A @ B ) => ( disjoint @ B @ A ) ) ) ).

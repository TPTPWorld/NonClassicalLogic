...
%--------------------------------------------------------------------------
thf(pel41_1,axiom-local,( {$box} @ ( ! [ Z :$i ] : ( ? [ Y :$i ] : ( {$box} @ ( ! [ X :$i ] : ( ( {$box} @ ( ( {$box} @ ( ( element @ X @ Y ) ) ) => ( ( {$box} @ ( ( element @ X @ Z ) ) ) & ( {$box} @ ( ~ ( ( {$box} @ ( ( element @ X @ X ) ) ) ) ) ) ) ) ) & ( {$box} @ ( ( ( {$box} @ ( ( element @ X @ Z ) ) ) & ( {$box} @ ( ~ ( ( {$box} @ ( ( element @ X @ X ) ) ) ) ) ) ) => ( {$box} @ ( ( element @ X @ Y ) ) ) ) ) ) ) ) ) ) ) ).

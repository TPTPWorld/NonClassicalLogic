...
thf(t37_xboole_1,axiom-local,( {$box} @ ( ! [ A :$i ] : ( {$box} @ ( ! [ B :$i ] : ( ( {$box} @ ( ( {$box} @ ( ( qmltpeq @ ( set_difference @ A @ B ) @ empty_set ) ) ) => ( {$box} @ ( ( subset @ A @ B ) ) ) ) ) & ( {$box} @ ( ( {$box} @ ( ( subset @ A @ B ) ) ) => ( {$box} @ ( ( qmltpeq @ ( set_difference @ A @ B ) @ empty_set ) ) ) ) ) ) ) ) ) ) ).

...
% converted problem
%--------------------------------------------------------------------------
% File     : GSY049+1 : QMLTP v1.1
% Domain   : GSY (Goedel translation of Syntactic)
% Problem  : Goedel translation of SYN049+1 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
%--------------------------------------------------------------------------
thf(pel19,conjecture,( ? [ X :$i ] : ( {$box} @ ( ! [ Y :$i ] : ( {$box} @ ( ! [ Z :$i ] : ( {$box} @ ( ( {$box} @ ( ( {$box} @ ( ( big_p @ Y ) ) ) => ( {$box} @ ( ( big_q @ Z ) ) ) ) ) => ( {$box} @ ( ( {$box} @ ( ( big_p @ X ) ) ) => ( {$box} @ ( ( big_q @ X ) ) ) ) ) ) ) ) ) ) ) ) ).
%--------------------------------------------------------------------------

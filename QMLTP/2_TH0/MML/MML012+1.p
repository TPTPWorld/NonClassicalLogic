...
% Comments :
%--------------------------------------------------------------------------
thf(aciom_paid_charge,axiom-local,(paid=>called)).
thf(axiom_charge_u,axiom-local,(charge=>(({$box(#u)}@charge)&({$box(#c)}@charge)))).
thf(axiom_1,axiom-local,({$box(#u)}@(called=>({$box(#c)}@called)))).
thf(axiom_2,axiom-local,({$box(#c)}@(paid=>({$box(#u)}@paid)))).
thf(axiom_3,axiom-local,((~(({$box(#c)}@called)))=>({$box(#u)}@(~(({$box(#c)}@called)))))).
thf(axiom_4,axiom-local,((~(({$box(#u)}@paid)))=>({$box(#c)}@(~(({$box(#u)}@paid)))))).
thf(requirement_1,conjecture,((~(((called&(~(paid)))=>charge)))=>({$box(#c)}@(~(((called&(~(paid)))=>charge)))))).

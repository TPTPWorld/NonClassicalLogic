...
% Comments :
%--------------------------------------------------------------------------
thf(axiom_1_alice,axiom-local,({$box(#b_alice)}@(((bigcity@portland)&({$box(#b_alice)}@({$box(#b_bob)}@(~((bigcity@portland))))))=>({$box(#i_alice)}@({$box(#b_bob)}@((bigcity@portland))))))).
thf(axiom_1_bob,axiom-local,({$box(#b_bob)}@(((bigcity@portland)&({$box(#b_bob)}@({$box(#b_alice)}@(~((bigcity@portland))))))=>({$box(#i_bob)}@({$box(#b_alice)}@((bigcity@portland))))))).
thf(axiom_2,axiom-local,({$box(#b_alice)}@((bigcity@portland)))).
thf(axiom_3,axiom-local,({$box(#b_alice)}@({$box(#b_bob)}@(~((bigcity@portland)))))).

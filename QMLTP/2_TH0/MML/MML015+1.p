...
% Comments :
%--------------------------------------------------------------------------
thf(axiom_1_a,axiom-local,(({$box(#b_alice)}@((bigcity@portland)))=>(~(({$box(#i_alice)}@((bigcity@portland))))))).
thf(axiom_1_b,axiom-local,(({$box(#b_bob)}@((bigcity@portland)))=>(~(({$box(#i_bob)}@((bigcity@portland))))))).
thf(axiom_1_c,axiom-local,(({$box(#b_alice)}@((beautycity@portland)))=>(~(({$box(#i_alice)}@((beautycity@portland))))))).
thf(axiom_1_d,axiom-local,(({$box(#b_bob)}@((beautycity@portland)))=>(~(({$box(#i_bob)}@((beautycity@portland))))))).
thf(axiom_2,axiom-local,({$box(#b_alice)}@(({$box(#b_bob)}@({$box(#b_alice)}@((bigcity@portland))))|({$box(#b_bob)}@({$box(#b_alice)}@((beautycity@portland))))))).

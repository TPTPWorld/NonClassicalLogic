...
% Comments :
%------------------------------------------------------------------------------
thf(axiom_1,axiom-local,({$box(#b_s)}@(((dest@paris)&(class@first))=>(price@ninetyfive)))).
thf(axiom_2,axiom-local,({$box(#b_s)}@(((dest@paris)&(class@second))=>(price@seventy)))).
thf(axiom_3_s,axiom-local,({$box(#b_s)}@(~(((class@first)&(class@second)))))).
thf(axiom_3_u,axiom-local,({$box(#b_u)}@(~(((class@first)&(class@second)))))).
thf(axiom_4_s,axiom-local,({$box(#b_s)}@(~(((price@seventy)&(price@ninetyfive)))))).
thf(axiom_4_u,axiom-local,({$box(#b_u)}@(~(((price@seventy)&(price@ninetyfive)))))).
thf(axiom_5,axiom-local,({$box(#b_s)}@((dest@paris)&(class@second)))).

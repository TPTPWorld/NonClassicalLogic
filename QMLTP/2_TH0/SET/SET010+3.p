...
thf(union_subset,axiom-local,( ! [ B :$i,C :$i,D :$i ] : ( ( ( subset @ B @ C ) & ( subset @ D @ C ) ) => ( subset @ ( union @ B @ D ) @ C ) ) ) ).
thf(intersection_is_subset,axiom-local,( ! [ B :$i,C :$i ] : ( subset @ ( intersection @ B @ C ) @ B ) ) ).
thf(subset_difference,axiom-local,( ! [ B :$i,C :$i,D :$i ] : ( ( subset @ B @ C ) => ( subset @ ( difference @ D @ C ) @ ( difference @ D @ B ) ) ) ) ).

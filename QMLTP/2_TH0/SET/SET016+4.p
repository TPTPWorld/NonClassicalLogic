...
thf(difference_substitution_1,axiom-local,( ! [ A :$i,B :$i,C :$i ] : ( ( qmltpeq @ A @ B ) => ( qmltpeq @ ( difference @ A @ C ) @ ( difference @ B @ C ) ) ) ) ).
thf(difference_substitution_2,axiom-local,( ! [ A :$i,B :$i,C :$i ] : ( ( qmltpeq @ A @ B ) => ( qmltpeq @ ( difference @ C @ A ) @ ( difference @ C @ B ) ) ) ) ).
...
thf(power_set_substitution_1,axiom-local,( ! [ A :$i,B :$i ] : ( ( qmltpeq @ A @ B ) => ( qmltpeq @ ( power_set @ A ) @ ( power_set @ B ) ) ) ) ).
thf(product_substitution_1,axiom-local,( ! [ A :$i,B :$i ] : ( ( qmltpeq @ A @ B ) => ( qmltpeq @ ( product @ A ) @ ( product @ B ) ) ) ) ).
thf(singleton_substitution_1,axiom-local,( ! [ A :$i,B :$i ] : ( ( qmltpeq @ A @ B ) => ( qmltpeq @ ( singleton @ A ) @ ( singleton @ B ) ) ) ) ).
thf(sum_substitution_1,axiom-local,( ! [ A :$i,B :$i ] : ( ( qmltpeq @ A @ B ) => ( qmltpeq @ ( sum @ A ) @ ( sum @ B ) ) ) ) ).
...
thf(equal_set_substitution_1,axiom-local,( ! [ A :$i,B :$i,C :$i ] : ( ( ( qmltpeq @ A @ B ) & ( equal_set @ A @ C ) ) => ( equal_set @ B @ C ) ) ) ).
thf(equal_set_substitution_2,axiom-local,( ! [ A :$i,B :$i,C :$i ] : ( ( ( qmltpeq @ A @ B ) & ( equal_set @ C @ A ) ) => ( equal_set @ C @ B ) ) ) ).
...
thf(subset_0,axiom-local,( ! [ A :$i,B :$i ] : ( ( subset @ A @ B ) <=> ! [ X :$i ] : ( ( member @ X @ A ) => ( member @ X @ B ) ) ) ) ).
thf(equal_set_0,axiom-local,( ! [ A :$i,B :$i ] : ( ( equal_set @ A @ B ) <=> ( ( subset @ A @ B ) & ( subset @ B @ A ) ) ) ) ).
thf(power_set_0,axiom-local,( ! [ X :$i,A :$i ] : ( ( member @ X @ ( power_set @ A ) ) <=> ( subset @ X @ A ) ) ) ).
thf(intersection_0,axiom-local,( ! [ X :$i,A :$i,B :$i ] : ( ( member @ X @ ( intersection @ A @ B ) ) <=> ( ( member @ X @ A ) & ( member @ X @ B ) ) ) ) ).
thf(union_0,axiom-local,( ! [ X :$i,A :$i,B :$i ] : ( ( member @ X @ ( union @ A @ B ) ) <=> ( ( member @ X @ A ) | ( member @ X @ B ) ) ) ) ).
thf(empty_set_0,axiom-local,( ! [ X :$i ] : ~ ( ( member @ X @ empty_set ) ) ) ).
thf(difference_0,axiom-local,( ! [ B :$i,A :$i,E :$i ] : ( ( member @ B @ ( difference @ E @ A ) ) <=> ( ( member @ B @ E ) & ~ ( ( member @ B @ A ) ) ) ) ) ).
thf(singleton_0,axiom-local,( ! [ X :$i,A :$i ] : ( ( member @ X @ ( singleton @ A ) ) <=> ( qmltpeq @ X @ A ) ) ) ).
thf(unordered_pair_0,axiom-local,( ! [ X :$i,A :$i,B :$i ] : ( ( member @ X @ ( unordered_pair @ A @ B ) ) <=> ( ( qmltpeq @ X @ A ) | ( qmltpeq @ X @ B ) ) ) ) ).
thf(sum_0,axiom-local,( ! [ X :$i,A :$i ] : ( ( member @ X @ ( sum @ A ) ) <=> ? [ Y :$i ] : ( ( member @ Y @ A ) & ( member @ X @ Y ) ) ) ) ).
thf(product_0,axiom-local,( ! [ X :$i,A :$i ] : ( ( member @ X @ ( product @ A ) ) <=> ! [ Y :$i ] : ( ( member @ Y @ A ) => ( member @ X @ Y ) ) ) ) ).
thf(thI50a,conjecture,( ! [ A :$i,B :$i,U :$i,V :$i ] : ( ( equal_set @ ( unordered_pair @ ( singleton @ A ) @ ( unordered_pair @ A @ B ) ) @ ( unordered_pair @ ( singleton @ U ) @ ( unordered_pair @ U @ V ) ) ) => ( qmltpeq @ A @ U ) ) ) ).
%------------------------------------------------------------------------------

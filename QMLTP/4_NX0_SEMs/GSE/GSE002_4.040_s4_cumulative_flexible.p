...
% English  : Goedel encoding of the TPTP SET002+4 problem

% Refs     : [Goe69] Goedel (1969), An Interpretation of the Intuitionistic
%          : [RO12]  Raths & Otten (2012), The QMLTP Problem Library for Fi
% Source   : [QMLTP]
% Names    : GSE002+1 [QMLTP]
%          : GSE002_4.040_s4_cumulative_flexible.p [QMLTP/4_NX0_SEMs]
...
tff(thI14,conjecture,
    ( {$box}
    @ (! [A: $i] : ( {$box} @ (equal_set(union(A,A),A)) )) ) ).

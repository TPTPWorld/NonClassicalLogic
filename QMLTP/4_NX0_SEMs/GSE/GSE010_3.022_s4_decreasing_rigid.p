...
tff(union_subset, axiom-local, {$box}((! [B:$i]: ({$box}((! [C:$i]: ({$box}((! [D:$i]: ({$box}((({$box}(subset(B,C)) & {$box}(subset(D,C))) => {$box}(subset(union(B,D),C)))))))))))))).
tff(intersection_is_subset, axiom-local, {$box}((! [B:$i]: ({$box}((! [C:$i]: ({$box}(subset(intersection(B,C),B))))))))).
tff(subset_difference, axiom-local, {$box}((! [B:$i]: ({$box}((! [C:$i]: ({$box}((! [D:$i]: ({$box}(({$box}(subset(B,C)) => {$box}(subset(difference(D,C),difference(D,B))))))))))))))).

...
% English  : Goedel encoding of the TPTP SET012+4 problem

% Refs     : [Goe69] Goedel (1969), An Interpretation of the Intuitionistic
%          : [RO12]  Raths & Otten (2012), The QMLTP Problem Library for Fi
% Source   : [QMLTP]
% Names    : GSE012+1 [QMLTP]
%          : GSE012_4.047_s5_decreasing_flexible.p [QMLTP/4_NX0_SEMs]
...
%            Number of connectives :  319 (   3   ~;   4   |;  25   &)
%                                         (   0 <=>;  45  =>;   0  <=;   0 <~>)
%                                         ( 242 {}@;   0 {#};   0 {.})
...
tff(thI23,conjecture,
    ...
    @ (! [A: $i] :
         ...
         @ (! [E: $i] :
              ( {$box}
              @ (( ( {$box} @ (subset(A,E)) )
                => ( {$box} @ (equal_set(difference(E,difference(E,A)),A)) ) )) )) )) ) ).

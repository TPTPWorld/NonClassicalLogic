...
% English  : Goedel encoding of the TPTP SET013+4 problem

% Refs     : [Goe69] Goedel (1969), An Interpretation of the Intuitionistic
%          : [RO12]  Raths & Otten (2012), The QMLTP Problem Library for Fi
% Source   : [QMLTP]
% Names    : GSE013+1 [QMLTP]
%          : GSE013_4.047_s5_decreasing_flexible.p [QMLTP/4_NX0_SEMs]

% Status   : Unknown
% Rating   : ? v9.0.0
% Syntax   : Number of formulae    :   46 (   0 unt;  13 typ;   0 def)
%            Number of atoms       :  586 (   0 equ)
%            Maximal formula atoms :    2 (  17 avg)
%            Number of connectives :  316 (   3   ~;   4   |;  25   &)
%                                         (   0 <=>;  44  =>;   0  <=;   0 <~>)
%                                         ( 240 {}@;   0 {#};   0 {.})
...
tff(thI06,conjecture,
    ( {$box}
    @ (! [A: $i] :
         ( {$box}
         @ (! [B: $i] : ( {$box} @ (equal_set(intersection(A,B),intersection(B,A))) )) )) ) ).

...
% English  : Goedel encoding of the TPTP SET015+4 problem

% Refs     : [Goe69] Goedel (1969), An Interpretation of the Intuitionistic
%          : [RO12]  Raths & Otten (2012), The QMLTP Problem Library for Fi
% Source   : [QMLTP]
% Names    : GSE015+1 [QMLTP]
%          : GSE015_4.046_s4_decreasing_flexible.p [QMLTP/4_NX0_SEMs]
...
tff(thI07,conjecture,
    ( {$box}
    @ (! [A: $i] :
         ( {$box}
         @ (! [B: $i] : ( {$box} @ (equal_set(union(A,B),union(B,A))) )) )) ) ).

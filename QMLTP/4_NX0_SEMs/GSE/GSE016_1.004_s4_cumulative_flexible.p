...
%          : GSE016_1.004_s4_cumulative_flexible.p [QMLTP/4_NX0_SEMs]
    ...
    @ (! [A: $i] :
         ...
         @ (! [B: $i] :
              ...
              @ (! [U: $i] :
                   ...
                   @ (! [V: $i] :
                        ( {$box}
                        @ (( ( {$box} @ (equal_set(unordered_pair(singleton(A),unordered_pair(A,B)),unordered_pair(singleton(U),unordered_pair(U,V)))) )
                          => ( {$box} @ (qmltpeq(A,U)) ) )) )) )) )) )) ) ).

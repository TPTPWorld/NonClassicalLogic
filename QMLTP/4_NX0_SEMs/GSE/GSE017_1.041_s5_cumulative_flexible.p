...
% Source   : [QMLTP]
% Names    : GSE017+1 [QMLTP]
%          : GSE017_1.041_s5_cumulative_flexible.p [QMLTP/4_NX0_SEMs]
...
%            Number of connectives :  704 (   8   ~;   5   |;  69   &)
%                                         (   0 <=>;  87  =>;   0  <=;   0 <~>)
%                                         ( 535 {}@;   0 {#};   0 {.})
    ...
    @ (! [X: $i] :
         ...
         @ (! [Y: $i] :
              ...
              @ (! [Z: $i] :
                   ...
                   @ (( ( ( {$box} @ (member(Y,universal_class)) )
                        & ( {$box} @ (member(Z,universal_class)) )
                        & ( {$box} @ (qmltpeq(unordered_pair(X,Y),unordered_pair(X,Z))) ) )
                     => ( {$box} @ (qmltpeq(Y,Z)) ) )) )) )) )) ) ).

...
%          : GSE027_1.041_s5_cumulative_flexible.p [QMLTP/4_NX0_SEMs]

% Status   : Unknown
% Rating   : ? v9.0.0
% Syntax   : Number of formulae    :  116 (   0 unt;  32 typ;   0 def)
%            Number of atoms       : 1312 (   0 equ)
%            Maximal formula atoms :    6 (  15 avg)
%            Number of connectives :  702 (   8   ~;   5   |;  68   &)
%                                         (   0 <=>;  87  =>;   0  <=;   0 <~>)
%                                         ( 534 {}@;   0 {#};   0 {.})
%            Maximal formula depth :    5 (   2 avg)
%            Maximal term depth    :    4 (   1 avg)
%            Number of FOOLs       :  534 ( 534 fml;   0 var)

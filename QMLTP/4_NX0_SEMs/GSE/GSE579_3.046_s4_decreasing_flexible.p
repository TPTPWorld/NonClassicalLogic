...
%          : GSE579_3.046_s4_decreasing_flexible.p [QMLTP/4_NX0_SEMs]

% Status   : Unknown
% Rating   : ? v9.0.0
% Syntax   : Number of formulae    :   18 (   0 unt;   4 typ;   0 def)
%            Number of atoms       :  266 (   0 equ)
%            Maximal formula atoms :    2 (  19 avg)
%            Number of connectives :  147 (   4   ~;   0   |;  15   &)
%                                         (   0 <=>;  19  =>;   0  <=;   0 <~>)
%                                         ( 109 {}@;   0 {#};   0 {.})

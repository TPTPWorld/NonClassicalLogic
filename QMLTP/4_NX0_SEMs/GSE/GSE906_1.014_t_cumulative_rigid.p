...
tff(d2_tarski, axiom-local, {$box}((! [A:$i]: ({$box}((! [B:$i]: ({$box}((! [C:$i]: (({$box}(({$box}(qmltpeq(C,unordered_pair(A,B))) => {$box}((! [D:$i]: (({$box}(({$box}(in(D,C)) => ({$box}(qmltpeq(D,A)) | {$box}(qmltpeq(D,B))))) & {$box}((({$box}(qmltpeq(D,A)) | {$box}(qmltpeq(D,B))) => {$box}(in(D,C)))))))))) & {$box}(({$box}((! [D:$i]: (({$box}(({$box}(in(D,C)) => ({$box}(qmltpeq(D,A)) | {$box}(qmltpeq(D,B))))) & {$box}((({$box}(qmltpeq(D,A)) | {$box}(qmltpeq(D,B))) => {$box}(in(D,C)))))))) => {$box}(qmltpeq(C,unordered_pair(A,B)))))))))))))))).
tff(d2_xboole_0, axiom-local, {$box}((! [A:$i]: ({$box}((! [B:$i]: ({$box}((! [C:$i]: (({$box}(({$box}(qmltpeq(C,set_union2(A,B))) => {$box}((! [D:$i]: (({$box}(({$box}(in(D,C)) => ({$box}(in(D,A)) | {$box}(in(D,B))))) & {$box}((({$box}(in(D,A)) | {$box}(in(D,B))) => {$box}(in(D,C)))))))))) & {$box}(({$box}((! [D:$i]: (({$box}(({$box}(in(D,C)) => ({$box}(in(D,A)) | {$box}(in(D,B))))) & {$box}((({$box}(in(D,A)) | {$box}(in(D,B))) => {$box}(in(D,C)))))))) => {$box}(qmltpeq(C,set_union2(A,B)))))))))))))))).
tff(d3_tarski, axiom-local, {$box}((! [A:$i]: ({$box}((! [B:$i]: (({$box}(({$box}(subset(A,B)) => {$box}((! [C:$i]: ({$box}(({$box}(in(C,A)) => {$box}(in(C,B))))))))) & {$box}(({$box}((! [C:$i]: ({$box}(({$box}(in(C,A)) => {$box}(in(C,B))))))) => {$box}(subset(A,B)))))))))))).

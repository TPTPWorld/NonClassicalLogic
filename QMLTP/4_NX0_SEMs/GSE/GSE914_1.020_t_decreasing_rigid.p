...
tff(d3_xboole_0, axiom-local, {$box} @ ((! [A:$i]: ({$box} @ ((! [B:$i]: ({$box} @ ((! [C:$i]: (({$box} @ (({$box} @ (qmltpeq(C,set_intersection2(A,B))) => {$box} @ ((! [D:$i]: (({$box} @ (({$box} @ (in(D,C)) => ({$box} @ (in(D,A)) & {$box} @ (in(D,B))))) & {$box} @ ((({$box} @ (in(D,A)) & {$box} @ (in(D,B))) => {$box} @ (in(D,C)))))))))) & {$box} @ (({$box} @ ((! [D:$i]: (({$box} @ (({$box} @ (in(D,C)) => ({$box} @ (in(D,A)) & {$box} @ (in(D,B))))) & {$box} @ ((({$box} @ (in(D,A)) & {$box} @ (in(D,B))) => {$box} @ (in(D,C)))))))) => {$box} @ (qmltpeq(C,set_intersection2(A,B)))))))))))))))).
tff(d7_xboole_0, axiom-local, {$box} @ ((! [A:$i]: ({$box} @ ((! [B:$i]: (({$box} @ (({$box} @ (disjoint(A,B)) => {$box} @ (qmltpeq(set_intersection2(A,B),empty_set)))) & {$box} @ (({$box} @ (qmltpeq(set_intersection2(A,B),empty_set)) => {$box} @ (disjoint(A,B)))))))))))).

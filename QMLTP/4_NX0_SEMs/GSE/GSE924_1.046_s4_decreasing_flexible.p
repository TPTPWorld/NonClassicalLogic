...
% Source   : [QMLTP]
% Names    : GSE924+1 [QMLTP]
%          : GSE924_1.046_s4_decreasing_flexible.p [QMLTP/4_NX0_SEMs]

% Status   : Unknown
% Rating   : ? v9.0.0
% Syntax   : Number of formulae    :   19 (   0 unt;   5 typ;   0 def)
%            Number of atoms       :  193 (   0 equ)
%            Maximal formula atoms :    2 (  13 avg)
%            Number of connectives :  105 (   6   ~;   0   |;   6   &)
%                                         (   0 <=>;  13  =>;   0  <=;   0 <~>)
%                                         (  80 {}@;   0 {#};   0 {.})

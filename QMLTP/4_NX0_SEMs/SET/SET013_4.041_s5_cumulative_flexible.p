...
%          : SET013_4.041_s5_cumulative_flexible.p [QMLTP/4_NX0_SEMs]

% Status   : Unknown
% Rating   : ? v9.0.0
% Syntax   : Number of formulae    :   46 (   3 unt;  13 typ;   0 def)
%            Number of atoms       :   78 (   0 equ)
%            Maximal formula atoms :    3 (   2 avg)
%            Number of connectives :   47 (   2   ~;   2   |;  11   &)
%                                         (  10 <=>;  22  =>;   0  <=;   0 <~>)
...
tff(thI06,conjecture,
    ! [A: $i,B: $i] : equal_set(intersection(A,B),intersection(B,A)) ).

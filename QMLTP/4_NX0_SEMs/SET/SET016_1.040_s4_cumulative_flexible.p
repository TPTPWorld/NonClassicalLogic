...
% Source   : [QMLTP]
% Names    : SET016+1 [QMLTP]
%          : SET016_1.040_s4_cumulative_flexible.p [QMLTP/4_NX0_SEMs]
...
%            Number of connectives :  109 (   5   ~;   3   |;  33   &)
%                                         (  18 <=>;  50  =>;   0  <=;   0 <~>)
...
%            Number of variables   :  198 (; 194   !;   4   ?; 198   :)
% SPC      : TH0_CSA_EQU_NAR
...
tff(ordered_pair_determines_components1,conjecture,
    ! [W: $i,X: $i,Y: $i,Z: $i] :
      ( ( qmltpeq(ordered_pair(W,X),ordered_pair(Y,Z))

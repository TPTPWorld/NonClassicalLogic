...
% Source   : [QMLTP]
% Names    : SET025+1 [QMLTP]
%          : SET025_1.040_s4_cumulative_flexible.p [QMLTP/4_NX0_SEMs]

% Status   : Unknown
% Rating   : ? v9.0.0
% Syntax   : Number of formulae    :  116 (  18 unt;  32 typ;   0 def)
%            Number of atoms       :  186 (   0 equ)
%            Maximal formula atoms :    4 (   2 avg)
%            Number of connectives :  107 (   5   ~;   3   |;  32   &)
%                                         (  18 <=>;  49  =>;   0  <=;   0 <~>)
...
%            Number of variables   :  196 (; 192   !;   4   ?; 196   :)
% SPC      : TH0_CSA_EQU_NAR
...
tff(ordered_pair_is_set,conjecture,
    ! [X: $i,Y: $i] : member(ordered_pair(X,Y),universal_class) ).

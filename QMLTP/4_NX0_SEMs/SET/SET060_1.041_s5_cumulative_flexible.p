...
% Source   : [QMLTP]
% Names    : SET060+1 [QMLTP]
%          : SET060_1.041_s5_cumulative_flexible.p [QMLTP/4_NX0_SEMs]
...
%            Number of connectives :  108 (   6   ~;   3   |;  32   &)
%                                         (  18 <=>;  49  =>;   0  <=;   0 <~>)
...
tff(special_classes_lemma,conjecture,
    ! [X: $i,Y: $i] : ~ member(Y,intersection(complement(X),X)) ).

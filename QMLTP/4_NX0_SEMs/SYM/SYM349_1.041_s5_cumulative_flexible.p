...
% Source   : [QMLTP]
% Names    : SYM349+1 [QMLTP]
%          : SYM349_1.041_s5_cumulative_flexible.p [QMLTP/4_NX0_SEMs]

% Status   : Unknown
% Rating   : ? v9.0.0
% Syntax   : Number of formulae    :   70 (   1 unt;  28 typ;   0 def)
%            Number of atoms       : 2095 (   0 equ)
%            Maximal formula atoms :    4 (  49 avg)
%            Number of connectives : 1203 (  97   ~; 120   |;  39   &)
%                                         (   0 <=>;   0  =>;   0  <=;   0 <~>)
%                                         ( 947 {}@;   0 {#};   0 {.})
%            Maximal formula depth :    3 (   2 avg)
%            Maximal term depth    :    0 (   0 avg)
%            Number of FOOLs       :  947 ( 947 fml;   0 var)

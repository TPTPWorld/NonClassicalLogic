...
%%% Generated on Fri May 06 13:09:31 EDT 2022
...
thf(r_decl, type, r: ($i > (mworld > $o))).
thf(schema1, axiom, (mlocal @ ((mand @ ((mor @ (mnot @ (r @ a))) @ (r @ b))) @ ((mand @ ((mequiv @ (r @ c)) @ (r @ a))) @ ((mand @ ((mimplies @ (r @ a)) @ (mdia @ (r @ b)))) @ ((mimplies @ (mnot @ (r @ a))) @ (mdia @ ((mand @ (mnot @ (r @ b))) @ (mnot @ (r @ c)))))))))).
thf(schema2, axiom, (mlocal @ ((mand @ ((mimplies @ (p @ a)) @ (p @ b))) @ ((mand @ ((mor @ (p @ c)) @ (mnot @ (p @ b)))) @ ((mimplies @ ((mand @ (p @ a)) @ (p @ b))) @ (mdia @ (mnot @ (p @ b)))))))).
thf(integration_assertion, axiom, (mlocal @ (mforall_di @ (^ [X:$i]: (((mequiv @ (p @ X)) @ (r @ X))))))).

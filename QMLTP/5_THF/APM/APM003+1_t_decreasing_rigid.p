...
%%% Generated on Thu Apr 28 13:19:35 EDT 2022
...
thf(u_decl, type, u: $i).
thf(one_decl, type, one: $i).
thf(number_decl, type, number: ($i > ($i > (mworld > $o)))).
thf(string_decl, type, string: ($i > (mworld > $o))).
thf(in_decl, type, in: ($i > ($i > ($i > (mworld > $o))))).
thf(do_decl, type, do: ($i > ($i > ($i > (mworld > $o))))).
thf(entry_box_decl, type, entry_box: ($i > (mworld > $o))).
thf(userid_decl, type, userid: ($i > ($i > (mworld > $o)))).
thf(ax1, axiom, (mlocal @ (mbox @ (mexists_di @ (^ [I:$i]: ((mbox @ ((mand @ ((userid @ u) @ I)) @ (string @ I))))))))).
thf(ax2, axiom, (mlocal @ (mexists_di @ (^ [B:$i]: ((mbox @ ((mand @ (entry_box @ B)) @ ((number @ B) @ one)))))))).
thf(ax3, axiom, (mlocal @ (mbox @ (mforall_di @ (^ [S:$i]: ((mforall_di @ (^ [I:$i]: ((mforall_di @ (^ [B:$i]: (((mimplies @ ((mand @ (string @ I)) @ (entry_box @ B))) @ (mexists_di @ (^ [A:$i]: ((mbox @ (mforall_di @ (^ [S2:$i]: (((mimplies @ (((do @ S) @ A) @ S2)) @ (((in @ I) @ B) @ S2)))))))))))))))))))))).
thf(con, conjecture, (mlocal @ (mbox @ (mexists_di @ (^ [I:$i]: ((mexists_di @ (^ [B:$i]: ((mexists_di @ (^ [A:$i]: ((mexists_di @ (^ [S:$i]: (((mand @ (mbox @ ((mand @ ((userid @ u) @ I)) @ ((mand @ (entry_box @ B)) @ ((number @ B) @ one))))) @ (mbox @ (mforall_di @ (^ [S2:$i]: (((mimplies @ (((do @ S) @ A) @ S2)) @ (((in @ I) @ B) @ S2)))))))))))))))))))))).

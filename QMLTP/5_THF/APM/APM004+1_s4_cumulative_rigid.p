...
%%% Generated on Thu Apr 28 13:19:52 EDT 2022
...
thf(bomb_decl, type, bomb: ($i > (mworld > $o))).
thf(defused_decl, type, defused: ($i > (mworld > $o))).
thf(ax1, axiom, (mlocal @ (mbox @ (mexists_di @ (^ [B:$i]: ((bomb @ B))))))).
thf(ax2, axiom, (mlocal @ (mexists_di @ (^ [A:$i]: ((mbox @ (mforall_di @ (^ [X:$i]: (((mimplies @ ((mand @ (bomb @ X)) @ (h @ A))) @ (mbox @ (bomb @ X)))))))))))).
thf(ax3, axiom, (mlocal @ (mbox @ (mforall_di @ (^ [X:$i]: ((mexists_di @ (^ [D:$i]: ((mbox @ ((mimplies @ ((mand @ (bomb @ X)) @ (h @ D))) @ (defused @ X)))))))))))).
thf(con, conjecture, (mlocal @ (mbox @ (mforall_di @ (^ [X:$i]: ((mexists_di @ (^ [D:$i]: (((mimplies @ ((mand @ (bomb @ X)) @ (h @ D))) @ (defused @ X))))))))))).

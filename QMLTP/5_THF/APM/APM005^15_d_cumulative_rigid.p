...
%%% Generated on Thu Apr 28 13:20:12 EDT 2022
...
thf(closed_decl, type, closed: ($i > (mworld > $o))).
thf(combo_decl, type, combo: ($i > ($i > (mworld > $o)))).
thf(open_decl, type, open: ($i > (mworld > $o))).
thf(ax1, axiom, (mlocal @ (mbox @ (mforall_di @ (^ [S:$i]: ((mforall_di @ (^ [V:$i]: ((mexists_di @ (^ [O:$i]: (((mand @ (mbox @ ((mimplies @ ((mand @ (closed @ S)) @ ((mand @ ((combo @ S) @ V)) @ (h @ O)))) @ (mbox @ (open @ S))))) @ (mbox @ ((mimplies @ ((mand @ (closed @ S)) @ ((mand @ (mnot @ ((combo @ S) @ V))) @ (h @ o)))) @ (mbox @ (closed @ S))))))))))))))))).
thf(ax2, axiom, (mlocal @ (mbox @ (closed @ d)))).
thf(ax3, axiom, (mlocal @ (mbox @ ((mor @ ((combo @ d) @ n)) @ (mnot @ ((combo @ d) @ n)))))).
thf(ax4, axiom, (mlocal @ (mbox @ (mforall_di @ (^ [S:$i]: ((mnot @ ((mand @ (open @ S)) @ (closed @ S))))))))).
thf(ax5, axiom, (mlocal @ (mexists_di @ (^ [V:$i]: ((mbox @ ((combo @ d) @ V))))))).
thf(con, conjecture, (mlocal @ (mbox @ (mexists_di @ (^ [V:$i]: ((mexists_di @ (^ [O:$i]: (((mimplies @ (mbox @ ((mand @ ((combo @ d) @ V)) @ (h @ O)))) @ (mbox @ (open @ d)))))))))))).

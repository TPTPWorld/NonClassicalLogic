...
%%% Generated on Thu Apr 28 13:20:58 EDT 2022
...
thf(q2_decl, type, q2: ($i > (mworld > $o))).
...
thf(query, axiom, (mlocal @ (mforall_di @ (^ [X:$i]: (((mequiv @ (q2 @ X)) @ ((mand @ (mbox @ (male @ X))) @ (mnot @ (mbox @ (mexists_di @ (^ [Y:$i]: (((mand @ ((parent @ X) @ Y)) @ (female @ Y)))))))))))))).
thf(con, conjecture, (mlocal @ ((mand @ (q2 @ john)) @ (q2 @ paul)))).

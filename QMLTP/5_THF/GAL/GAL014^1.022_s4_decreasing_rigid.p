%------------------------------------------------------------------------------
% File     : GAL014^1.022 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   54 (  12 unt;  22 typ;  10 def)
%            Number of atoms       : 1121 (  10 equ;   0 cnn)
%            Maximal formula atoms :  240 (  35 avg)
%            Number of connectives : 2751 (   1   ~;   1   |;   5   &;2738   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)

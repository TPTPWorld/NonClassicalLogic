%------------------------------------------------------------------------------
% File     : GAL014^1.024 : TPTP v8.1.0. Released v8.1.0.
...
%            Number of atoms       : 1118 (  10 equ;   0 cnn)
%            Maximal formula atoms :  240 (  36 avg)
%            Number of connectives : 2743 (   1   ~;   1   |;   4   &;2732   @)
%                                         (   1 <=>;   4  =>;   0  <=;   0 <~>)
...
%%% Generated on Wed Apr 27 15:22:50 CEST 2022 using command 'downgrade(tff)'.
thf(unit_decl,type,
    unit: $i ).

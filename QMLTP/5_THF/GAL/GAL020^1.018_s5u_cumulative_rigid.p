%------------------------------------------------------------------------------
% File     : GAL020^1.018 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   55 (  12 unt;  27 typ;  10 def)
%            Number of atoms       :  590 (  10 equ;   0 cnn)
%            Maximal formula atoms :  219 (  21 avg)
%            Number of connectives : 1247 (   1   ~;   1   |;   4   &;1236   @)
%                                         (   1 <=>;   4  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   51 (  11 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :   68 (  68   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   27 (  26 usr;   9 con; 0-3 aty)
...
%%% Generated on Wed Apr 27 15:22:54 CEST 2022 using command 'downgrade(tff)'.
thf(e11_decl,type,
    e11: $i ).

%------------------------------------------------------------------------------
% File     : GAL021^1.006 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Theorem 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   43 (  11 unt;  21 typ;  10 def)
%            Number of atoms       :  725 (  10 equ;   0 cnn)
%            Maximal formula atoms :  540 (  32 avg)
%            Number of connectives : 1932 (   1   ~;   1   |;   2   &;1925   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)
%            Maximal formula depth :  112 (  12 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :   63 (  63   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   21 (  20 usr;   6 con; 0-3 aty)
%            Number of variables   :   43 (  37   ^   4   !;   2   ?;  43   :)
% SPC      : TH0_THM_EQU_NAR

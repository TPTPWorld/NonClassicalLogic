%------------------------------------------------------------------------------
% File     : GAL021^1.018 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Logic Calculi
% Problem  : Goedel translation of ALG021+1 (from TPTP-v5.0.0)
% Version  : [BP13] axioms.
% English  : 
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   46 (  12 unt;  22 typ;  10 def)
%            Number of atoms       :  731 (  10 equ;   0 cnn)
%            Maximal formula atoms :  540 (  30 avg)
%            Number of connectives : 1948 (   1   ~;   1   |;   4   &;1937   @)
%                                         (   1 <=>;   4  =>;   0  <=;   0 <~>)
%            Maximal formula depth :  112 (  12 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :   65 (  65   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   22 (  21 usr;   6 con; 0-3 aty)
%            Number of variables   :   48 (  37   ^   8   !;   3   ?;  48   :)
% SPC      : TH0_UNK_EQU_NAR
...
%%% Generated on Wed Apr 27 15:22:55 CEST 2022 using command 'downgrade(tff)'.
thf(unit_decl,type,
    unit: $i ).

...
%%% Generated on Thu Apr 28 13:30:16 EDT 2022
...
thf(pel4, conjecture, (mlocal @ ((mand @ (mbox @ ((mimplies @ (mbox @ ((mimplies @ (mbox @ (mnot @ (mbox @ p)))) @ (mbox @ q)))) @ (mbox @ ((mimplies @ (mbox @ (mnot @ (mbox @ q)))) @ (mbox @ p)))))) @ (mbox @ ((mimplies @ (mbox @ ((mimplies @ (mbox @ (mnot @ (mbox @ q)))) @ (mbox @ p)))) @ (mbox @ ((mimplies @ (mbox @ (mnot @ (mbox @ p)))) @ (mbox @ q)))))))).

...
%%% Generated on Thu Apr 28 13:30:41 EDT 2022
...
thf(pel5, conjecture, (mlocal @ (mbox @ ((mimplies @ (mbox @ ((mimplies @ ((mor @ (mbox @ p)) @ (mbox @ q))) @ ((mor @ (mbox @ p)) @ (mbox @ r))))) @ ((mor @ (mbox @ p)) @ (mbox @ ((mimplies @ (mbox @ q)) @ (mbox @ r)))))))).

...
%%% Generated on Thu Apr 28 13:31:20 EDT 2022
...
thf(meets_decl, type, meets: ($i > ($i > (mworld > $o)))).
thf(m1, axiom, (mlocal @ (mbox @ (mforall_di @ (^ [P:$i]: ((mbox @ (mforall_di @ (^ [Q:$i]: ((mbox @ (mforall_di @ (^ [R:$i]: ((mbox @ (mforall_di @ (^ [S:$i]: ((mbox @ ((mimplies @ ((mand @ (mbox @ ((meets @ P) @ Q))) @ ((mand @ (mbox @ ((meets @ P) @ S))) @ (mbox @ ((meets @ R) @ Q))))) @ (mbox @ ((meets @ R) @ S)))))))))))))))))))))).
thf(m2, axiom, (mlocal @ (mbox @ (mforall_di @ (^ [P:$i]: ((mbox @ (mforall_di @ (^ [Q:$i]: ((mbox @ (mforall_di @ (^ [R:$i]: ((mbox @ (mforall_di @ (^ [S:$i]: ((mbox @ ((mimplies @ ((mand @ (mbox @ ((meets @ P) @ Q))) @ (mbox @ ((meets @ R) @ S)))) @ (mbox @ (mnot @ ((mand @ (mbox @ ((mimplies @ (mbox @ (mnot @ ((mand @ (mbox @ ((mimplies @ (mbox @ ((meets @ P) @ S))) @ (mexists_di @ (^ [T:$i]: (((mand @ (mbox @ ((meets @ P) @ T))) @ (mbox @ ((meets @ T) @ S))))))))) @ (mbox @ ((mimplies @ (mexists_di @ (^ [T:$i]: (((mand @ (mbox @ ((meets @ P) @ T))) @ (mbox @ ((meets @ T) @ S))))))) @ (mbox @ ((meets @ P) @ S)))))))) @ (mexists_di @ (^ [T:$i]: (((mand @ (mbox @ ((meets @ R) @ T))) @ (mbox @ ((meets @ T) @ Q))))))))) @ (mbox @ ((mimplies @ (mexists_di @ (^ [T:$i]: (((mand @ (mbox @ ((meets @ R) @ T))) @ (mbox @ ((meets @ T) @ Q))))))) @ (mbox @ (mnot @ ((mand @ (mbox @ ((mimplies @ (mbox @ ((meets @ P) @ S))) @ (mexists_di @ (^ [T:$i]: (((mand @ (mbox @ ((meets @ P) @ T))) @ (mbox @ ((meets @ T) @ S))))))))) @ (mbox @ ((mimplies @ (mexists_di @ (^ [T:$i]: (((mand @ (mbox @ ((meets @ P) @ T))) @ (mbox @ ((meets @ T) @ S))))))) @ (mbox @ ((meets @ P) @ S)))))))))))))))))))))))))))))))).
thf(m3, axiom, (mlocal @ (mbox @ (mforall_di @ (^ [P:$i]: ((mexists_di @ (^ [Q:$i]: ((mexists_di @ (^ [R:$i]: (((mand @ (mbox @ ((meets @ Q) @ P))) @ (mbox @ ((meets @ P) @ R))))))))))))))).
thf(not_m5, axiom, (mlocal @ (mbox @ (mnot @ (mbox @ (mforall_di @ (^ [P:$i]: ((mbox @ (mforall_di @ (^ [Q:$i]: ((mbox @ ((mimplies @ (mbox @ ((meets @ P) @ Q))) @ (mexists_di @ (^ [R:$i]: ((mexists_di @ (^ [S:$i]: ((mexists_di @ (^ [T:$i]: (((mand @ (mbox @ ((meets @ R) @ P))) @ ((mand @ (mbox @ ((meets @ Q) @ S))) @ ((mand @ (mbox @ ((meets @ R) @ T))) @ (mbox @ ((meets @ T) @ S)))))))))))))))))))))))))))).

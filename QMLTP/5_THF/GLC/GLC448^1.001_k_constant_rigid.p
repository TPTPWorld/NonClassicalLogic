%------------------------------------------------------------------------------
% File     : GLC448^1.001 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  115 (  10 unt;  51 typ;  10 def)
%            Number of atoms       :  874 (  10 equ;   0 cnn)
%            Maximal formula atoms :   36 (  13 avg)
%            Number of connectives : 1342 (   1   ~;   1   |;   2   &;1335   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)

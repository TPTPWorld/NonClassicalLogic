%------------------------------------------------------------------------------
% File     : GLC448^1.007 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  117 (  11 unt;  52 typ;  10 def)
%            Number of atoms       :  877 (  10 equ;   0 cnn)
%            Maximal formula atoms :   36 (  13 avg)
%            Number of connectives : 1350 (   1   ~;   1   |;   3   &;1341   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)

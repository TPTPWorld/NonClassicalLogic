%------------------------------------------------------------------------------
% File     : GLC448^1.008 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  118 (  12 unt;  52 typ;  10 def)
%            Number of atoms       :  878 (  10 equ;   0 cnn)
%            Maximal formula atoms :   36 (  13 avg)
%            Number of connectives : 1352 (   1   ~;   1   |;   3   &;1343   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)

%------------------------------------------------------------------------------
% File     : GLC449^1.001 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  124 (  10 unt;  51 typ;  10 def)
%            Number of atoms       :  966 (  10 equ;   0 cnn)
%            Maximal formula atoms :   60 (  13 avg)
%            Number of connectives : 1464 (   1   ~;   1   |;   2   &;1457   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   30 (  12 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :  102 ( 102   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   51 (  50 usr;   1 con; 0-3 aty)
%            Number of variables   :  194 ( 190   ^   2   !;   2   ?; 194   :)
% SPC      : TH0_UNK_EQU_NAR

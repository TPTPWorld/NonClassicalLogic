%------------------------------------------------------------------------------
% File     : GLC449^1.005 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  126 (  11 unt;  51 typ;  10 def)
%            Number of atoms       :  970 (  10 equ;   0 cnn)
%            Maximal formula atoms :   60 (  12 avg)
%            Number of connectives : 1474 (   1   ~;   1   |;   3   &;1465   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   30 (  12 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :  102 ( 102   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   51 (  50 usr;   1 con; 0-3 aty)
%            Number of variables   :  198 ( 190   ^   6   !;   2   ?; 198   :)
% SPC      : TH0_UNK_EQU_NAR

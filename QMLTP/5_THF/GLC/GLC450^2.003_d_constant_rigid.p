%------------------------------------------------------------------------------
% File     : GLC450^2.003 : TPTP v8.1.0. Released v8.1.0.
...
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  124 (  11 unt;  51 typ;  10 def)
%            Number of atoms       :  952 (  10 equ;   0 cnn)
%            Maximal formula atoms :   56 (  13 avg)
%            Number of connectives : 1449 (   1   ~;   1   |;   2   &;1442   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   24 (  12 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :  102 ( 102   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   51 (  50 usr;   1 con; 0-3 aty)
%            Number of variables   :  194 ( 188   ^   3   !;   3   ?; 194   :)
% SPC      : TH0_CSA_EQU_NAR
              ...
              @ ^ [X1: $i] :
                  ...
                  @ ( mforall_di
                    @ ^ [X2: $i] :
                        ( mbox
                        @ ( mforall_di
                          @ ^ [Y: $i] : ( mbox @ ( mimplies @ ( mbox @ ( is_a_theorem @ ( equiv @ X1 @ X2 ) ) ) @ ( mbox @ ( is_a_theorem @ ( equiv @ ( and @ X1 @ Y ) @ ( and @ X2 @ Y ) ) ) ) ) ) ) ) ) ) ) )
          @ ( mand
            @ ( mbox
              @ ( mforall_di
                @ ^ [X1: $i] :
                    ...
                    @ ( mforall_di
                      @ ^ [X2: $i] :
                          ( mbox
                          @ ( mforall_di
                            @ ^ [Y: $i] : ( mbox @ ( mimplies @ ( mbox @ ( is_a_theorem @ ( equiv @ X1 @ X2 ) ) ) @ ( mbox @ ( is_a_theorem @ ( equiv @ ( and @ Y @ X1 ) @ ( and @ Y @ X2 ) ) ) ) ) ) ) ) ) ) ) )
            @ ( mbox
              @ ( mforall_di
                @ ^ [X: $i] :
                    ( mbox

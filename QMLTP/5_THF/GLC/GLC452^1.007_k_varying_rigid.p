%------------------------------------------------------------------------------
% File     : GLC452^1.007 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  130 (  11 unt;  53 typ;  10 def)
%            Number of atoms       :  913 (  10 equ;   0 cnn)
%            Maximal formula atoms :   36 (  11 avg)
%            Number of connectives : 1374 (   1   ~;   1   |;   3   &;1365   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)

%------------------------------------------------------------------------------
% File     : GLC452^1.011 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  132 (  12 unt;  53 typ;  10 def)
%            Number of atoms       :  917 (  10 equ;   0 cnn)
%            Maximal formula atoms :   36 (  11 avg)
%            Number of connectives : 1384 (   1   ~;   1   |;   4   &;1373   @)
%                                         (   1 <=>;   4  =>;   0  <=;   0 <~>)

%------------------------------------------------------------------------------
% File     : GLC453^1.013 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  131 (  11 unt;  53 typ;  10 def)
%            Number of atoms       :  916 (  10 equ;   0 cnn)
%            Maximal formula atoms :   36 (  11 avg)
%            Number of connectives : 1382 (   1   ~;   1   |;   4   &;1371   @)
%                                         (   1 <=>;   4  =>;   0  <=;   0 <~>)

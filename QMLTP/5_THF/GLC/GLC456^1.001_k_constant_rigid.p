%------------------------------------------------------------------------------
% File     : GLC456^1.001 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  127 (  10 unt;  51 typ;  10 def)
%            Number of atoms       :  910 (  10 equ;   0 cnn)
%            Maximal formula atoms :   36 (  11 avg)
%            Number of connectives : 1366 (   1   ~;   1   |;   2   &;1359   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   23 (  11 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :  102 ( 102   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   51 (  50 usr;   1 con; 0-3 aty)
%            Number of variables   :  181 ( 177   ^   2   !;   2   ?; 181   :)
% SPC      : TH0_UNK_EQU_NAR

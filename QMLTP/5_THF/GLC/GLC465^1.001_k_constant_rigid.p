%------------------------------------------------------------------------------
% File     : GLC465^1.001 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  118 (  10 unt;  52 typ;  10 def)
%            Number of atoms       :  880 (  10 equ;   0 cnn)
%            Maximal formula atoms :   36 (  13 avg)
%            Number of connectives : 1346 (   1   ~;   1   |;   2   &;1339   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)

%------------------------------------------------------------------------------
% File     : GLC465^1.009 : TPTP v8.1.0. Released v8.1.0.
...
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  121 (  12 unt;  53 typ;  10 def)
%            Number of atoms       :  884 (  10 equ;   0 cnn)
%            Maximal formula atoms :   36 (  13 avg)
%            Number of connectives : 1356 (   1   ~;   1   |;   3   &;1347   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   23 (  12 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :  105 ( 105   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   53 (  52 usr;   1 con; 0-3 aty)
%            Number of variables   :  185 ( 177   ^   4   !;   4   ?; 185   :)
% SPC      : TH0_CSA_EQU_NAR

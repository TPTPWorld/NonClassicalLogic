%------------------------------------------------------------------------------
% File     : GLC465^1.023 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Theorem 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  123 (  12 unt;  53 typ;  10 def)
%            Number of atoms       :  890 (  10 equ;   0 cnn)
%            Maximal formula atoms :   36 (  12 avg)
%            Number of connectives : 1372 (   1   ~;   1   |;   5   &;1359   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   23 (  12 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :  105 ( 105   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   53 (  52 usr;   1 con; 0-3 aty)
%            Number of variables   :  190 ( 177   ^  10   !;   3   ?; 190   :)
% SPC      : TH0_THM_EQU_NAR
...
thf(hilbert_implies_3,conjecture,

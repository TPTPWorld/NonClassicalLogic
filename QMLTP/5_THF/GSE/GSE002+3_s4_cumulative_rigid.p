...
%%% Generated on Thu Apr 28 13:52:06 EDT 2022
...
thf(subset_union, axiom, (mlocal @ (mbox @ (mforall_di @ (^ [B:$i]: ((mbox @ (mforall_di @ (^ [C:$i]: ((mbox @ ((mimplies @ (mbox @ ((subset @ B) @ C))) @ (mbox @ ((qmltpeq @ ((union @ B) @ C)) @ C)))))))))))))).
...
thf(prove_idempotency_of_union, conjecture, (mlocal @ (mbox @ (mforall_di @ (^ [B:$i]: ((mbox @ ((qmltpeq @ ((union @ B) @ B)) @ B)))))))).

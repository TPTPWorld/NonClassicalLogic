...
%%% Generated on Fri May 06 13:13:13 EDT 2022
...
thf(prove_intersection_difference_empty_set, conjecture, (mlocal @ (mbox @ (mforall_di @ (^ [B:$i]: ((mbox @ (mforall_di @ (^ [C:$i]: ((mbox @ ((qmltpeq @ ((intersection @ ((difference @ B) @ C)) @ C)) @ empty_set)))))))))))).

...
%%% Generated on Thu Apr 28 13:54:23 EDT 2022
...
thf(union_subset, axiom, (mlocal @ (mbox @ (mforall_di @ (^ [B:$i]: ((mbox @ (mforall_di @ (^ [C:$i]: ((mbox @ (mforall_di @ (^ [D:$i]: ((mbox @ ((mimplies @ ((mand @ (mbox @ ((subset @ B) @ C))) @ (mbox @ ((subset @ D) @ C)))) @ (mbox @ ((subset @ ((union @ B) @ D)) @ C)))))))))))))))))).
thf(intersection_is_subset, axiom, (mlocal @ (mbox @ (mforall_di @ (^ [B:$i]: ((mbox @ (mforall_di @ (^ [C:$i]: ((mbox @ ((subset @ ((intersection @ B) @ C)) @ B)))))))))))).
thf(subset_difference, axiom, (mlocal @ (mbox @ (mforall_di @ (^ [B:$i]: ((mbox @ (mforall_di @ (^ [C:$i]: ((mbox @ (mforall_di @ (^ [D:$i]: ((mbox @ ((mimplies @ (mbox @ ((subset @ B) @ C))) @ (mbox @ ((subset @ ((difference @ D) @ C)) @ ((difference @ D) @ B))))))))))))))))))).
thf(equal_defn, axiom, (mlocal @ (mbox @ (mforall_di @ (^ [B:$i]: ((mbox @ (mforall_di @ (^ [C:$i]: (((mand @ (mbox @ ((mimplies @ (mbox @ ((qmltpeq @ B) @ C))) @ ((mand @ (mbox @ ((subset @ B) @ C))) @ (mbox @ ((subset @ C) @ B)))))) @ (mbox @ ((mimplies @ ((mand @ (mbox @ ((subset @ B) @ C))) @ (mbox @ ((subset @ C) @ B)))) @ (mbox @ ((qmltpeq @ B) @ C))))))))))))))).
...
thf(subset_defn, axiom, (mlocal @ (mbox @ (mforall_di @ (^ [B:$i]: ((mbox @ (mforall_di @ (^ [C:$i]: (((mand @ (mbox @ ((mimplies @ (mbox @ ((subset @ B) @ C))) @ (mbox @ (mforall_di @ (^ [D:$i]: ((mbox @ ((mimplies @ (mbox @ ((member @ D) @ B))) @ (mbox @ ((member @ D) @ C))))))))))) @ (mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [D:$i]: ((mbox @ ((mimplies @ (mbox @ ((member @ D) @ B))) @ (mbox @ ((member @ D) @ C))))))))) @ (mbox @ ((subset @ B) @ C))))))))))))))).
thf(reflexivity_of_subset, axiom, (mlocal @ (mbox @ (mforall_di @ (^ [B:$i]: ((mbox @ ((subset @ B) @ B)))))))).
...
thf(prove_difference_and_intersection_and_union, conjecture, (mlocal @ (mbox @ (mforall_di @ (^ [B:$i]: ((mbox @ (mforall_di @ (^ [C:$i]: ((mbox @ (mforall_di @ (^ [D:$i]: ((mbox @ ((qmltpeq @ ((difference @ B) @ ((intersection @ C) @ D))) @ ((union @ ((difference @ B) @ C)) @ ((difference @ B) @ D)))))))))))))))))).

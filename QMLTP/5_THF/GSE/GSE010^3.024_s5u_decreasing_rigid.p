%------------------------------------------------------------------------------
% File     : GSE010^3.024 : TPTP v8.1.0. Released v8.1.0.
    ...
    @ ( mbox
      @ ( mforall_di
        @ ^ [B: $i] :
            ( mbox
            @ ( mforall_di
              @ ^ [C: $i] : ( mbox @ ( subset @ ( intersection @ B @ C ) @ B ) ) ) ) ) ) ) ).
        ...
        @ ^ [B: $i] :
            ...
            @ ( mforall_di
              @ ^ [C: $i] :
                  ( mbox
                  @ ( mforall_di
                    @ ^ [D: $i] : ( mbox @ ( qmltpeq @ ( difference @ B @ ( intersection @ C @ D ) ) @ ( union @ ( difference @ B @ C ) @ ( difference @ B @ D ) ) ) ) ) ) ) ) ) ) ) ).

...
%%% Generated on Thu Apr 28 13:54:58 EDT 2022
...
thf(prove_difference_difference_intersection, conjecture, (mlocal @ (mbox @ (mforall_di @ (^ [B:$i]: ((mbox @ (mforall_di @ (^ [C:$i]: ((mbox @ ((qmltpeq @ ((difference @ B) @ ((difference @ B) @ C))) @ ((intersection @ B) @ C))))))))))))).

%------------------------------------------------------------------------------
% File     : GSE014^4.012 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   72 (  12 unt;  27 typ;  10 def)
%            Number of atoms       :  589 (  10 equ;   0 cnn)
%            Maximal formula atoms :   30 (  13 avg)
%            Number of connectives :  857 (   1   ~;   1   |;   3   &; 848   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   21 (  13 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :   83 (  83   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   27 (  26 usr;   2 con; 0-3 aty)
%            Number of variables   :  121 ( 113   ^   5   !;   3   ?; 121   :)
% SPC      : TH0_UNK_EQU_NAR
        ...
        @ ^ [A: $i] :
            ...
            @ ( mforall_di
              @ ^ [X: $i] :
                  ( mbox
                  @ ( mforall_di
                    @ ^ [Y: $i] : ( mand @ ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( subset @ X @ A ) ) @ ( mbox @ ( subset @ Y @ A ) ) ) @ ( mbox @ ( subset @ ( union @ X @ Y ) @ A ) ) ) ) @ ( mbox @ ( mimplies @ ( mbox @ ( subset @ ( union @ X @ Y ) @ A ) ) @ ( mand @ ( mbox @ ( subset @ X @ A ) ) @ ( mbox @ ( subset @ Y @ A ) ) ) ) ) ) ) ) ) ) ) ) ) ).

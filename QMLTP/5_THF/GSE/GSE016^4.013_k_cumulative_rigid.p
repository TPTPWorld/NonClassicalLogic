%------------------------------------------------------------------------------
% File     : GSE016^4.013 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   72 (  11 unt;  27 typ;  10 def)
%            Number of atoms       :  580 (  10 equ;   0 cnn)
%            Maximal formula atoms :   30 (  12 avg)
%            Number of connectives :  850 (   1   ~;   1   |;   4   &; 839   @)
%                                         (   1 <=>;   4  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   23 (  13 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :   83 (  83   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   27 (  26 usr;   2 con; 0-3 aty)
%            Number of variables   :  123 ( 114   ^   6   !;   3   ?; 123   :)
% SPC      : TH0_UNK_EQU_NAR

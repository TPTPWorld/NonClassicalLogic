%------------------------------------------------------------------------------
% File     : GSE017^1.016 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  144 (  12 unt;  46 typ;  10 def)
%            Number of atoms       : 1265 (  10 equ;   0 cnn)
%            Maximal formula atoms :   32 (  12 avg)
%            Number of connectives : 2010 (   1   ~;   1   |;   5   &;1997   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   27 (  14 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :  106 ( 106   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   46 (  45 usr;   6 con; 0-3 aty)
%            Number of variables   :  236 ( 223   ^  10   !;   3   ?; 236   :)
% SPC      : TH0_UNK_EQU_NAR
...
thf(left_cancellation,conjecture,
    ( mlocal
    @ ( mbox
      @ ( mforall_di
        @ ^ [X: $i] :
            ...
            @ ( mforall_di
              @ ^ [Y: $i] :
                  ( mbox
                  @ ( mforall_di
                    @ ^ [Z: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( member @ Y @ universal_class ) ) @ ( mand @ ( mbox @ ( member @ Z @ universal_class ) ) @ ( mbox @ ( qmltpeq @ ( unordered_pair @ X @ Y ) @ ( unordered_pair @ X @ Z ) ) ) ) ) @ ( mbox @ ( qmltpeq @ Y @ Z ) ) ) ) ) ) ) ) ) ) ) ).

%------------------------------------------------------------------------------
% File     : GSE018^1.022 : TPTP v8.1.0. Released v8.1.0.
              ...
              @ ^ [X: $i] :
                  ...
                  @ ( mforall_di
                    @ ^ [Y: $i] :
                        ( mbox
                        @ ( mforall_di
                          @ ^ [Z: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( qmltpeq @ ( ordered_pair @ W @ X ) @ ( ordered_pair @ Y @ Z ) ) ) @ ( mbox @ ( member @ X @ universal_class ) ) ) @ ( mbox @ ( qmltpeq @ X @ Z ) ) ) ) ) ) ) ) ) ) ) ) ) ).

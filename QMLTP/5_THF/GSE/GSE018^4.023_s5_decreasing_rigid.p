%------------------------------------------------------------------------------
% File     : GSE018^4.023 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   74 (  12 unt;  27 typ;  10 def)
%            Number of atoms       :  584 (  10 equ;   0 cnn)
%            Maximal formula atoms :   30 (  12 avg)
%            Number of connectives :  860 (   1   ~;   1   |;   5   &; 847   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   23 (  13 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :   83 (  83   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   27 (  26 usr;   2 con; 0-3 aty)
%            Number of variables   :  127 ( 114   ^  10   !;   3   ?; 127   :)
% SPC      : TH0_UNK_EQU_NAR
              ...
              @ ^ [B: $i] :
                  ...
                  @ ( mforall_di
                    @ ^ [U: $i] :
                        ( mbox
                        @ ( mforall_di
                          @ ^ [V: $i] : ( mbox @ ( mimplies @ ( mbox @ ( equal_set @ ( unordered_pair @ ( singleton @ A ) @ ( unordered_pair @ A @ B ) ) @ ( unordered_pair @ ( singleton @ U ) @ ( unordered_pair @ U @ V ) ) ) ) @ ( mbox @ ( qmltpeq @ B @ V ) ) ) ) ) ) ) ) ) ) ) ) ) ).

...
%%% Generated on Thu Apr 28 14:04:42 EDT 2022
...
thf(prove_transitivity_of_subset, conjecture, (mlocal @ (mbox @ (mforall_di @ (^ [B:$i]: ((mbox @ (mforall_di @ (^ [C:$i]: ((mbox @ (mforall_di @ (^ [D:$i]: ((mbox @ ((mimplies @ ((mand @ (mbox @ ((subset @ B) @ C))) @ (mbox @ ((subset @ C) @ D)))) @ (mbox @ ((subset @ B) @ D)))))))))))))))))).

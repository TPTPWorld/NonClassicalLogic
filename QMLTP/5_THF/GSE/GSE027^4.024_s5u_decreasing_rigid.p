%------------------------------------------------------------------------------
% File     : GSE027^4.024 : TPTP v8.1.0. Released v8.1.0.
        ...
        @ ^ [A: $i] :
            ...
            @ ( mforall_di
              @ ^ [B: $i] :
                  ( mbox
                  @ ( mforall_di
                    @ ^ [C: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( subset @ A @ B ) ) @ ( mbox @ ( subset @ B @ C ) ) ) @ ( mbox @ ( subset @ A @ C ) ) ) ) ) ) ) ) ) ) ) ).

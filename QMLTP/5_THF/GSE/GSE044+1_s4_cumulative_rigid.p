...
%%% Generated on Thu Apr 28 14:06:17 EDT 2022
...
thf(pel40, conjecture, (mlocal @ (mbox @ ((mimplies @ (mexists_di @ (^ [Y:$i]: ((mbox @ (mforall_di @ (^ [X:$i]: (((mand @ (mbox @ ((mimplies @ (mbox @ ((element @ X) @ Y))) @ (mbox @ ((element @ X) @ X))))) @ (mbox @ ((mimplies @ (mbox @ ((element @ X) @ X))) @ (mbox @ ((element @ X) @ Y))))))))))))) @ (mbox @ (mnot @ (mbox @ (mforall_di @ (^ [X1:$i]: ((mexists_di @ (^ [Y1:$i]: ((mbox @ (mforall_di @ (^ [Z:$i]: (((mand @ (mbox @ ((mimplies @ (mbox @ ((element @ Z) @ Y1))) @ (mbox @ (mnot @ (mbox @ ((element @ Z) @ X1))))))) @ (mbox @ ((mimplies @ (mbox @ (mnot @ (mbox @ ((element @ Z) @ X1))))) @ (mbox @ ((element @ Z) @ Y1)))))))))))))))))))))).

%------------------------------------------------------------------------------
% File     : GSE044^1.018 : TPTP v8.1.0. Released v8.1.0.
      ...
      @ ( mimplies
        @ ( mexists_di
          @ ^ [Y: $i] :
              ( mbox
              @ ( mforall_di
                @ ^ [X: $i] : ( mand @ ( mbox @ ( mimplies @ ( mbox @ ( element @ X @ Y ) ) @ ( mbox @ ( element @ X @ X ) ) ) ) @ ( mbox @ ( mimplies @ ( mbox @ ( element @ X @ X ) ) @ ( mbox @ ( element @ X @ Y ) ) ) ) ) ) ) )
        @ ( mbox
          @ ( mnot
            @ ( mbox
              @ ( mforall_di

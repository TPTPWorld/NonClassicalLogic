%------------------------------------------------------------------------------
% File     : GSE045^1.005 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Theorem 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   28 (  11 unt;  14 typ;  10 def)
%            Number of atoms       :   63 (  10 equ;   0 cnn)
%            Maximal formula atoms :   29 (   4 avg)
%            Number of connectives :   86 (   1   ~;   1   |;   3   &;  77   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)
      ...
      @ ( mforall_di
        @ ^ [Z: $i] :
            ...
            @ ^ [Y: $i] :
                ( mbox
                @ ( mforall_di
                  @ ^ [X: $i] : ( mand @ ( mbox @ ( mimplies @ ( mbox @ ( element @ X @ Y ) ) @ ( mand @ ( mbox @ ( element @ X @ Z ) ) @ ( mbox @ ( mnot @ ( mbox @ ( element @ X @ X ) ) ) ) ) ) ) @ ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( element @ X @ Z ) ) @ ( mbox @ ( mnot @ ( mbox @ ( element @ X @ X ) ) ) ) ) @ ( mbox @ ( element @ X @ Y ) ) ) ) ) ) ) ) ) ) ) ).

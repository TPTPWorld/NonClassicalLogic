...
%%% Generated on Thu Apr 28 14:06:41 EDT 2022
...
thf(pel41_1, axiom, (mlocal @ (mbox @ (mforall_di @ (^ [Z:$i]: ((mexists_di @ (^ [Y:$i]: ((mbox @ (mforall_di @ (^ [X:$i]: (((mand @ (mbox @ ((mimplies @ (mbox @ ((element @ X) @ Y))) @ ((mand @ (mbox @ ((element @ X) @ Z))) @ (mbox @ (mnot @ (mbox @ ((element @ X) @ X)))))))) @ (mbox @ ((mimplies @ ((mand @ (mbox @ ((element @ X) @ Z))) @ (mbox @ (mnot @ (mbox @ ((element @ X) @ X)))))) @ (mbox @ ((element @ X) @ Y)))))))))))))))))).
thf(pel41, conjecture, (mlocal @ (mbox @ (mnot @ (mexists_di @ (^ [Z:$i]: ((mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ ((element @ X) @ Z))))))))))))).

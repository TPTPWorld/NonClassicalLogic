...
%%% Generated on Fri May 06 13:14:45 EDT 2022
...
thf(pel42, conjecture, (mlocal @ (mbox @ (mnot @ (mexists_di @ (^ [Y:$i]: ((mbox @ (mforall_di @ (^ [X:$i]: (((mand @ (mbox @ ((mimplies @ (mbox @ ((element @ X) @ Y))) @ (mbox @ (mnot @ (mexists_di @ (^ [Z:$i]: (((mand @ (mbox @ ((element @ X) @ Z))) @ (mbox @ ((element @ Z) @ X))))))))))) @ (mbox @ ((mimplies @ (mbox @ (mnot @ (mexists_di @ (^ [Z:$i]: (((mand @ (mbox @ ((element @ X) @ Z))) @ (mbox @ ((element @ Z) @ X))))))))) @ (mbox @ ((element @ X) @ Y)))))))))))))))).

%------------------------------------------------------------------------------
% File     : GSE056^1.022 : TPTP v8.1.0. Released v8.1.0.
...
%            Number of atoms       : 1271 (  10 equ;   0 cnn)
%            Maximal formula atoms :   32 (  12 avg)
%            Number of connectives : 2014 (   1   ~;   1   |;   5   &;2001   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)
    ...
    @ ( mbox
      @ ( mforall_di
        @ ^ [X: $i] :
            ...
            @ ( mforall_di
              @ ^ [Y: $i] :
                  ( mor @ ( mbox @ ( qmltpeq @ X @ Y ) )
                  @ ( mor
                    @ ( mexists_di
                      @ ^ [U: $i] : ( mand @ ( mbox @ ( member @ U @ X ) ) @ ( mbox @ ( mnot @ ( mbox @ ( member @ U @ Y ) ) ) ) ) )
                    @ ( mexists_di
                      @ ^ [W: $i] : ( mand @ ( mbox @ ( member @ W @ Y ) ) @ ( mbox @ ( mnot @ ( mbox @ ( member @ W @ X ) ) ) ) ) ) ) ) ) ) ) ) ) ).

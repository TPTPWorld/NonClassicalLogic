%------------------------------------------------------------------------------
% File     : GSE063^1.016 : TPTP v8.1.0. Released v8.1.0.
...
%            Number of connectives : 1992 (   1   ~;   1   |;   5   &;1979   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)
...
thf(corollary_of_null_class_is_subclass,conjecture,
    ...
    @ ( mbox
      @ ( mforall_di
        @ ^ [X: $i] : ( mbox @ ( mimplies @ ( mbox @ ( subclass @ X @ null_class ) ) @ ( mbox @ ( qmltpeq @ X @ null_class ) ) ) ) ) ) ) ).

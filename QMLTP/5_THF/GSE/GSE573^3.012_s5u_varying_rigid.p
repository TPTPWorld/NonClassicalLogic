%------------------------------------------------------------------------------
% File     : GSE573^3.012 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Theorem 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   33 (  12 unt;  17 typ;  10 def)
%            Number of atoms       :  103 (  10 equ;   0 cnn)
%            Maximal formula atoms :   26 (   6 avg)
%            Number of connectives :  140 (   1   ~;   1   |;   3   &; 131   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   19 (   6 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :   68 (  68   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   17 (  16 usr;   1 con; 0-3 aty)
%            Number of variables   :   42 (  34   ^   5   !;   3   ?;  42   :)
% SPC      : TH0_THM_EQU_NAR
    ...
    @ ( mbox
      @ ( mforall_di
        @ ^ [B: $i] :
            ( mbox
            @ ( mforall_di
              @ ^ [C: $i] : ( mand @ ( mbox @ ( mimplies @ ( mbox @ ( disjoint @ B @ C ) ) @ ( mbox @ ( mnot @ ( mbox @ ( intersect @ B @ C ) ) ) ) ) ) @ ( mbox @ ( mimplies @ ( mbox @ ( mnot @ ( mbox @ ( intersect @ B @ C ) ) ) ) @ ( mbox @ ( disjoint @ B @ C ) ) ) ) ) ) ) ) ) ) ).
        ...
        @ ^ [B: $i] :
            ...
            @ ( mforall_di
              @ ^ [C: $i] :
                  ( mbox
                  @ ( mforall_di
                    @ ^ [D: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( member @ B @ C ) ) @ ( mbox @ ( disjoint @ C @ D ) ) ) @ ( mbox @ ( mnot @ ( mbox @ ( member @ B @ D ) ) ) ) ) ) ) ) ) ) ) ) ) ).

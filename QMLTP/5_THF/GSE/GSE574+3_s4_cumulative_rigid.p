...
%%% Generated on Thu Apr 28 14:15:36 EDT 2022
...
thf(prove_th13, conjecture, (mlocal @ (mbox @ (mforall_di @ (^ [B:$i]: ((mbox @ (mforall_di @ (^ [C:$i]: ((mbox @ (mforall_di @ (^ [D:$i]: ((mbox @ ((mimplies @ ((mand @ (mbox @ ((member @ B) @ C))) @ (mbox @ ((member @ B) @ D)))) @ (mbox @ ((intersect @ C) @ D)))))))))))))))))).

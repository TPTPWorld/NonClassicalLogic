%------------------------------------------------------------------------------
% File     : GSE576^3.012 : TPTP v8.1.0. Released v8.1.0.
...
%            Number of atoms       :  104 (  10 equ;   0 cnn)
%            Maximal formula atoms :   26 (   6 avg)
%            Number of connectives :  141 (   1   ~;   1   |;   3   &; 132   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)
            ...
            @ ( mforall_di
              @ ^ [C: $i] :
                  ...
                  @ ( mimplies
                    @ ( mbox
                      @ ( mforall_di
                        @ ^ [D: $i] : ( mbox @ ( mimplies @ ( mbox @ ( member @ D @ B ) ) @ ( mbox @ ( mnot @ ( mbox @ ( member @ D @ C ) ) ) ) ) ) ) )
                    @ ( mbox @ ( disjoint @ B @ C ) ) ) ) ) ) ) ) ) ).

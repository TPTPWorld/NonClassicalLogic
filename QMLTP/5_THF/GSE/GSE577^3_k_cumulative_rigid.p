...
%%% Generated on Thu Apr 28 14:17:07 EDT 2022
...
thf(prove_th18, conjecture, (mlocal @ (mbox @ (mforall_di @ (^ [B:$i]: ((mbox @ (mforall_di @ (^ [C:$i]: ((mbox @ (mforall_di @ (^ [D:$i]: ((mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [E:$i]: (((mand @ (mbox @ ((mimplies @ (mbox @ ((member @ E) @ B))) @ ((mor @ (mbox @ ((member @ E) @ C))) @ (mbox @ ((member @ E) @ D)))))) @ (mbox @ ((mimplies @ ((mor @ (mbox @ ((member @ E) @ C))) @ (mbox @ ((member @ E) @ D)))) @ (mbox @ ((member @ E) @ B)))))))))) @ (mbox @ ((qmltpeq @ B) @ ((union @ C) @ D))))))))))))))))))).

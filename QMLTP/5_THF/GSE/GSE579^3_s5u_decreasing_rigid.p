...
%%% Generated on Fri May 06 13:15:58 EDT 2022
...
thf(prove_th20, conjecture, (mlocal @ (mbox @ (mforall_di @ (^ [B:$i]: ((mbox @ (mforall_di @ (^ [C:$i]: ((mbox @ (mforall_di @ (^ [D:$i]: ((mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [E:$i]: (((mand @ (mbox @ ((mimplies @ (mbox @ ((member @ E) @ B))) @ ((mand @ (mbox @ ((member @ E) @ C))) @ (mbox @ (mnot @ (mbox @ ((member @ E) @ D)))))))) @ (mbox @ ((mimplies @ ((mand @ (mbox @ ((member @ E) @ C))) @ (mbox @ (mnot @ (mbox @ ((member @ E) @ D)))))) @ (mbox @ ((member @ E) @ B)))))))))) @ (mbox @ ((qmltpeq @ B) @ ((difference @ C) @ D))))))))))))))))))).

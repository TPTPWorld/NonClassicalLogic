%------------------------------------------------------------------------------
% File     : GSE582^3.021 : TPTP v8.1.0. Released v8.1.0.
...
%            Number of atoms       :  459 (  10 equ;   0 cnn)
%            Maximal formula atoms :   52 (  12 avg)
%            Number of connectives :  669 (   1   ~;   1   |;   4   &; 658   @)
%                                         (   1 <=>;   4  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   29 (  12 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :   74 (  74   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   20 (  19 usr;   1 con; 0-3 aty)
%            Number of variables   :  100 (  89   ^   7   !;   4   ?; 100   :)
% SPC      : TH0_UNK_EQU_NAR
        ...
        @ ^ [A: $i] :
            ...
            @ ( mforall_di
              @ ^ [B: $i] :
                  ( mbox
                  @ ( mforall_di
                    @ ^ [C: $i] : ( mbox @ ( mimplies @ ( mbox @ ( qmltpeq @ A @ B ) ) @ ( mbox @ ( qmltpeq @ ( symmetric_difference @ A @ C ) @ ( symmetric_difference @ B @ C ) ) ) ) ) ) ) ) ) ) ) ) ).
        ...
        @ ^ [A: $i] :
            ...
            @ ( mforall_di
              @ ^ [B: $i] :
                  ( mbox
                  @ ( mforall_di
                    @ ^ [C: $i] : ( mbox @ ( mimplies @ ( mbox @ ( qmltpeq @ A @ B ) ) @ ( mbox @ ( qmltpeq @ ( symmetric_difference @ C @ A ) @ ( symmetric_difference @ C @ B ) ) ) ) ) ) ) ) ) ) ) ) ).
    ...
    @ ( mbox
      @ ( mforall_di
        @ ^ [B: $i] :
            ( mbox
            @ ( mforall_di
              @ ^ [C: $i] : ( mbox @ ( qmltpeq @ ( symmetric_difference @ B @ C ) @ ( union @ ( difference @ B @ C ) @ ( difference @ C @ B ) ) ) ) ) ) ) ) ) ).
    ...
    @ ( mbox
      @ ( mforall_di
        @ ^ [B: $i] :
            ( mbox
            @ ( mforall_di
              @ ^ [C: $i] : ( mbox @ ( qmltpeq @ ( symmetric_difference @ B @ C ) @ ( symmetric_difference @ C @ B ) ) ) ) ) ) ) ) ).
                  ...
                  @ ( mforall_di
                    @ ^ [D: $i] :
                        ...
                        @ ( mimplies
                          @ ( mbox
                            @ ( mforall_di
                              @ ^ [E: $i] : ( mand @ ( mbox @ ( mimplies @ ( mbox @ ( mnot @ ( mbox @ ( member @ E @ B ) ) ) ) @ ( mand @ ( mbox @ ( mimplies @ ( mbox @ ( member @ E @ C ) ) @ ( mbox @ ( member @ E @ D ) ) ) ) @ ( mbox @ ( mimplies @ ( mbox @ ( member @ E @ D ) ) @ ( mbox @ ( member @ E @ C ) ) ) ) ) ) ) @ ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( mimplies @ ( mbox @ ( member @ E @ C ) ) @ ( mbox @ ( member @ E @ D ) ) ) ) @ ( mbox @ ( mimplies @ ( mbox @ ( member @ E @ D ) ) @ ( mbox @ ( member @ E @ C ) ) ) ) ) @ ( mbox @ ( mnot @ ( mbox @ ( member @ E @ B ) ) ) ) ) ) ) ) )
                          @ ( mbox @ ( qmltpeq @ B @ ( symmetric_difference @ C @ D ) ) ) ) ) ) ) ) ) ) ) ) ).

...
%%% Generated on Thu Apr 28 14:20:40 EDT 2022
...
thf(prove_extensionality, conjecture, (mlocal @ (mbox @ (mforall_di @ (^ [B:$i]: ((mbox @ (mforall_di @ (^ [C:$i]: ((mbox @ ((mimplies @ ((mand @ (mbox @ ((subset @ B) @ C))) @ (mbox @ ((subset @ C) @ B)))) @ (mbox @ ((qmltpeq @ B) @ C)))))))))))))).

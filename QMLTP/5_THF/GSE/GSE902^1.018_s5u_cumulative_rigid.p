...
thf(l1_zfmisc_1,axiom,
    ...
    @ ( mbox
      @ ( mforall_di
        @ ^ [A: $i] : ( mbox @ ( mnot @ ( mbox @ ( qmltpeq @ ( singleton @ A ) @ empty_set ) ) ) ) ) ) ) ).
        ...
        @ ^ [A: $i] :
            ...
            @ ( mforall_di
              @ ^ [B: $i] :
                  ( mbox
                  @ ( mforall_di
                    @ ^ [C: $i] : ( mbox @ ( mnot @ ( mand @ ( mbox @ ( qmltpeq @ ( singleton @ A ) @ ( set_union2 @ B @ C ) ) ) @ ( mand @ ( mbox @ ( mnot @ ( mand @ ( mbox @ ( qmltpeq @ B @ ( singleton @ A ) ) ) @ ( mbox @ ( qmltpeq @ C @ ( singleton @ A ) ) ) ) ) ) @ ( mand @ ( mbox @ ( mnot @ ( mand @ ( mbox @ ( qmltpeq @ B @ empty_set ) ) @ ( mbox @ ( qmltpeq @ C @ ( singleton @ A ) ) ) ) ) ) @ ( mbox @ ( mnot @ ( mand @ ( mbox @ ( qmltpeq @ B @ ( singleton @ A ) ) ) @ ( mbox @ ( qmltpeq @ C @ empty_set ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ).
    ...
    @ ( mbox
      @ ( mforall_di
        @ ^ [A: $i] :
            ( mbox
            @ ( mforall_di
              @ ^ [B: $i] : ( mbox @ ( subset @ A @ ( set_union2 @ A @ B ) ) ) ) ) ) ) ) ).

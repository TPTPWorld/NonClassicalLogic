%------------------------------------------------------------------------------
% File     : GSE907^1.018 : TPTP v8.1.0. Released v8.1.0.
    ...
    @ ( mbox
      @ ( mforall_di
        @ ^ [A: $i] :
            ( mbox
            @ ( mforall_di
              @ ^ [B: $i] : ( mbox @ ( mimplies @ ( mbox @ ( subset @ A @ B ) ) @ ( mbox @ ( qmltpeq @ ( set_union2 @ A @ B ) @ B ) ) ) ) ) ) ) ) ) ).
        ...
        @ ^ [A: $i] :
            ...
            @ ( mforall_di
              @ ^ [B: $i] :
                  ( mbox
                  @ ( mforall_di
                    @ ^ [C: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( in @ A @ B ) ) @ ( mbox @ ( in @ C @ B ) ) ) @ ( mbox @ ( qmltpeq @ ( set_union2 @ ( unordered_pair @ A @ C ) @ B ) @ B ) ) ) ) ) ) ) ) ) ) ) ).

%------------------------------------------------------------------------------
% File     : GSE908^1.017 : TPTP v8.1.0. Released v8.1.0.
...
%            Number of atoms       :  352 (  10 equ;   0 cnn)
%            Maximal formula atoms :   58 (  10 avg)
%            Number of connectives :  494 (   1   ~;   1   |;   5   &; 481   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)
    ...
    @ ( mbox
      @ ( mforall_di
        @ ^ [A: $i] :
            ( mbox
            @ ( mforall_di
              @ ^ [B: $i] : ( mbox @ ( mnot @ ( mbox @ ( qmltpeq @ ( set_union2 @ ( singleton @ A ) @ B ) @ empty_set ) ) ) ) ) ) ) ) ) ).

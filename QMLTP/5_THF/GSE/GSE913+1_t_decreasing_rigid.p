...
%%% Generated on Thu Apr 28 14:28:16 EDT 2022
...
thf(t54_zfmisc_1, conjecture, (mlocal @ (mbox @ (mforall_di @ (^ [A:$i]: ((mbox @ (mforall_di @ (^ [B:$i]: ((mbox @ (mnot @ ((mand @ (mbox @ ((disjoint @ (singleton @ A)) @ B))) @ (mbox @ ((in @ A) @ B))))))))))))))).
thf(l25_zfmisc_1, axiom, (mlocal @ (mbox @ (mforall_di @ (^ [A:$i]: ((mbox @ (mforall_di @ (^ [B:$i]: ((mbox @ (mnot @ ((mand @ (mbox @ ((disjoint @ (singleton @ A)) @ B))) @ (mbox @ ((in @ A) @ B))))))))))))))).

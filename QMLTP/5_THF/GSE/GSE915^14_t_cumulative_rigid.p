...
%%% Generated on Thu Apr 28 14:29:22 EDT 2022
...
thf(t56_zfmisc_1, conjecture, (mlocal @ (mbox @ (mforall_di @ (^ [A:$i]: ((mbox @ (mforall_di @ (^ [B:$i]: ((mbox @ ((mimplies @ (mbox @ (mnot @ (mbox @ ((in @ A) @ B))))) @ (mbox @ ((disjoint @ (singleton @ A)) @ B)))))))))))))).

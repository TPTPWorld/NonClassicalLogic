...
%%% Generated on Thu Apr 28 14:33:42 EDT 2022
...
thf(t67_zfmisc_1, conjecture, (mlocal @ (mbox @ (mforall_di @ (^ [A:$i]: ((mbox @ (mforall_di @ (^ [B:$i]: (((mand @ (mbox @ ((mimplies @ (mbox @ ((qmltpeq @ ((set_difference @ (singleton @ A)) @ B)) @ (singleton @ A)))) @ (mbox @ (mnot @ (mbox @ ((in @ A) @ B))))))) @ (mbox @ ((mimplies @ (mbox @ (mnot @ (mbox @ ((in @ A) @ B))))) @ (mbox @ ((qmltpeq @ ((set_difference @ (singleton @ A)) @ B)) @ (singleton @ A)))))))))))))))).

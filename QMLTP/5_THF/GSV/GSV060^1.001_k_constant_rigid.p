%------------------------------------------------------------------------------
% File     : GSV060^1.001 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Theorem 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  191 (  10 unt;  47 typ;  10 def)
%            Number of atoms       : 1899 (  10 equ;   0 cnn)
%            Maximal formula atoms :   97 (  13 avg)
%            Number of connectives : 3038 (   1   ~;   1   |;   2   &;3031   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)

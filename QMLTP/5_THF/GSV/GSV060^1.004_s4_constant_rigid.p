%------------------------------------------------------------------------------
% File     : GSV060^1.004 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Theorem 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  193 (  11 unt;  47 typ;  10 def)
%            Number of atoms       : 1903 (  10 equ;   0 cnn)
%            Maximal formula atoms :   97 (  13 avg)
%            Number of connectives : 3048 (   1   ~;   1   |;   3   &;3039   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)

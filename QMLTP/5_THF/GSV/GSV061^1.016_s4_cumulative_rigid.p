%------------------------------------------------------------------------------
% File     : GSV061^1.016 : TPTP v8.1.0. Released v8.1.0.
...
%            Number of connectives : 3081 (   1   ~;   1   |;   5   &;3068   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)
...
thf(cl5_nebula_array_0002,conjecture,
    mlocal @ ( mbox @ ( mimplies @ ( mbox @ true ) @ ( mand @ ( mbox @ ( mimplies @ ( mbox @ ( mnot @ ( mbox @ ( gt @ loopcounter @ n1 ) ) ) ) @ ( mbox @ true ) ) ) @ ( mbox @ ( mimplies @ ( mbox @ ( gt @ loopcounter @ n1 ) ) @ ( mbox @ true ) ) ) ) ) ) ).

%------------------------------------------------------------------------------
% File     : GSV064^1.023 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  207 (  12 unt;  52 typ;  10 def)
%            Number of atoms       : 1963 (  10 equ;   0 cnn)
%            Maximal formula atoms :   97 (  12 avg)
%            Number of connectives : 3163 (   1   ~;   1   |;   5   &;3150   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)
...
thf(cl5_nebula_array_0005,conjecture,
    mlocal @ ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ pv10 ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv53 ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv54 ) ) @ ( mand @ ( mbox @ ( leq @ pv10 @ ( minus @ n135300 @ n1 ) ) ) @ ( mand @ ( mbox @ ( leq @ pv53 @ ( minus @ n5 @ n1 ) ) ) @ ( mbox @ ( leq @ pv54 @ ( minus @ n5 @ n1 ) ) ) ) ) ) ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ n0 ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv10 ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv53 ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv54 ) ) @ ( mand @ ( mbox @ ( leq @ pv10 @ ( minus @ n135300 @ n1 ) ) ) @ ( mand @ ( mbox @ ( leq @ pv53 @ ( minus @ n5 @ n1 ) ) ) @ ( mbox @ ( leq @ pv54 @ ( minus @ n5 @ n1 ) ) ) ) ) ) ) ) ) ) ) ).

%------------------------------------------------------------------------------
% File     : GSV065^1.001 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Theorem 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  201 (  10 unt;  50 typ;  10 def)
%            Number of atoms       : 1941 (  10 equ;   0 cnn)
%            Maximal formula atoms :   97 (  12 avg)
%            Number of connectives : 3113 (   1   ~;   1   |;   2   &;3106   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)
...
thf(cl5_nebula_array_0006,conjecture,
    mlocal @ ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ pv10 ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv53 ) ) @ ( mand @ ( mbox @ ( leq @ pv10 @ ( minus @ n135300 @ n1 ) ) ) @ ( mbox @ ( leq @ pv53 @ ( minus @ n5 @ n1 ) ) ) ) ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ n0 ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv10 ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv53 ) ) @ ( mand @ ( mbox @ ( leq @ pv10 @ ( minus @ n135300 @ n1 ) ) ) @ ( mbox @ ( leq @ pv53 @ ( minus @ n5 @ n1 ) ) ) ) ) ) ) ) ) ).

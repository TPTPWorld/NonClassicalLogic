%------------------------------------------------------------------------------
% File     : GSV066^1.005 : TPTP v8.1.0. Released v8.1.0.
...
%            Number of connectives : 3118 (   1   ~;   1   |;   3   &;3109   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)
...
thf(cl5_nebula_array_0007,conjecture,
    mlocal @ ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ pv10 ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv53 ) ) @ ( mand @ ( mbox @ ( leq @ pv10 @ ( minus @ n135300 @ n1 ) ) ) @ ( mbox @ ( leq @ pv53 @ ( minus @ n5 @ n1 ) ) ) ) ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv10 ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv53 ) ) @ ( mand @ ( mbox @ ( leq @ pv10 @ ( minus @ n135300 @ n1 ) ) ) @ ( mbox @ ( leq @ pv53 @ ( minus @ n5 @ n1 ) ) ) ) ) ) ) ) ).

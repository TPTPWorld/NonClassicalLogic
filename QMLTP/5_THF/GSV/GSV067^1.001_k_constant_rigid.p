%------------------------------------------------------------------------------
% File     : GSV067^1.001 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  203 (  10 unt;  52 typ;  10 def)
%            Number of atoms       : 1960 (  10 equ;   0 cnn)
%            Maximal formula atoms :   97 (  12 avg)
%            Number of connectives : 3152 (   1   ~;   1   |;   2   &;3145   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)

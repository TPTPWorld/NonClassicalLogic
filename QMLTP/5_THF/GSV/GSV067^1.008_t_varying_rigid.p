%------------------------------------------------------------------------------
% File     : GSV067^1.008 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  206 (  12 unt;  53 typ;  10 def)
%            Number of atoms       : 1964 (  10 equ;   0 cnn)
%            Maximal formula atoms :   97 (  12 avg)
%            Number of connectives : 3162 (   1   ~;   1   |;   3   &;3153   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)

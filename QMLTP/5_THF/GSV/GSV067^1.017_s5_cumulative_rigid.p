%------------------------------------------------------------------------------
% File     : GSV067^1.017 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Theorem 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  208 (  12 unt;  53 typ;  10 def)
%            Number of atoms       : 1970 (  10 equ;   0 cnn)
%            Maximal formula atoms :   97 (  12 avg)
%            Number of connectives : 3178 (   1   ~;   1   |;   5   &;3165   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)
...
thf(cl5_nebula_array_0008,conjecture,
    mlocal @ ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ pv10 ) ) @ ( mand @ ( mbox @ ( leq @ n1 @ pv63 ) ) @ ( mand @ ( mbox @ ( leq @ pv10 @ ( minus @ n135300 @ n1 ) ) ) @ ( mbox @ ( leq @ pv63 @ ( minus @ n5 @ n1 ) ) ) ) ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv10 ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv63 ) ) @ ( mand @ ( mbox @ ( leq @ pv10 @ ( minus @ n135300 @ n1 ) ) ) @ ( mand @ ( mbox @ ( leq @ pv63 @ ( minus @ n5 @ n1 ) ) ) @ ( mand @ ( mbox @ ( mimplies @ ( mbox @ ( mnot @ ( mbox @ ( gt @ ( a_select3 @ q @ pv10 @ pv63 ) @ pv78 ) ) ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv10 ) ) @ ( mbox @ ( leq @ pv10 @ ( minus @ n135300 @ n1 ) ) ) ) ) ) @ ( mbox @ ( mimplies @ ( mbox @ ( gt @ ( a_select3 @ q @ pv10 @ pv63 ) @ pv78 ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv10 ) ) @ ( mbox @ ( leq @ pv10 @ ( minus @ n135300 @ n1 ) ) ) ) ) ) ) ) ) ) ) ) ) ).

thf(gt_5_4,axiom,
    mlocal @ ( mbox @ ( gt @ n5 @ n4 ) ) ).

thf(gt_135300_4,axiom,
    mlocal @ ( mbox @ ( gt @ n135300 @ n4 ) ) ).

thf(gt_135300_5,axiom,
    mlocal @ ( mbox @ ( gt @ n135300 @ n5 ) ) ).
...
thf(gt_135300_tptp_minus_1,axiom,
    mlocal @ ( mbox @ ( gt @ n135300 @ tptp_minus_1 ) ) ).

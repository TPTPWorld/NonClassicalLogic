%------------------------------------------------------------------------------
% File     : GSV069^1.016 : TPTP v8.1.0. Released v8.1.0.
...
%            Number of connectives : 3122 (   1   ~;   1   |;   5   &;3109   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)
...
thf(cl5_nebula_array_0010,conjecture,
    mlocal @ ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ pv10 ) ) @ ( mbox @ ( leq @ pv10 @ ( minus @ n135300 @ n1 ) ) ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ n0 ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv10 ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ ( minus @ n5 @ n1 ) ) ) @ ( mbox @ ( leq @ pv10 @ ( minus @ n135300 @ n1 ) ) ) ) ) ) ) ) ).

%------------------------------------------------------------------------------
% File     : GSV071^1.006 : TPTP v8.1.0. Released v8.1.0.
...
thf(cl5_nebula_array_0012,conjecture,
    mlocal @ ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ pv21 ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv23 ) ) @ ( mand @ ( mbox @ ( leq @ pv21 @ ( minus @ n5 @ n1 ) ) ) @ ( mbox @ ( leq @ pv23 @ ( minus @ n135300 @ n1 ) ) ) ) ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv21 ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv23 ) ) @ ( mand @ ( mbox @ ( leq @ pv21 @ ( minus @ n5 @ n1 ) ) ) @ ( mbox @ ( leq @ pv23 @ ( minus @ n135300 @ n1 ) ) ) ) ) ) ) ) ).

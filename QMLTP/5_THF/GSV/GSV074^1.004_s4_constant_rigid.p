%------------------------------------------------------------------------------
% File     : GSV074^1.004 : TPTP v8.1.0. Released v8.1.0.
...
thf(cl5_nebula_array_0015,conjecture,
    mlocal @ ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ pv31 ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv36 ) ) @ ( mand @ ( mbox @ ( leq @ pv31 @ ( minus @ n5 @ n1 ) ) ) @ ( mbox @ ( leq @ pv36 @ ( minus @ n135300 @ n1 ) ) ) ) ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv31 ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv36 ) ) @ ( mand @ ( mbox @ ( leq @ pv31 @ ( minus @ n5 @ n1 ) ) ) @ ( mbox @ ( leq @ pv36 @ ( minus @ n135300 @ n1 ) ) ) ) ) ) ) ) ).

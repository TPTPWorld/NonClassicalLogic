%------------------------------------------------------------------------------
% File     : GSV075^1.006 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Theorem 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  202 (  11 unt;  50 typ;  10 def)
%            Number of atoms       : 1939 (  10 equ;   0 cnn)
%            Maximal formula atoms :   97 (  12 avg)
%            Number of connectives : 3110 (   1   ~;   1   |;   2   &;3103   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)
...
thf(cl5_nebula_array_0016,conjecture,
    mlocal @ ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ pv31 ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv37 ) ) @ ( mand @ ( mbox @ ( leq @ pv31 @ ( minus @ n5 @ n1 ) ) ) @ ( mbox @ ( leq @ pv37 @ ( minus @ n135300 @ n1 ) ) ) ) ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv31 ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv37 ) ) @ ( mand @ ( mbox @ ( leq @ pv31 @ ( minus @ n5 @ n1 ) ) ) @ ( mbox @ ( leq @ pv37 @ ( minus @ n135300 @ n1 ) ) ) ) ) ) ) ) ).

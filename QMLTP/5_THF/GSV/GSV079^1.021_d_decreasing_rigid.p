%------------------------------------------------------------------------------
% File     : GSV079^1.021 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  204 (  12 unt;  50 typ;  10 def)
%            Number of atoms       : 1942 (  10 equ;   0 cnn)
%            Maximal formula atoms :   97 (  12 avg)
%            Number of connectives : 3131 (   1   ~;   1   |;   4   &;3120   @)
%                                         (   1 <=>;   4  =>;   0  <=;   0 <~>)

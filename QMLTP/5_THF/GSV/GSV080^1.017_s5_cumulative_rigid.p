%------------------------------------------------------------------------------
% File     : GSV080^1.017 : TPTP v8.1.0. Released v8.1.0.
...
thf(cl5_nebula_array_0021,conjecture,
    mlocal @ ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ pv56 ) ) @ ( mbox @ ( leq @ pv56 @ ( minus @ n5 @ n1 ) ) ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv56 ) ) @ ( mbox @ ( leq @ pv56 @ ( minus @ n5 @ n1 ) ) ) ) ) ) ).

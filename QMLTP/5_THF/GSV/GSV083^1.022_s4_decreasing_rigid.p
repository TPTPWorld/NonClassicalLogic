%------------------------------------------------------------------------------
% File     : GSV083^1.022 : TPTP v8.1.0. Released v8.1.0.
...
thf(cl5_nebula_array_0024,conjecture,
    mlocal @ ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ pv66 ) ) @ ( mbox @ ( leq @ pv66 @ ( minus @ n5 @ n1 ) ) ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv66 ) ) @ ( mbox @ ( leq @ pv66 @ ( minus @ n5 @ n1 ) ) ) ) ) ) ).

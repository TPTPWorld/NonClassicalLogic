%------------------------------------------------------------------------------
% File     : GSV084^1.017 : TPTP v8.1.0. Released v8.1.0.
...
thf(cl5_nebula_array_0025,conjecture,
    mlocal @ ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ pv67 ) ) @ ( mbox @ ( leq @ pv67 @ ( minus @ n5 @ n1 ) ) ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv67 ) ) @ ( mbox @ ( leq @ pv67 @ ( minus @ n5 @ n1 ) ) ) ) ) ) ).

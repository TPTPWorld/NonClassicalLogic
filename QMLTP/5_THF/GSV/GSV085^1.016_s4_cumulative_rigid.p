%------------------------------------------------------------------------------
% File     : GSV085^1.016 : TPTP v8.1.0. Released v8.1.0.
...
thf(cl5_nebula_array_0026,conjecture,
    mlocal @ ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ pv68 ) ) @ ( mbox @ ( leq @ pv68 @ ( minus @ n5 @ n1 ) ) ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv68 ) ) @ ( mbox @ ( leq @ pv68 @ ( minus @ n5 @ n1 ) ) ) ) ) ) ).

%------------------------------------------------------------------------------
% File     : GSV086^1.017 : TPTP v8.1.0. Released v8.1.0.
...
%            Number of connectives : 3068 (   1   ~;   1   |;   5   &;3055   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)
...
thf(cl5_nebula_array_0027,conjecture,
    mlocal @ ( mbox @ ( mimplies @ ( mbox @ ( mnot @ ( mbox @ ( geq @ pv65 @ tptp_float_0_001 ) ) ) ) @ ( mbox @ true ) ) ) ).

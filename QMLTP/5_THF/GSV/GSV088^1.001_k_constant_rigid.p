%------------------------------------------------------------------------------
% File     : GSV088^1.001 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  199 (  10 unt;  48 typ;  10 def)
%            Number of atoms       : 1920 (  10 equ;   0 cnn)
%            Maximal formula atoms :   97 (  12 avg)
%            Number of connectives : 3070 (   1   ~;   1   |;   2   &;3063   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)

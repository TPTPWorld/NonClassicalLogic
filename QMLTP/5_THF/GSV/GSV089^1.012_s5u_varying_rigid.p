%------------------------------------------------------------------------------
% File     : GSV089^1.012 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Theorem 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  196 (  12 unt;  50 typ;  10 def)
%            Number of atoms       : 1918 (  10 equ;   0 cnn)
%            Maximal formula atoms :   97 (  13 avg)
%            Number of connectives : 3216 (   1   ~;   1   |;   3   &;3207   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)

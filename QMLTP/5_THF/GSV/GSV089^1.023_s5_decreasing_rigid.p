%------------------------------------------------------------------------------
% File     : GSV089^1.023 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  198 (  12 unt;  50 typ;  10 def)
%            Number of atoms       : 1924 (  10 equ;   0 cnn)
%            Maximal formula atoms :   97 (  13 avg)
%            Number of connectives : 3232 (   1   ~;   1   |;   5   &;3219   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   51 (  15 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :  113 ( 113   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   50 (  49 usr;  13 con; 0-4 aty)
...
thf(quaternion_ds1_inuse_0001,conjecture,
    mlocal @ ( mbox @ ( mimplies @ ( mbox @ true ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ u_defuse @ n2 @ n0 @ use ) @ n1 @ n0 @ use ) @ n2 @ n0 @ use ) @ n0 @ n0 @ use ) @ n1 @ n0 @ use ) @ n0 @ n0 @ use ) @ n0 @ n0 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ u_defuse @ n2 @ n0 @ use ) @ n1 @ n0 @ use ) @ n2 @ n0 @ use ) @ n0 @ n0 @ use ) @ n1 @ n0 @ use ) @ n0 @ n0 @ use ) @ n1 @ n0 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ u_defuse @ n2 @ n0 @ use ) @ n1 @ n0 @ use ) @ n2 @ n0 @ use ) @ n0 @ n0 @ use ) @ n1 @ n0 @ use ) @ n0 @ n0 @ use ) @ n2 @ n0 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ xinit_defuse @ n5 @ use ) @ n4 @ use ) @ n5 @ use ) @ n3 @ use ) @ n4 @ use ) @ n3 @ use ) @ n3 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ xinit_defuse @ n5 @ use ) @ n4 @ use ) @ n5 @ use ) @ n3 @ use ) @ n4 @ use ) @ n3 @ use ) @ n4 ) @ use ) ) @ ( mbox @ ( customqmltpeq @ ( a_select2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ xinit_defuse @ n5 @ use ) @ n4 @ use ) @ n5 @ use ) @ n3 @ use ) @ n4 @ use ) @ n3 @ use ) @ n5 ) @ use ) ) ) ) ) ) ) ) ) ).

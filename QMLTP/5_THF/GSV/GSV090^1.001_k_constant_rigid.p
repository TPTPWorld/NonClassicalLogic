%------------------------------------------------------------------------------
% File     : GSV090^1.001 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  196 (  10 unt;  52 typ;  10 def)
%            Number of atoms       : 2001 (  10 equ;   0 cnn)
%            Maximal formula atoms :  109 (  13 avg)
%            Number of connectives : 3398 (   1   ~;   1   |;   2   &;3391   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)

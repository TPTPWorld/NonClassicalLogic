%------------------------------------------------------------------------------
% File     : GSV091^1.001 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  197 (  10 unt;  53 typ;  10 def)
%            Number of atoms       : 2037 (  10 equ;   0 cnn)
%            Maximal formula atoms :  145 (  14 avg)
%            Number of connectives : 3482 (   1   ~;   1   |;   2   &;3475   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)

%------------------------------------------------------------------------------
% File     : GSV091^1.004 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  199 (  11 unt;  53 typ;  10 def)
%            Number of atoms       : 2041 (  10 equ;   0 cnn)
%            Maximal formula atoms :  145 (  13 avg)
%            Number of connectives : 3492 (   1   ~;   1   |;   3   &;3483   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   54 (  15 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :  111 ( 111   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   53 (  52 usr;  17 con; 0-4 aty)

%------------------------------------------------------------------------------
% File     : GSV092^1.003 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  199 (  11 unt;  54 typ;  10 def)
%            Number of atoms       : 2079 (  10 equ;   0 cnn)
%            Maximal formula atoms :  186 (  14 avg)
%            Number of connectives : 3461 (   1   ~;   1   |;   2   &;3454   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   51 (  15 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :  111 ( 111   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   54 (  53 usr;  18 con; 0-4 aty)

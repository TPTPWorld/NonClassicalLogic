%------------------------------------------------------------------------------
% File     : GSV093^1.014 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Theorem 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  223 (  12 unt;  59 typ;  10 def)
%            Number of atoms       : 2250 (  10 equ;   0 cnn)
%            Maximal formula atoms :  273 (  13 avg)
%            Number of connectives : 3755 (   1   ~;   1   |;   4   &;3744   @)
%                                         (   1 <=>;   4  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   54 (  14 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :  113 ( 113   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   59 (  58 usr;  22 con; 0-4 aty)
%            Number of variables   :  370 ( 360   ^   7   !;   3   ?; 370   :)
% SPC      : TH0_THM_EQU_NAR

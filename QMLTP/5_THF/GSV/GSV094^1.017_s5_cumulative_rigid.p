%------------------------------------------------------------------------------
% File     : GSV094^1.017 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Theorem 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  225 (  12 unt;  60 typ;  10 def)
%            Number of atoms       : 2345 (  10 equ;   0 cnn)
%            Maximal formula atoms :  365 (  14 avg)
%            Number of connectives : 3978 (   1   ~;   1   |;   5   &;3965   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   55 (  14 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :  113 ( 113   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   60 (  59 usr;  23 con; 0-4 aty)
%            Number of variables   :  371 ( 358   ^  10   !;   3   ?; 371   :)
% SPC      : TH0_THM_EQU_NAR
...
thf(quaternion_ds1_inuse_0006,conjecture,
    ( mlocal
    @ ( mbox
      @ ( mimplies
                                                          ...
                                                          @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_noise_defuse @ n4 ) @ use ) )
                                                            @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_noise_defuse @ n5 ) @ use ) )
                                                              @ ( mand @ ( mbox @ ( leq @ n0 @ pv5 ) )
                                                                @ ( mand @ ( mbox @ ( leq @ n0 @ pv51 ) )
                                                                  @ ( mand @ ( mbox @ ( leq @ n0 @ pv52 ) )
                                                                    @ ( mand @ ( mbox @ ( leq @ pv5 @ ( minus @ n999 @ n1 ) ) )
                                                                      @ ( mand @ ( mbox @ ( leq @ pv51 @ ( minus @ n6 @ n1 ) ) )
                                                                        @ ( mand @ ( mbox @ ( leq @ pv52 @ ( minus @ n6 @ n1 ) ) )
                                                                          @ ( mbox
                                                                            @ ( mforall_di
                                                                              @ ^ [A: $i] :
                                                                                  ( mbox
        ...
        @ ( mand
          @ ( mbox
            @ ( mimplies @ ( mbox @ ( mnot @ ( mbox @ ( customqmltpeq @ pv51 @ pv52 ) ) ) )
              @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ rho_defuse @ n0 ) @ use ) )
                @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ rho_defuse @ n1 ) @ use ) )
                  @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ rho_defuse @ n2 ) @ use ) )
                    @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ sigma_defuse @ n0 ) @ use ) )
          ...
          @ ( mbox
            @ ( mimplies @ ( mbox @ ( customqmltpeq @ pv51 @ pv52 ) )
              @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ rho_defuse @ n0 ) @ use ) )
                @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ rho_defuse @ n1 ) @ use ) )
                  @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ rho_defuse @ n2 ) @ use ) )
                    @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ sigma_defuse @ n0 ) @ use ) )
                                                                            ...
                                                                            @ ( mbox
                                                                              @ ( mforall_di
                                                                                @ ^ [E: $i] :
                                                                                    ( mbox
                                                                                    @ ( mforall_di
                                                                                      @ ^ [F: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ E ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ F ) ) @ ( mand @ ( mbox @ ( leq @ E @ n2 ) ) @ ( mbox @ ( leq @ F @ ( minus @ pv5 @ n1 ) ) ) ) ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select3 @ u_defuse @ E @ F ) @ use ) ) @ ( mbox @ ( customqmltpeq @ ( a_select3 @ z_defuse @ E @ F ) @ use ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ).

%------------------------------------------------------------------------------
% File     : GSV095^1.017 : TPTP v8.1.0. Released v8.1.0.
...
%            Number of atoms       : 2213 (  10 equ;   0 cnn)
%            Maximal formula atoms :  233 (  13 avg)
%            Number of connectives : 3693 (   1   ~;   1   |;   5   &;3680   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)
...
thf(quaternion_ds1_inuse_0007,conjecture,
    ( mlocal
    @ ( mbox
      @ ( mimplies

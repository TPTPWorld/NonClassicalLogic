%------------------------------------------------------------------------------
% File     : GSV098^1.002 : TPTP v8.1.0. Released v8.1.0.
...
%            Number of atoms       : 2152 (  10 equ;   0 cnn)
%            Maximal formula atoms :  238 (  14 avg)
%            Number of connectives : 3587 (   1   ~;   1   |;   2   &;3580   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   52 (  15 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :  111 ( 111   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   56 (  55 usr;  20 con; 0-4 aty)
%            Number of variables   :  362 ( 357   ^   3   !;   2   ?; 362   :)
% SPC      : TH0_UNK_EQU_NAR
...
thf(quaternion_ds1_inuse_0010,conjecture,
    ( mlocal
    @ ( mbox
      @ ( mimplies
                                                              ...
                                                              @ ( mbox
                                                                @ ( mforall_di
                                                                  @ ^ [E: $i] :
                                                                      ( mbox
                                                                      @ ( mforall_di
                                                                        @ ^ [F: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ E ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ F ) ) @ ( mand @ ( mbox @ ( leq @ E @ n2 ) ) @ ( mbox @ ( leq @ F @ ( minus @ ( plus @ n1 @ pv5 ) @ n1 ) ) ) ) ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select3 @ u_defuse @ E @ F ) @ use ) ) @ ( mbox @ ( customqmltpeq @ ( a_select3 @ z_defuse @ E @ F ) @ use ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ).

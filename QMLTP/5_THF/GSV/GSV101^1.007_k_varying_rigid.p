%------------------------------------------------------------------------------
% File     : GSV101^1.007 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  219 (  11 unt;  57 typ;  10 def)
%            Number of atoms       : 2178 (  10 equ;   0 cnn)
%            Maximal formula atoms :  205 (  13 avg)
%            Number of connectives : 3578 (   1   ~;   1   |;   3   &;3569   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   51 (  14 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :  113 ( 113   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   57 (  56 usr;  20 con; 0-4 aty)
%            Number of variables   :  369 ( 363   ^   3   !;   3   ?; 369   :)
% SPC      : TH0_UNK_EQU_NAR

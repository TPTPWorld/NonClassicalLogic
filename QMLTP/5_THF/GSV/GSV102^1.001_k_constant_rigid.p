%------------------------------------------------------------------------------
% File     : GSV102^1.001 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  195 (  10 unt;  51 typ;  10 def)
%            Number of atoms       : 1974 (  10 equ;   0 cnn)
%            Maximal formula atoms :   97 (  13 avg)
%            Number of connectives : 3254 (   1   ~;   1   |;   2   &;3247   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)

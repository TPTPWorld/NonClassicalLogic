%------------------------------------------------------------------------------
% File     : GSV103^1.004 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  196 (  11 unt;  50 typ;  10 def)
%            Number of atoms       : 1951 (  10 equ;   0 cnn)
%            Maximal formula atoms :   97 (  13 avg)
%            Number of connectives : 3282 (   1   ~;   1   |;   3   &;3273   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)

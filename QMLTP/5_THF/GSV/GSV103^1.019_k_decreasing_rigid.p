%------------------------------------------------------------------------------
% File     : GSV103^1.019 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  197 (  11 unt;  51 typ;  10 def)
%            Number of atoms       : 1953 (  10 equ;   0 cnn)
%            Maximal formula atoms :   97 (  13 avg)
%            Number of connectives : 3288 (   1   ~;   1   |;   4   &;3277   @)
%                                         (   1 <=>;   4  =>;   0  <=;   0 <~>)

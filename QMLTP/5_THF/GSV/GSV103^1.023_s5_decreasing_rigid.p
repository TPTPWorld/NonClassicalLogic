%------------------------------------------------------------------------------
% File     : GSV103^1.023 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  199 (  12 unt;  51 typ;  10 def)
%            Number of atoms       : 1957 (  10 equ;   0 cnn)
%            Maximal formula atoms :   97 (  13 avg)
%            Number of connectives : 3298 (   1   ~;   1   |;   5   &;3285   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)

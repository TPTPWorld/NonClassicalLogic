%------------------------------------------------------------------------------
% File     : GSV104^1.001 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  193 (  10 unt;  49 typ;  10 def)
%            Number of atoms       : 1929 (  10 equ;   0 cnn)
%            Maximal formula atoms :   97 (  13 avg)
%            Number of connectives : 3149 (   1   ~;   1   |;   2   &;3142   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)

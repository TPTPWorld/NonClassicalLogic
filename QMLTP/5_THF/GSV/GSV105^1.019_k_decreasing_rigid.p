%------------------------------------------------------------------------------
% File     : GSV105^1.019 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  206 (  11 unt;  51 typ;  10 def)
%            Number of atoms       : 1966 (  10 equ;   0 cnn)
%            Maximal formula atoms :   97 (  12 avg)
%            Number of connectives : 3156 (   1   ~;   1   |;   4   &;3145   @)
%                                         (   1 <=>;   4  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   51 (  14 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :  113 ( 113   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   51 (  50 usr;  14 con; 0-4 aty)
%            Number of variables   :  361 ( 352   ^   6   !;   3   ?; 361   :)
% SPC      : TH0_UNK_EQU_NAR

%------------------------------------------------------------------------------
% File     : GSV106^1.005 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Theorem 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  203 (  11 unt;  57 typ;  10 def)
%            Number of atoms       : 2000 (  10 equ;   0 cnn)
%            Maximal formula atoms :  104 (  13 avg)
%            Number of connectives : 3227 (   1   ~;   1   |;   3   &;3218   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   51 (  15 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :  111 ( 111   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   57 (  56 usr;  21 con; 0-4 aty)

%------------------------------------------------------------------------------
% File     : GSV106^1.007 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  203 (  11 unt;  58 typ;  10 def)
%            Number of atoms       : 1999 (  10 equ;   0 cnn)
%            Maximal formula atoms :  104 (  13 avg)
%            Number of connectives : 3225 (   1   ~;   1   |;   3   &;3216   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)

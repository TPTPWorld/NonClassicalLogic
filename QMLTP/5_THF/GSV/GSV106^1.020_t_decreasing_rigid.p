%------------------------------------------------------------------------------
% File     : GSV106^1.020 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  205 (  12 unt;  58 typ;  10 def)
%            Number of atoms       : 2003 (  10 equ;   0 cnn)
%            Maximal formula atoms :  104 (  13 avg)
%            Number of connectives : 3235 (   1   ~;   1   |;   4   &;3224   @)
%                                         (   1 <=>;   4  =>;   0  <=;   0 <~>)

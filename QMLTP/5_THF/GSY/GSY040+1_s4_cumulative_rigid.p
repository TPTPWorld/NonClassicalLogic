...
%%% Generated on Thu Apr 28 15:11:42 EDT 2022
...
thf(pel1, conjecture, (mlocal @ ((mand @ (mbox @ ((mimplies @ (mbox @ ((mimplies @ (mbox @ p)) @ (mbox @ q)))) @ (mbox @ ((mimplies @ (mbox @ (mnot @ (mbox @ q)))) @ (mbox @ (mnot @ (mbox @ p)))))))) @ (mbox @ ((mimplies @ (mbox @ ((mimplies @ (mbox @ (mnot @ (mbox @ q)))) @ (mbox @ (mnot @ (mbox @ p)))))) @ (mbox @ ((mimplies @ (mbox @ p)) @ (mbox @ q)))))))).

%------------------------------------------------------------------------------
% File     : GSY040^1.018 : TPTP v8.1.0. Released v8.1.0.
...
thf(pel1,conjecture,
    mlocal @ ( mand @ ( mbox @ ( mimplies @ ( mbox @ ( mimplies @ ( mbox @ p ) @ ( mbox @ q ) ) ) @ ( mbox @ ( mimplies @ ( mbox @ ( mnot @ ( mbox @ q ) ) ) @ ( mbox @ ( mnot @ ( mbox @ p ) ) ) ) ) ) ) @ ( mbox @ ( mimplies @ ( mbox @ ( mimplies @ ( mbox @ ( mnot @ ( mbox @ q ) ) ) @ ( mbox @ ( mnot @ ( mbox @ p ) ) ) ) ) @ ( mbox @ ( mimplies @ ( mbox @ p ) @ ( mbox @ q ) ) ) ) ) ) ).

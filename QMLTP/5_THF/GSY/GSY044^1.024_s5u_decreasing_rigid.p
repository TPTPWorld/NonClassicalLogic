%------------------------------------------------------------------------------
% File     : GSY044^1.024 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Theorem 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   27 (   9 unt;  14 typ;   8 def)
%            Number of atoms       :   60 (   8 equ;   0 cnn)
%            Maximal formula atoms :   14 (   4 avg)
%            Number of connectives :   62 (   1   ~;   1   |;   2   &;  55   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)
...
thf(pel10_1,axiom,
    mlocal @ ( mbox @ ( mimplies @ ( mbox @ q ) @ ( mbox @ r ) ) ) ).

thf(pel10_2,axiom,
    mlocal @ ( mbox @ ( mimplies @ ( mbox @ r ) @ ( mand @ ( mbox @ p ) @ ( mbox @ q ) ) ) ) ).

thf(pel10_3,axiom,
    mlocal @ ( mbox @ ( mimplies @ ( mbox @ p ) @ ( mor @ ( mbox @ q ) @ ( mbox @ r ) ) ) ) ).

thf(pel10,conjecture,
    mlocal @ ( mand @ ( mbox @ ( mimplies @ ( mbox @ p ) @ ( mbox @ q ) ) ) @ ( mbox @ ( mimplies @ ( mbox @ q ) @ ( mbox @ p ) ) ) ) ).

%------------------------------------------------------------------------------
% File     : GSY045^1.009 : TPTP v8.1.0. Released v8.1.0.
...
thf(pel13,conjecture,
    mlocal @ ( mand @ ( mbox @ ( mimplies @ ( mor @ ( mbox @ p ) @ ( mand @ ( mbox @ q ) @ ( mbox @ r ) ) ) @ ( mand @ ( mor @ ( mbox @ p ) @ ( mbox @ q ) ) @ ( mor @ ( mbox @ p ) @ ( mbox @ r ) ) ) ) ) @ ( mbox @ ( mimplies @ ( mand @ ( mor @ ( mbox @ p ) @ ( mbox @ q ) ) @ ( mor @ ( mbox @ p ) @ ( mbox @ r ) ) ) @ ( mor @ ( mbox @ p ) @ ( mand @ ( mbox @ q ) @ ( mbox @ r ) ) ) ) ) ) ).

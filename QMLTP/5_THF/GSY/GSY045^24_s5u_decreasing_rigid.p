...
%%% Generated on Fri May 06 13:21:53 EDT 2022
...
thf(pel13, conjecture, (mlocal @ ((mand @ (mbox @ ((mimplies @ ((mor @ (mbox @ p)) @ ((mand @ (mbox @ q)) @ (mbox @ r)))) @ ((mand @ ((mor @ (mbox @ p)) @ (mbox @ q))) @ ((mor @ (mbox @ p)) @ (mbox @ r)))))) @ (mbox @ ((mimplies @ ((mand @ ((mor @ (mbox @ p)) @ (mbox @ q))) @ ((mor @ (mbox @ p)) @ (mbox @ r)))) @ ((mor @ (mbox @ p)) @ ((mand @ (mbox @ q)) @ (mbox @ r)))))))).

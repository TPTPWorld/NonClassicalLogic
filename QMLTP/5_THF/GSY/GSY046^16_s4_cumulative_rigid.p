...
%%% Generated on Thu Apr 28 15:13:49 EDT 2022
...
thf(pel15, conjecture, (mlocal @ ((mand @ (mbox @ ((mimplies @ (mbox @ ((mimplies @ (mbox @ p)) @ (mbox @ q)))) @ ((mor @ (mbox @ (mnot @ (mbox @ p)))) @ (mbox @ q))))) @ (mbox @ ((mimplies @ ((mor @ (mbox @ (mnot @ (mbox @ p)))) @ (mbox @ q))) @ (mbox @ ((mimplies @ (mbox @ p)) @ (mbox @ q)))))))).

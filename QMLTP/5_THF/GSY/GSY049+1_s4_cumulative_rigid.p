...
%%% Generated on Thu Apr 28 15:15:25 EDT 2022
...
thf(pel19, conjecture, (mlocal @ (mexists_di @ (^ [X:$i]: ((mbox @ (mforall_di @ (^ [Y:$i]: ((mbox @ (mforall_di @ (^ [Z:$i]: ((mbox @ ((mimplies @ (mbox @ ((mimplies @ (mbox @ (big_p @ Y))) @ (mbox @ (big_q @ Z))))) @ (mbox @ ((mimplies @ (mbox @ (big_p @ X))) @ (mbox @ (big_q @ X))))))))))))))))))).

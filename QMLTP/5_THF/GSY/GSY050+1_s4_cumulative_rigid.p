...
%%% Generated on Thu Apr 28 15:15:57 EDT 2022
...
thf(big_s_decl, type, big_s: ($i > (mworld > $o))).
thf(big_q_decl, type, big_q: ($i > (mworld > $o))).
thf(big_r_decl, type, big_r: ($i > (mworld > $o))).
thf(big_p_decl, type, big_p: ($i > (mworld > $o))).
thf(pel20, conjecture, (mlocal @ (mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ (mforall_di @ (^ [Y:$i]: ((mexists_di @ (^ [Z:$i]: ((mbox @ (mforall_di @ (^ [W:$i]: ((mbox @ ((mimplies @ ((mand @ (mbox @ (big_p @ X))) @ (mbox @ (big_q @ Y)))) @ ((mand @ (mbox @ (big_r @ Z))) @ (mbox @ (big_s @ W))))))))))))))))))))) @ (mexists_di @ (^ [X1:$i]: ((mexists_di @ (^ [Y1:$i]: ((mbox @ ((mimplies @ ((mand @ (mbox @ (big_p @ X1))) @ (mbox @ (big_q @ Y1)))) @ (mexists_di @ (^ [Z1:$i]: ((mbox @ (big_r @ Z1))))))))))))))))).

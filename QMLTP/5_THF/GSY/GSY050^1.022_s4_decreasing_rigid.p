%------------------------------------------------------------------------------
% File     : GSY050^1.022 : TPTP v8.1.0. Released v8.1.0.
                ...
                @ ( mforall_di
                  @ ^ [Y: $i] :
                      ...
                      @ ^ [Z: $i] :
                          ( mbox
                          @ ( mforall_di
                            @ ^ [W: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( big_p @ X ) ) @ ( mbox @ ( big_q @ Y ) ) ) @ ( mand @ ( mbox @ ( big_r @ Z ) ) @ ( mbox @ ( big_s @ W ) ) ) ) ) ) ) ) ) ) ) )
        @ ( mexists_di
          @ ^ [X1: $i] :
              ( mexists_di
              @ ^ [Y1: $i] :
                  ( mbox
                  @ ( mimplies @ ( mand @ ( mbox @ ( big_p @ X1 ) ) @ ( mbox @ ( big_q @ Y1 ) ) )
                    @ ( mexists_di
                      @ ^ [Z1: $i] : ( mbox @ ( big_r @ Z1 ) ) ) ) ) ) ) ) ) ) ).

%------------------------------------------------------------------------------
% File     : GSY051^1.005 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Theorem 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   30 (  11 unt;  15 typ;  10 def)
%            Number of atoms       :   57 (  10 equ;   0 cnn)
%            Maximal formula atoms :   15 (   3 avg)
%            Number of connectives :   69 (   1   ~;   1   |;   3   &;  60   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)
...
thf(pel21_1,axiom,
    ( mlocal
    @ ( mexists_di
      @ ^ [X: $i] : ( mbox @ ( mimplies @ ( mbox @ p ) @ ( mbox @ ( big_f @ X ) ) ) ) ) ) ).

thf(pel21_2,axiom,
    ( mlocal
    @ ( mexists_di
      @ ^ [X: $i] : ( mbox @ ( mimplies @ ( mbox @ ( big_f @ X ) ) @ ( mbox @ p ) ) ) ) ) ).

thf(pel21,conjecture,
    ( mlocal
    @ ( mexists_di

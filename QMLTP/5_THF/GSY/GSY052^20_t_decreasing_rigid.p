...
%%% Generated on Thu Apr 28 15:17:15 EDT 2022
...
thf(pel22, conjecture, (mlocal @ (mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [X:$i]: (((mand @ (mbox @ ((mimplies @ (mbox @ p)) @ (mbox @ (big_f @ X))))) @ (mbox @ ((mimplies @ (mbox @ (big_f @ X))) @ (mbox @ p))))))))) @ ((mand @ (mbox @ ((mimplies @ (mbox @ p)) @ (mbox @ (mforall_di @ (^ [X1:$i]: ((mbox @ (big_f @ X1))))))))) @ (mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [X1:$i]: ((mbox @ (big_f @ X1))))))) @ (mbox @ p)))))))).

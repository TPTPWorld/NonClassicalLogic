%------------------------------------------------------------------------------
% File     : GSY355^1.018 : TPTP v8.1.0. Released v8.1.0.
    ...
    @ ( mbox
      @ ( mimplies
        @ ( mand
          @ ( mbox
            @ ( mforall_di
              @ ^ [X: $i] : ( mbox @ ( mimplies @ ( mbox @ ( big_r @ X ) ) @ ( mbox @ ( big_p @ X ) ) ) ) ) )
          @ ( mbox
            @ ( mforall_di
              @ ^ [X: $i] : ( mbox @ ( mimplies @ ( mbox @ ( mnot @ ( mbox @ ( big_q @ X ) ) ) ) @ ( mbox @ ( big_r @ X ) ) ) ) ) ) )
        @ ( mbox
          @ ( mforall_di
            @ ^ [X: $i] : ( mor @ ( mbox @ ( big_p @ X ) ) @ ( mbox @ ( big_q @ X ) ) ) ) ) ) ) ) ).

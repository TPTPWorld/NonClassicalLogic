%------------------------------------------------------------------------------
% File     : GSY356^1.012 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Theorem 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   31 (  12 unt;  18 typ;  10 def)
%            Number of atoms       :   61 (  10 equ;   0 cnn)
%            Maximal formula atoms :   35 (   4 avg)
%            Number of connectives :   87 (   1   ~;   1   |;   3   &;  78   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   21 (   3 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :   65 (  65   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   18 (  17 usr;   3 con; 0-3 aty)
            ...
            @ ( mbox
              @ ( mforall_di
                @ ^ [X: $i] :
                    ( mbox
                    @ ( mforall_di
                      @ ^ [Y: $i] : ( mbox @ ( mimplies @ ( mbox @ ( big_r @ X @ Y ) ) @ ( mand @ ( mbox @ ( big_r @ Y @ X ) ) @ ( mbox @ ( big_q @ X @ Y ) ) ) ) ) ) ) ) )
            @ ( mbox
              @ ( mforall_di
                @ ^ [U: $i] :
                    ( mbox
                    @ ( mforall_di
                      @ ^ [V: $i] : ( mbox @ ( mimplies @ ( mbox @ ( big_q @ U @ V ) ) @ ( mbox @ ( big_q @ U @ U ) ) ) ) ) ) ) ) ) )
        @ ( mand @ ( mbox @ ( big_q @ a @ a ) ) @ ( mbox @ ( big_q @ b @ b ) ) ) ) ) ) ).

...
%%% Generated on Thu Apr 28 15:19:09 EDT 2022
...
thf(x2109, conjecture, (mlocal @ ((mand @ (mbox @ ((mimplies @ (mexists_di @ (^ [X:$i]: (((mand @ (mbox @ p)) @ (mbox @ (big_q @ X))))))) @ ((mand @ (mbox @ p)) @ (mexists_di @ (^ [X:$i]: ((mbox @ (big_q @ X))))))))) @ (mbox @ ((mimplies @ ((mand @ (mbox @ p)) @ (mexists_di @ (^ [X:$i]: ((mbox @ (big_q @ X))))))) @ (mexists_di @ (^ [X:$i]: (((mand @ (mbox @ p)) @ (mbox @ (big_q @ X))))))))))).

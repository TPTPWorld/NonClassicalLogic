%------------------------------------------------------------------------------
% File     : GSY359^1.008 : TPTP v8.1.0. Released v8.1.0.
            ...
            @ ( mbox
              @ ( mforall_di
                @ ^ [X: $i] :
                    ( mbox
                    @ ( mforall_di
                      @ ^ [Y: $i] : ( mbox @ ( mimplies @ ( mbox @ ( big_q @ X @ Y ) ) @ ( mbox @ ( big_q @ X @ X ) ) ) ) ) ) ) ) ) )
        @ ( mexists_di
          @ ^ [X: $i] :
              ( mexists_di
              @ ^ [Y: $i] : ( mand @ ( mbox @ ( big_q @ X @ Y ) ) @ ( mbox @ ( big_r @ Y ) ) ) ) ) ) ) ) ).

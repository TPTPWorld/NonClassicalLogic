...
%%% Generated on Thu Apr 28 15:20:28 EDT 2022
...
thf(x2111, conjecture, (mlocal @ (mbox @ ((mimplies @ ((mand @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ ((mimplies @ (mexists_di @ (^ [Y:$i]: ((mbox @ ((big_p @ X) @ Y)))))) @ (mbox @ (mforall_di @ (^ [Y:$i]: ((mbox @ ((big_q @ X) @ Y))))))))))))) @ (mbox @ (mforall_di @ (^ [Z:$i]: ((mexists_di @ (^ [Y:$i]: ((mbox @ ((big_p @ Z) @ Y))))))))))) @ (mbox @ (mforall_di @ (^ [Y:$i]: ((mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ ((big_q @ X) @ Y)))))))))))))).

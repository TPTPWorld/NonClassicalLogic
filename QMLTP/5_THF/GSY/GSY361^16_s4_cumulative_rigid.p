...
%%% Generated on Thu Apr 28 15:20:46 EDT 2022
...
thf(x2112, conjecture, (mlocal @ (mbox @ ((mimplies @ ((mand @ (mexists_di @ (^ [V:$i]: ((mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ ((big_p @ X) @ V)))))))))) @ ((mand @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ ((mimplies @ (mbox @ (big_s @ X))) @ (mexists_di @ (^ [Y:$i]: ((mbox @ ((big_q @ Y) @ X)))))))))))) @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ (mforall_di @ (^ [Y:$i]: ((mbox @ ((mimplies @ (mbox @ ((big_p @ X) @ Y))) @ (mbox @ (mnot @ (mbox @ ((big_q @ X) @ Y))))))))))))))))) @ (mexists_di @ (^ [U:$i]: ((mbox @ (mnot @ (mbox @ (big_s @ U))))))))))).

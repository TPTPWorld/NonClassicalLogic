%------------------------------------------------------------------------------
% File     : GSY362^1.018 : TPTP v8.1.0. Released v8.1.0.
...
%            Number of connectives :   75 (   1   ~;   1   |;   4   &;  64   @)
%                                         (   1 <=>;   4  =>;   0  <=;   0 <~>)
        ...
        @ ( mand
          ...
          @ ( mexists_di
            @ ^ [Z: $i] :
                ( mbox
                @ ( mforall_di
                  @ ^ [X: $i] : ( mbox @ ( mimplies @ ( mbox @ ( big_p @ X ) ) @ ( mbox @ ( mnot @ ( mbox @ ( big_r @ Z @ X ) ) ) ) ) ) ) ) ) )
        @ ( mexists_di
          @ ^ [X: $i] : ( mbox @ ( mnot @ ( mbox @ ( big_p @ X ) ) ) ) ) ) ) ) ).

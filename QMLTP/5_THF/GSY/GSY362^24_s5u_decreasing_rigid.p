...
%%% Generated on Fri May 06 13:22:45 EDT 2022
...
thf(x2113, conjecture, (mlocal @ (mbox @ ((mimplies @ ((mand @ (mbox @ (mforall_di @ (^ [Y:$i]: ((mexists_di @ (^ [W:$i]: ((mbox @ ((big_r @ Y) @ W)))))))))) @ (mexists_di @ (^ [Z:$i]: ((mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ ((mimplies @ (mbox @ (big_p @ X))) @ (mbox @ (mnot @ (mbox @ ((big_r @ Z) @ X))))))))))))))) @ (mexists_di @ (^ [X:$i]: ((mbox @ (mnot @ (mbox @ (big_p @ X))))))))))).

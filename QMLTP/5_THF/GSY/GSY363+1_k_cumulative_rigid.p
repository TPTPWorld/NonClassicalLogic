...
%%% Generated on Thu Apr 28 15:21:43 EDT 2022
...
thf(x2114, conjecture, (mlocal @ (mbox @ ((mimplies @ ((mand @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ ((big_r @ X) @ b))))))) @ (mbox @ (mforall_di @ (^ [Y:$i]: ((mbox @ ((mimplies @ (mexists_di @ (^ [Z:$i]: ((mbox @ ((big_r @ Y) @ Z)))))) @ (mbox @ ((big_r @ a) @ Y)))))))))) @ (mexists_di @ (^ [U:$i]: ((mbox @ (mforall_di @ (^ [V:$i]: ((mbox @ ((big_r @ U) @ V))))))))))))).

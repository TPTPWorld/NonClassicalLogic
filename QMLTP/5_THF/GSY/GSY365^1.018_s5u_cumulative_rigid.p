%------------------------------------------------------------------------------
% File     : GSY365^1.018 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Theorem 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   32 (  12 unt;  18 typ;  10 def)
%            Number of atoms       :   68 (  10 equ;   0 cnn)
%            Maximal formula atoms :   39 (   4 avg)
%            Number of connectives :   98 (   1   ~;   1   |;   4   &;  87   @)
%                                         (   1 <=>;   4  =>;   0  <=;   0 <~>)
        ...
        @ ( mand
          @ ( mbox
            @ ( mforall_di
              @ ^ [X: $i] :
                  ( mexists_di
                  @ ^ [Y: $i] : ( mbox @ ( mimplies @ ( mbox @ ( big_p @ X ) ) @ ( mand @ ( mbox @ ( big_r @ X @ ( g @ ( h @ Y ) ) ) ) @ ( mbox @ ( big_p @ Y ) ) ) ) ) ) ) )
          @ ( mbox
            @ ( mforall_di
              @ ^ [W: $i] : ( mbox @ ( mimplies @ ( mbox @ ( big_p @ W ) ) @ ( mand @ ( mbox @ ( big_p @ ( g @ W ) ) ) @ ( mbox @ ( big_p @ ( h @ W ) ) ) ) ) ) ) ) )
        @ ( mbox
          @ ( mforall_di
            @ ^ [X: $i] :
                ( mbox
                @ ( mimplies @ ( mbox @ ( big_p @ X ) )
                  @ ( mexists_di
                    @ ^ [Y: $i] : ( mand @ ( mbox @ ( big_r @ X @ Y ) ) @ ( mbox @ ( big_p @ Y ) ) ) ) ) ) ) ) ) ) ) ).

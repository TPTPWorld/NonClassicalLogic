...
%%% Generated on Thu Apr 28 15:24:12 EDT 2022
...
thf(x2118, conjecture, (mlocal @ (mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [X:$i]: (((mor @ ((mand @ (mbox @ p)) @ (mbox @ (big_q @ X)))) @ ((mand @ (mbox @ (mnot @ (mbox @ p)))) @ (mbox @ (big_r @ X))))))))) @ ((mor @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ (big_q @ X))))))) @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ (big_r @ X))))))))))).

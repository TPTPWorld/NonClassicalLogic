...
%%% Generated on Thu Apr 28 15:25:12 EDT 2022
...
thf(x2120, conjecture, (mlocal @ (mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [U:$i]: ((mbox @ (mforall_di @ (^ [V:$i]: ((mbox @ (mforall_di @ (^ [W:$i]: (((mor @ (mbox @ ((big_p @ U) @ V))) @ (mbox @ ((big_p @ V) @ W)))))))))))))))) @ (mexists_di @ (^ [X:$i]: ((mbox @ (mforall_di @ (^ [Y:$i]: ((mbox @ ((big_p @ X) @ Y))))))))))))).

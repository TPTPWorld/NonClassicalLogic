...
%%% Generated on Fri May 06 13:23:12 EDT 2022
...
thf(a_decl, type, a: $i).
thf(big_p_decl, type, big_p: ($i > ($i > ($i > (mworld > $o))))).
thf(f_decl, type, f: ($i > $i)).
thf(h_decl, type, h: ($i > $i)).
thf(x2121, conjecture, (mlocal @ (mexists_di @ (^ [V:$i]: ((mbox @ (mforall_di @ (^ [Y:$i]: ((mexists_di @ (^ [Z:$i]: ((mbox @ ((mimplies @ ((mor @ (mbox @ (((big_p @ a) @ Y) @ (h @ Y)))) @ (mbox @ (((big_p @ V) @ Y) @ (f @ Y))))) @ (mbox @ (((big_p @ V) @ Y) @ Z)))))))))))))))).

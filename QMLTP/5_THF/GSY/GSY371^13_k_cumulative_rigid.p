...
%%% Generated on Thu Apr 28 15:26:00 EDT 2022
...
thf(x2122, conjecture, (mlocal @ (mbox @ ((mimplies @ (mbox @ ((mimplies @ (mexists_di @ (^ [X:$i]: ((mbox @ ((big_r @ X) @ X)))))) @ (mbox @ (mforall_di @ (^ [Y:$i]: ((mbox @ ((big_r @ Y) @ Y))))))))) @ (mexists_di @ (^ [U:$i]: ((mbox @ (mforall_di @ (^ [V:$i]: ((mbox @ ((mimplies @ (mbox @ ((big_r @ U) @ U))) @ (mbox @ ((big_r @ V) @ V))))))))))))))).

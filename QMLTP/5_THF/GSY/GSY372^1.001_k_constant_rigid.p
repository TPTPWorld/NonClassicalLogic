%------------------------------------------------------------------------------
% File     : GSY372^1.001 : TPTP v8.1.0. Released v8.1.0.
    ...
    @ ( mbox
      @ ( mforall_di
        @ ^ [X: $i] :
            ...
            @ ( mimplies
              @ ( mexists_di
                @ ^ [Y: $i] : ( mbox @ ( mimplies @ ( mbox @ ( big_p @ Y ) ) @ ( mbox @ ( big_q @ X ) ) ) ) )
              @ ( mexists_di
                @ ^ [Y: $i] : ( mbox @ ( mimplies @ ( mbox @ ( big_p @ Y ) ) @ ( mbox @ ( big_q @ Y ) ) ) ) ) ) ) ) ) ) ).

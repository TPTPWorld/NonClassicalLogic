...
%%% Generated on Thu Apr 28 15:26:53 EDT 2022
...
thf(x2123, conjecture, (mlocal @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ ((mimplies @ (mexists_di @ (^ [Y:$i]: ((mbox @ ((mimplies @ (mbox @ (big_p @ Y))) @ (mbox @ (big_q @ X)))))))) @ (mexists_di @ (^ [Y:$i]: ((mbox @ ((mimplies @ (mbox @ (big_p @ Y))) @ (mbox @ (big_q @ Y))))))))))))))).

...
%%% Generated on Thu Apr 28 15:27:10 EDT 2022
...
thf(x2124, conjecture, (mlocal @ ((mand @ (mbox @ ((mimplies @ (mexists_di @ (^ [X:$i]: ((mbox @ ((mimplies @ (mbox @ (big_p @ X))) @ (mbox @ (big_q @ X)))))))) @ (mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ (big_p @ X))))))) @ (mexists_di @ (^ [X:$i]: ((mbox @ (big_q @ X)))))))))) @ (mbox @ ((mimplies @ (mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ (big_p @ X))))))) @ (mexists_di @ (^ [X:$i]: ((mbox @ (big_q @ X)))))))) @ (mexists_di @ (^ [X:$i]: ((mbox @ ((mimplies @ (mbox @ (big_p @ X))) @ (mbox @ (big_q @ X)))))))))))).

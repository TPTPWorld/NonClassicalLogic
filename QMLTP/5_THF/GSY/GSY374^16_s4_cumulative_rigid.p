...
%%% Generated on Thu Apr 28 15:27:42 EDT 2022
...
thf(x2125, conjecture, (mlocal @ ((mand @ (mbox @ ((mimplies @ (mexists_di @ (^ [X:$i]: ((mbox @ (mforall_di @ (^ [Y:$i]: (((mand @ (mbox @ ((mimplies @ (mbox @ (big_p @ X))) @ (mbox @ (big_p @ Y))))) @ (mbox @ ((mimplies @ (mbox @ (big_p @ Y))) @ (mbox @ (big_p @ X))))))))))))) @ ((mand @ (mbox @ ((mimplies @ (mexists_di @ (^ [X:$i]: ((mbox @ (big_p @ X)))))) @ (mbox @ (mforall_di @ (^ [Y:$i]: ((mbox @ (big_p @ Y))))))))) @ (mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [Y:$i]: ((mbox @ (big_p @ Y))))))) @ (mexists_di @ (^ [X:$i]: ((mbox @ (big_p @ X))))))))))) @ (mbox @ ((mimplies @ ((mand @ (mbox @ ((mimplies @ (mexists_di @ (^ [X:$i]: ((mbox @ (big_p @ X)))))) @ (mbox @ (mforall_di @ (^ [Y:$i]: ((mbox @ (big_p @ Y))))))))) @ (mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [Y:$i]: ((mbox @ (big_p @ Y))))))) @ (mexists_di @ (^ [X:$i]: ((mbox @ (big_p @ X))))))))) @ (mexists_di @ (^ [X:$i]: ((mbox @ (mforall_di @ (^ [Y:$i]: (((mand @ (mbox @ ((mimplies @ (mbox @ (big_p @ X))) @ (mbox @ (big_p @ Y))))) @ (mbox @ ((mimplies @ (mbox @ (big_p @ Y))) @ (mbox @ (big_p @ X))))))))))))))))).

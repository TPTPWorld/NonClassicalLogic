...
%%% Generated on Thu Apr 28 15:29:01 EDT 2022
...
thf(x2127, conjecture, (mlocal @ (mbox @ ((mimplies @ (mexists_di @ (^ [X:$i]: ((mbox @ (mforall_di @ (^ [Y:$i]: (((mand @ (mbox @ ((mimplies @ (mbox @ (big_p @ Y))) @ (mbox @ (big_p @ X))))) @ (mbox @ ((mimplies @ (mbox @ (big_p @ X))) @ (mbox @ (big_p @ Y))))))))))))) @ ((mor @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ (big_p @ X))))))) @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ (mnot @ (mbox @ (big_p @ X))))))))))))).

...
%%% Generated on Fri May 06 13:23:39 EDT 2022
...
thf(x2130, conjecture, (mlocal @ (mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ (big_p @ X))))))) @ ((mor @ (mbox @ (mnot @ (mexists_di @ (^ [Y:$i]: ((mbox @ (big_q @ Y)))))))) @ (mexists_di @ (^ [Z:$i]: ((mbox @ ((mimplies @ (mbox @ (big_p @ Z))) @ (mbox @ (big_q @ Z)))))))))))).

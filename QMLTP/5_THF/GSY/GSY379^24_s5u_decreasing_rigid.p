...
%%% Generated on Fri May 06 13:23:42 EDT 2022
...
thf(big_q_decl, type, big_q: ($i > ($i > ($i > (mworld > $o))))).
thf(big_p_decl, type, big_p: ($i > (mworld > $o))).
thf(x2131, conjecture, (mlocal @ (mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ (big_p @ X))))))) @ (mexists_di @ (^ [Y:$i]: ((mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ (mforall_di @ (^ [Z:$i]: ((mbox @ (((big_q @ X) @ Y) @ Z))))))))))) @ (mbox @ (mnot @ (mbox @ (mforall_di @ (^ [Z:$i]: (((mand @ (mbox @ (big_p @ Z))) @ (mbox @ (mnot @ (mbox @ (((big_q @ Y) @ Y) @ Z)))))))))))))))))))).

...
%%% Generated on Thu Apr 28 15:30:42 EDT 2022
...
thf(x2132, conjecture, (mlocal @ (mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [W:$i]: ((mbox @ (mnot @ (mbox @ ((big_r @ W) @ W))))))))) @ (mexists_di @ (^ [X:$i]: ((mexists_di @ (^ [Y:$i]: (((mand @ (mbox @ (mnot @ (mbox @ ((big_r @ X) @ Y))))) @ (mbox @ ((mimplies @ (mbox @ ((big_q @ Y) @ X))) @ (mbox @ (mforall_di @ (^ [Z:$i]: ((mbox @ ((big_q @ Z) @ Z))))))))))))))))))).

...
%%% Generated on Fri May 06 13:23:49 EDT 2022
...
thf(x2133, conjecture, (mlocal @ (mbox @ ((mimplies @ ((mand @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ ((mimplies @ (mexists_di @ (^ [Y:$i]: ((mbox @ ((big_q @ X) @ Y)))))) @ (mbox @ (big_p @ X))))))))) @ ((mand @ (mbox @ (mforall_di @ (^ [V:$i]: ((mexists_di @ (^ [U:$i]: ((mbox @ ((big_q @ U) @ V)))))))))) @ (mbox @ (mforall_di @ (^ [W:$i]: ((mbox @ (mforall_di @ (^ [Z:$i]: ((mbox @ ((mimplies @ (mbox @ ((big_q @ W) @ Z))) @ ((mor @ (mbox @ ((big_q @ Z) @ W))) @ (mbox @ ((big_q @ Z) @ Z)))))))))))))))) @ (mbox @ (mforall_di @ (^ [Z:$i]: ((mbox @ (big_p @ Z)))))))))).

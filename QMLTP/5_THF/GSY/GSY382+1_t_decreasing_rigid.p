...
%%% Generated on Thu Apr 28 15:32:14 EDT 2022
...
thf(x2134, conjecture, (mlocal @ (mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [Z:$i]: ((mexists_di @ (^ [X:$i]: (((mor @ (mbox @ (mforall_di @ (^ [Y:$i]: ((mbox @ ((big_p @ X) @ Y))))))) @ (mbox @ ((big_q @ X) @ Z))))))))))) @ (mbox @ (mforall_di @ (^ [Y:$i]: ((mexists_di @ (^ [X:$i]: (((mor @ (mbox @ ((big_p @ X) @ Y))) @ (mbox @ ((big_q @ X) @ Y)))))))))))))).

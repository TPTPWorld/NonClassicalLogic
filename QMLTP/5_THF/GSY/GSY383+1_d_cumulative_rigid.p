...
%%% Generated on Thu Apr 28 15:32:19 EDT 2022
...
thf(x2135, conjecture, (mlocal @ (mexists_di @ (^ [X:$i]: ((mbox @ (mforall_di @ (^ [Y:$i]: ((mbox @ ((mimplies @ ((mand @ (mbox @ (big_p @ X))) @ (mbox @ (big_q @ Y)))) @ ((mor @ (mbox @ (big_q @ X))) @ (mbox @ (big_p @ Y)))))))))))))).

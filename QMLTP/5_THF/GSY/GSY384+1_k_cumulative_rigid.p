...
%%% Generated on Thu Apr 28 15:32:58 EDT 2022
...
thf(x2136, conjecture, (mlocal @ (mbox @ (mforall_di @ (^ [Z:$i]: ((mexists_di @ (^ [X:$i]: ((mexists_di @ (^ [Y:$i]: ((mbox @ (mforall_di @ (^ [U:$i]: ((mbox @ ((mimplies @ (mbox @ (((big_p @ X) @ Y) @ Z))) @ (mbox @ (((big_p @ U) @ X) @ X)))))))))))))))))))).

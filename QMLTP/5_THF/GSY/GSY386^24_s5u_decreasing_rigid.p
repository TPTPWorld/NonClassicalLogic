...
%%% Generated on Fri May 06 13:24:06 EDT 2022
...
thf(big_f_decl, type, big_f: ($i > ($i > (mworld > $o)))).
thf(big_s_decl, type, big_s: ($i > ($i > (mworld > $o)))).
thf(big_d_decl, type, big_d: ($i > ($i > ($i > (mworld > $o))))).
thf(x2138, conjecture, (mlocal @ (mbox @ ((mimplies @ ((mand @ (mbox @ (mforall_di @ (^ [X:$i]: ((mexists_di @ (^ [Y:$i]: ((mbox @ ((big_f @ X) @ Y)))))))))) @ ((mand @ (mexists_di @ (^ [X:$i]: ((mbox @ (mforall_di @ (^ [E:$i]: ((mexists_di @ (^ [N:$i]: ((mbox @ (mforall_di @ (^ [W:$i]: ((mbox @ ((mimplies @ (mbox @ ((big_s @ N) @ W))) @ (mbox @ (((big_d @ W) @ X) @ E))))))))))))))))))) @ (mbox @ (mforall_di @ (^ [E:$i]: ((mexists_di @ (^ [D:$i]: ((mbox @ (mforall_di @ (^ [A:$i]: ((mbox @ (mforall_di @ (^ [B:$i]: ((mbox @ ((mimplies @ (mbox @ (((big_d @ A) @ B) @ D))) @ (mbox @ (mforall_di @ (^ [Y:$i]: ((mbox @ (mforall_di @ (^ [Z:$i]: ((mbox @ ((mimplies @ ((mand @ (mbox @ ((big_f @ A) @ Y))) @ (mbox @ ((big_f @ B) @ Z)))) @ (mbox @ (((big_d @ Y) @ Z) @ E)))))))))))))))))))))))))))))))) @ (mexists_di @ (^ [Y:$i]: ((mbox @ (mforall_di @ (^ [E:$i]: ((mexists_di @ (^ [M:$i]: ((mbox @ (mforall_di @ (^ [W:$i]: ((mbox @ ((mimplies @ (mbox @ ((big_s @ M) @ W))) @ (mbox @ (mforall_di @ (^ [Z:$i]: ((mbox @ ((mimplies @ (mbox @ ((big_f @ W) @ Z))) @ (mbox @ (((big_d @ Z) @ Y) @ E)))))))))))))))))))))))))))).

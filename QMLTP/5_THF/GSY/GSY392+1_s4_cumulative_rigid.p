...
%%% Generated on Thu Apr 28 15:37:18 EDT 2022
...
thf(pel14, conjecture, (mlocal @ ((mand @ (mbox @ ((mimplies @ ((mand @ (mbox @ ((mimplies @ (mbox @ p1)) @ (mbox @ p2)))) @ (mbox @ ((mimplies @ (mbox @ p2)) @ (mbox @ p1))))) @ ((mand @ ((mor @ (mbox @ p2)) @ (mbox @ (mnot @ (mbox @ p1))))) @ ((mor @ (mbox @ (mnot @ (mbox @ p2)))) @ (mbox @ p1)))))) @ (mbox @ ((mimplies @ ((mand @ ((mor @ (mbox @ p2)) @ (mbox @ (mnot @ (mbox @ p1))))) @ ((mor @ (mbox @ (mnot @ (mbox @ p2)))) @ (mbox @ p1)))) @ ((mand @ (mbox @ ((mimplies @ (mbox @ p1)) @ (mbox @ p2)))) @ (mbox @ ((mimplies @ (mbox @ p2)) @ (mbox @ p1))))))))).

...
%%% Generated on Thu Apr 28 15:38:22 EDT 2022
...
thf(kalish201, conjecture, (mlocal @ (mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ ((mimplies @ (mbox @ (f @ X))) @ (mbox @ (g @ X))))))))) @ (mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [Y:$i]: ((mbox @ (f @ Y))))))) @ (mbox @ (mforall_di @ (^ [Z:$i]: ((mbox @ (g @ Z)))))))))))).

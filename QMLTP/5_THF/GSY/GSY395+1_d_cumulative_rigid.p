...
%%% Generated on Thu Apr 28 15:38:41 EDT 2022
...
thf(kalish202, conjecture, (mlocal @ (mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ ((mimplies @ (mbox @ (f @ X))) @ (mbox @ (g @ X))))))))) @ (mbox @ ((mimplies @ (mexists_di @ (^ [Y:$i]: ((mbox @ (f @ Y)))))) @ (mexists_di @ (^ [Z:$i]: ((mbox @ (g @ Z))))))))))).

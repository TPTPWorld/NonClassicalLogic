...
%%% Generated on Thu Apr 28 15:39:19 EDT 2022
...
thf(kalish203, conjecture, (mlocal @ ((mand @ (mbox @ ((mimplies @ (mbox @ (mnot @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ (f @ X))))))))) @ (mexists_di @ (^ [Y:$i]: ((mbox @ (mnot @ (mbox @ (f @ Y)))))))))) @ (mbox @ ((mimplies @ (mexists_di @ (^ [Y:$i]: ((mbox @ (mnot @ (mbox @ (f @ Y)))))))) @ (mbox @ (mnot @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ (f @ X))))))))))))).

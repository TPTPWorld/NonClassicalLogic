...
%%% Generated on Thu Apr 28 15:39:51 EDT 2022
...
thf(kalish204, conjecture, (mlocal @ ((mand @ (mbox @ ((mimplies @ (mbox @ (mnot @ (mexists_di @ (^ [X:$i]: ((mbox @ (f @ X)))))))) @ (mbox @ (mforall_di @ (^ [Y:$i]: ((mbox @ (mnot @ (mbox @ (f @ Y))))))))))) @ (mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [Y:$i]: ((mbox @ (mnot @ (mbox @ (f @ Y))))))))) @ (mbox @ (mnot @ (mexists_di @ (^ [X:$i]: ((mbox @ (f @ X)))))))))))).

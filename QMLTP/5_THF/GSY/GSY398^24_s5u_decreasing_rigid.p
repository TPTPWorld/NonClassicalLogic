...
%%% Generated on Fri May 06 13:24:47 EDT 2022
...
thf(kalish215, conjecture, (mlocal @ ((mand @ (mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [X:$i]: (((mand @ (mbox @ p)) @ (mbox @ (f @ X)))))))) @ ((mand @ (mbox @ p)) @ (mbox @ (mforall_di @ (^ [Y:$i]: ((mbox @ (f @ Y)))))))))) @ (mbox @ ((mimplies @ ((mand @ (mbox @ p)) @ (mbox @ (mforall_di @ (^ [Y:$i]: ((mbox @ (f @ Y)))))))) @ (mbox @ (mforall_di @ (^ [X:$i]: (((mand @ (mbox @ p)) @ (mbox @ (f @ X)))))))))))).

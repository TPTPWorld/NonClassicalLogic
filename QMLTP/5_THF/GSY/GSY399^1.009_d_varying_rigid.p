%------------------------------------------------------------------------------
% File     : GSY399^1.009 : TPTP v8.1.0. Released v8.1.0.
...
%            Number of connectives :   75 (   1   ~;   1   |;   3   &;  66   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)
...
thf(kalish223,conjecture,
    ( mlocal
    @ ( mbox
      @ ( mimplies
        @ ( mbox
          @ ( mforall_di
            @ ^ [X: $i] : ( mand @ ( mbox @ ( mimplies @ ( mbox @ ( f @ X ) ) @ ( mbox @ p ) ) ) @ ( mbox @ ( mimplies @ ( mbox @ p ) @ ( mbox @ ( f @ X ) ) ) ) ) ) )
        @ ( mand
          @ ( mbox
            @ ( mimplies
              @ ( mbox

...
%%% Generated on Thu Apr 28 15:41:01 EDT 2022
...
thf(kalish223, conjecture, (mlocal @ (mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [X:$i]: (((mand @ (mbox @ ((mimplies @ (mbox @ (f @ X))) @ (mbox @ p)))) @ (mbox @ ((mimplies @ (mbox @ p)) @ (mbox @ (f @ X)))))))))) @ ((mand @ (mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [Y:$i]: ((mbox @ (f @ Y))))))) @ (mbox @ p)))) @ (mbox @ ((mimplies @ (mbox @ p)) @ (mbox @ (mforall_di @ (^ [Y:$i]: ((mbox @ (f @ Y))))))))))))).

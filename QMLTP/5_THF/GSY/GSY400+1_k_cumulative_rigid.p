...
%%% Generated on Thu Apr 28 15:41:27 EDT 2022
...
thf(kalish227, conjecture, (mlocal @ ((mand @ (mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ p)))))) @ (mbox @ p)))) @ (mbox @ ((mimplies @ (mbox @ p)) @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ p)))))))))).

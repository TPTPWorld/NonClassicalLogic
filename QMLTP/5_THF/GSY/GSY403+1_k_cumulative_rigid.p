...
%%% Generated on Thu Apr 28 15:43:02 EDT 2022
...
thf(kalish234, conjecture, (mlocal @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ ((mimplies @ ((mand @ (mbox @ ((mimplies @ (mbox @ (f @ X))) @ (mbox @ (g @ X))))) @ (mbox @ ((mimplies @ (mbox @ (g @ X))) @ (mbox @ (h @ X)))))) @ (mbox @ ((mimplies @ (mbox @ (f @ X))) @ (mbox @ (h @ X)))))))))))).

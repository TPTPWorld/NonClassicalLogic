...
%%% Generated on Fri May 06 13:25:10 EDT 2022
...
thf(kalish239, conjecture, (mlocal @ (mbox @ ((mimplies @ ((mand @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ (f @ X))))))) @ (mexists_di @ (^ [Y:$i]: ((mbox @ (g @ Y))))))) @ (mexists_di @ (^ [Z:$i]: (((mand @ (mbox @ (f @ Z))) @ (mbox @ (g @ Z)))))))))).

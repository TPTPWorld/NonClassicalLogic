%------------------------------------------------------------------------------
% File     : GSY406^1.006 : TPTP v8.1.0. Released v8.1.0.
    ...
    @ ( mbox
      @ ( mimplies
        @ ( mand
          @ ( mbox
            @ ( mforall_di
              @ ^ [X: $i] : ( mbox @ ( mimplies @ ( mbox @ ( f @ X ) ) @ ( mbox @ ( g @ X ) ) ) ) ) )
          @ ( mexists_di
            @ ^ [Y: $i] : ( mand @ ( mbox @ ( f @ Y ) ) @ ( mbox @ ( h @ Y ) ) ) ) )
        @ ( mexists_di
          @ ^ [Z: $i] : ( mand @ ( mbox @ ( g @ Z ) ) @ ( mbox @ ( h @ Z ) ) ) ) ) ) ) ).

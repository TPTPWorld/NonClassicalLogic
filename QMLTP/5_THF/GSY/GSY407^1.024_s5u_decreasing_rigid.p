%------------------------------------------------------------------------------
% File     : GSY407^1.024 : TPTP v8.1.0. Released v8.1.0.
...
%            Number of connectives :   80 (   1   ~;   1   |;   4   &;  69   @)
%                                         (   1 <=>;   4  =>;   0  <=;   0 <~>)
...
thf(kalish241,conjecture,
    ...
    @ ( mbox
      @ ( mimplies
        @ ( mbox
          @ ( mforall_di
            @ ^ [X: $i] : ( mbox @ ( mimplies @ ( mbox @ ( f @ X ) ) @ ( mor @ ( mbox @ ( g @ X ) ) @ ( mbox @ ( h @ X ) ) ) ) ) ) )
        @ ( mor
          @ ( mbox
            @ ( mforall_di
              @ ^ [Y: $i] : ( mbox @ ( mimplies @ ( mbox @ ( f @ Y ) ) @ ( mbox @ ( g @ Y ) ) ) ) ) )
          @ ( mexists_di
            @ ^ [Z: $i] : ( mand @ ( mbox @ ( f @ Z ) ) @ ( mbox @ ( h @ Z ) ) ) ) ) ) ) ) ).

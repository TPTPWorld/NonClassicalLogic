...
%%% Generated on Fri May 06 13:25:17 EDT 2022
...
thf(kalish241, conjecture, (mlocal @ (mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ ((mimplies @ (mbox @ (f @ X))) @ ((mor @ (mbox @ (g @ X))) @ (mbox @ (h @ X)))))))))) @ ((mor @ (mbox @ (mforall_di @ (^ [Y:$i]: ((mbox @ ((mimplies @ (mbox @ (f @ Y))) @ (mbox @ (g @ Y))))))))) @ (mexists_di @ (^ [Z:$i]: (((mand @ (mbox @ (f @ Z))) @ (mbox @ (h @ Z))))))))))).

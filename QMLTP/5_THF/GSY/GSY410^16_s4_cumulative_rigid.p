...
%%% Generated on Thu Apr 28 15:46:53 EDT 2022
...
thf(kalish249, conjecture, (mlocal @ (mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ (mforall_di @ (^ [Y:$i]: ((mbox @ ((f @ X) @ Y))))))))))) @ (mexists_di @ (^ [U:$i]: ((mexists_di @ (^ [V:$i]: ((mbox @ ((f @ U) @ V)))))))))))).

...
%%% Generated on Thu Apr 28 15:47:37 EDT 2022
...
thf(f_decl, type, f: ($i > ($i > ($i > (mworld > $o))))).
thf(kalish250, conjecture, (mlocal @ ((mand @ (mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ (mforall_di @ (^ [Y:$i]: ((mbox @ (mforall_di @ (^ [Z:$i]: ((mbox @ (((f @ X) @ Y) @ Z))))))))))))))) @ (mbox @ (mnot @ (mexists_di @ (^ [U:$i]: ((mexists_di @ (^ [V:$i]: ((mexists_di @ (^ [W:$i]: ((mbox @ (mnot @ (mbox @ (((f @ U) @ V) @ W)))))))))))))))))) @ (mbox @ ((mimplies @ (mbox @ (mnot @ (mexists_di @ (^ [U:$i]: ((mexists_di @ (^ [V:$i]: ((mexists_di @ (^ [W:$i]: ((mbox @ (mnot @ (mbox @ (((f @ U) @ V) @ W)))))))))))))))) @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ (mforall_di @ (^ [Y:$i]: ((mbox @ (mforall_di @ (^ [Z:$i]: ((mbox @ (((f @ X) @ Y) @ Z))))))))))))))))))).

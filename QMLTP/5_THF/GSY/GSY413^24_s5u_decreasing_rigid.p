...
%%% Generated on Fri May 06 13:25:38 EDT 2022
...
thf(f_decl, type, f: ($i > ($i > (mworld > $o)))).
thf(kalish256, conjecture, (mlocal @ (mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [Z:$i]: ((mexists_di @ (^ [Y:$i]: ((mbox @ (mforall_di @ (^ [X:$i]: (((mand @ (mbox @ ((mimplies @ (mbox @ ((f @ X) @ Y))) @ ((mand @ (mbox @ ((f @ X) @ Z))) @ (mbox @ (mnot @ (mbox @ ((f @ X) @ X)))))))) @ (mbox @ ((mimplies @ ((mand @ (mbox @ ((f @ X) @ Z))) @ (mbox @ (mnot @ (mbox @ ((f @ X) @ X)))))) @ (mbox @ ((f @ X) @ Y))))))))))))))))) @ (mbox @ (mnot @ (mexists_di @ (^ [V:$i]: ((mbox @ (mforall_di @ (^ [U:$i]: ((mbox @ ((f @ U) @ V))))))))))))))).

...
%%% Generated on Thu Apr 28 15:49:14 EDT 2022
...
thf(h_decl, type, h: ($i > ($i > (mworld > $o)))).
thf(kalish265, conjecture, (mlocal @ ((mand @ (mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ ((mimplies @ (mexists_di @ (^ [Y:$i]: (((mand @ (mbox @ ((h @ X) @ Y))) @ (mbox @ (f @ Y))))))) @ (mexists_di @ (^ [Z:$i]: (((mand @ (mbox @ ((h @ X) @ Z))) @ (mbox @ (g @ Z))))))))))))) @ (mbox @ (mforall_di @ (^ [U:$i]: ((mbox @ (mforall_di @ (^ [V:$i]: ((mbox @ (mforall_di @ (^ [W:$i]: ((mbox @ ((mimplies @ ((mand @ (mbox @ ((h @ U) @ V))) @ (mbox @ (f @ V)))) @ ((mand @ (mbox @ ((h @ U) @ W))) @ (mbox @ (g @ W)))))))))))))))))))) @ (mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [U:$i]: ((mbox @ (mforall_di @ (^ [V:$i]: ((mbox @ (mforall_di @ (^ [W:$i]: ((mbox @ ((mimplies @ ((mand @ (mbox @ ((h @ U) @ V))) @ (mbox @ (f @ V)))) @ ((mand @ (mbox @ ((h @ U) @ W))) @ (mbox @ (g @ W)))))))))))))))))) @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ ((mimplies @ (mexists_di @ (^ [Y:$i]: (((mand @ (mbox @ ((h @ X) @ Y))) @ (mbox @ (f @ Y))))))) @ (mexists_di @ (^ [Z:$i]: (((mand @ (mbox @ ((h @ X) @ Z))) @ (mbox @ (g @ Z))))))))))))))))).

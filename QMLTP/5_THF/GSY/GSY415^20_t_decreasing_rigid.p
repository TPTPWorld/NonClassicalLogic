...
%%% Generated on Thu Apr 28 15:49:48 EDT 2022
...
thf(f_substitution_1, axiom, (mlocal @ (mbox @ (mforall_di @ (^ [A:$i]: ((mbox @ (mforall_di @ (^ [B:$i]: ((mbox @ ((mimplies @ ((mand @ (mbox @ ((qmltpeq @ A) @ B))) @ (mbox @ (f @ A)))) @ (mbox @ (f @ B)))))))))))))).
thf(kalish317, conjecture, (mlocal @ ((mand @ (mbox @ ((mimplies @ ((mand @ (mexists_di @ (^ [X:$i]: ((mbox @ (f @ X)))))) @ (mbox @ (mforall_di @ (^ [Y:$i]: ((mbox @ (mforall_di @ (^ [Z:$i]: ((mbox @ ((mimplies @ ((mand @ (mbox @ (f @ Y))) @ (mbox @ (f @ Z)))) @ (mbox @ ((qmltpeq @ Y) @ Z)))))))))))))) @ (mexists_di @ (^ [U:$i]: (((mand @ (mbox @ (f @ U))) @ (mbox @ (mforall_di @ (^ [V:$i]: ((mbox @ ((mimplies @ (mbox @ (f @ V))) @ (mbox @ ((qmltpeq @ U) @ V))))))))))))))) @ (mbox @ ((mimplies @ (mexists_di @ (^ [U:$i]: (((mand @ (mbox @ (f @ U))) @ (mbox @ (mforall_di @ (^ [V:$i]: ((mbox @ ((mimplies @ (mbox @ (f @ V))) @ (mbox @ ((qmltpeq @ U) @ V))))))))))))) @ ((mand @ (mexists_di @ (^ [X:$i]: ((mbox @ (f @ X)))))) @ (mbox @ (mforall_di @ (^ [Y:$i]: ((mbox @ (mforall_di @ (^ [Z:$i]: ((mbox @ ((mimplies @ ((mand @ (mbox @ (f @ Y))) @ (mbox @ (f @ Z)))) @ (mbox @ ((qmltpeq @ Y) @ Z)))))))))))))))))).

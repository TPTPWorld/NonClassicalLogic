...
%%% Generated on Thu Apr 28 15:52:09 EDT 2022
...
thf('mrel_#shoot_serial', axiom, (! [W:mworld]: ((? [V:mworld]: ((((mrel @ '#shoot') @ W) @ V)))))).
thf('mrel_#load_serial', axiom, (! [W:mworld]: ((? [V:mworld]: ((((mrel @ '#load') @ W) @ V)))))).

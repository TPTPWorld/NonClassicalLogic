%------------------------------------------------------------------------------
% File     : MML004^1.009 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Puzzles
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   39 (  11 unt;  17 typ;   8 def)
%            Number of atoms       :   93 (   8 equ;   0 cnn)
...
thf('mrel_#shoot_serial',axiom,
    ! [W: mworld] :
    ? [V: mworld] : ( mrel @ '#shoot' @ W @ V ) ).

thf('mrel_#load_serial',axiom,
    ! [W: mworld] :
    ? [V: mworld] : ( mrel @ '#load' @ W @ V ) ).

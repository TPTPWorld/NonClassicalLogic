%------------------------------------------------------------------------------
% File     : MML004^1.024 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Puzzles
...
thf('mrel_#shoot_universal',axiom,
    ! [W: mworld,V: mworld] : ( mrel @ '#shoot' @ W @ V ) ).

thf('mrel_#load_universal',axiom,
    ! [W: mworld,V: mworld] : ( mrel @ '#load' @ W @ V ) ).

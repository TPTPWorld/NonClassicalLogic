...
%%% Generated on Thu Apr 28 15:52:27 EDT 2022
...
thf('mrel_#shoot_euclidean', axiom, (! [W:mworld,V:mworld,U:mworld]: ((((((mrel @ '#shoot') @ W) @ U) & (((mrel @ '#shoot') @ W) @ V)) => (((mrel @ '#shoot') @ U) @ V))))).
thf('mrel_#load_reflexive', axiom, (! [W:mworld]: ((((mrel @ '#load') @ W) @ W)))).
thf('mrel_#load_euclidean', axiom, (! [W:mworld,V:mworld,U:mworld]: ((((((mrel @ '#load') @ W) @ U) & (((mrel @ '#load') @ W) @ V)) => (((mrel @ '#load') @ U) @ V))))).

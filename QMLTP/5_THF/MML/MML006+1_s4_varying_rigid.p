...
%%% Generated on Thu Apr 28 15:53:31 EDT 2022
...
thf('mrel_#pour_b_transitive', axiom, (! [W:mworld,V:mworld,U:mworld]: ((((((mrel @ '#pour_b') @ W) @ V) & (((mrel @ '#pour_b') @ V) @ U)) => (((mrel @ '#pour_b') @ W) @ U))))).
thf('mrel_#make_c_reflexive', axiom, (! [W:mworld]: ((((mrel @ '#make_c') @ W) @ W)))).
thf('mrel_#make_c_transitive', axiom, (! [W:mworld,V:mworld,U:mworld]: ((((((mrel @ '#make_c') @ W) @ V) & (((mrel @ '#make_c') @ V) @ U)) => (((mrel @ '#make_c') @ W) @ U))))).
thf('mrel_#pour_a_reflexive', axiom, (! [W:mworld]: ((((mrel @ '#pour_a') @ W) @ W)))).
thf('mrel_#pour_a_transitive', axiom, (! [W:mworld,V:mworld,U:mworld]: ((((((mrel @ '#pour_a') @ W) @ V) & (((mrel @ '#pour_a') @ V) @ U)) => (((mrel @ '#pour_a') @ W) @ U))))).

...
%%% Generated on Thu Apr 28 15:53:33 EDT 2022
...
thf('mrel_#pour_b_reflexive', axiom, (! [W:mworld]: ((((mrel @ '#pour_b') @ W) @ W)))).
thf('mrel_#pour_b_euclidean', axiom, (! [W:mworld,V:mworld,U:mworld]: ((((((mrel @ '#pour_b') @ W) @ U) & (((mrel @ '#pour_b') @ W) @ V)) => (((mrel @ '#pour_b') @ U) @ V))))).
thf('mrel_#make_c_reflexive', axiom, (! [W:mworld]: ((((mrel @ '#make_c') @ W) @ W)))).
thf('mrel_#make_c_euclidean', axiom, (! [W:mworld,V:mworld,U:mworld]: ((((((mrel @ '#make_c') @ W) @ U) & (((mrel @ '#make_c') @ W) @ V)) => (((mrel @ '#make_c') @ U) @ V))))).
thf('mrel_#pour_a_reflexive', axiom, (! [W:mworld]: ((((mrel @ '#pour_a') @ W) @ W)))).
thf('mrel_#pour_a_euclidean', axiom, (! [W:mworld,V:mworld,U:mworld]: ((((((mrel @ '#pour_a') @ W) @ U) & (((mrel @ '#pour_a') @ W) @ V)) => (((mrel @ '#pour_a') @ U) @ V))))).

...
%%% Generated on Thu Apr 28 15:53:15 EDT 2022
...
thf('mrel_#pour_b_serial', axiom, (! [W:mworld]: ((? [V:mworld]: ((((mrel @ '#pour_b') @ W) @ V)))))).
thf('mrel_#make_c_serial', axiom, (! [W:mworld]: ((? [V:mworld]: ((((mrel @ '#make_c') @ W) @ V)))))).
thf('mrel_#pour_a_serial', axiom, (! [W:mworld]: ((? [V:mworld]: ((((mrel @ '#pour_a') @ W) @ V)))))).

...
%%% Generated on Thu Apr 28 15:55:07 EDT 2022
...
thf(axiom_1, axiom, (mlocal @ (mforall_di @ (^ [D:$i]: ((mforall_di @ (^ [P:$i]: (((mimplies @ ((mbox @ '#bs') @ ((mbox @ '#wu') @ ((printedon @ D) @ P)))) @ ((mbox @ '#bs') @ ((mbox @ '#bu') @ ((printableon @ D) @ P)))))))))))).

%------------------------------------------------------------------------------
% File     : MML009^1.009 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Processes
...
%            Number of variables   :   44 (  32   ^   6   !;   6   ?;  44   :)
% SPC      : TH0_UNK_EQU_NAR
...
thf('mrel_#wu_serial',axiom,
    ! [W: mworld] :
    ? [V: mworld] : ( mrel @ '#wu' @ W @ V ) ).

thf('mrel_#bu_serial',axiom,
    ! [W: mworld] :
    ? [V: mworld] : ( mrel @ '#bu' @ W @ V ) ).

thf('mrel_#bs_serial',axiom,
    ! [W: mworld] :
    ? [V: mworld] : ( mrel @ '#bs' @ W @ V ) ).

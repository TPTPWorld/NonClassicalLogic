%------------------------------------------------------------------------------
% File     : MML009^1.012 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Processes
...
thf('mrel_#wu_universal',axiom,
    ! [W: mworld,V: mworld] : ( mrel @ '#wu' @ W @ V ) ).

thf('mrel_#bu_universal',axiom,
    ! [W: mworld,V: mworld] : ( mrel @ '#bu' @ W @ V ) ).

thf('mrel_#bs_universal',axiom,
    ! [W: mworld,V: mworld] : ( mrel @ '#bs' @ W @ V ) ).

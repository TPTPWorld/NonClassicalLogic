...
%%% Generated on Thu Apr 28 15:55:40 EDT 2022
...
thf('#wu_type', type, '#wu': mindex).
thf('#bu_type', type, '#bu': mindex).
thf('#bs_type', type, '#bs': mindex).
...
thf('mrel_#wu_reflexive', axiom, (! [W:mworld]: ((((mrel @ '#wu') @ W) @ W)))).
thf('mrel_#wu_transitive', axiom, (! [W:mworld,V:mworld,U:mworld]: ((((((mrel @ '#wu') @ W) @ V) & (((mrel @ '#wu') @ V) @ U)) => (((mrel @ '#wu') @ W) @ U))))).
thf('mrel_#bu_reflexive', axiom, (! [W:mworld]: ((((mrel @ '#bu') @ W) @ W)))).
thf('mrel_#bu_transitive', axiom, (! [W:mworld,V:mworld,U:mworld]: ((((((mrel @ '#bu') @ W) @ V) & (((mrel @ '#bu') @ V) @ U)) => (((mrel @ '#bu') @ W) @ U))))).
thf('mrel_#bs_reflexive', axiom, (! [W:mworld]: ((((mrel @ '#bs') @ W) @ W)))).
thf('mrel_#bs_transitive', axiom, (! [W:mworld,V:mworld,U:mworld]: ((((((mrel @ '#bs') @ W) @ V) & (((mrel @ '#bs') @ V) @ U)) => (((mrel @ '#bs') @ W) @ U))))).
...
thf(userdoc_decl, type, userdoc: $i).
thf(lw_decl, type, lw: $i).
thf(printed_decl, type, printed: ($i > (mworld > $o))).
thf(printableon_decl, type, printableon: ($i > ($i > (mworld > $o)))).
thf(printedable_decl, type, printedable: ($i > ($i > (mworld > $o)))).
thf(printedon_decl, type, printedon: ($i > ($i > (mworld > $o)))).
thf(aciom_1, axiom, (mlocal @ (mforall_di @ (^ [D:$i]: ((mforall_di @ (^ [P:$i]: (((mimplies @ ((mbox @ '#bs') @ ((mbox @ '#wu') @ ((printedon @ D) @ P)))) @ ((mbox @ '#bs') @ ((mbox @ '#bu') @ ((printableon @ D) @ P)))))))))))).
thf(axiom_2_1, axiom, (mlocal @ (mforall_di @ (^ [D:$i]: ((mforall_di @ (^ [P:$i]: (((mimplies @ ((mand @ ((mbox @ '#bs') @ ((mbox @ '#wu') @ (printed @ D)))) @ ((mbox @ '#bs') @ ((mbox @ '#bu') @ ((mimplies @ (printed @ D)) @ ((printedon @ D) @ P)))))) @ ((mbox @ '#bs') @ ((mbox @ '#wu') @ ((printedon @ D) @ P)))))))))))).
thf(axiom_2_2, axiom, (mlocal @ (mforall_di @ (^ [D:$i]: ((mforall_di @ (^ [P:$i]: (((mimplies @ ((mand @ ((mbox @ '#bs') @ ((mbox @ '#wu') @ ((printedon @ D) @ P)))) @ ((mbox @ '#bs') @ ((mbox @ '#bu') @ ((mimplies @ ((printedon @ D) @ P)) @ ((printedable @ D) @ P)))))) @ ((mbox @ '#bs') @ ((mbox @ '#wu') @ ((printedable @ D) @ P)))))))))))).
thf(axiom_3, axiom, (mlocal @ ((mbox @ '#bs') @ ((mbox @ '#wu') @ (printed @ userdoc))))).
thf(axiom_4, axiom, (mlocal @ ((mbox @ '#bs') @ ((mbox @ '#bu') @ (mforall_di @ (^ [D:$i]: (((mimplies @ (printed @ D)) @ ((printedon @ D) @ lw))))))))).
thf(con, conjecture, (mlocal @ ((mbox @ '#bs') @ ((mbox @ '#wu') @ ((printedon @ userdoc) @ lw))))).

...
%%% Generated on Thu Apr 28 15:56:03 EDT 2022
...
thf('mrel_#u_serial', axiom, (! [W:mworld]: ((? [V:mworld]: ((((mrel @ '#u') @ W) @ V)))))).
...
thf(requirement_1, conjecture, (mlocal @ ((mimplies @ (mnot @ ((mimplies @ charge) @ ((mand @ called) @ (mnot @ paid))))) @ ((mbox @ '#u') @ (mnot @ ((mimplies @ charge) @ ((mand @ called) @ (mnot @ paid)))))))).

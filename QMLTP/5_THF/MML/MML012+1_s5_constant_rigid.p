...
%%% Generated on Thu Apr 28 15:56:49 EDT 2022
...
thf('mrel_#u_euclidean', axiom, (! [W:mworld,V:mworld,U:mworld]: ((((((mrel @ '#u') @ W) @ U) & (((mrel @ '#u') @ W) @ V)) => (((mrel @ '#u') @ U) @ V))))).
thf(charge_decl, type, charge: (mworld > $o)).
thf(called_decl, type, called: (mworld > $o)).
thf(paid_decl, type, paid: (mworld > $o)).
thf(aciom_paid_charge, axiom, (mlocal @ ((mimplies @ paid) @ called))).
thf(axiom_charge_u, axiom, (mlocal @ ((mimplies @ charge) @ ((mand @ ((mbox @ '#u') @ charge)) @ ((mbox @ '#c') @ charge))))).
thf(axiom_1, axiom, (mlocal @ ((mbox @ '#u') @ ((mimplies @ called) @ ((mbox @ '#c') @ called))))).
thf(axiom_2, axiom, (mlocal @ ((mbox @ '#c') @ ((mimplies @ paid) @ ((mbox @ '#u') @ paid))))).
thf(axiom_3, axiom, (mlocal @ ((mimplies @ (mnot @ ((mbox @ '#c') @ called))) @ ((mbox @ '#u') @ (mnot @ ((mbox @ '#c') @ called)))))).
thf(axiom_4, axiom, (mlocal @ ((mimplies @ (mnot @ ((mbox @ '#u') @ paid))) @ ((mbox @ '#c') @ (mnot @ ((mbox @ '#u') @ paid)))))).
thf(requirement_1, conjecture, (mlocal @ ((mimplies @ (mnot @ ((mimplies @ ((mand @ called) @ (mnot @ paid))) @ charge))) @ ((mbox @ '#c') @ (mnot @ ((mimplies @ ((mand @ called) @ (mnot @ paid))) @ charge)))))).

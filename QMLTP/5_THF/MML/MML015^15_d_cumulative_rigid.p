...
%%% Generated on Thu Apr 28 15:58:07 EDT 2022
...
thf('mrel_#i_alice_serial', axiom, (! [W:mworld]: ((? [V:mworld]: ((((mrel @ '#i_alice') @ W) @ V)))))).
thf('mrel_#i_bob_serial', axiom, (! [W:mworld]: ((? [V:mworld]: ((((mrel @ '#i_bob') @ W) @ V)))))).
thf('mrel_#b_alice_serial', axiom, (! [W:mworld]: ((? [V:mworld]: ((((mrel @ '#b_alice') @ W) @ V)))))).
thf('mrel_#alice_serial', axiom, (! [W:mworld]: ((? [V:mworld]: ((((mrel @ '#alice') @ W) @ V)))))).
thf('mrel_#b_bob_serial', axiom, (! [W:mworld]: ((? [V:mworld]: ((((mrel @ '#b_bob') @ W) @ V)))))).

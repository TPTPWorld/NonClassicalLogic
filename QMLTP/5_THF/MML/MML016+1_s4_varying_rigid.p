...
%%% Generated on Thu Apr 28 15:58:56 EDT 2022
...
thf('mrel_#b_u_transitive', axiom, (! [W:mworld,V:mworld,U:mworld]: ((((((mrel @ '#b_u') @ W) @ V) & (((mrel @ '#b_u') @ V) @ U)) => (((mrel @ '#b_u') @ W) @ U))))).
thf('mrel_#b_s_reflexive', axiom, (! [W:mworld]: ((((mrel @ '#b_s') @ W) @ W)))).
thf('mrel_#b_s_transitive', axiom, (! [W:mworld,V:mworld,U:mworld]: ((((((mrel @ '#b_s') @ W) @ V) & (((mrel @ '#b_s') @ V) @ U)) => (((mrel @ '#b_s') @ W) @ U))))).

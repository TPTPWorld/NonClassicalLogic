...
%%% Generated on Thu Apr 28 15:58:58 EDT 2022
...
thf('mrel_#b_u_reflexive', axiom, (! [W:mworld]: ((((mrel @ '#b_u') @ W) @ W)))).
thf('mrel_#b_u_euclidean', axiom, (! [W:mworld,V:mworld,U:mworld]: ((((((mrel @ '#b_u') @ W) @ U) & (((mrel @ '#b_u') @ W) @ V)) => (((mrel @ '#b_u') @ U) @ V))))).
thf('mrel_#b_s_reflexive', axiom, (! [W:mworld]: ((((mrel @ '#b_s') @ W) @ W)))).
thf('mrel_#b_s_euclidean', axiom, (! [W:mworld,V:mworld,U:mworld]: ((((((mrel @ '#b_s') @ W) @ U) & (((mrel @ '#b_s') @ W) @ V)) => (((mrel @ '#b_s') @ U) @ V))))).

...
%%% Generated on Thu Apr 28 16:00:53 EDT 2022
...
thf('mrel_#coffee_serial', axiom, (! [W:mworld]: ((? [V:mworld]: ((((mrel @ '#coffee') @ W) @ V)))))).
thf('mrel_#ticket_serial', axiom, (! [W:mworld]: ((? [V:mworld]: ((((mrel @ '#ticket') @ W) @ V)))))).

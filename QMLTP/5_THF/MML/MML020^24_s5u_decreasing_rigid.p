...
%%% Generated on Fri May 06 13:26:58 EDT 2022
...
thf('mrel_#coffee_universal', axiom, (! [W:mworld,V:mworld]: ((((mrel @ '#coffee') @ W) @ V)))).
thf('mrel_#ticket_universal', axiom, (! [W:mworld,V:mworld]: ((((mrel @ '#ticket') @ W) @ V)))).

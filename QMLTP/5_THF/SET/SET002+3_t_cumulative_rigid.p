...
%%% Generated on Thu Apr 28 16:04:43 EDT 2022
...
thf(subset_union, axiom, (mlocal @ (mforall_di @ (^ [B:$i]: ((mforall_di @ (^ [C:$i]: (((mimplies @ ((subset @ B) @ C)) @ ((qmltpeq @ ((union @ B) @ C)) @ C)))))))))).
...
thf(prove_idempotency_of_union, conjecture, (mlocal @ (mforall_di @ (^ [B:$i]: (((qmltpeq @ ((union @ B) @ B)) @ B)))))).

%------------------------------------------------------------------------------
% File     : SET008^3.016 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Set Theory
% Problem  : TPTP problem SET008+3.p with axiomatized equality
% Version  : [BP13] axioms.
% English  : 
...
% Status   : Theorem 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   57 (  12 unt;  21 typ;  10 def)
%            Number of atoms       :  189 (  10 equ;   0 cnn)
%            Maximal formula atoms :   10 (   5 avg)
%            Number of connectives :  313 (   1   ~;   1   |;   5   &; 300   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   14 (   8 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :   74 (  74   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   21 (  20 usr;   2 con; 0-3 aty)
%            Number of variables   :   90 (  77   ^  10   !;   3   ?;  90   :)
% SPC      : TH0_THM_EQU_NAR
...
thf(prove_intersection_difference_empty_set,conjecture,
    ...
    @ ( mforall_di
      @ ^ [B: $i] :
          ( mforall_di
          @ ^ [C: $i] : ( qmltpeq @ ( intersection @ ( difference @ B @ C ) @ C ) @ empty_set ) ) ) ) ).

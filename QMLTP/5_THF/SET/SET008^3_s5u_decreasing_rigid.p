...
%%% Generated on Fri May 06 13:27:28 EDT 2022
...
thf(empty_set_defn, axiom, (mlocal @ (mforall_di @ (^ [B:$i]: ((mnot @ ((member @ B) @ empty_set))))))).
...
thf(empty_defn, axiom, (mlocal @ (mforall_di @ (^ [B:$i]: (((mequiv @ (empty @ B)) @ (mforall_di @ (^ [C:$i]: ((mnot @ ((member @ C) @ B))))))))))).
...
thf(prove_intersection_difference_empty_set, conjecture, (mlocal @ (mforall_di @ (^ [B:$i]: ((mforall_di @ (^ [C:$i]: (((qmltpeq @ ((intersection @ ((difference @ B) @ C)) @ C)) @ empty_set))))))))).

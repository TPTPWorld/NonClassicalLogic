...
%%% Generated on Thu Apr 28 16:06:38 EDT 2022
...
thf(intersection_defn, axiom, (mlocal @ (mforall_di @ (^ [B:$i]: ((mforall_di @ (^ [C:$i]: ((mforall_di @ (^ [D:$i]: (((mequiv @ ((member @ D) @ ((intersection @ B) @ C))) @ ((mand @ ((member @ D) @ B)) @ ((member @ D) @ C)))))))))))))).
...
thf(union_subset, axiom, (mlocal @ (mforall_di @ (^ [B:$i]: ((mforall_di @ (^ [C:$i]: ((mforall_di @ (^ [D:$i]: (((mimplies @ ((mand @ ((subset @ B) @ C)) @ ((subset @ D) @ C))) @ ((subset @ ((union @ B) @ D)) @ C))))))))))))).
thf(intersection_is_subset, axiom, (mlocal @ (mforall_di @ (^ [B:$i]: ((mforall_di @ (^ [C:$i]: (((subset @ ((intersection @ B) @ C)) @ B))))))))).
thf(subset_difference, axiom, (mlocal @ (mforall_di @ (^ [B:$i]: ((mforall_di @ (^ [C:$i]: ((mforall_di @ (^ [D:$i]: (((mimplies @ ((subset @ B) @ C)) @ ((subset @ ((difference @ D) @ C)) @ ((difference @ D) @ B)))))))))))))).
thf(equal_defn, axiom, (mlocal @ (mforall_di @ (^ [B:$i]: ((mforall_di @ (^ [C:$i]: (((mequiv @ ((qmltpeq @ B) @ C)) @ ((mand @ ((subset @ B) @ C)) @ ((subset @ C) @ B))))))))))).
thf(commutativity_of_union, axiom, (mlocal @ (mforall_di @ (^ [B:$i]: ((mforall_di @ (^ [C:$i]: (((qmltpeq @ ((union @ B) @ C)) @ ((union @ C) @ B)))))))))).
thf(commutativity_of_intersection, axiom, (mlocal @ (mforall_di @ (^ [B:$i]: ((mforall_di @ (^ [C:$i]: (((qmltpeq @ ((intersection @ B) @ C)) @ ((intersection @ C) @ B)))))))))).
...
thf(prove_difference_and_intersection_and_union, conjecture, (mlocal @ (mforall_di @ (^ [B:$i]: ((mforall_di @ (^ [C:$i]: ((mforall_di @ (^ [D:$i]: (((qmltpeq @ ((difference @ B) @ ((intersection @ C) @ D))) @ ((union @ ((difference @ B) @ C)) @ ((difference @ B) @ D)))))))))))))).

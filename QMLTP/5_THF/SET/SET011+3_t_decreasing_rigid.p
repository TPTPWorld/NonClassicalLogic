...
%%% Generated on Thu Apr 28 16:07:26 EDT 2022
...
thf(prove_difference_difference_intersection, conjecture, (mlocal @ (mforall_di @ (^ [B:$i]: ((mforall_di @ (^ [C:$i]: (((qmltpeq @ ((difference @ B) @ ((difference @ B) @ C))) @ ((intersection @ B) @ C)))))))))).

%------------------------------------------------------------------------------
% File     : SET011^3.024 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Set Theory
% Problem  : TPTP problem SET011+3.p with axiomatized equality
% Version  : [BP13] axioms.
% English  : 
...
%            Number of connectives :  282 (   1   ~;   1   |;   4   &; 271   @)
%                                         (   1 <=>;   4  =>;   0  <=;   0 <~>)
...
thf(prove_difference_difference_intersection,conjecture,
    ( mlocal
    @ ( mforall_di
      @ ^ [B: $i] :
          ( mforall_di
          @ ^ [C: $i] : ( qmltpeq @ ( difference @ B @ ( difference @ B @ C ) ) @ ( intersection @ B @ C ) ) ) ) ) ).

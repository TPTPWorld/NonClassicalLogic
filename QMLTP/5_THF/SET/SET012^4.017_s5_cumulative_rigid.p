%------------------------------------------------------------------------------
% File     : SET012^4.017 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Set Theory
% Problem  : TPTP problem SET012+4.p with axiomatized equality
% Version  : [BP13] axioms.
% English  : 
...
thf(thI23,conjecture,
    ...
    @ ( mforall_di
      @ ^ [A: $i] :
          ( mforall_di
          @ ^ [E: $i] : ( mimplies @ ( subset @ A @ E ) @ ( equal_set @ ( difference @ E @ ( difference @ E @ A ) ) @ A ) ) ) ) ) ).

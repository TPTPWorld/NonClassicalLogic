...
%%% Generated on Fri May 06 13:27:49 EDT 2022
...
thf(prove_union_subset, conjecture, (mlocal @ (mforall_di @ (^ [B:$i]: ((mforall_di @ (^ [C:$i]: ((mforall_di @ (^ [D:$i]: (((mimplies @ ((mand @ ((subset @ B) @ C)) @ ((subset @ D) @ C))) @ ((subset @ ((union @ B) @ D)) @ C))))))))))))).

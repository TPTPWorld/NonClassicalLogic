%------------------------------------------------------------------------------
% File     : SET014^4.023 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Set Theory
% Problem  : TPTP problem SET014+4.p with axiomatized equality
% Version  : [BP13] axioms.
% English  : 
...
thf(thI45,conjecture,
    ...
    @ ( mforall_di
      @ ^ [A: $i] :
          ...
          @ ^ [X: $i] :
              ( mforall_di
              @ ^ [Y: $i] : ( mequiv @ ( mand @ ( subset @ X @ A ) @ ( subset @ Y @ A ) ) @ ( subset @ ( union @ X @ Y ) @ A ) ) ) ) ) ) ).

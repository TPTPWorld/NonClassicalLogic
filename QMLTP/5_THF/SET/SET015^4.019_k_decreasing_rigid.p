%------------------------------------------------------------------------------
% File     : SET015^4.019 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Set Theory
% Problem  : TPTP problem SET015+4.p with axiomatized equality
% Version  : [BP13] axioms.
% English  : 
...
thf(thI07,conjecture,
    ...
    @ ( mforall_di
      @ ^ [A: $i] :
          ( mforall_di
          @ ^ [B: $i] : ( equal_set @ ( union @ A @ B ) @ ( union @ B @ A ) ) ) ) ) ).

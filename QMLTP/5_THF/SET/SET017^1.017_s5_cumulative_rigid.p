%------------------------------------------------------------------------------
% File     : SET017^1.017 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Set Theory
% Problem  : TPTP problem SET017+1.p with axiomatized equality
% Version  : [BP13] axioms.
% English  : 
...
thf(left_cancellation,conjecture,
    ...
    @ ( mforall_di
      @ ^ [X: $i] :
          ...
          @ ^ [Y: $i] :
              ( mforall_di
              @ ^ [Z: $i] : ( mimplies @ ( mand @ ( member @ Y @ universal_class ) @ ( mand @ ( member @ Z @ universal_class ) @ ( qmltpeq @ ( unordered_pair @ X @ Y ) @ ( unordered_pair @ X @ Z ) ) ) ) @ ( qmltpeq @ Y @ Z ) ) ) ) ) ) ).

...
%%% Generated on Fri May 06 13:28:39 EDT 2022
...
thf(prove_transitivity_of_subset, conjecture, (mlocal @ (mforall_di @ (^ [B:$i]: ((mforall_di @ (^ [C:$i]: ((mforall_di @ (^ [D:$i]: (((mimplies @ ((mand @ ((subset @ B) @ C)) @ ((subset @ C) @ D))) @ ((subset @ B) @ D))))))))))))).

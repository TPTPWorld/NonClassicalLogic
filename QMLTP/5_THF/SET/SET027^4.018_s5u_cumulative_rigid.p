%------------------------------------------------------------------------------
% File     : SET027^4.018 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Set Theory
% Problem  : TPTP problem SET027+4.p with axiomatized equality
% Version  : [BP13] axioms.
% English  : 
...
thf(thI03,conjecture,
    ...
    @ ( mforall_di
      @ ^ [A: $i] :
          ...
          @ ^ [B: $i] :
              ( mforall_di
              @ ^ [C: $i] : ( mimplies @ ( mand @ ( subset @ A @ B ) @ ( subset @ B @ C ) ) @ ( subset @ A @ C ) ) ) ) ) ) ).

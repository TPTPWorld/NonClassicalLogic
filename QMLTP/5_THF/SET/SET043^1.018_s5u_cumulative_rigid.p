%------------------------------------------------------------------------------
% File     : SET043^1.018 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Set Theory
% Problem  : TPTP problem SET043+1.p with axiomatized equality
% Version  : [BP13] axioms.
% English  : 
...
thf(pel39,conjecture,
    ( mlocal
    @ ( mnot
      @ ( mexists_di
        @ ^ [X: $i] :
            ( mforall_di
            @ ^ [Y: $i] : ( mequiv @ ( element @ Y @ X ) @ ( mnot @ ( element @ Y @ Y ) ) ) ) ) ) ) ).

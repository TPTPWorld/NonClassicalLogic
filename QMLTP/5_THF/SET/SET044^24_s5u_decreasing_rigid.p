...
%%% Generated on Fri May 06 13:28:49 EDT 2022
...
thf(pel40, conjecture, (mlocal @ ((mimplies @ (mexists_di @ (^ [Y:$i]: ((mforall_di @ (^ [X:$i]: (((mequiv @ ((element @ X) @ Y)) @ ((element @ X) @ X))))))))) @ (mnot @ (mforall_di @ (^ [X1:$i]: ((mexists_di @ (^ [Y1:$i]: ((mforall_di @ (^ [Z:$i]: (((mequiv @ ((element @ Z) @ Y1)) @ (mnot @ ((element @ Z) @ X1)))))))))))))))).

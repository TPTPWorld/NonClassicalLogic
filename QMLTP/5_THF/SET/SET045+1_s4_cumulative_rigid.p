...
%%% Generated on Thu Apr 28 16:18:48 EDT 2022
...
thf(pel41_1, axiom, (mlocal @ (mforall_di @ (^ [Z:$i]: ((mexists_di @ (^ [Y:$i]: ((mforall_di @ (^ [X:$i]: (((mequiv @ ((element @ X) @ Y)) @ ((mand @ ((element @ X) @ Z)) @ (mnot @ ((element @ X) @ X))))))))))))))).
thf(pel41, conjecture, (mlocal @ (mnot @ (mexists_di @ (^ [Z:$i]: ((mforall_di @ (^ [X:$i]: (((element @ X) @ Z)))))))))).

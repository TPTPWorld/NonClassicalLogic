%------------------------------------------------------------------------------
% File     : SET045^1.004 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Set Theory
% Problem  : TPTP problem SET045+1.p with axiomatized equality
% Version  : [BP13] axioms.
% English  : 
...
%            Number of connectives :   58 (   1   ~;   1   |;   3   &;  49   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)
...
thf(pel41_1,axiom,
    ...
    @ ( mforall_di
      @ ^ [Z: $i] :
          ...
          @ ^ [Y: $i] :
              ( mforall_di
              @ ^ [X: $i] : ( mequiv @ ( element @ X @ Y ) @ ( mand @ ( element @ X @ Z ) @ ( mnot @ ( element @ X @ X ) ) ) ) ) ) ) ) ).

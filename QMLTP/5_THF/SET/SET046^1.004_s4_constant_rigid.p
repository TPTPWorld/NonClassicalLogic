%------------------------------------------------------------------------------
% File     : SET046^1.004 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Set Theory
% Problem  : TPTP problem SET046+1.p with axiomatized equality
% Version  : [BP13] axioms.
% English  : 
...
%            Number of connectives :   53 (   1   ~;   1   |;   3   &;  44   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)
      ...
      @ ( mexists_di
        @ ^ [Y: $i] :
            ...
            @ ^ [X: $i] :
                ...
                @ ( mnot
                  @ ( mexists_di
                    @ ^ [Z: $i] : ( mand @ ( element @ X @ Z ) @ ( element @ Z @ X ) ) ) ) ) ) ) ) ) ).

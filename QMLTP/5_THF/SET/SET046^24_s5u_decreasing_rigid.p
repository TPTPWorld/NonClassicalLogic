...
%%% Generated on Fri May 06 13:28:56 EDT 2022
...
thf(pel42, conjecture, (mlocal @ (mnot @ (mexists_di @ (^ [Y:$i]: ((mforall_di @ (^ [X:$i]: (((mequiv @ ((element @ X) @ Y)) @ (mnot @ (mexists_di @ (^ [Z:$i]: (((mand @ ((element @ X) @ Z)) @ ((element @ Z) @ X)))))))))))))))).

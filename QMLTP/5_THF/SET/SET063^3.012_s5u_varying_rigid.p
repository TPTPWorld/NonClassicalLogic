%------------------------------------------------------------------------------
% File     : SET063^3.012 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Set Theory
% Problem  : TPTP problem SET063+3.p with axiomatized equality
% Version  : [BP13] axioms.
% English  : 
...
thf(prove_subset_of_empty_set_is_empty_set,conjecture,
    ( mlocal
    @ ( mforall_di
      @ ^ [B: $i] : ( mimplies @ ( subset @ B @ empty_set ) @ ( qmltpeq @ B @ empty_set ) ) ) ) ).

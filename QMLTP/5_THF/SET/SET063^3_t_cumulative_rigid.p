...
%%% Generated on Thu Apr 28 16:26:06 EDT 2022
...
thf(empty_set_subset, axiom, (mlocal @ (mforall_di @ (^ [B:$i]: (((subset @ empty_set) @ B)))))).
...
thf(prove_subset_of_empty_set_is_empty_set, conjecture, (mlocal @ (mforall_di @ (^ [B:$i]: (((mimplies @ ((subset @ B) @ empty_set)) @ ((qmltpeq @ B) @ empty_set))))))).

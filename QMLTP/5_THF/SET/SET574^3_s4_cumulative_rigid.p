...
%%% Generated on Thu Apr 28 16:27:31 EDT 2022
...
thf(prove_th13, conjecture, (mlocal @ (mforall_di @ (^ [B:$i]: ((mforall_di @ (^ [C:$i]: ((mforall_di @ (^ [D:$i]: (((mimplies @ ((mand @ ((member @ B) @ C)) @ ((member @ B) @ D))) @ ((intersect @ C) @ D))))))))))))).

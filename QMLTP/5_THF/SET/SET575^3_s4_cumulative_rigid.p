...
%%% Generated on Thu Apr 28 16:28:04 EDT 2022
...
thf(prove_th15, conjecture, (mlocal @ (mforall_di @ (^ [B:$i]: ((mforall_di @ (^ [C:$i]: (((mimplies @ ((intersect @ B) @ C)) @ (mexists_di @ (^ [D:$i]: (((mand @ ((member @ D) @ B)) @ ((member @ D) @ C)))))))))))))).

...
%%% Generated on Fri May 06 13:29:55 EDT 2022
...
thf(intersect_defn, axiom, (mlocal @ (mforall_di @ (^ [B:$i]: ((mforall_di @ (^ [C:$i]: (((mequiv @ ((intersect @ B) @ C)) @ (mexists_di @ (^ [D:$i]: (((mand @ ((member @ D) @ B)) @ ((member @ D) @ C)))))))))))))).
thf(disjoint_defn, axiom, (mlocal @ (mforall_di @ (^ [B:$i]: ((mforall_di @ (^ [C:$i]: (((mequiv @ ((disjoint @ B) @ C)) @ (mnot @ ((intersect @ B) @ C))))))))))).
thf(symmetry_of_intersect, axiom, (mlocal @ (mforall_di @ (^ [B:$i]: ((mforall_di @ (^ [C:$i]: (((mimplies @ ((intersect @ B) @ C)) @ ((intersect @ C) @ B)))))))))).
thf(prove_th17, conjecture, (mlocal @ (mforall_di @ (^ [B:$i]: ((mforall_di @ (^ [C:$i]: (((mimplies @ (mforall_di @ (^ [D:$i]: (((mimplies @ ((member @ D) @ B)) @ (mnot @ ((member @ D) @ C))))))) @ ((disjoint @ B) @ C)))))))))).

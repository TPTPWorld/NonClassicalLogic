...
%%% Generated on Thu Apr 28 16:29:22 EDT 2022
...
thf(prove_th18, conjecture, (mlocal @ (mforall_di @ (^ [B:$i]: ((mforall_di @ (^ [C:$i]: ((mforall_di @ (^ [D:$i]: (((mimplies @ (mforall_di @ (^ [E:$i]: (((mequiv @ ((member @ E) @ B)) @ ((mor @ ((member @ E) @ C)) @ ((member @ E) @ D))))))) @ ((qmltpeq @ B) @ ((union @ C) @ D)))))))))))))).

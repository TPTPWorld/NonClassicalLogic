...
%%% Generated on Thu Apr 28 16:29:35 EDT 2022
...
thf(prove_th19, conjecture, (mlocal @ (mforall_di @ (^ [B:$i]: ((mforall_di @ (^ [C:$i]: ((mforall_di @ (^ [D:$i]: (((mimplies @ (mforall_di @ (^ [E:$i]: (((mequiv @ ((member @ E) @ B)) @ ((mand @ ((member @ E) @ C)) @ ((member @ E) @ D))))))) @ ((qmltpeq @ B) @ ((intersection @ C) @ D)))))))))))))).

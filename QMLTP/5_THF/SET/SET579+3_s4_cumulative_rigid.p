...
%%% Generated on Thu Apr 28 16:30:16 EDT 2022
...
thf(prove_th20, conjecture, (mlocal @ (mforall_di @ (^ [B:$i]: ((mforall_di @ (^ [C:$i]: ((mforall_di @ (^ [D:$i]: (((mimplies @ (mforall_di @ (^ [E:$i]: (((mequiv @ ((member @ E) @ B)) @ ((mand @ ((member @ E) @ C)) @ (mnot @ ((member @ E) @ D)))))))) @ ((qmltpeq @ B) @ ((difference @ C) @ D)))))))))))))).

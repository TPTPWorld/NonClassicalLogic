%------------------------------------------------------------------------------
% File     : SET581^3.006 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Set Theory
% Problem  : TPTP problem SET581+3.p with axiomatized equality
% Version  : [BP13] axioms.
% English  : 
...
%            Number of atoms       :  148 (  10 equ;   0 cnn)
%            Maximal formula atoms :    9 (   5 avg)
%            Number of connectives :  230 (   1   ~;   1   |;   2   &; 223   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)
...
thf(not_equal_substitution_1,axiom,
    ...
    @ ( mforall_di
      @ ^ [A: $i] :
          ...
          @ ^ [B: $i] :
              ( mforall_di
              @ ^ [C: $i] : ( mimplies @ ( mand @ ( qmltpeq @ A @ B ) @ ( not_equal @ A @ C ) ) @ ( not_equal @ B @ C ) ) ) ) ) ) ).
...
thf(not_equal_substitution_2,axiom,
    ...
    @ ( mforall_di
      @ ^ [A: $i] :
          ...
          @ ^ [B: $i] :
              ( mforall_di
              @ ^ [C: $i] : ( mimplies @ ( mand @ ( qmltpeq @ A @ B ) @ ( not_equal @ C @ A ) ) @ ( not_equal @ C @ B ) ) ) ) ) ) ).
...
thf(not_equal_defn,axiom,
    ...
    @ ( mforall_di
      @ ^ [B: $i] :
          ( mforall_di
          @ ^ [C: $i] : ( mequiv @ ( not_equal @ B @ C ) @ ( mnot @ ( qmltpeq @ B @ C ) ) ) ) ) ) ).
...
thf(prove_th24,conjecture,
    ...
    @ ( mforall_di
      @ ^ [B: $i] :
          ...
          @ ^ [C: $i] :
              ( mforall_di
              @ ^ [D: $i] : ( mimplies @ ( mand @ ( member @ B @ C ) @ ( member @ B @ D ) ) @ ( not_equal @ ( intersection @ C @ D ) @ empty_set ) ) ) ) ) ) ).

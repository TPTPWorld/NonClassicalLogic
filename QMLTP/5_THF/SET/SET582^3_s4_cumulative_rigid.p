...
%%% Generated on Thu Apr 28 16:31:55 EDT 2022
...
thf(member_equal, axiom, (mlocal @ (mforall_di @ (^ [B:$i]: ((mforall_di @ (^ [C:$i]: (((mimplies @ (mforall_di @ (^ [D:$i]: (((mequiv @ ((member @ D) @ B)) @ ((member @ D) @ C)))))) @ ((qmltpeq @ B) @ C)))))))))).
...
thf(prove_th25, conjecture, (mlocal @ (mforall_di @ (^ [B:$i]: ((mforall_di @ (^ [C:$i]: ((mforall_di @ (^ [D:$i]: (((mimplies @ (mforall_di @ (^ [E:$i]: (((mequiv @ (mnot @ ((member @ E) @ B))) @ ((mequiv @ ((member @ E) @ C)) @ ((member @ E) @ D))))))) @ ((qmltpeq @ B) @ ((symmetric_difference @ C) @ D)))))))))))))).

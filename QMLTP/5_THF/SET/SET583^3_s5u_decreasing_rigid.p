...
%%% Generated on Fri May 06 13:30:19 EDT 2022
...
thf(prove_extensionality, conjecture, (mlocal @ (mforall_di @ (^ [B:$i]: ((mforall_di @ (^ [C:$i]: (((mimplies @ ((mand @ ((subset @ B) @ C)) @ ((subset @ C) @ B))) @ ((qmltpeq @ B) @ C)))))))))).

...
%%% Generated on Thu Apr 28 16:33:02 EDT 2022
...
thf(t41_zfmisc_1, conjecture, (mlocal @ (mforall_di @ (^ [A:$i]: ((mforall_di @ (^ [B:$i]: ((mnot @ ((mand @ (mnot @ ((qmltpeq @ A) @ (singleton @ B)))) @ ((mand @ (mnot @ ((qmltpeq @ A) @ empty_set))) @ (mforall_di @ (^ [C:$i]: ((mnot @ ((mand @ ((in @ C) @ A)) @ (mnot @ ((qmltpeq @ C) @ B)))))))))))))))))).
thf(l45_zfmisc_1, axiom, (mlocal @ (mforall_di @ (^ [A:$i]: ((mforall_di @ (^ [B:$i]: ((mnot @ ((mand @ (mnot @ ((qmltpeq @ A) @ (singleton @ B)))) @ ((mand @ (mnot @ ((qmltpeq @ A) @ empty_set))) @ (mforall_di @ (^ [C:$i]: ((mnot @ ((mand @ ((in @ C) @ A)) @ (mnot @ ((qmltpeq @ C) @ B)))))))))))))))))).

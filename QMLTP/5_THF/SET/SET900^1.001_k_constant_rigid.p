%------------------------------------------------------------------------------
% File     : SET900^1.001 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Set Theory
% Problem  : TPTP problem SET900+1.p with axiomatized equality
% Version  : [BP13] axioms.
% English  : 
...
thf(t41_zfmisc_1,conjecture,
    ...
    @ ( mforall_di
      @ ^ [A: $i] :
          ...
          @ ^ [B: $i] :
              ( mnot
              @ ( mand @ ( mnot @ ( qmltpeq @ A @ ( singleton @ B ) ) )
                @ ( mand @ ( mnot @ ( qmltpeq @ A @ empty_set ) )
                  @ ( mforall_di
                    @ ^ [C: $i] : ( mnot @ ( mand @ ( in @ C @ A ) @ ( mnot @ ( qmltpeq @ C @ B ) ) ) ) ) ) ) ) ) ) ) ).

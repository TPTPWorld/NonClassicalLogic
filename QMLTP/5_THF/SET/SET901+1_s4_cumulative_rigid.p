...
%%% Generated on Thu Apr 28 16:33:35 EDT 2022
...
thf(t42_zfmisc_1, conjecture, (mlocal @ (mforall_di @ (^ [A:$i]: ((mforall_di @ (^ [B:$i]: ((mforall_di @ (^ [C:$i]: (((mequiv @ ((subset @ A) @ ((unordered_pair @ B) @ C))) @ (mnot @ ((mand @ (mnot @ ((qmltpeq @ A) @ empty_set))) @ ((mand @ (mnot @ ((qmltpeq @ A) @ (singleton @ B)))) @ ((mand @ (mnot @ ((qmltpeq @ A) @ (singleton @ C)))) @ (mnot @ ((qmltpeq @ A) @ ((unordered_pair @ B) @ C))))))))))))))))))).
thf(l46_zfmisc_1, axiom, (mlocal @ (mforall_di @ (^ [A:$i]: ((mforall_di @ (^ [B:$i]: ((mforall_di @ (^ [C:$i]: (((mequiv @ ((subset @ A) @ ((unordered_pair @ B) @ C))) @ (mnot @ ((mand @ (mnot @ ((qmltpeq @ A) @ empty_set))) @ ((mand @ (mnot @ ((qmltpeq @ A) @ (singleton @ B)))) @ ((mand @ (mnot @ ((qmltpeq @ A) @ (singleton @ C)))) @ (mnot @ ((qmltpeq @ A) @ ((unordered_pair @ B) @ C))))))))))))))))))).

%------------------------------------------------------------------------------
% File     : SET902^1.018 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Set Theory
% Problem  : TPTP problem SET902+1.p with axiomatized equality
% Version  : [BP13] axioms.
% English  : 
...
%            Number of connectives :  271 (   1   ~;   1   |;   4   &; 260   @)
%                                         (   1 <=>;   4  =>;   0  <=;   0 <~>)
...
thf(l1_zfmisc_1,axiom,
    ( mlocal
    @ ( mforall_di
      @ ^ [A: $i] : ( mnot @ ( qmltpeq @ ( singleton @ A ) @ empty_set ) ) ) ) ).

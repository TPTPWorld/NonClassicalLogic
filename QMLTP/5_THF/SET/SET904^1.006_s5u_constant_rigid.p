%------------------------------------------------------------------------------
% File     : SET904^1.006 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Set Theory
% Problem  : TPTP problem SET904+1.p with axiomatized equality
% Version  : [BP13] axioms.
% English  : 
...
%            Number of variables   :   75 (  69   ^   4   !;   2   ?;  75   :)
% SPC      : TH0_THM_EQU_NAR
...
thf(t45_zfmisc_1,conjecture,
    ...
    @ ( mforall_di
      @ ^ [A: $i] :
          ( mforall_di
          @ ^ [B: $i] : ( mimplies @ ( subset @ ( set_union2 @ ( singleton @ A ) @ B ) @ B ) @ ( in @ A @ B ) ) ) ) ) ).

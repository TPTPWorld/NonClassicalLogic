%------------------------------------------------------------------------------
% File     : SET910^1.018 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Set Theory
% Problem  : TPTP problem SET910+1.p with axiomatized equality
% Version  : [BP13] axioms.
% English  : 
...
thf(t51_zfmisc_1,conjecture,
    ...
    @ ( mforall_di
      @ ^ [A: $i] :
          ( mforall_di
          @ ^ [B: $i] : ( mimplies @ ( qmltpeq @ ( set_intersection2 @ A @ ( singleton @ B ) ) @ ( singleton @ B ) ) @ ( in @ B @ A ) ) ) ) ) ).

...
%%% Generated on Thu Apr 28 16:38:01 EDT 2022
...
thf(t51_zfmisc_1, conjecture, (mlocal @ (mforall_di @ (^ [A:$i]: ((mforall_di @ (^ [B:$i]: (((mimplies @ ((qmltpeq @ ((set_intersection2 @ A) @ (singleton @ B))) @ (singleton @ B))) @ ((in @ B) @ A)))))))))).
thf(l30_zfmisc_1, axiom, (mlocal @ (mforall_di @ (^ [A:$i]: ((mforall_di @ (^ [B:$i]: (((mimplies @ ((qmltpeq @ ((set_intersection2 @ A) @ (singleton @ B))) @ (singleton @ B))) @ ((in @ B) @ A)))))))))).

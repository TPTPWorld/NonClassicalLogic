...
%%% Generated on Fri May 06 13:30:57 EDT 2022
...
thf(t52_zfmisc_1, conjecture, (mlocal @ (mforall_di @ (^ [A:$i]: ((mforall_di @ (^ [B:$i]: (((mimplies @ ((in @ A) @ B)) @ ((qmltpeq @ ((set_intersection2 @ B) @ (singleton @ A))) @ (singleton @ A))))))))))).

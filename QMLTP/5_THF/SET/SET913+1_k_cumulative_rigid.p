...
%%% Generated on Thu Apr 28 16:39:32 EDT 2022
...
thf(t54_zfmisc_1, conjecture, (mlocal @ (mforall_di @ (^ [A:$i]: ((mforall_di @ (^ [B:$i]: ((mnot @ ((mand @ ((disjoint @ (singleton @ A)) @ B)) @ ((in @ A) @ B))))))))))).
thf(l25_zfmisc_1, axiom, (mlocal @ (mforall_di @ (^ [A:$i]: ((mforall_di @ (^ [B:$i]: ((mnot @ ((mand @ ((disjoint @ (singleton @ A)) @ B)) @ ((in @ A) @ B))))))))))).

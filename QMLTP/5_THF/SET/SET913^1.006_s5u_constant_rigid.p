%------------------------------------------------------------------------------
% File     : SET913^1.006 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Set Theory
% Problem  : TPTP problem SET913+1.p with axiomatized equality
% Version  : [BP13] axioms.
% English  : 
...
%            Number of connectives :   77 (   1   ~;   1   |;   2   &;  70   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)
...
thf(t54_zfmisc_1,conjecture,
    ...
    @ ( mforall_di
      @ ^ [A: $i] :
          ( mforall_di
          @ ^ [B: $i] : ( mnot @ ( mand @ ( disjoint @ ( singleton @ A ) @ B ) @ ( in @ A @ B ) ) ) ) ) ) ).

...
%%% Generated on Thu Apr 28 16:44:52 EDT 2022
...
thf(t37_xboole_1, axiom, (mlocal @ (mforall_di @ (^ [A:$i]: ((mforall_di @ (^ [B:$i]: (((mequiv @ ((qmltpeq @ ((set_difference @ A) @ B)) @ empty_set)) @ ((subset @ A) @ B)))))))))).
thf(t66_zfmisc_1, conjecture, (mlocal @ (mforall_di @ (^ [A:$i]: ((mforall_di @ (^ [B:$i]: ((mnot @ ((mand @ ((qmltpeq @ ((set_difference @ A) @ (singleton @ B))) @ empty_set)) @ ((mand @ (mnot @ ((qmltpeq @ A) @ empty_set))) @ (mnot @ ((qmltpeq @ A) @ (singleton @ B)))))))))))))).

...
%%% Generated on Fri May 06 13:31:40 EDT 2022
...
thf(t67_zfmisc_1, conjecture, (mlocal @ (mforall_di @ (^ [A:$i]: ((mforall_di @ (^ [B:$i]: (((mequiv @ ((qmltpeq @ ((set_difference @ (singleton @ A)) @ B)) @ (singleton @ A))) @ (mnot @ ((in @ A) @ B))))))))))).

...
%%% Generated on Fri May 06 13:31:43 EDT 2022
...
thf(t68_zfmisc_1, conjecture, (mlocal @ (mforall_di @ (^ [A:$i]: ((mforall_di @ (^ [B:$i]: (((mequiv @ ((qmltpeq @ ((set_difference @ (singleton @ A)) @ B)) @ empty_set)) @ ((in @ A) @ B)))))))))).

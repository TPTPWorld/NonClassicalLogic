...
%%% Generated on Fri May 06 13:31:47 EDT 2022
...
thf(l34_zfmisc_1, axiom, (mlocal @ (mforall_di @ (^ [A:$i]: ((mforall_di @ (^ [B:$i]: (((mequiv @ ((qmltpeq @ ((set_difference @ (singleton @ A)) @ B)) @ (singleton @ A))) @ (mnot @ ((in @ A) @ B))))))))))).
thf(l36_zfmisc_1, axiom, (mlocal @ (mforall_di @ (^ [A:$i]: ((mforall_di @ (^ [B:$i]: (((mequiv @ ((qmltpeq @ ((set_difference @ (singleton @ A)) @ B)) @ empty_set)) @ ((in @ A) @ B)))))))))).
thf(rc1_xboole_0, axiom, (mlocal @ (mexists_di @ (^ [A:$i]: ((empty @ A)))))).
thf(rc2_xboole_0, axiom, (mlocal @ (mexists_di @ (^ [A:$i]: ((mnot @ (empty @ A))))))).
thf(t69_zfmisc_1, conjecture, (mlocal @ (mforall_di @ (^ [A:$i]: ((mforall_di @ (^ [B:$i]: (((mor @ ((qmltpeq @ ((set_difference @ (singleton @ A)) @ B)) @ empty_set)) @ ((qmltpeq @ ((set_difference @ (singleton @ A)) @ B)) @ (singleton @ A))))))))))).

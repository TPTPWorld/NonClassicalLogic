...
%%% Generated on Fri May 06 13:32:28 EDT 2022
...
thf(con, conjecture, (mlocal @ ((mimplies @ (mbox @ (mforall_di @ (^ [X:$i]: (((mimplies @ (f @ X)) @ (g @ X))))))) @ ((mimplies @ (mforall_di @ (^ [X:$i]: ((f @ X))))) @ (mforall_di @ (^ [X:$i]: ((g @ X)))))))).

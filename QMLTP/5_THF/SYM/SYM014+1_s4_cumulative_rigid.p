...
%%% Generated on Thu Apr 28 16:53:42 EDT 2022
...
thf(con, conjecture, (mlocal @ ((mimplies @ (mforall_di @ (^ [X:$i]: ((mbox @ ((mimplies @ (f @ X)) @ (g @ X))))))) @ (mbox @ ((mimplies @ (mforall_di @ (^ [X:$i]: ((f @ X))))) @ (mforall_di @ (^ [X:$i]: ((g @ X))))))))).

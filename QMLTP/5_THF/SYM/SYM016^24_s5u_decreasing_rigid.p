...
%%% Generated on Fri May 06 13:32:41 EDT 2022
...
thf(con, conjecture, (mlocal @ ((mimplies @ (mforall_di @ (^ [X:$i]: (((mor @ (mdia @ (f @ X))) @ (mdia @ (mnot @ (f @ X)))))))) @ (mbox @ ((mequiv @ (mbox @ (f @ a))) @ ((mor @ p) @ (mnot @ p))))))).

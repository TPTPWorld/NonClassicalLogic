...
%%% Generated on Fri May 06 13:32:45 EDT 2022
...
thf(con, conjecture, (mlocal @ ((mor @ (mforall_di @ (^ [X:$i]: (((mor @ (mbox @ (f @ X))) @ (mbox @ (mnot @ (f @ X)))))))) @ (mforall_di @ (^ [X:$i]: (((mand @ (mdia @ (f @ X))) @ (mdia @ (mnot @ (f @ X)))))))))).

...
%%% Generated on Thu Apr 28 16:56:08 EDT 2022
...
thf(con, conjecture, (mlocal @ ((mimplies @ ((mand @ (mforall_di @ (^ [X:$i]: (((mimplies @ (f @ X)) @ (mbox @ (g @ X))))))) @ (mforall_di @ (^ [X:$i]: (((mimplies @ (g @ X)) @ (mbox @ (h @ X)))))))) @ (mforall_di @ (^ [X:$i]: (((mimplies @ (f @ X)) @ (mbox @ (h @ X))))))))).

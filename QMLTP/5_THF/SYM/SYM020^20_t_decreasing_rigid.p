...
%%% Generated on Thu Apr 28 16:57:07 EDT 2022
...
thf(con, conjecture, (mlocal @ ((mequiv @ (mbox @ (mforall_di @ (^ [X:$i]: (((mimplies @ (g @ X)) @ (f @ X))))))) @ (mforall_di @ (^ [X:$i]: (((mimplies @ (mbox @ (g @ X))) @ (mdia @ (f @ X))))))))).

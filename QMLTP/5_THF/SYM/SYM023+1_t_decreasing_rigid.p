...
%%% Generated on Thu Apr 28 16:58:42 EDT 2022
...
thf(q_decl, type, q: ($i > (mworld > $o))).
thf(con, conjecture, (mlocal @ ((mimplies @ ((mand @ (mexists_di @ (^ [X:$i]: ((mdia @ (p @ X)))))) @ (mbox @ (mforall_di @ (^ [X:$i]: (((mimplies @ (p @ X)) @ (q @ X)))))))) @ (mexists_di @ (^ [X:$i]: ((mdia @ (q @ X)))))))).

...
%%% Generated on Thu Apr 28 16:59:31 EDT 2022
...
thf(con, conjecture, (mlocal @ ((mimplies @ ((mand @ (mdia @ (mexists_di @ (^ [X:$i]: ((p @ X)))))) @ (mdia @ (mexists_di @ (^ [X:$i]: ((q @ X))))))) @ (mexists_di @ (^ [X:$i]: ((mdia @ ((mand @ (p @ X)) @ (q @ X))))))))).

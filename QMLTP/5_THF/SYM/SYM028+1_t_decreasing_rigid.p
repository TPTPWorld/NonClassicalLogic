...
%%% Generated on Thu Apr 28 17:01:20 EDT 2022
...
thf(con, conjecture, (mlocal @ ((mimplies @ ((mand @ (mdia @ (mexists_di @ (^ [X:$i]: ((mbox @ (a @ X))))))) @ (mbox @ (mforall_di @ (^ [X:$i]: ((mdia @ (b @ X)))))))) @ (mdia @ (mexists_di @ (^ [X:$i]: ((mdia @ ((mand @ (a @ X)) @ (b @ X)))))))))).

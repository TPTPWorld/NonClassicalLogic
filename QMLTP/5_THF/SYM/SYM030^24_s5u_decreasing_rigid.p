...
%%% Generated on Fri May 06 13:33:28 EDT 2022
...
thf(con, conjecture, (mlocal @ ((mimplies @ (mforall_di @ (^ [X:$i]: ((mbox @ (mforall_di @ (^ [Y:$i]: (((r @ X) @ Y))))))))) @ (mforall_di @ (^ [X:$i]: ((mforall_di @ (^ [Y:$i]: ((mbox @ ((r @ X) @ Y))))))))))).

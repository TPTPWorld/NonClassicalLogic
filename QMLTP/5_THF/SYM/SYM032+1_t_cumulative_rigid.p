...
%%% Generated on Thu Apr 28 17:03:25 EDT 2022
...
thf(con, conjecture, (mlocal @ ((mimplies @ (mbox @ (mexists_di @ (^ [X:$i]: (((mor @ (mdia @ (f @ X))) @ (mdia @ (g @ X)))))))) @ (mbox @ (mexists_di @ (^ [X:$i]: ((mdia @ ((mor @ (f @ X)) @ (g @ X)))))))))).

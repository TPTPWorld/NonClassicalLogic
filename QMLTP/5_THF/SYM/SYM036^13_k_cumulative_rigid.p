...
%%% Generated on Thu Apr 28 17:05:13 EDT 2022
...
thf(con, conjecture, (mlocal @ ((mequiv @ ((mimplies @ (mbox @ (mforall_di @ (^ [X:$i]: ((f @ X)))))) @ (mforall_di @ (^ [X:$i]: ((mbox @ (f @ X))))))) @ ((mimplies @ (mexists_di @ (^ [X:$i]: ((mdia @ (f @ X)))))) @ (mdia @ (mexists_di @ (^ [X:$i]: ((f @ X))))))))).

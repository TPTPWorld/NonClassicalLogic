...
%%% Generated on Fri May 06 13:33:52 EDT 2022
...
thf(con, conjecture, (mlocal @ ((mequiv @ ((mimplies @ (mforall_di @ (^ [X:$i]: ((mbox @ (f @ X)))))) @ (mbox @ (mforall_di @ (^ [X:$i]: ((f @ X))))))) @ ((mimplies @ (mdia @ (mexists_di @ (^ [X:$i]: ((f @ X)))))) @ (mexists_di @ (^ [X:$i]: ((mdia @ (f @ X))))))))).

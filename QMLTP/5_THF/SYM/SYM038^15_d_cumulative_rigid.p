...
%%% Generated on Thu Apr 28 17:06:10 EDT 2022
...
thf(con, conjecture, (mlocal @ ((mimplies @ ((mand @ (mforall_di @ (^ [X:$i]: ((mbox @ (mexists_di @ (^ [Y:$i]: (((mimplies @ (f @ X)) @ (g @ Y)))))))))) @ ((mand @ (mforall_di @ (^ [X:$i]: ((mbox @ (mexists_di @ (^ [Y:$i]: (((mimplies @ (mnot @ (f @ X))) @ (g @ Y)))))))))) @ (mexists_di @ (^ [X:$i]: ((h @ X))))))) @ (mbox @ (mexists_di @ (^ [X:$i]: ((g @ X)))))))).

...
%%% Generated on Thu Apr 28 17:07:52 EDT 2022
...
thf(m_decl, type, m: ($i > (mworld > $o))).
thf(con, conjecture, (mlocal @ (mnot @ ((mimplies @ (mforall_di @ (^ [X:$i]: (((mimplies @ (m @ X)) @ (mbox @ ((mimplies @ (e @ X)) @ (m @ X)))))))) @ (mforall_di @ (^ [X:$i]: ((mbox @ ((mimplies @ (e @ X)) @ (m @ X)))))))))).

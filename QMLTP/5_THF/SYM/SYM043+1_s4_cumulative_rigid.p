...
%%% Generated on Thu Apr 28 17:09:02 EDT 2022
...
thf(con, conjecture, (mlocal @ ((mimplies @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ (e @ X))))))) @ ((mequiv @ (mdia @ (mexists_di @ (^ [X:$i]: ((f @ X)))))) @ (mexists_di @ (^ [X:$i]: ((mdia @ (f @ X))))))))).

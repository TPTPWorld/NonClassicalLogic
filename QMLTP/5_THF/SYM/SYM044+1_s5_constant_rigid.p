...
%%% Generated on Thu Apr 28 17:09:39 EDT 2022
...
thf(con, conjecture, (mlocal @ ((mimplies @ (mdia @ (mexists_di @ (^ [X:$i]: ((mbox @ ((mand @ (e @ X)) @ (mforall_di @ (^ [Y:$i]: (((r @ X) @ Y))))))))))) @ (mbox @ (mforall_di @ (^ [Y:$i]: ((mexists_di @ (^ [X:$i]: (((r @ X) @ Y))))))))))).

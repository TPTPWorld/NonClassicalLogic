...
%%% Generated on Fri May 06 13:34:22 EDT 2022
...
thf(con, conjecture, (mlocal @ ((mimplies @ (mforall_di @ (^ [X:$i]: ((mbox @ (e @ X)))))) @ ((mimplies @ (mexists_di @ (^ [X:$i]: ((mdia @ (f @ X)))))) @ (mdia @ (mexists_di @ (^ [X:$i]: ((f @ X))))))))).

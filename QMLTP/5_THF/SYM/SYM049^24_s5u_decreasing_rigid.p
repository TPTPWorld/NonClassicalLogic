...
%%% Generated on Fri May 06 13:34:33 EDT 2022
...
thf(con, conjecture, (mlocal @ ((mimplies @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ (e @ X))))))) @ ((mequiv @ (mbox @ (mforall_di @ (^ [X:$i]: ((f @ X)))))) @ (mforall_di @ (^ [X:$i]: ((mbox @ (f @ X))))))))).

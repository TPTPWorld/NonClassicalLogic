...
%%% Generated on Thu Apr 28 17:12:45 EDT 2022
...
thf(con, conjecture, (mlocal @ ((mimplies @ (mdia @ (mforall_di @ (^ [X:$i]: ((mbox @ (e @ X))))))) @ (mdia @ ((mimplies @ (mbox @ (mforall_di @ (^ [X:$i]: ((f @ X)))))) @ (mforall_di @ (^ [X:$i]: ((mbox @ (f @ X)))))))))).

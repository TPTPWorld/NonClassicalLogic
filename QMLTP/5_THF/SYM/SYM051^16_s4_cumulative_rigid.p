...
%%% Generated on Thu Apr 28 17:13:16 EDT 2022
...
thf(con, conjecture, (mlocal @ ((mimplies @ (mdia @ (mexists_di @ (^ [X:$i]: ((mbox @ ((mimplies @ a) @ (mnot @ (e @ X))))))))) @ ((mimplies @ (mdia @ a)) @ (mnot @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ (e @ X))))))))))).

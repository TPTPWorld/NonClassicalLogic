...
%%% Generated on Fri May 06 13:34:46 EDT 2022
...
thf(con, conjecture, (mlocal @ ((mimplies @ ((mand @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ (e @ X))))))) @ ((mand @ a) @ (mdia @ (mforall_di @ (^ [X:$i]: (((mimplies @ (f @ X)) @ (mbox @ ((mimplies @ a) @ (mnot @ (f @ X)))))))))))) @ (mbox @ (mexists_di @ (^ [X:$i]: ((mdia @ (mnot @ (f @ X)))))))))).

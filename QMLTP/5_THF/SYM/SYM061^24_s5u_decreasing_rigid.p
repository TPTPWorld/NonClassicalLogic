...
%%% Generated on Fri May 06 13:35:13 EDT 2022
...
thf(con, conjecture, (mlocal @ ((mimplies @ (mbox @ (mforall_di @ (^ [X:$i]: (((mimplies @ (f @ X)) @ (g @ X))))))) @ (mbox @ (mforall_di @ (^ [X:$i]: (((mimplies @ (f @ X)) @ (mbox @ (g @ X)))))))))).

...
%%% Generated on Fri May 06 13:35:20 EDT 2022
...
thf(con, conjecture, (mlocal @ ((mimplies @ ((mimplies @ (mbox @ (mforall_di @ (^ [Y:$i]: (((mimplies @ (mforall_di @ (^ [X:$i]: ((mbox @ (a @ X)))))) @ (mbox @ (a @ Y)))))))) @ (mforall_di @ (^ [Y:$i]: (((mimplies @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ (a @ X))))))) @ (mbox @ (a @ Y)))))))) @ ((mimplies @ (mforall_di @ (^ [X:$i]: ((mbox @ (a @ X)))))) @ (mbox @ (mforall_di @ (^ [X:$i]: ((a @ X))))))))).

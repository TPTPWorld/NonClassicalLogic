...
%%% Generated on Thu Apr 28 17:20:12 EDT 2022
...
thf(con, conjecture, (mlocal @ ((mimplies @ ((mimplies @ (mdia @ (mexists_di @ (^ [X:$i]: ((mexists_di @ (^ [Y:$i]: (((qmltpeq @ X) @ Y))))))))) @ (mexists_di @ (^ [X:$i]: ((mexists_di @ (^ [Y:$i]: ((mdia @ ((qmltpeq @ X) @ Y)))))))))) @ ((mimplies @ (mexists_di @ (^ [X:$i]: ((mdia @ (p @ X)))))) @ (mdia @ (mexists_di @ (^ [X:$i]: ((p @ X))))))))).

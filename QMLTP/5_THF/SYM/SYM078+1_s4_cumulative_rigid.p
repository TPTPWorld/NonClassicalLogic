...
%%% Generated on Thu Apr 28 17:27:37 EDT 2022
...
thf(con, conjecture, (mlocal @ ((mimplies @ (mbox @ (mforall_di @ (^ [X:$i]: (((mimplies @ (f @ X)) @ (g @ X))))))) @ (mforall_di @ (^ [X:$i]: ((mbox @ ((mimplies @ (f @ X)) @ (mbox @ (mforall_di @ (^ [X:$i]: ((g @ X))))))))))))).

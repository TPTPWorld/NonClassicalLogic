...
%%% Generated on Thu Apr 28 17:28:02 EDT 2022
...
thf(con, conjecture, (mlocal @ ((mimplies @ (mbox @ (mforall_di @ (^ [X:$i]: (((mor @ (f @ X)) @ (g @ X))))))) @ ((mor @ (mforall_di @ (^ [X:$i]: ((mbox @ (f @ X)))))) @ (mbox @ (mforall_di @ (^ [X:$i]: ((g @ X))))))))).

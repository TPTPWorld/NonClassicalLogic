...
%%% Generated on Thu Apr 28 17:28:41 EDT 2022
...
thf(con, conjecture, (mlocal @ ((mimplies @ (mexists_di @ (^ [X:$i]: ((mbox @ ((mor @ (f @ X)) @ (g @ X))))))) @ (mbox @ ((mor @ (mforall_di @ (^ [X:$i]: ((f @ X))))) @ (mexists_di @ (^ [X:$i]: ((g @ X))))))))).

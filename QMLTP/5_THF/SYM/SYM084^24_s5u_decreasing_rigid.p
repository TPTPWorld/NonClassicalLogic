...
%%% Generated on Fri May 06 13:36:31 EDT 2022
...
thf(con, conjecture, (mlocal @ ((mimplies @ ((mand @ (mbox @ (mforall_di @ (^ [X:$i]: (((mimplies @ (f @ X)) @ (mbox @ (f @ X)))))))) @ (mdia @ (mexists_di @ (^ [X:$i]: ((f @ X))))))) @ (mbox @ (mexists_di @ (^ [X:$i]: ((f @ X)))))))).

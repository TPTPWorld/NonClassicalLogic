...
%%% Generated on Fri May 06 13:36:35 EDT 2022
...
thf(n_decl, type, n: ($i > (mworld > $o))).
thf(o_decl, type, o: ($i > (mworld > $o))).
...
thf(n_substitution_1, axiom, (mlocal @ (mforall_di @ (^ [A:$i]: ((mforall_di @ (^ [B:$i]: (((mimplies @ ((mand @ ((qmltpeq @ A) @ B)) @ (n @ A))) @ (n @ B)))))))))).
thf(o_substitution_1, axiom, (mlocal @ (mforall_di @ (^ [A:$i]: ((mforall_di @ (^ [B:$i]: (((mimplies @ ((mand @ ((qmltpeq @ A) @ B)) @ (o @ A))) @ (o @ B)))))))))).
thf(con, conjecture, (mlocal @ ((mimplies @ (mexists_di @ (^ [X:$i]: (((mand @ (n @ X)) @ ((mand @ (mforall_di @ (^ [Y:$i]: (((mimplies @ (n @ Y)) @ ((qmltpeq @ Y) @ X)))))) @ (mbox @ (o @ X)))))))) @ (mbox @ (mexists_di @ (^ [X:$i]: (((mand @ (n @ X)) @ ((mand @ (mforall_di @ (^ [Y:$i]: (((mimplies @ (n @ Y)) @ ((qmltpeq @ Y) @ X)))))) @ (o @ X)))))))))).

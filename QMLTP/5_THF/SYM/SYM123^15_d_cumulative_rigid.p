...
%%% Generated on Thu Apr 28 17:43:15 EDT 2022
...
thf(con, conjecture, (mlocal @ ((mimplies @ (mdia @ ((mimplies @ p) @ ((mand @ q) @ r)))) @ ((mand @ ((mimplies @ (mbox @ p)) @ (mdia @ q))) @ ((mimplies @ (mbox @ p)) @ (mdia @ r)))))).

...
%%% Generated on Fri May 06 13:09:27 EDT 2022
...
thf(law1, axiom, (mlocal @ (mbox @ ((mimplies @ ((mand @ (dest @ paris)) @ (class @ first))) @ (price @ ninetyfive))))).
thf(law2, axiom, (mlocal @ (mbox @ ((mimplies @ ((mand @ (dest @ paris)) @ (class @ second))) @ (price @ seventy))))).
thf(law3, axiom, (mlocal @ (mbox @ (mnot @ ((mand @ (class @ first)) @ (class @ second)))))).
thf(law4, axiom, (mlocal @ (mbox @ (mnot @ ((mand @ (price @ ninetyfive)) @ (price @ seventy)))))).
thf(belief1, axiom, (mlocal @ (mbox @ (dest @ paris)))).
thf(belief2, axiom, (mlocal @ (mbox @ (class @ second)))).
thf(con, conjecture, (mlocal @ (mbox @ (price @ seventy)))).

...
%%% Generated on Fri May 06 13:09:48 EDT 2022
...
thf(ann_decl, type, ann: $i).
thf(mary_decl, type, mary: $i).
thf(bob_decl, type, bob: $i).
thf(john_decl, type, john: $i).
thf(paul_decl, type, paul: $i).
thf(jane_decl, type, jane: $i).
thf(qmltpeq_decl, type, qmltpeq: ($i > ($i > (mworld > $o)))).
thf(parent_decl, type, parent: ($i > ($i > (mworld > $o)))).
thf(q3_decl, type, q3: ($i > (mworld > $o))).
...
thf(q3_substitution_1, axiom, (mlocal @ (mforall_di @ (^ [A:$i]: ((mforall_di @ (^ [B:$i]: (((mimplies @ ((mand @ ((qmltpeq @ A) @ B)) @ (q3 @ A))) @ (q3 @ B)))))))))).
thf(parent_substitution_1, axiom, (mlocal @ (mforall_di @ (^ [A:$i]: ((mforall_di @ (^ [B:$i]: ((mforall_di @ (^ [C:$i]: (((mimplies @ ((mand @ ((qmltpeq @ A) @ B)) @ ((parent @ A) @ C))) @ ((parent @ B) @ C))))))))))))).
thf(parent_substitution_2, axiom, (mlocal @ (mforall_di @ (^ [A:$i]: ((mforall_di @ (^ [B:$i]: ((mforall_di @ (^ [C:$i]: (((mimplies @ ((mand @ ((qmltpeq @ A) @ B)) @ ((parent @ C) @ A))) @ ((parent @ C) @ B))))))))))))).
thf(abox, axiom, (mlocal @ (mbox @ ((mand @ (female @ mary)) @ ((mand @ (female @ ann)) @ ((mand @ (female @ jane)) @ ((mand @ (male @ bob)) @ ((mand @ (male @ john)) @ ((mand @ (male @ paul)) @ ((mand @ ((parent @ bob) @ mary)) @ ((mand @ ((parent @ bob) @ ann)) @ ((mand @ ((parent @ john) @ paul)) @ ((parent @ mary) @ jane))))))))))))).
thf(tbox, axiom, (mlocal @ (mforall_di @ (^ [X:$i]: (((mimplies @ (mbox @ (male @ X))) @ (mbox @ (mnot @ (female @ X))))))))).
thf(query, axiom, (mlocal @ (mforall_di @ (^ [X:$i]: (((mequiv @ (q3 @ X)) @ (mexists_di @ (^ [Y:$i]: (((mand @ (mbox @ ((parent @ Y) @ X))) @ (mforall_di @ (^ [Z:$i]: (((mimplies @ (mbox @ ((parent @ Y) @ Z))) @ ((qmltpeq @ Z) @ X))))))))))))))).
thf(con, conjecture, (mlocal @ ((mand @ (q3 @ jane)) @ (q3 @ paul)))).

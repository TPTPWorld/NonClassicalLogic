...
%%% Generated on Fri May 06 13:10:24 EDT 2022
...
thf(ax3, axiom, (mlocal @ (mbox @ (mnot @ (mexists_di @ (^ [U:$i]: (((mand @ (mbox @ (sorti1 @ U))) @ (mbox @ (mforall_di @ (^ [V:$i]: ((mbox @ ((mimplies @ (mbox @ (sorti1 @ V))) @ (mbox @ ((qmltpeq @ ((op1 @ V) @ V)) @ U)))))))))))))))).
thf(ax4, axiom, (mlocal @ (mbox @ (mnot @ (mbox @ (mnot @ (mexists_di @ (^ [U:$i]: (((mand @ (mbox @ (sorti2 @ U))) @ (mbox @ (mforall_di @ (^ [V:$i]: ((mbox @ ((mimplies @ (mbox @ (sorti2 @ V))) @ (mbox @ ((qmltpeq @ ((op2 @ V) @ V)) @ U)))))))))))))))))).

...
%%% Generated on Fri May 06 13:13:16 EDT 2022
...
thf(prove_subset_difference, conjecture, (mlocal @ (mbox @ (mforall_di @ (^ [B:$i]: ((mbox @ (mforall_di @ (^ [C:$i]: ((mbox @ (mforall_di @ (^ [D:$i]: ((mbox @ ((mimplies @ (mbox @ ((subset @ B) @ C))) @ (mbox @ ((subset @ ((difference @ D) @ C)) @ ((difference @ D) @ B))))))))))))))))))).

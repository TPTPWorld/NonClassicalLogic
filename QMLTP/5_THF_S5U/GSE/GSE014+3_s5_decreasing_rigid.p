...
%%% Generated on Fri May 06 13:13:35 EDT 2022
...
thf(prove_union_subset, conjecture, (mlocal @ (mbox @ (mforall_di @ (^ [B:$i]: ((mbox @ (mforall_di @ (^ [C:$i]: ((mbox @ (mforall_di @ (^ [D:$i]: ((mbox @ ((mimplies @ ((mand @ (mbox @ ((subset @ B) @ C))) @ (mbox @ ((subset @ D) @ C)))) @ (mbox @ ((subset @ ((union @ B) @ D)) @ C)))))))))))))))))).

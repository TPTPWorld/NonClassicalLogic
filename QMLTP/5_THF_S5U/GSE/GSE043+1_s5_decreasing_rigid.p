...
%%% Generated on Fri May 06 13:14:35 EDT 2022
...
thf(pel39, conjecture, (mlocal @ (mbox @ (mnot @ (mexists_di @ (^ [X:$i]: ((mbox @ (mforall_di @ (^ [Y:$i]: (((mand @ (mbox @ ((mimplies @ (mbox @ ((element @ Y) @ X))) @ (mbox @ (mnot @ (mbox @ ((element @ Y) @ Y))))))) @ (mbox @ ((mimplies @ (mbox @ (mnot @ (mbox @ ((element @ Y) @ Y))))) @ (mbox @ ((element @ Y) @ X)))))))))))))))).

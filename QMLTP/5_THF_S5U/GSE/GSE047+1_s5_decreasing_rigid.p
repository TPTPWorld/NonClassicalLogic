...
%%% Generated on Fri May 06 13:14:49 EDT 2022
...
thf(set_equal_decl, type, set_equal: ($i > ($i > (mworld > $o)))).
thf(element_decl, type, element: ($i > ($i > (mworld > $o)))).
thf(pel43_1, axiom, (mlocal @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ (mforall_di @ (^ [Y:$i]: (((mand @ (mbox @ ((mimplies @ (mbox @ ((set_equal @ X) @ Y))) @ (mbox @ (mforall_di @ (^ [Z:$i]: (((mand @ (mbox @ ((mimplies @ (mbox @ ((element @ Z) @ X))) @ (mbox @ ((element @ Z) @ Y))))) @ (mbox @ ((mimplies @ (mbox @ ((element @ Z) @ Y))) @ (mbox @ ((element @ Z) @ X)))))))))))) @ (mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [Z:$i]: (((mand @ (mbox @ ((mimplies @ (mbox @ ((element @ Z) @ X))) @ (mbox @ ((element @ Z) @ Y))))) @ (mbox @ ((mimplies @ (mbox @ ((element @ Z) @ Y))) @ (mbox @ ((element @ Z) @ X)))))))))) @ (mbox @ ((set_equal @ X) @ Y))))))))))))))).
thf(pel43, conjecture, (mlocal @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ (mforall_di @ (^ [Y:$i]: (((mand @ (mbox @ ((mimplies @ (mbox @ ((set_equal @ X) @ Y))) @ (mbox @ ((set_equal @ Y) @ X))))) @ (mbox @ ((mimplies @ (mbox @ ((set_equal @ Y) @ X))) @ (mbox @ ((set_equal @ X) @ Y))))))))))))))).

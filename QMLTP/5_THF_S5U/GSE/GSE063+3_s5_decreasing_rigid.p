...
%%% Generated on Fri May 06 13:15:29 EDT 2022
...
thf(empty_set_subset, axiom, (mlocal @ (mbox @ (mforall_di @ (^ [B:$i]: ((mbox @ ((subset @ empty_set) @ B)))))))).
...
thf(prove_subset_of_empty_set_is_empty_set, conjecture, (mlocal @ (mbox @ (mforall_di @ (^ [B:$i]: ((mbox @ ((mimplies @ (mbox @ ((subset @ B) @ empty_set))) @ (mbox @ ((qmltpeq @ B) @ empty_set)))))))))).

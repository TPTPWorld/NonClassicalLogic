...
%%% Generated on Fri May 06 13:15:37 EDT 2022
...
thf(prove_th12, conjecture, (mlocal @ (mbox @ (mforall_di @ (^ [B:$i]: ((mbox @ (mforall_di @ (^ [C:$i]: ((mbox @ (mforall_di @ (^ [D:$i]: ((mbox @ ((mimplies @ ((mand @ (mbox @ ((member @ B) @ C))) @ (mbox @ ((disjoint @ C) @ D)))) @ (mbox @ (mnot @ (mbox @ ((member @ B) @ D)))))))))))))))))))).

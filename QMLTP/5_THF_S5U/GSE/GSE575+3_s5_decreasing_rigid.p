...
%%% Generated on Fri May 06 13:15:43 EDT 2022
...
thf(prove_th15, conjecture, (mlocal @ (mbox @ (mforall_di @ (^ [B:$i]: ((mbox @ (mforall_di @ (^ [C:$i]: ((mbox @ ((mimplies @ (mbox @ ((intersect @ B) @ C))) @ (mexists_di @ (^ [D:$i]: (((mand @ (mbox @ ((member @ D) @ B))) @ (mbox @ ((member @ D) @ C)))))))))))))))))).

...
%%% Generated on Fri May 06 13:16:09 EDT 2022
...
thf(member_equal, axiom, (mlocal @ (mbox @ (mforall_di @ (^ [B:$i]: ((mbox @ (mforall_di @ (^ [C:$i]: ((mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [D:$i]: (((mand @ (mbox @ ((mimplies @ (mbox @ ((member @ D) @ B))) @ (mbox @ ((member @ D) @ C))))) @ (mbox @ ((mimplies @ (mbox @ ((member @ D) @ C))) @ (mbox @ ((member @ D) @ B)))))))))) @ (mbox @ ((qmltpeq @ B) @ C)))))))))))))).
...
thf(prove_th25, conjecture, (mlocal @ (mbox @ (mforall_di @ (^ [B:$i]: ((mbox @ (mforall_di @ (^ [C:$i]: ((mbox @ (mforall_di @ (^ [D:$i]: ((mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [E:$i]: (((mand @ (mbox @ ((mimplies @ (mbox @ (mnot @ (mbox @ ((member @ E) @ B))))) @ ((mand @ (mbox @ ((mimplies @ (mbox @ ((member @ E) @ C))) @ (mbox @ ((member @ E) @ D))))) @ (mbox @ ((mimplies @ (mbox @ ((member @ E) @ D))) @ (mbox @ ((member @ E) @ C)))))))) @ (mbox @ ((mimplies @ ((mand @ (mbox @ ((mimplies @ (mbox @ ((member @ E) @ C))) @ (mbox @ ((member @ E) @ D))))) @ (mbox @ ((mimplies @ (mbox @ ((member @ E) @ D))) @ (mbox @ ((member @ E) @ C)))))) @ (mbox @ (mnot @ (mbox @ ((member @ E) @ B)))))))))))) @ (mbox @ ((qmltpeq @ B) @ ((symmetric_difference @ C) @ D))))))))))))))))))).

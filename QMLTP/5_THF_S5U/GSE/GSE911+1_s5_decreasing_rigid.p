...
%%% Generated on Fri May 06 13:16:52 EDT 2022
...
thf(t52_zfmisc_1, conjecture, (mlocal @ (mbox @ (mforall_di @ (^ [A:$i]: ((mbox @ (mforall_di @ (^ [B:$i]: ((mbox @ ((mimplies @ (mbox @ ((in @ A) @ B))) @ (mbox @ ((qmltpeq @ ((set_intersection2 @ B) @ (singleton @ A))) @ (singleton @ A))))))))))))))).

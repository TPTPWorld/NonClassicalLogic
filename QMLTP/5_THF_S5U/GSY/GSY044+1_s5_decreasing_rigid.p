...
%%% Generated on Fri May 06 13:21:50 EDT 2022
...
thf(r_decl, type, r: (mworld > $o)).
thf(pel10_1, axiom, (mlocal @ (mbox @ ((mimplies @ (mbox @ q)) @ (mbox @ r))))).
thf(pel10_2, axiom, (mlocal @ (mbox @ ((mimplies @ (mbox @ r)) @ ((mand @ (mbox @ p)) @ (mbox @ q)))))).
thf(pel10_3, axiom, (mlocal @ (mbox @ ((mimplies @ (mbox @ p)) @ ((mor @ (mbox @ q)) @ (mbox @ r)))))).
thf(pel10, conjecture, (mlocal @ ((mand @ (mbox @ ((mimplies @ (mbox @ p)) @ (mbox @ q)))) @ (mbox @ ((mimplies @ (mbox @ q)) @ (mbox @ p)))))).

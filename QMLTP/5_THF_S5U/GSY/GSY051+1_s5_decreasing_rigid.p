...
%%% Generated on Fri May 06 13:22:14 EDT 2022
...
thf(big_f_decl, type, big_f: ($i > (mworld > $o))).
thf(pel21_1, axiom, (mlocal @ (mexists_di @ (^ [X:$i]: ((mbox @ ((mimplies @ (mbox @ p)) @ (mbox @ (big_f @ X))))))))).
thf(pel21_2, axiom, (mlocal @ (mexists_di @ (^ [X:$i]: ((mbox @ ((mimplies @ (mbox @ (big_f @ X))) @ (mbox @ p)))))))).
thf(pel21, conjecture, (mlocal @ (mexists_di @ (^ [X:$i]: (((mand @ (mbox @ ((mimplies @ (mbox @ p)) @ (mbox @ (big_f @ X))))) @ (mbox @ ((mimplies @ (mbox @ (big_f @ X))) @ (mbox @ p))))))))).

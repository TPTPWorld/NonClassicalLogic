...
%%% Generated on Fri May 06 13:22:21 EDT 2022
...
thf(x2106, conjecture, (mlocal @ (mbox @ ((mimplies @ ((mand @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ ((mimplies @ (mbox @ (big_r @ X))) @ (mbox @ (big_p @ X))))))))) @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ ((mimplies @ (mbox @ (mnot @ (mbox @ (big_q @ X))))) @ (mbox @ (big_r @ X)))))))))) @ (mbox @ (mforall_di @ (^ [X:$i]: (((mor @ (mbox @ (big_p @ X))) @ (mbox @ (big_q @ X))))))))))).

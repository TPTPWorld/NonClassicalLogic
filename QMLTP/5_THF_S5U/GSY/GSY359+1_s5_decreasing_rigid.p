...
%%% Generated on Fri May 06 13:22:35 EDT 2022
...
thf(x2110, conjecture, (mlocal @ (mbox @ ((mimplies @ ((mand @ (mexists_di @ (^ [X:$i]: ((mbox @ (big_r @ X)))))) @ ((mand @ (mbox @ (mforall_di @ (^ [Y:$i]: ((mbox @ ((mimplies @ (mbox @ (big_r @ Y))) @ (mexists_di @ (^ [Z:$i]: ((mbox @ ((big_q @ Y) @ Z)))))))))))) @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ (mforall_di @ (^ [Y:$i]: ((mbox @ ((mimplies @ (mbox @ ((big_q @ X) @ Y))) @ (mbox @ ((big_q @ X) @ X))))))))))))))) @ (mexists_di @ (^ [X:$i]: ((mexists_di @ (^ [Y:$i]: (((mand @ (mbox @ ((big_q @ X) @ Y))) @ (mbox @ (big_r @ Y))))))))))))).

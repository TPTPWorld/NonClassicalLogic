...
%%% Generated on Fri May 06 13:22:59 EDT 2022
...
thf(x2117, conjecture, (mlocal @ (mbox @ ((mimplies @ ((mand @ (mbox @ (mforall_di @ (^ [U:$i]: ((mbox @ (mforall_di @ (^ [V:$i]: (((mand @ (mbox @ ((mimplies @ (mbox @ ((big_r @ U) @ U))) @ (mbox @ ((big_r @ U) @ V))))) @ (mbox @ ((mimplies @ (mbox @ ((big_r @ U) @ V))) @ (mbox @ ((big_r @ U) @ U)))))))))))))) @ (mbox @ (mforall_di @ (^ [W:$i]: ((mbox @ (mforall_di @ (^ [Z:$i]: (((mand @ (mbox @ ((mimplies @ (mbox @ ((big_r @ W) @ W))) @ (mbox @ ((big_r @ Z) @ W))))) @ (mbox @ ((mimplies @ (mbox @ ((big_r @ Z) @ W))) @ (mbox @ ((big_r @ W) @ W))))))))))))))) @ (mbox @ ((mimplies @ (mexists_di @ (^ [X:$i]: ((mbox @ ((big_r @ X) @ X)))))) @ (mbox @ (mforall_di @ (^ [Y:$i]: ((mbox @ ((big_r @ Y) @ Y)))))))))))).

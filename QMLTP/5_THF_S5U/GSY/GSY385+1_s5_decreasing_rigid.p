...
%%% Generated on Fri May 06 13:24:03 EDT 2022
...
thf(x2137, conjecture, (mlocal @ (mexists_di @ (^ [X:$i]: ((mbox @ (mforall_di @ (^ [Y:$i]: ((mbox @ ((mimplies @ (mbox @ (big_p @ X))) @ ((mor @ (mbox @ (big_q @ X))) @ (mbox @ (big_p @ Y)))))))))))))).

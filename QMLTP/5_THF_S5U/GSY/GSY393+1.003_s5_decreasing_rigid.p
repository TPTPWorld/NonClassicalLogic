...
%%% Generated on Fri May 06 13:24:30 EDT 2022
...
thf(p3_decl, type, p3: (mworld > $o)).
thf(pel12, conjecture, (mlocal @ ((mand @ (mbox @ ((mimplies @ ((mand @ (mbox @ ((mimplies @ ((mand @ (mbox @ ((mimplies @ (mbox @ p1)) @ (mbox @ p2)))) @ (mbox @ ((mimplies @ (mbox @ p2)) @ (mbox @ p1))))) @ (mbox @ p3)))) @ (mbox @ ((mimplies @ (mbox @ p3)) @ ((mand @ (mbox @ ((mimplies @ (mbox @ p1)) @ (mbox @ p2)))) @ (mbox @ ((mimplies @ (mbox @ p2)) @ (mbox @ p1)))))))) @ ((mand @ (mbox @ ((mimplies @ (mbox @ p1)) @ ((mand @ (mbox @ ((mimplies @ (mbox @ p2)) @ (mbox @ p3)))) @ (mbox @ ((mimplies @ (mbox @ p3)) @ (mbox @ p2))))))) @ (mbox @ ((mimplies @ ((mand @ (mbox @ ((mimplies @ (mbox @ p2)) @ (mbox @ p3)))) @ (mbox @ ((mimplies @ (mbox @ p3)) @ (mbox @ p2))))) @ (mbox @ p1))))))) @ (mbox @ ((mimplies @ ((mand @ (mbox @ ((mimplies @ (mbox @ p1)) @ ((mand @ (mbox @ ((mimplies @ (mbox @ p2)) @ (mbox @ p3)))) @ (mbox @ ((mimplies @ (mbox @ p3)) @ (mbox @ p2))))))) @ (mbox @ ((mimplies @ ((mand @ (mbox @ ((mimplies @ (mbox @ p2)) @ (mbox @ p3)))) @ (mbox @ ((mimplies @ (mbox @ p3)) @ (mbox @ p2))))) @ (mbox @ p1))))) @ ((mand @ (mbox @ ((mimplies @ ((mand @ (mbox @ ((mimplies @ (mbox @ p1)) @ (mbox @ p2)))) @ (mbox @ ((mimplies @ (mbox @ p2)) @ (mbox @ p1))))) @ (mbox @ p3)))) @ (mbox @ ((mimplies @ (mbox @ p3)) @ ((mand @ (mbox @ ((mimplies @ (mbox @ p1)) @ (mbox @ p2)))) @ (mbox @ ((mimplies @ (mbox @ p2)) @ (mbox @ p1)))))))))))).

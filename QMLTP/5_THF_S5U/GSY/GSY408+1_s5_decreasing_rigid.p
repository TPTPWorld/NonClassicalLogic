...
%%% Generated on Fri May 06 13:25:21 EDT 2022
...
thf(kalish244, conjecture, (mlocal @ (mbox @ ((mimplies @ (mbox @ (mnot @ (mexists_di @ (^ [X:$i]: ((mbox @ (f @ X)))))))) @ (mbox @ (mforall_di @ (^ [Y:$i]: ((mbox @ ((mimplies @ (mbox @ (f @ Y))) @ (mbox @ (g @ Y)))))))))))).

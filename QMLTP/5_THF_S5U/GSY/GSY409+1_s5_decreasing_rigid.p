...
%%% Generated on Fri May 06 13:25:24 EDT 2022
...
thf(kalish246, conjecture, (mlocal @ ((mand @ (mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ (f @ X))))))) @ (mbox @ (mforall_di @ (^ [Y:$i]: ((mbox @ (mforall_di @ (^ [Z:$i]: (((mand @ (mbox @ (f @ Y))) @ (mbox @ (f @ Z)))))))))))))) @ (mbox @ ((mimplies @ (mbox @ (mforall_di @ (^ [Y:$i]: ((mbox @ (mforall_di @ (^ [Z:$i]: (((mand @ (mbox @ (f @ Y))) @ (mbox @ (f @ Z)))))))))))) @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ (f @ X))))))))))).

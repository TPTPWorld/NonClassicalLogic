...
%%% Generated on Fri May 06 13:25:34 EDT 2022
...
thf(kalish255, conjecture, (mlocal @ (mbox @ (mnot @ (mexists_di @ (^ [X:$i]: ((mbox @ (mforall_di @ (^ [Y:$i]: (((mand @ (mbox @ ((mimplies @ (mbox @ ((f @ X) @ Y))) @ (mbox @ (mnot @ (mbox @ ((f @ X) @ X))))))) @ (mbox @ ((mimplies @ (mbox @ (mnot @ (mbox @ ((f @ X) @ X))))) @ (mbox @ ((f @ X) @ Y)))))))))))))))).

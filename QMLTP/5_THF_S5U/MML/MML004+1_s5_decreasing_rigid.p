...
%%% Generated on Fri May 06 13:26:03 EDT 2022
...
thf('mrel_#shoot_universal', axiom, (! [W:mworld,V:mworld]: ((((mrel @ '#shoot') @ W) @ V)))).
thf('mrel_#load_universal', axiom, (! [W:mworld,V:mworld]: ((((mrel @ '#load') @ W) @ V)))).

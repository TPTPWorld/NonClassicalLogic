...
%%% Generated on Fri May 06 13:28:59 EDT 2022
...
thf(pel43_1, axiom, (mlocal @ (mforall_di @ (^ [X:$i]: ((mforall_di @ (^ [Y:$i]: (((mequiv @ ((set_equal @ X) @ Y)) @ (mforall_di @ (^ [Z:$i]: (((mequiv @ ((element @ Z) @ X)) @ ((element @ Z) @ Y)))))))))))))).
thf(pel43, conjecture, (mlocal @ (mforall_di @ (^ [X:$i]: ((mforall_di @ (^ [Y:$i]: (((mequiv @ ((set_equal @ X) @ Y)) @ ((set_equal @ Y) @ X)))))))))).

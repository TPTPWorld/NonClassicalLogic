...
%%% Generated on Fri May 06 13:29:44 EDT 2022
...
thf(prove_th12, conjecture, (mlocal @ (mforall_di @ (^ [B:$i]: ((mforall_di @ (^ [C:$i]: ((mforall_di @ (^ [D:$i]: (((mimplies @ ((mand @ ((member @ B) @ C)) @ ((disjoint @ C) @ D))) @ (mnot @ ((member @ B) @ D)))))))))))))).

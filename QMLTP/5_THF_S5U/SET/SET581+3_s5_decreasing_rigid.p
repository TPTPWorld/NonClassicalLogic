...
%%% Generated on Fri May 06 13:30:12 EDT 2022
...
thf(not_equal_substitution_1, axiom, (mlocal @ (mforall_di @ (^ [A:$i]: ((mforall_di @ (^ [B:$i]: ((mforall_di @ (^ [C:$i]: (((mimplies @ ((mand @ ((qmltpeq @ A) @ B)) @ ((not_equal @ A) @ C))) @ ((not_equal @ B) @ C))))))))))))).
thf(not_equal_substitution_2, axiom, (mlocal @ (mforall_di @ (^ [A:$i]: ((mforall_di @ (^ [B:$i]: ((mforall_di @ (^ [C:$i]: (((mimplies @ ((mand @ ((qmltpeq @ A) @ B)) @ ((not_equal @ C) @ A))) @ ((not_equal @ C) @ B))))))))))))).
...
thf(not_equal_defn, axiom, (mlocal @ (mforall_di @ (^ [B:$i]: ((mforall_di @ (^ [C:$i]: (((mequiv @ ((not_equal @ B) @ C)) @ (mnot @ ((qmltpeq @ B) @ C))))))))))).
...
thf(prove_th24, conjecture, (mlocal @ (mforall_di @ (^ [B:$i]: ((mforall_di @ (^ [C:$i]: ((mforall_di @ (^ [D:$i]: (((mimplies @ ((mand @ ((member @ B) @ C)) @ ((member @ B) @ D))) @ ((not_equal @ ((intersection @ C) @ D)) @ empty_set))))))))))))).

...
%%% Generated on Fri May 06 13:32:31 EDT 2022
...
thf(con, conjecture, (mlocal @ ((mimplies @ (mforall_di @ (^ [X:$i]: (((mimplies @ (f @ X)) @ (mbox @ (g @ X))))))) @ ((mimplies @ (mforall_di @ (^ [X:$i]: ((f @ X))))) @ (mbox @ (mforall_di @ (^ [X:$i]: ((g @ X))))))))).

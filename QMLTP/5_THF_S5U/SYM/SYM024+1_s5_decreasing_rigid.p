...
%%% Generated on Fri May 06 13:33:08 EDT 2022
...
thf(con, conjecture, (mlocal @ ((mimplies @ (mexists_di @ (^ [X:$i]: ((mforall_di @ (^ [Y:$i]: ((mbox @ ((r @ X) @ Y))))))))) @ (mforall_di @ (^ [Y:$i]: ((mexists_di @ (^ [X:$i]: (((r @ X) @ Y)))))))))).

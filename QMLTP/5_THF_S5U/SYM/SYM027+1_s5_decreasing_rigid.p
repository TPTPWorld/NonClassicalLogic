...
%%% Generated on Fri May 06 13:33:18 EDT 2022
...
thf(con, conjecture, (mlocal @ ((mimplies @ ((mand @ (mdia @ (mforall_di @ (^ [X:$i]: ((a @ X)))))) @ (mbox @ (mexists_di @ (^ [X:$i]: ((b @ X))))))) @ (mexists_di @ (^ [X:$i]: ((mdia @ ((mand @ (a @ X)) @ (b @ X))))))))).

...
%%% Generated on Fri May 06 13:33:25 EDT 2022
...
thf(con, conjecture, (mlocal @ ((mimplies @ ((mand @ (mforall_di @ (^ [X:$i]: ((mbox @ (mbox @ (f @ X))))))) @ (mdia @ (mexists_di @ (^ [X:$i]: ((g @ X))))))) @ (mdia @ (mexists_di @ (^ [X:$i]: (((mand @ (f @ X)) @ (g @ X))))))))).

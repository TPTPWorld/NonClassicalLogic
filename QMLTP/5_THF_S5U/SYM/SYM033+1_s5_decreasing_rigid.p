...
%%% Generated on Fri May 06 13:33:38 EDT 2022
...
thf(con, conjecture, (mlocal @ ((mimplies @ ((mand @ a) @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ ((mimplies @ a) @ (f @ X))))))))) @ (mbox @ (mforall_di @ (^ [X:$i]: ((mdia @ ((mand @ b) @ (f @ X)))))))))).

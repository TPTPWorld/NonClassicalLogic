...
%%% Generated on Fri May 06 13:33:45 EDT 2022
...
thf(con, conjecture, (mlocal @ ((mimplies @ ((mand @ (mforall_di @ (^ [X:$i]: ((mbox @ (f @ X)))))) @ (mexists_di @ (^ [Y:$i]: ((mdia @ (g @ Y))))))) @ (mexists_di @ (^ [X:$i]: ((mdia @ ((mand @ (f @ X)) @ (g @ X))))))))).

...
%%% Generated on Fri May 06 13:34:26 EDT 2022
...
thf(con, conjecture, (mlocal @ ((mimplies @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ ((mimplies @ (f @ X)) @ (e @ X)))))))) @ ((mimplies @ (mexists_di @ (^ [X:$i]: ((mdia @ (f @ X)))))) @ (mdia @ (mexists_di @ (^ [X:$i]: ((f @ X))))))))).

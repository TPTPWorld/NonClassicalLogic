...
%%% Generated on Fri May 06 13:34:43 EDT 2022
...
thf(e_substitution_1, axiom, (mlocal @ (mforall_di @ (^ [A:$i]: ((mforall_di @ (^ [B:$i]: (((mimplies @ ((mand @ ((qmltpeq @ A) @ B)) @ (e @ A))) @ (e @ B)))))))))).
thf(con, conjecture, (mlocal @ ((mimplies @ ((mand @ (mdia @ (mexists_di @ (^ [X:$i]: ((mdia @ (mexists_di @ (^ [Y:$i]: ((mnot @ ((qmltpeq @ X) @ Y))))))))))) @ ((mand @ a) @ (mbox @ (mforall_di @ (^ [X:$i]: ((mbox @ ((mimplies @ a) @ (e @ X)))))))))) @ (mexists_di @ (^ [X:$i]: ((mexists_di @ (^ [Y:$i]: ((mnot @ ((qmltpeq @ X) @ Y))))))))))).

...
%%% Generated on Fri May 06 13:35:03 EDT 2022
...
thf(f_substitution_1, axiom, (mlocal @ (mforall_di @ (^ [A:$i]: ((mforall_di @ (^ [B:$i]: (((mimplies @ ((mand @ ((qmltpeq @ A) @ B)) @ (f @ A))) @ (f @ B)))))))))).
thf(con, conjecture, (mlocal @ ((mimplies @ (mforall_di @ (^ [X:$i]: ((mbox @ (mexists_di @ (^ [Y:$i]: (((qmltpeq @ Y) @ X))))))))) @ ((mimplies @ (mbox @ (mforall_di @ (^ [X:$i]: ((f @ X)))))) @ (mforall_di @ (^ [X:$i]: ((mbox @ (f @ X))))))))).

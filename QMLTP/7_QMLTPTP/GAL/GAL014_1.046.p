%------------------------------------------------------------------------------
% File     : GAL014_1.046 : TPTP v9.0.0. Released v9.0.0.
% Domain   : General Algebra
% Problem  : Groups 4: CPROPS-COVERING-PROBLEM-1
% Version  : [QMLTP] axioms.
% English  : Goedel encoding of the TPTP ALG014+1 problem

% Refs     : [Goe69] Goedel (1969), An Interpretation of the Intuitionistic
%          : [RO12]  Raths & Otten (2012), The QMLTP Problem Library for Fi
% Source   : [QMLTP]
% Names    : GAL014+1 [QMLTP]
%          : GAL014_1.046_s4_decreasing_flexible.p [QMLTP/4_NX0_SEMs]
...
%            Number of connectives :  751 (  61   ~;  70   |; 197   &)
%                                         (   0 <=>;  21  =>;   0  <=;   0 <~>)
%                                         ( 402 {}@;   0 {#};   0 {.})
%            Maximal formula depth :   65 (  12 avg)
%            Maximal term depth    :    3 (   1 avg)
%            Number of FOOLs       :  402 ( 402 fml;   0 var)

%------------------------------------------------------------------------------
% File     : GAL016_1.040 : TPTP v9.0.0. Released v9.0.0.
% Domain   : General Algebra
% Problem  : Groups 4: CPROPS-ISO-COMPLETE-PROBLEM-2
% Version  : [QMLTP] axioms.
% English  : Goedel encoding of the TPTP ALG016+1 problem

% Refs     : [Goe69] Goedel (1969), An Interpretation of the Intuitionistic
%          : [RO12]  Raths & Otten (2012), The QMLTP Problem Library for Fi
% Source   : [QMLTP]
% Names    : GAL016+1 [QMLTP]
%          : GAL016_1.040_s4_cumulative_flexible.p [QMLTP/4_NX0_SEMs]

% Status   : Unknown
% Rating   : ? v9.0.0
% Syntax   : Number of formulae    :   62 (   0 unt;  19 typ;   0 def)
%            Number of atoms       : 2662 (   0 equ)
%            Maximal formula atoms :  256 (  61 avg)
%            Number of connectives : 1799 ( 138   ~; 183   |; 476   &)
%                                         (   0 <=>;  44  =>;   0  <=;   0 <~>)
%                                         ( 958 {}@;   0 {#};   0 {.})
%            Maximal formula depth :   65 (  12 avg)
%            Maximal term depth    :    4 (   1 avg)
%            Number of FOOLs       :  958 ( 958 fml;   0 var)
...
tff(ax24,axiom-local,
    ( ( {$box} @ (qmltpeq(e10,op1(op1(e12,op1(e12,e12)),e12))) )
    & ( {$box} @ (qmltpeq(e11,op1(e12,op1(e12,e12)))) )
    & ( {$box} @ (qmltpeq(e13,op1(e12,e12))) ) ) ).

tff(ax25,axiom-local,
    ( ( {$box} @ (qmltpeq(e20,op2(op2(e22,op2(e22,e22)),e22))) )
    & ( {$box} @ (qmltpeq(e21,op2(e22,op2(e22,e22)))) )
    & ( {$box} @ (qmltpeq(e23,op2(e22,e22))) ) ) ).

tff(ax26,axiom-local,
    ( ( {$box} @ (qmltpeq(h1(e12),e20)) )
    & ( {$box} @ (qmltpeq(h1(e10),op2(op2(e20,op2(e20,e20)),e20))) )
    & ( {$box} @ (qmltpeq(h1(e11),op2(e20,op2(e20,e20)))) )
    & ( {$box} @ (qmltpeq(h1(e13),op2(e20,e20))) ) ) ).

tff(ax27,axiom-local,
    ( ( {$box} @ (qmltpeq(h2(e12),e21)) )
    & ( {$box} @ (qmltpeq(h2(e10),op2(op2(e21,op2(e21,e21)),e21))) )
    & ( {$box} @ (qmltpeq(h2(e11),op2(e21,op2(e21,e21)))) )
    & ( {$box} @ (qmltpeq(h2(e13),op2(e21,e21))) ) ) ).

tff(ax28,axiom-local,
    ( ( {$box} @ (qmltpeq(h3(e12),e22)) )
    & ( {$box} @ (qmltpeq(h3(e10),op2(op2(e22,op2(e22,e22)),e22))) )
    & ( {$box} @ (qmltpeq(h3(e11),op2(e22,op2(e22,e22)))) )
    & ( {$box} @ (qmltpeq(h3(e13),op2(e22,e22))) ) ) ).

tff(ax29,axiom-local,
    ( ( {$box} @ (qmltpeq(h4(e12),e23)) )
    & ( {$box} @ (qmltpeq(h4(e10),op2(op2(e23,op2(e23,e23)),e23))) )
    & ( {$box} @ (qmltpeq(h4(e11),op2(e23,op2(e23,e23)))) )
    & ( {$box} @ (qmltpeq(h4(e13),op2(e23,e23))) ) ) ).

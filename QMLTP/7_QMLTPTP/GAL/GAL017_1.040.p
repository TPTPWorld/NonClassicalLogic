%------------------------------------------------------------------------------
% File     : GAL017_1.040 : TPTP v9.0.0. Released v9.0.0.
% Domain   : General Algebra
% Problem  : Groups 4: CPROPS-PAIRWISE-EXCLUSIVE-PROBLEM-1
% Version  : [QMLTP] axioms.
% English  : Goedel encoding of the TPTP ALG017+1 problem

% Refs     : [Goe69] Goedel (1969), An Interpretation of the Intuitionistic
%          : [RO12]  Raths & Otten (2012), The QMLTP Problem Library for Fi
% Source   : [QMLTP]
% Names    : GAL017+1 [QMLTP]
%          : GAL017_1.040_s4_cumulative_flexible.p [QMLTP/4_NX0_SEMs]

% Status   : Unknown
% Rating   : ? v9.0.0
% Syntax   : Number of formulae    :   26 (   0 unt;   8 typ;   0 def)
%            Number of atoms       : 1115 (   0 equ)
%            Maximal formula atoms :  128 (  61 avg)
%            Number of connectives :  755 (  62   ~;  69   |; 199   &)
%                                         (   0 <=>;  21  =>;   0  <=;   0 <~>)
%                                         ( 404 {}@;   0 {#};   0 {.})
%            Maximal formula depth :   65 (  12 avg)
%            Maximal term depth    :    3 (   1 avg)
%            Number of FOOLs       :  404 ( 404 fml;   0 var)

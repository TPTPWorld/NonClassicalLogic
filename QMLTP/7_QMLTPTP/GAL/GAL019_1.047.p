%------------------------------------------------------------------------------
% File     : GAL019_1.047 : TPTP v9.0.0. Released v9.0.0.
% Domain   : General Algebra
% Problem  : Groups 4: CPROPS-SORTED-DISCRIMINANT-PROBLEM-2
% Version  : [QMLTP] axioms.
% English  : Goedel encoding of the TPTP ALG019+1 problem

% Refs     : [Goe69] Goedel (1969), An Interpretation of the Intuitionistic
%          : [RO12]  Raths & Otten (2012), The QMLTP Problem Library for Fi
% Source   : [QMLTP]
% Names    : GAL019+1 [QMLTP]
%          : GAL019_1.047_s5_decreasing_flexible.p [QMLTP/4_NX0_SEMs]
...
%            Number of connectives :  157 (   4   ~;   0   |;   9   &)
%                                         (   0 <=>;  25  =>;   0  <=;   0 <~>)
%                                         ( 119 {}@;   0 {#};   0 {.})

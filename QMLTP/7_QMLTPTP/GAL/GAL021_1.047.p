%------------------------------------------------------------------------------
% File     : GAL021_1.047 : TPTP v9.0.0. Released v9.0.0.
% Domain   : General Algebra
% Problem  : Groups 4: REPRESENTATIVES-SATISFY-PROPS-PROBLEM-1
% Version  : [QMLTP] axioms.
% English  : Goedel encoding of the TPTP ALG021+1 problem

% Refs     : [Goe69] Goedel (1969), An Interpretation of the Intuitionistic
%          : [RO12]  Raths & Otten (2012), The QMLTP Problem Library for Fi
% Source   : [QMLTP]
% Names    : GAL021+1 [QMLTP]
%          : GAL021_1.047_s5_decreasing_flexible.p [QMLTP/4_NX0_SEMs]

% Status   : Unknown
% Rating   : ? v9.0.0
% Syntax   : Number of formulae    :   19 (   0 unt;   8 typ;   0 def)
%            Number of atoms       :  707 (   0 equ)
%            Maximal formula atoms :  360 (  64 avg)
%            Number of connectives :  458 (   6   ~;  66   |; 137   &)
%                                         (   0 <=>;   5  =>;   0  <=;   0 <~>)
%                                         ( 244 {}@;   0 {#};   0 {.})

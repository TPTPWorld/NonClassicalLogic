%------------------------------------------------------------------------------
% File     : GLC448_1.046 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Logic Calculi
% Problem  : Redundant axiom in Principia axiomatization
% Version  : [QMLTP] axioms.
% English  : Goedel encoding of the TPTP LCL448+1 problem

% Refs     : [Goe69] Goedel (1969), An Interpretation of the Intuitionistic
%          : [RO12]  Raths & Otten (2012), The QMLTP Problem Library for Fi
% Source   : [QMLTP]
% Names    : GLC448+1 [QMLTP]
%          : GLC448_1.046_s4_decreasing_flexible.p [QMLTP/4_NX0_SEMs]

% Status   : Unknown
% Rating   : ? v9.0.0
% Syntax   : Number of formulae    :   92 (   0 unt;  38 typ;   0 def)
%            Number of atoms       :  925 (   0 equ)
%            Maximal formula atoms :    4 (  17 avg)
%            Number of connectives :  487 (   0   ~;   0   |;  30   &)
%                                         (   0 <=>;  73  =>;   0  <=;   0 <~>)
%                                         ( 384 {}@;   0 {#};   0 {.})
...
tff(principia_op_implies_or,axiom-local,
    {$box} @ (op_implies_or) ).

tff(principia_op_and,axiom-local,
    {$box} @ (op_and) ).

tff(principia_op_equiv,axiom-local,
    {$box} @ (op_equiv) ).

tff(principia_modus_ponens,axiom-local,
    {$box} @ (modus_ponens) ).

tff(principia_r1,axiom-local,
    {$box} @ (r1) ).

tff(principia_r2,axiom-local,
    {$box} @ (r2) ).

tff(principia_r3,axiom-local,
    {$box} @ (r3) ).

tff(principia_r5,axiom-local,
    {$box} @ (r5) ).

tff(substitution_of_equivalents_1,axiom-local,
    {$box} @ (substitution_of_equivalents) ).

tff(principia_r4,conjecture,
    {$box} @ (r4) ).

%------------------------------------------------------------------------------
% File     : GLC449_1.047 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Logic Calculi
% Problem  : Congruence of equiv, to admit substitution of equivalents
% Version  : [QMLTP] axioms.
% English  : Goedel encoding of the TPTP LCL449+1 problem

% Refs     : [Goe69] Goedel (1969), An Interpretation of the Intuitionistic
%          : [RO12]  Raths & Otten (2012), The QMLTP Problem Library for Fi
% Source   : [QMLTP]
% Names    : GLC449+1 [QMLTP]
%          : GLC449_1.047_s5_decreasing_flexible.p [QMLTP/4_NX0_SEMs]

% Status   : Unknown
% Rating   : ? v9.0.0
% Syntax   : Number of formulae    :  101 (   0 unt;  38 typ;   0 def)
%            Number of atoms       : 1023 (   0 equ)
%            Maximal formula atoms :    4 (  16 avg)
%            Number of connectives :  537 (   0   ~;   0   |;  35   &)
%                                         (   0 <=>;  79  =>;   0  <=;   0 <~>)
%                                         ( 423 {}@;   0 {#};   0 {.})
%            Maximal formula depth :    3 (   2 avg)
%            Maximal term depth    :    5 (   2 avg)
%            Number of FOOLs       :  423 ( 423 fml;   0 var)
%            Number of types       :    2 (   0 usr)
%            Number of type conns  :   12 (   7   >;   5   *;   0   +;   0  <<)
%            Number of predicates  :   34 (  33 usr;  31 prp; 0-2 aty)
%            Number of functors    :    5 (   5 usr;   0 con; 1-2 aty)
%            Number of variables   :  167 (; 167   !;   0   ?; 167   :)
...
tff(make_subs_of_equiv,axiom-local,
    ( {$box}
    @ (( ( ( {$box}
                     ...
                     @ (! [Y1: $i] :
                          ...
                          @ (! [Y2: $i] :
                               ...
                               @ (( ( ( {$box} @ (is_a_theorem(equiv(X1,X2))) )
                                    & ( {$box} @ (is_a_theorem(equiv(Y1,Y2))) ) )
                                 => ( {$box} @ (is_a_theorem(equiv(and(X1,Y1),and(X2,Y2)))) ) )) )) )) )) )) )
         & ( {$box}
           @ (! [X: $i] :
                ( {$box}
                @ (! [Y: $i] :

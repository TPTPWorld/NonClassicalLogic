%------------------------------------------------------------------------------
% File     : GLC450_1.041 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Logic Calculi
% Problem  : Congruence of equiv lemmas, to admit substitution of equivalents
% Version  : [QMLTP] axioms.
% English  : Goedel encoding of the TPTP LCL450+1 problem

% Refs     : [Goe69] Goedel (1969), An Interpretation of the Intuitionistic
%          : [RO12]  Raths & Otten (2012), The QMLTP Problem Library for Fi
% Source   : [QMLTP]
% Names    : GLC450+1 [QMLTP]
%          : GLC450_1.041_s5_cumulative_flexible.p [QMLTP/4_NX0_SEMs]
...
%            Number of connectives :  523 (   0   ~;   0   |;  35   &)
%                                         (   0 <=>;  76  =>;   0  <=;   0 <~>)
%                                         ( 412 {}@;   0 {#};   0 {.})
%            Maximal formula depth :    5 (   2 avg)
%            Maximal term depth    :    5 (   2 avg)
%            Number of FOOLs       :  412 ( 412 fml;   0 var)
%            Number of types       :    2 (   0 usr)
%            Number of type conns  :   12 (   7   >;   5   *;   0   +;   0  <<)
%            Number of predicates  :   34 (  33 usr;  31 prp; 0-2 aty)
%            Number of functors    :    5 (   5 usr;   0 con; 1-2 aty)
%            Number of variables   :  163 (; 163   !;   0   ?; 163   :)

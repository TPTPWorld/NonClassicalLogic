%------------------------------------------------------------------------------
% File     : GLC454_1.046 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Logic Calculi
% Problem  : Prove Principia's r1 axiom from Hilbert's axiomatization
% Version  : [QMLTP] axioms.
% English  : Goedel encoding of the TPTP LCL454+1 problem

% Refs     : [Goe69] Goedel (1969), An Interpretation of the Intuitionistic
%          : [RO12]  Raths & Otten (2012), The QMLTP Problem Library for Fi
% Source   : [QMLTP]
% Names    : GLC454+1 [QMLTP]
%          : GLC454_1.046_s4_decreasing_flexible.p [QMLTP/4_NX0_SEMs]

% Status   : Unknown
% Rating   : ? v9.0.0
% Syntax   : Number of formulae    :  104 (   0 unt;  38 typ;   0 def)
%            Number of atoms       :  961 (   0 equ)
%            Maximal formula atoms :    4 (  14 avg)
%            Number of connectives :  499 (   0   ~;   0   |;  30   &)
%                                         (   0 <=>;  73  =>;   0  <=;   0 <~>)
%                                         ( 396 {}@;   0 {#};   0 {.})

%------------------------------------------------------------------------------
% File     : GLC456_1.047 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Logic Calculi
% Problem  : Prove Principia's r3 axiom from Hilbert's axiomatization
% Version  : [QMLTP] axioms.
% English  : Goedel encoding of the TPTP LCL456+1 problem

% Refs     : [Goe69] Goedel (1969), An Interpretation of the Intuitionistic
%          : [RO12]  Raths & Otten (2012), The QMLTP Problem Library for Fi
% Source   : [QMLTP]
% Names    : GLC456+1 [QMLTP]
%          : GLC456_1.047_s5_decreasing_flexible.p [QMLTP/4_NX0_SEMs]

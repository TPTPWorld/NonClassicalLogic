%------------------------------------------------------------------------------
% File     : GLC458_1.041 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Logic Calculi
% Problem  : Prove Principia's r5 axiom from Hilbert's axiomatization
% Version  : [QMLTP] axioms.
% English  : Goedel encoding of the TPTP LCL458+1 problem

% Refs     : [Goe69] Goedel (1969), An Interpretation of the Intuitionistic
%          : [RO12]  Raths & Otten (2012), The QMLTP Problem Library for Fi
% Source   : [QMLTP]
% Names    : GLC458+1 [QMLTP]
%          : GLC458_1.041_s5_cumulative_flexible.p [QMLTP/4_NX0_SEMs]

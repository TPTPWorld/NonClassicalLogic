%------------------------------------------------------------------------------
% File     : GLC460_1.047 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Logic Calculi
% Problem  : Prove Rosser's kn2 axiom from Hilbert's axiomatization
% Version  : [QMLTP] axioms.
% English  : Goedel encoding of the TPTP LCL460+1 problem

% Refs     : [Goe69] Goedel (1969), An Interpretation of the Intuitionistic
%          : [RO12]  Raths & Otten (2012), The QMLTP Problem Library for Fi
% Source   : [QMLTP]
% Names    : GLC460+1 [QMLTP]
%          : GLC460_1.047_s5_decreasing_flexible.p [QMLTP/4_NX0_SEMs]
...
tff(rosser_op_or,axiom-local,
    {$box} @ (op_or) ).

tff(rosser_op_implies_and,axiom-local,
    {$box} @ (op_implies_and) ).

tff(rosser_op_equiv,axiom-local,
    {$box} @ (op_equiv) ).

tff(rosser_kn2,conjecture,
    {$box} @ (kn2) ).

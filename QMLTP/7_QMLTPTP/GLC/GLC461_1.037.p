%------------------------------------------------------------------------------
% File     : GLC461_1.037 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Logic Calculi
% Problem  : Prove Rosser's kn3 axiom from Hilbert's axiomatization
% Version  : [QMLTP] axioms.
% English  : Goedel encoding of the TPTP LCL461+1 problem

% Refs     : [Goe69] Goedel (1969), An Interpretation of the Intuitionistic
%          : [RO12]  Raths & Otten (2012), The QMLTP Problem Library for Fi
% Source   : [QMLTP]
% Names    : GLC461+1 [QMLTP]
%          : GLC461_1.037_k_cumulative_flexible.p [QMLTP/4_NX0_SEMs]

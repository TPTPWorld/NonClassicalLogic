%------------------------------------------------------------------------------
% File     : GLC462_1.045 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Logic Calculi
% Problem  : Prove Hilbert's modus_tollens axiom from Lukasiewicz's system
% Version  : [QMLTP] axioms.
% English  : Goedel encoding of the TPTP LCL462+1 problem

% Refs     : [Goe69] Goedel (1969), An Interpretation of the Intuitionistic
%          : [RO12]  Raths & Otten (2012), The QMLTP Problem Library for Fi
% Source   : [QMLTP]
% Names    : GLC462+1 [QMLTP]
%          : GLC462_1.045_d_decreasing_flexible.p [QMLTP/4_NX0_SEMs]
...
tff(hilbert_modus_tollens,conjecture,
    {$box} @ (modus_tollens) ).

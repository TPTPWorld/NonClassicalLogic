%------------------------------------------------------------------------------
% File     : GLC463_1.046 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Logic Calculi
% Problem  : Prove Hilbert's implies_1 axiom from Lukasiewicz's axiomatization
% Version  : [QMLTP] axioms.
% English  : Goedel encoding of the TPTP LCL463+1 problem

% Refs     : [Goe69] Goedel (1969), An Interpretation of the Intuitionistic
%          : [RO12]  Raths & Otten (2012), The QMLTP Problem Library for Fi
% Source   : [QMLTP]
% Names    : GLC463+1 [QMLTP]
%          : GLC463_1.046_s4_decreasing_flexible.p [QMLTP/4_NX0_SEMs]
...
tff(hilbert_implies_1,conjecture,
    {$box} @ (implies_1) ).

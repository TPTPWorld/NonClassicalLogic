%------------------------------------------------------------------------------
% File     : GLC465_1.041 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Logic Calculi
% Problem  : Prove Hilbert's implies_3 axiom from Lukasiewicz's axiomatization
% Version  : [QMLTP] axioms.
% English  : Goedel encoding of the TPTP LCL465+1 problem

% Refs     : [Goe69] Goedel (1969), An Interpretation of the Intuitionistic
%          : [RO12]  Raths & Otten (2012), The QMLTP Problem Library for Fi
% Source   : [QMLTP]
% Names    : GLC465+1 [QMLTP]
%          : GLC465_1.041_s5_cumulative_flexible.p [QMLTP/4_NX0_SEMs]
...
tff(hilbert_implies_3,conjecture,
    {$box} @ (implies_3) ).

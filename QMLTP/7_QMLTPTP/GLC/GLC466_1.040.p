%------------------------------------------------------------------------------
% File     : GLC466_1.040 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Logic Calculi
% Problem  : Prove Hilbert's and_1 axiom from Lukasiewicz's axiomatization
% Version  : [QMLTP] axioms.
% English  : Goedel encoding of the TPTP LCL466+1 problem

% Refs     : [Goe69] Goedel (1969), An Interpretation of the Intuitionistic
%          : [RO12]  Raths & Otten (2012), The QMLTP Problem Library for Fi
% Source   : [QMLTP]
% Names    : GLC466+1 [QMLTP]
%          : GLC466_1.040_s4_cumulative_flexible.p [QMLTP/4_NX0_SEMs]

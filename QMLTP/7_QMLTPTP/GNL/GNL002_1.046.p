%------------------------------------------------------------------------------
% File     : GNL002_1.046 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Natural Language Processing
% Problem  : "The old dirty white Chevy" problem 2
% Version  : [QMLTP] axioms.
% English  : Goedel encoding of the TPTP NLP002+1 problem

% Refs     : [Goe69] Goedel (1969), An Interpretation of the Intuitionistic
%          : [RO12]  Raths & Otten (2012), The QMLTP Problem Library for Fi
% Source   : [QMLTP]
% Names    : GNL002+1 [QMLTP]
%          : GNL002_1.046_s4_decreasing_flexible.p [QMLTP/4_NX0_SEMs]

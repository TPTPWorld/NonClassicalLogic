%------------------------------------------------------------------------------
% File     : GNL004_1.041 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Natural Language Processing
% Problem  : "The old dirty white Chevy" problem 4
% Version  : [QMLTP] axioms.
% English  : Goedel encoding of the TPTP NLP004+1 problem

% Refs     : [Goe69] Goedel (1969), An Interpretation of the Intuitionistic
%          : [RO12]  Raths & Otten (2012), The QMLTP Problem Library for Fi
% Source   : [QMLTP]
% Names    : GNL004+1 [QMLTP]
%          : GNL004_1.041_s5_cumulative_flexible.p [QMLTP/4_NX0_SEMs]

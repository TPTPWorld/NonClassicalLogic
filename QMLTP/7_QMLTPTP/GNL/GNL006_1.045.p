%------------------------------------------------------------------------------
% File     : GNL006_1.045 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Natural Language Processing
% Problem  : "The old dirty white Chevy" problem 6
% Version  : [QMLTP] axioms.
% English  : Goedel encoding of the TPTP NLP006+1 problem

% Refs     : [Goe69] Goedel (1969), An Interpretation of the Intuitionistic
%          : [RO12]  Raths & Otten (2012), The QMLTP Problem Library for Fi
% Source   : [QMLTP]
% Names    : GNL006+1 [QMLTP]
%          : GNL006_1.045_d_decreasing_flexible.p [QMLTP/4_NX0_SEMs]
...
tff(co1,conjecture,
    ( ( {$box}
      @ (( ? [U: $i,V: $i,W: $i,X: $i,Y: $i,Z: $i,X1: $i,X2: $i,X3: $i,X4: $i] :
             ...
             & ( {$box} @ (qmltpeq(X1,X4)) )
             & ( {$box} @ (in(X4,X2)) ) )
        => ? [X5: $i,X6: $i,X7: $i,X8: $i,X9: $i,X10: $i,X11: $i,X13: $i,X14: $i] :
             ( ( {$box} @ (seat(X5)) )
             & ( {$box} @ (furniture(X5)) )
             & ( {$box} @ (front(X5)) )
             & ( {$box} @ (hollywood(X6)) )
             ...
             & ( {$box} @ (in(X14,X5)) ) ) )) )
    & ( {$box}
      @ (( ? [X15: $i,X16: $i,X17: $i,X18: $i,X19: $i,X20: $i,X21: $i,X23: $i,X24: $i] :
             ( ( {$box} @ (seat(X15)) )
             & ( {$box} @ (furniture(X15)) )
             & ( {$box} @ (front(X15)) )
             & ( {$box} @ (hollywood(X16)) )

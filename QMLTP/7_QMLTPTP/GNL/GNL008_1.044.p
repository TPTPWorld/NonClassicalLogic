%------------------------------------------------------------------------------
% File     : GNL008_1.044 : TPTP v9.0.0. Released v9.0.0.
% Domain   : Natural Language Processing
% Problem  : "The old dirty white Chevy" problem 8
% Version  : [QMLTP] axioms.
% English  : Goedel encoding of the TPTP NLP008+1 problem

% Refs     : [Goe69] Goedel (1969), An Interpretation of the Intuitionistic
%          : [RO12]  Raths & Otten (2012), The QMLTP Problem Library for Fi
% Source   : [QMLTP]
% Names    : GNL008+1 [QMLTP]
%          : GNL008_1.044_t_decreasing_flexible.p [QMLTP/4_NX0_SEMs]
...
tff(co1,conjecture,
    ...
    & ( {$box}
      @ (( ? [X15: $i,X16: $i,X17: $i,X18: $i,X19: $i,X20: $i,X21: $i,X22: $i,X23: $i,X24: $i] :
             ...
             & ( {$box} @ (qmltpeq(X21,X24)) )
             & ( {$box} @ (in(X24,X15)) ) )
        => ? [X25: $i,X26: $i,X27: $i,X28: $i,X29: $i,X30: $i,X31: $i,X33: $i,X34: $i] :
             ( ( {$box} @ (seat(X25)) )
             & ( {$box} @ (furniture(X25)) )
             & ( {$box} @ (front(X25)) )
             & ( {$box} @ (hollywood(X26)) )

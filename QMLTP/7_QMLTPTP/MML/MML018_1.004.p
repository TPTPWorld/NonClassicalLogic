%------------------------------------------------------------------------------
% File     : MML018_1.004 : TPTP v9.0.0. Released v9.0.0.
...
%          : MML018_1.004_s4_constant_rigid.p [QMLTP/4_NX0_SEMs]
...
tff(axiom_1,axiom-local,
    ...
    @ (! [X: $i] :
         ( {$box(#cr)}
         @ (( account(person,X)
           => ? [B: $i] : ( {$box(#teller)} @ (balance(person,B)) ) )) )) ) ).

tff(axiom_1_0,axiom-local,
    {$box(#cr)} @ (account(person,fortytwo)) ).

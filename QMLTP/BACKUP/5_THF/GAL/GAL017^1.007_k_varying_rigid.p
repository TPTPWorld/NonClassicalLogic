%------------------------------------------------------------------------------
% File     : GAL017^1.007 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   51 (  11 unt;  22 typ;  10 def)
%            Number of atoms       : 1119 (  10 equ;   0 cnn)
%            Maximal formula atoms :  240 (  38 avg)
%            Number of connectives : 2744 (   1   ~;   1   |;   3   &;2735   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)

%------------------------------------------------------------------------------
% File     : GAL017^1.012 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Theorem 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   52 (  12 unt;  22 typ;  10 def)
%            Number of atoms       : 1120 (  10 equ;   0 cnn)
%            Maximal formula atoms :  240 (  37 avg)
%            Number of connectives : 2746 (   1   ~;   1   |;   3   &;2737   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)

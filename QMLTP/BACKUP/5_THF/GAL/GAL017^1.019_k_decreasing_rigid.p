%------------------------------------------------------------------------------
% File     : GAL017^1.019 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   52 (  11 unt;  22 typ;  10 def)
%            Number of atoms       : 1122 (  10 equ;   0 cnn)
%            Maximal formula atoms :  240 (  37 avg)
%            Number of connectives : 2752 (   1   ~;   1   |;   4   &;2741   @)
%                                         (   1 <=>;   4  =>;   0  <=;   0 <~>)

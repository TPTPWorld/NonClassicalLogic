%------------------------------------------------------------------------------
% File     : GAL020^1.001 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   51 (  10 unt;  26 typ;  10 def)
%            Number of atoms       :  583 (  10 equ;   0 cnn)
%            Maximal formula atoms :  219 (  23 avg)
%            Number of connectives : 1229 (   1   ~;   1   |;   2   &;1222   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)

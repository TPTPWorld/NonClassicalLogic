%------------------------------------------------------------------------------
% File     : GAL020^1.006 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   52 (  11 unt;  26 typ;  10 def)
%            Number of atoms       :  584 (  10 equ;   0 cnn)
%            Maximal formula atoms :  219 (  22 avg)
%            Number of connectives : 1231 (   1   ~;   1   |;   2   &;1224   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)

%------------------------------------------------------------------------------
% File     : GAL020^1.023 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   56 (  12 unt;  27 typ;  10 def)
%            Number of atoms       :  593 (  10 equ;   0 cnn)
%            Maximal formula atoms :  219 (  20 avg)
%            Number of connectives : 1255 (   1   ~;   1   |;   5   &;1242   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)

%------------------------------------------------------------------------------
% File     : GLC414^1.006 : TPTP v8.1.0. Released v8.1.0.
          ...
          @ ( mbox
            @ ( mforall_di
              @ ^ [P: $i] :
                  ( mbox
                  @ ( mforall_di
                    @ ^ [Q: $i] : ( mor @ ( mbox @ ( mnot @ ( mbox @ ( a_truth @ ( implies @ P @ Q ) ) ) ) ) @ ( mor @ ( mbox @ ( mnot @ ( mbox @ ( a_truth @ P ) ) ) ) @ ( mbox @ ( a_truth @ Q ) ) ) ) ) ) ) )
          @ ( mand
            @ ( mbox
              @ ( mforall_di
                @ ^ [P: $i] :
                    ( mbox
                    @ ( mforall_di
                      @ ^ [Q: $i] : ( mbox @ ( a_truth @ ( implies @ P @ ( implies @ Q @ P ) ) ) ) ) ) ) )
            @ ( mand
              @ ( mbox
                @ ( mforall_di
                  @ ^ [P: $i] :
                      ...
                      @ ( mforall_di
                        @ ^ [Q: $i] :
                            ( mbox
                            @ ( mforall_di
                              @ ^ [R: $i] : ( mbox @ ( a_truth @ ( implies @ ( implies @ P @ ( implies @ Q @ R ) ) @ ( implies @ ( implies @ P @ Q ) @ ( implies @ P @ R ) ) ) ) ) ) ) ) ) ) )
              @ ( mand
                @ ( mbox
                  @ ( mforall_di
                    @ ^ [P: $i] :
                        ( mbox
                        @ ( mforall_di
                          @ ^ [Q: $i] : ( mbox @ ( a_truth @ ( implies @ ( implies @ ( not @ P ) @ ( not @ Q ) ) @ ( implies @ Q @ P ) ) ) ) ) ) ) )
                @ ( mexists_di
                  @ ^ [A: $i] : ( mbox @ ( mnot @ ( mbox @ ( a_truth @ ( implies @ A @ A ) ) ) ) ) ) ) ) ) ) ) ) ) ).

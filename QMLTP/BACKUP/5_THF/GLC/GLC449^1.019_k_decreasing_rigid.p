%------------------------------------------------------------------------------
% File     : GLC449^1.019 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  127 (  11 unt;  52 typ;  10 def)
%            Number of atoms       :  972 (  10 equ;   0 cnn)
%            Maximal formula atoms :   60 (  12 avg)
%            Number of connectives : 1480 (   1   ~;   1   |;   4   &;1469   @)
%                                         (   1 <=>;   4  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   30 (  12 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :  104 ( 104   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   52 (  51 usr;   1 con; 0-3 aty)
%            Number of variables   :  199 ( 190   ^   6   !;   3   ?; 199   :)
% SPC      : TH0_UNK_EQU_NAR

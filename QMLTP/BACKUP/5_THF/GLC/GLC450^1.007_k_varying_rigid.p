%------------------------------------------------------------------------------
% File     : GLC450^1.007 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  125 (  11 unt;  52 typ;  10 def)
%            Number of atoms       :  946 (  10 equ;   0 cnn)
%            Maximal formula atoms :   48 (  12 avg)
%            Number of connectives : 1440 (   1   ~;   1   |;   3   &;1431   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   27 (  12 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :  104 ( 104   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   52 (  51 usr;   1 con; 0-3 aty)
%            Number of variables   :  192 ( 186   ^   3   !;   3   ?; 192   :)
% SPC      : TH0_UNK_EQU_NAR

%------------------------------------------------------------------------------
% File     : GLC450^2.023 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  128 (  12 unt;  52 typ;  10 def)
%            Number of atoms       :  961 (  10 equ;   0 cnn)
%            Maximal formula atoms :   56 (  12 avg)
%            Number of connectives : 1473 (   1   ~;   1   |;   5   &;1460   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   24 (  12 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :  104 ( 104   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   52 (  51 usr;   1 con; 0-3 aty)
%            Number of variables   :  201 ( 188   ^  10   !;   3   ?; 201   :)
% SPC      : TH0_UNK_EQU_NAR

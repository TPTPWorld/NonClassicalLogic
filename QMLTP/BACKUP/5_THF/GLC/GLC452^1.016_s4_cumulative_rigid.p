%------------------------------------------------------------------------------
% File     : GLC452^1.016 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  133 (  12 unt;  53 typ;  10 def)
%            Number of atoms       :  920 (  10 equ;   0 cnn)
%            Maximal formula atoms :   36 (  11 avg)
%            Number of connectives : 1392 (   1   ~;   1   |;   5   &;1379   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)

%------------------------------------------------------------------------------
% File     : GLC465^1.007 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  120 (  11 unt;  53 typ;  10 def)
%            Number of atoms       :  883 (  10 equ;   0 cnn)
%            Maximal formula atoms :   36 (  13 avg)
%            Number of connectives : 1354 (   1   ~;   1   |;   3   &;1345   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)

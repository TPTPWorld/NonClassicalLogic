%------------------------------------------------------------------------------
% File     : GLC465^1.018 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Theorem 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  122 (  12 unt;  53 typ;  10 def)
%            Number of atoms       :  887 (  10 equ;   0 cnn)
%            Maximal formula atoms :   36 (  12 avg)
%            Number of connectives : 1364 (   1   ~;   1   |;   4   &;1353   @)
%                                         (   1 <=>;   4  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   23 (  12 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :  105 ( 105   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   53 (  52 usr;   1 con; 0-3 aty)
%            Number of variables   :  188 ( 177   ^   8   !;   3   ?; 188   :)
% SPC      : TH0_THM_EQU_NAR

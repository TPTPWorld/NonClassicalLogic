%------------------------------------------------------------------------------
% File     : GLC467^1.013 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  121 (  11 unt;  53 typ;  10 def)
%            Number of atoms       :  886 (  10 equ;   0 cnn)
%            Maximal formula atoms :   36 (  13 avg)
%            Number of connectives : 1362 (   1   ~;   1   |;   4   &;1351   @)
%                                         (   1 <=>;   4  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   23 (  12 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :  105 ( 105   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   53 (  52 usr;   1 con; 0-3 aty)
%            Number of variables   :  186 ( 177   ^   6   !;   3   ?; 186   :)
% SPC      : TH0_UNK_EQU_NAR

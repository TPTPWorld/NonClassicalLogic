%------------------------------------------------------------------------------
% File     : GNL008^1.001 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   71 (  10 unt;  34 typ;  10 def)
%            Number of atoms       :  790 (  10 equ;   0 cnn)
%            Maximal formula atoms :  402 (  21 avg)
%            Number of connectives : 1034 (   1   ~;   1   |;   2   &;1027   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   60 (  13 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :  103 ( 103   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   34 (  33 usr;   1 con; 0-3 aty)
%            Number of variables   :  123 ( 119   ^   2   !;   2   ?; 123   :)
% SPC      : TH0_UNK_EQU_NAR
                                ...
                                @ ^ [X10: $i] :
                                    ...
                                    @ ^ [X11: $i] :
                                        ...
                                        @ ^ [X12: $i] :
                                            ...
                                            @ ^ [X13: $i] :
                                                ( mexists_di
                                                @ ^ [X14: $i] : ( mand @ ( mbox @ ( seat @ X5 ) ) @ ( mand @ ( mbox @ ( furniture @ X5 ) ) @ ( mand @ ( mbox @ ( front @ X5 ) ) @ ( mand @ ( mbox @ ( hollywood @ X6 ) ) @ ( mand @ ( mbox @ ( city @ X6 ) ) @ ( mand @ ( mbox @ ( event @ X7 ) ) @ ( mand @ ( mbox @ ( chevy @ X8 ) ) @ ( mand @ ( mbox @ ( car @ X8 ) ) @ ( mand @ ( mbox @ ( white @ X8 ) ) @ ( mand @ ( mbox @ ( dirty @ X8 ) ) @ ( mand @ ( mbox @ ( old @ X8 ) ) @ ( mand @ ( mbox @ ( street @ X9 ) ) @ ( mand @ ( mbox @ ( way @ X9 ) ) @ ( mand @ ( mbox @ ( lonely @ X9 ) ) @ ( mand @ ( mbox @ ( barrel @ X7 @ X8 ) ) @ ( mand @ ( mbox @ ( down @ X7 @ X9 ) ) @ ( mand @ ( mbox @ ( in @ X7 @ X6 ) ) @ ( mand @ ( mbox @ ( seat @ X12 ) ) @ ( mand @ ( mbox @ ( furniture @ X12 ) ) @ ( mand @ ( mbox @ ( front @ X12 ) ) @ ( mand @ ( mbox @ ( mnot @ ( mbox @ ( qmltpeq @ X10 @ X11 ) ) ) ) @ ( mand @ ( mbox @ ( fellow @ X10 ) ) @ ( mand @ ( mbox @ ( man @ X10 ) ) @ ( mand @ ( mbox @ ( young @ X10 ) ) @ ( mand @ ( mbox @ ( fellow @ X11 ) ) @ ( mand @ ( mbox @ ( man @ X11 ) ) @ ( mand @ ( mbox @ ( young @ X11 ) ) @ ( mand @ ( mbox @ ( qmltpeq @ X10 @ X13 ) ) @ ( mand @ ( mbox @ ( in @ X13 @ X12 ) ) @ ( mand @ ( mbox @ ( qmltpeq @ X11 @ X14 ) ) @ ( mbox @ ( in @ X14 @ X5 ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )
      @ ( mbox
        @ ( mimplies
          @ ( mexists_di
            @ ^ [X15: $i] :
                                ...
                                @ ^ [X20: $i] :
                                    ...
                                    @ ^ [X21: $i] :
                                        ...
                                        @ ^ [X22: $i] :
                                            ...
                                            @ ^ [X23: $i] :
                                                ( mexists_di
                                                @ ^ [X24: $i] : ( mand @ ( mbox @ ( seat @ X15 ) ) @ ( mand @ ( mbox @ ( furniture @ X15 ) ) @ ( mand @ ( mbox @ ( front @ X15 ) ) @ ( mand @ ( mbox @ ( hollywood @ X16 ) ) @ ( mand @ ( mbox @ ( city @ X16 ) ) @ ( mand @ ( mbox @ ( event @ X17 ) ) @ ( mand @ ( mbox @ ( chevy @ X18 ) ) @ ( mand @ ( mbox @ ( car @ X18 ) ) @ ( mand @ ( mbox @ ( white @ X18 ) ) @ ( mand @ ( mbox @ ( dirty @ X18 ) ) @ ( mand @ ( mbox @ ( old @ X18 ) ) @ ( mand @ ( mbox @ ( street @ X19 ) ) @ ( mand @ ( mbox @ ( way @ X19 ) ) @ ( mand @ ( mbox @ ( lonely @ X19 ) ) @ ( mand @ ( mbox @ ( barrel @ X17 @ X18 ) ) @ ( mand @ ( mbox @ ( down @ X17 @ X19 ) ) @ ( mand @ ( mbox @ ( in @ X17 @ X16 ) ) @ ( mand @ ( mbox @ ( seat @ X22 ) ) @ ( mand @ ( mbox @ ( furniture @ X22 ) ) @ ( mand @ ( mbox @ ( front @ X22 ) ) @ ( mand @ ( mbox @ ( mnot @ ( mbox @ ( qmltpeq @ X20 @ X21 ) ) ) ) @ ( mand @ ( mbox @ ( fellow @ X20 ) ) @ ( mand @ ( mbox @ ( man @ X20 ) ) @ ( mand @ ( mbox @ ( young @ X20 ) ) @ ( mand @ ( mbox @ ( fellow @ X21 ) ) @ ( mand @ ( mbox @ ( man @ X21 ) ) @ ( mand @ ( mbox @ ( young @ X21 ) ) @ ( mand @ ( mbox @ ( qmltpeq @ X20 @ X23 ) ) @ ( mand @ ( mbox @ ( in @ X23 @ X22 ) ) @ ( mand @ ( mbox @ ( qmltpeq @ X21 @ X24 ) ) @ ( mbox @ ( in @ X24 @ X15 ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )
          @ ( mexists_di
            @ ^ [X25: $i] :
                ( mexists_di
                @ ^ [X26: $i] :
                            ...
                            @ ^ [X29: $i] :
                                ...
                                @ ^ [X30: $i] :
                                    ...
                                    @ ^ [X31: $i] :
                                        ...
                                        @ ^ [X33: $i] :
                                            ( mexists_di
                                            @ ^ [X34: $i] : ( mand @ ( mbox @ ( seat @ X25 ) ) @ ( mand @ ( mbox @ ( furniture @ X25 ) ) @ ( mand @ ( mbox @ ( front @ X25 ) ) @ ( mand @ ( mbox @ ( hollywood @ X26 ) ) @ ( mand @ ( mbox @ ( city @ X26 ) ) @ ( mand @ ( mbox @ ( event @ X27 ) ) @ ( mand @ ( mbox @ ( street @ X28 ) ) @ ( mand @ ( mbox @ ( way @ X28 ) ) @ ( mand @ ( mbox @ ( lonely @ X28 ) ) @ ( mand @ ( mbox @ ( chevy @ X29 ) ) @ ( mand @ ( mbox @ ( car @ X29 ) ) @ ( mand @ ( mbox @ ( white @ X29 ) ) @ ( mand @ ( mbox @ ( dirty @ X29 ) ) @ ( mand @ ( mbox @ ( old @ X29 ) ) @ ( mand @ ( mbox @ ( barrel @ X27 @ X29 ) ) @ ( mand @ ( mbox @ ( down @ X27 @ X28 ) ) @ ( mand @ ( mbox @ ( in @ X27 @ X26 ) ) @ ( mand @ ( mbox @ ( mnot @ ( mbox @ ( qmltpeq @ X30 @ X31 ) ) ) ) @ ( mand @ ( mbox @ ( fellow @ X30 ) ) @ ( mand @ ( mbox @ ( man @ X30 ) ) @ ( mand @ ( mbox @ ( young @ X30 ) ) @ ( mand @ ( mbox @ ( fellow @ X31 ) ) @ ( mand @ ( mbox @ ( man @ X31 ) ) @ ( mand @ ( mbox @ ( young @ X31 ) ) @ ( mand @ ( mbox @ ( qmltpeq @ X30 @ X33 ) ) @ ( mand @ ( mbox @ ( in @ X33 @ X25 ) ) @ ( mand @ ( mbox @ ( qmltpeq @ X31 @ X34 ) ) @ ( mbox @ ( in @ X34 @ X25 ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ).

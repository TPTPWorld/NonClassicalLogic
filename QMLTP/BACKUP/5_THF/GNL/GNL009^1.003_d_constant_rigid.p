%------------------------------------------------------------------------------
% File     : GNL009^1.003 : TPTP v8.1.0. Released v8.1.0.
...
%            Number of atoms       :  771 (  10 equ;   0 cnn)
%            Maximal formula atoms :  382 (  20 avg)
%            Number of connectives : 1010 (   1   ~;   1   |;   2   &;1003   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   56 (  13 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :  103 ( 103   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   34 (  33 usr;   1 con; 0-3 aty)
%            Number of variables   :  123 ( 117   ^   3   !;   3   ?; 123   :)
% SPC      : TH0_THM_EQU_NAR

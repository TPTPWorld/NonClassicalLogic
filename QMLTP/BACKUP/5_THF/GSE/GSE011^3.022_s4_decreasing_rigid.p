%------------------------------------------------------------------------------
% File     : GSE011^3.022 : TPTP v8.1.0. Released v8.1.0.
    ...
    @ ( mbox
      @ ( mforall_di
        @ ^ [B: $i] :
            ( mbox
            @ ( mforall_di
              @ ^ [C: $i] : ( mbox @ ( qmltpeq @ ( difference @ B @ ( difference @ B @ C ) ) @ ( intersection @ B @ C ) ) ) ) ) ) ) ) ).

%------------------------------------------------------------------------------
% File     : GSE012^4.022 : TPTP v8.1.0. Released v8.1.0.
    ...
    @ ( mbox
      @ ( mforall_di
        @ ^ [A: $i] :
            ( mbox
            @ ( mforall_di
              @ ^ [E: $i] : ( mbox @ ( mimplies @ ( mbox @ ( subset @ A @ E ) ) @ ( mbox @ ( equal_set @ ( difference @ E @ ( difference @ E @ A ) ) @ A ) ) ) ) ) ) ) ) ) ).

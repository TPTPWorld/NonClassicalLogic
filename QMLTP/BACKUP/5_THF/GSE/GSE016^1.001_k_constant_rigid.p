%------------------------------------------------------------------------------
% File     : GSE016^1.001 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  139 (  10 unt;  45 typ;  10 def)
%            Number of atoms       : 1254 (  10 equ;   0 cnn)
%            Maximal formula atoms :   32 (  13 avg)
%            Number of connectives : 1981 (   1   ~;   1   |;   2   &;1974   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   27 (  15 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :  104 ( 104   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   45 (  44 usr;   6 con; 0-3 aty)
%            Number of variables   :  228 ( 224   ^   2   !;   2   ?; 228   :)
% SPC      : TH0_UNK_EQU_NAR

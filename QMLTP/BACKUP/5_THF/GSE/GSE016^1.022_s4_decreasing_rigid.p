%------------------------------------------------------------------------------
% File     : GSE016^1.022 : TPTP v8.1.0. Released v8.1.0.
...
thf(ordered_pair_determines_components1,conjecture,
    ( mlocal
    @ ( mbox
      @ ( mforall_di
        @ ^ [W: $i] :
              ...
              @ ^ [X: $i] :
                  ...
                  @ ( mforall_di
                    @ ^ [Y: $i] :
                        ( mbox
                        @ ( mforall_di
                          @ ^ [Z: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( qmltpeq @ ( ordered_pair @ W @ X ) @ ( ordered_pair @ Y @ Z ) ) ) @ ( mbox @ ( member @ W @ universal_class ) ) ) @ ( mbox @ ( qmltpeq @ W @ Y ) ) ) ) ) ) ) ) ) ) ) ) ) ).

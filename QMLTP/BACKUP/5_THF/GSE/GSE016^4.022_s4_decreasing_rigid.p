%------------------------------------------------------------------------------
% File     : GSE016^4.022 : TPTP v8.1.0. Released v8.1.0.
              ...
              @ ^ [B: $i] :
                  ...
                  @ ( mforall_di
                    @ ^ [U: $i] :
                        ( mbox
                        @ ( mforall_di
                          @ ^ [V: $i] : ( mbox @ ( mimplies @ ( mbox @ ( equal_set @ ( unordered_pair @ ( singleton @ A ) @ ( unordered_pair @ A @ B ) ) @ ( unordered_pair @ ( singleton @ U ) @ ( unordered_pair @ U @ V ) ) ) ) @ ( mbox @ ( qmltpeq @ A @ U ) ) ) ) ) ) ) ) ) ) ) ) ) ).

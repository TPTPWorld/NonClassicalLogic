%------------------------------------------------------------------------------
% File     : GSE017^1.007 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  141 (  11 unt;  46 typ;  10 def)
%            Number of atoms       : 1258 (  10 equ;   0 cnn)
%            Maximal formula atoms :   32 (  13 avg)
%            Number of connectives : 1992 (   1   ~;   1   |;   3   &;1983   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)

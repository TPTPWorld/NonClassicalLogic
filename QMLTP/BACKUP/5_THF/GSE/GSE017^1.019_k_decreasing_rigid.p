%------------------------------------------------------------------------------
% File     : GSE017^1.019 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  142 (  11 unt;  46 typ;  10 def)
%            Number of atoms       : 1261 (  10 equ;   0 cnn)
%            Maximal formula atoms :   32 (  13 avg)
%            Number of connectives : 2000 (   1   ~;   1   |;   4   &;1989   @)
%                                         (   1 <=>;   4  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   27 (  14 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :  106 ( 106   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   46 (  45 usr;   6 con; 0-3 aty)
%            Number of variables   :  232 ( 223   ^   6   !;   3   ?; 232   :)
% SPC      : TH0_UNK_EQU_NAR

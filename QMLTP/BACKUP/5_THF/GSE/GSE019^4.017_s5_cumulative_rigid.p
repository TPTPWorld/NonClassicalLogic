%------------------------------------------------------------------------------
% File     : GSE019^4.017 : TPTP v8.1.0. Released v8.1.0.
...
%            Number of atoms       :  583 (  10 equ;   0 cnn)
%            Maximal formula atoms :   30 (  12 avg)
%            Number of connectives :  851 (   1   ~;   1   |;   5   &; 838   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)
    ...
    @ ( mbox
      @ ( mforall_di
        @ ^ [A: $i] :
            ( mbox
            @ ( mforall_di
              @ ^ [B: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( subset @ A @ B ) ) @ ( mbox @ ( subset @ B @ A ) ) ) @ ( mbox @ ( equal_set @ A @ B ) ) ) ) ) ) ) ) ) ).

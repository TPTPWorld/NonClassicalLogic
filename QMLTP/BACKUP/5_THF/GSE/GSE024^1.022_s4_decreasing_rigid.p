%------------------------------------------------------------------------------
% File     : GSE024^1.022 : TPTP v8.1.0. Released v8.1.0.
...
%            Number of connectives : 1993 (   1   ~;   1   |;   5   &;1980   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)
...
thf(set_in_its_singleton,conjecture,
    ...
    @ ( mbox
      @ ( mforall_di
        @ ^ [X: $i] : ( mbox @ ( mimplies @ ( mbox @ ( member @ X @ universal_class ) ) @ ( mbox @ ( member @ X @ ( singleton @ X ) ) ) ) ) ) ) ) ).

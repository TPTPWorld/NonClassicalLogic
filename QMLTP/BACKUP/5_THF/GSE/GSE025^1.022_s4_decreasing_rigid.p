%------------------------------------------------------------------------------
% File     : GSE025^1.022 : TPTP v8.1.0. Released v8.1.0.
...
thf(ordered_pair_is_set,conjecture,
    ( mlocal
    @ ( mbox
      @ ( mforall_di
        @ ^ [X: $i] :
            ( mbox
            @ ( mforall_di
              @ ^ [Y: $i] : ( mbox @ ( member @ ( ordered_pair @ X @ Y ) @ universal_class ) ) ) ) ) ) ) ).

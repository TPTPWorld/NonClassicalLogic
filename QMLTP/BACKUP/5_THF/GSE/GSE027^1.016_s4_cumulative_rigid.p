%------------------------------------------------------------------------------
% File     : GSE027^1.016 : TPTP v8.1.0. Released v8.1.0.
...
%            Number of connectives : 2001 (   1   ~;   1   |;   5   &;1988   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)
        ...
        @ ^ [X: $i] :
            ...
            @ ( mforall_di
              @ ^ [Y: $i] :
                  ( mbox
                  @ ( mforall_di
                    @ ^ [Z: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( subclass @ X @ Y ) ) @ ( mbox @ ( subclass @ Y @ Z ) ) ) @ ( mbox @ ( subclass @ X @ Z ) ) ) ) ) ) ) ) ) ) ) ).

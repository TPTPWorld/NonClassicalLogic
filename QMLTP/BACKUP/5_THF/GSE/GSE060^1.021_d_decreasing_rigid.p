%------------------------------------------------------------------------------
% File     : GSE060^1.021 : TPTP v8.1.0. Released v8.1.0.
...
%            Number of atoms       : 1252 (  10 equ;   0 cnn)
%            Maximal formula atoms :   32 (  12 avg)
%            Number of connectives : 1985 (   1   ~;   1   |;   4   &;1974   @)
%                                         (   1 <=>;   4  =>;   0  <=;   0 <~>)
    ...
    @ ( mbox
      @ ( mforall_di
        @ ^ [X: $i] :
            ( mbox
            @ ( mforall_di
              @ ^ [Y: $i] : ( mbox @ ( mnot @ ( mbox @ ( member @ Y @ ( intersection @ ( complement @ X ) @ X ) ) ) ) ) ) ) ) ) ) ).

%------------------------------------------------------------------------------
% File     : GSE063^3.012 : TPTP v8.1.0. Released v8.1.0.
...
%            Number of atoms       :  240 (  10 equ;   0 cnn)
...
%            Number of variables   :   64 (  56   ^   5   !;   3   ?;  64   :)
% SPC      : TH0_THM_EQU_NAR
...
thf(prove_subset_of_empty_set_is_empty_set,conjecture,
    ...
    @ ( mbox
      @ ( mforall_di
        @ ^ [B: $i] : ( mbox @ ( mimplies @ ( mbox @ ( subset @ B @ empty_set ) ) @ ( mbox @ ( qmltpeq @ B @ empty_set ) ) ) ) ) ) ) ).

%------------------------------------------------------------------------------
% File     : GSE063^4.012 : TPTP v8.1.0. Released v8.1.0.
...
%            Number of atoms       :  568 (  10 equ;   0 cnn)
%            Maximal formula atoms :   30 (  12 avg)
%            Number of connectives :  824 (   1   ~;   1   |;   3   &; 815   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)
...
thf(thI17,conjecture,
    ...
    @ ( mbox
      @ ( mforall_di
        @ ^ [A: $i] : ( mbox @ ( equal_set @ ( intersection @ A @ empty_set ) @ empty_set ) ) ) ) ) ).

%------------------------------------------------------------------------------
% File     : GSE578^3.006 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Theorem 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   44 (  11 unt;  17 typ;  10 def)
%            Number of atoms       :  313 (  10 equ;   0 cnn)
%            Maximal formula atoms :   44 (  11 avg)
%            Number of connectives :  439 (   1   ~;   1   |;   2   &; 432   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   26 (  11 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :   68 (  68   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   17 (  16 usr;   1 con; 0-3 aty)
%            Number of variables   :   73 (  67   ^   4   !;   2   ?;  73   :)
% SPC      : TH0_THM_EQU_NAR
                  ...
                  @ ( mforall_di
                    @ ^ [D: $i] :
                        ...
                        @ ( mimplies
                          @ ( mbox
                            @ ( mforall_di
                              @ ^ [E: $i] : ( mand @ ( mbox @ ( mimplies @ ( mbox @ ( member @ E @ B ) ) @ ( mand @ ( mbox @ ( member @ E @ C ) ) @ ( mbox @ ( member @ E @ D ) ) ) ) ) @ ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( member @ E @ C ) ) @ ( mbox @ ( member @ E @ D ) ) ) @ ( mbox @ ( member @ E @ B ) ) ) ) ) ) )
                          @ ( mbox @ ( qmltpeq @ B @ ( intersection @ C @ D ) ) ) ) ) ) ) ) ) ) ) ) ).

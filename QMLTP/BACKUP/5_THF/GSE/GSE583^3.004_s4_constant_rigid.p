%------------------------------------------------------------------------------
% File     : GSE583^3.004 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Theorem 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   39 (  11 unt;  16 typ;  10 def)
...
%            Number of variables   :   58 (  50   ^   6   !;   2   ?;  58   :)
% SPC      : TH0_THM_EQU_NAR
    ...
    @ ( mbox
      @ ( mforall_di
        @ ^ [B: $i] :
            ( mbox
            @ ( mforall_di
              @ ^ [C: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( subset @ B @ C ) ) @ ( mbox @ ( subset @ C @ B ) ) ) @ ( mbox @ ( qmltpeq @ B @ C ) ) ) ) ) ) ) ) ) ).

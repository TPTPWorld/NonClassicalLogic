%------------------------------------------------------------------------------
% File     : GSE903^1.023 : TPTP v8.1.0. Released v8.1.0.
...
%            Number of atoms       :  233 (  10 equ;   0 cnn)
%            Maximal formula atoms :   35 (   7 avg)
%            Number of connectives :  329 (   1   ~;   1   |;   5   &; 316   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)
        ...
        @ ^ [A: $i] :
            ...
            @ ( mforall_di
              @ ^ [B: $i] :
                  ( mbox
                  @ ( mforall_di
                    @ ^ [C: $i] : ( mbox @ ( mnot @ ( mand @ ( mbox @ ( qmltpeq @ ( singleton @ A ) @ ( set_union2 @ B @ C ) ) ) @ ( mand @ ( mbox @ ( mnot @ ( mbox @ ( qmltpeq @ B @ C ) ) ) ) @ ( mand @ ( mbox @ ( mnot @ ( mbox @ ( qmltpeq @ B @ empty_set ) ) ) ) @ ( mbox @ ( mnot @ ( mbox @ ( qmltpeq @ C @ empty_set ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ).

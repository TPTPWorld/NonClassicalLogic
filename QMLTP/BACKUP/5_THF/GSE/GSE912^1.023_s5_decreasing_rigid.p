%------------------------------------------------------------------------------
% File     : GSE912^1.023 : TPTP v8.1.0. Released v8.1.0.
    ...
    @ ( mbox
      @ ( mforall_di
        @ ^ [A: $i] :
            ( mbox
            @ ( mforall_di
              @ ^ [B: $i] : ( mbox @ ( mimplies @ ( mbox @ ( subset @ A @ B ) ) @ ( mbox @ ( qmltpeq @ ( set_intersection2 @ A @ B ) @ A ) ) ) ) ) ) ) ) ) ).
        ...
        @ ^ [A: $i] :
            ...
            @ ( mforall_di
              @ ^ [B: $i] :
                  ( mbox
                  @ ( mforall_di
                    @ ^ [C: $i] : ( mand @ ( mbox @ ( mimplies @ ( mbox @ ( subset @ ( unordered_pair @ A @ B ) @ C ) ) @ ( mand @ ( mbox @ ( in @ A @ C ) ) @ ( mbox @ ( in @ B @ C ) ) ) ) ) @ ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( in @ A @ C ) ) @ ( mbox @ ( in @ B @ C ) ) ) @ ( mbox @ ( subset @ ( unordered_pair @ A @ B ) @ C ) ) ) ) ) ) ) ) ) ) ) ) ).
        ...
        @ ^ [A: $i] :
            ...
            @ ( mforall_di
              @ ^ [B: $i] :
                  ( mbox
                  @ ( mforall_di
                    @ ^ [C: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( in @ A @ B ) ) @ ( mbox @ ( in @ C @ B ) ) ) @ ( mbox @ ( qmltpeq @ ( set_intersection2 @ ( unordered_pair @ A @ C ) @ B ) @ ( unordered_pair @ A @ C ) ) ) ) ) ) ) ) ) ) ) ) ).

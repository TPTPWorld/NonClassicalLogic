%------------------------------------------------------------------------------
% File     : GSE913^1.024 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Theorem 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   37 (  12 unt;  18 typ;  10 def)
%            Number of atoms       :   87 (  10 equ;   0 cnn)
%            Maximal formula atoms :   13 (   4 avg)
%            Number of connectives :  117 (   1   ~;   1   |;   4   &; 106   @)
%                                         (   1 <=>;   4  =>;   0  <=;   0 <~>)
    ...
    @ ( mbox
      @ ( mforall_di
        @ ^ [A: $i] :
            ( mbox
            @ ( mforall_di
              @ ^ [B: $i] : ( mbox @ ( mnot @ ( mand @ ( mbox @ ( disjoint @ ( singleton @ A ) @ B ) ) @ ( mbox @ ( in @ A @ B ) ) ) ) ) ) ) ) ) ) ).

%------------------------------------------------------------------------------
% File     : GSE918^1.006 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Theorem 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   51 (  11 unt;  19 typ;  10 def)
%            Number of atoms       :  387 (  10 equ;   0 cnn)
%            Maximal formula atoms :   58 (  12 avg)
%            Number of connectives :  557 (   1   ~;   1   |;   2   &; 550   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   27 (  11 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :   70 (  70   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   19 (  18 usr;   1 con; 0-3 aty)
%            Number of variables   :   84 (  78   ^   4   !;   2   ?;  84   :)
% SPC      : TH0_THM_EQU_NAR
        ...
        @ ^ [A: $i] :
            ...
            @ ( mforall_di
              @ ^ [B: $i] :
                  ( mbox
                  @ ( mforall_di
                    @ ^ [C: $i] : ( mbox @ ( mnot @ ( mand @ ( mbox @ ( qmltpeq @ ( set_intersection2 @ ( unordered_pair @ A @ B ) @ C ) @ ( singleton @ A ) ) ) @ ( mand @ ( mbox @ ( in @ B @ C ) ) @ ( mbox @ ( mnot @ ( mbox @ ( qmltpeq @ A @ B ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ).

%------------------------------------------------------------------------------
% File     : GSE919^1.024 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   54 (  12 unt;  20 typ;  10 def)
%            Number of atoms       :  395 (  10 equ;   0 cnn)
%            Maximal formula atoms :   58 (  11 avg)
%            Number of connectives :  577 (   1   ~;   1   |;   4   &; 566   @)
%                                         (   1 <=>;   4  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   27 (  11 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :   72 (  72   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   20 (  19 usr;   1 con; 0-3 aty)
%            Number of variables   :   89 (  78   ^   8   !;   3   ?;  89   :)
% SPC      : TH0_UNK_EQU_NAR
        ...
        @ ^ [A: $i] :
            ...
            @ ( mforall_di
              @ ^ [B: $i] :
                  ( mand
                  @ ( mbox
                    @ ( mimplies @ ( mbox @ ( qmltpeq @ B @ ( singleton @ A ) ) )
                      @ ( mbox
                        @ ( mforall_di
                          @ ^ [C: $i] : ( mand @ ( mbox @ ( mimplies @ ( mbox @ ( in @ C @ B ) ) @ ( mbox @ ( qmltpeq @ C @ A ) ) ) ) @ ( mbox @ ( mimplies @ ( mbox @ ( qmltpeq @ C @ A ) ) @ ( mbox @ ( in @ C @ B ) ) ) ) ) ) ) ) )
                  @ ( mbox
                    @ ( mimplies
                      @ ( mbox
                        @ ( mforall_di
                          @ ^ [C: $i] : ( mand @ ( mbox @ ( mimplies @ ( mbox @ ( in @ C @ B ) ) @ ( mbox @ ( qmltpeq @ C @ A ) ) ) ) @ ( mbox @ ( mimplies @ ( mbox @ ( qmltpeq @ C @ A ) ) @ ( mbox @ ( in @ C @ B ) ) ) ) ) ) )
                      @ ( mbox @ ( qmltpeq @ B @ ( singleton @ A ) ) ) ) ) ) ) ) ) ) ) ).
        ...
        @ ^ [A: $i] :
            ...
            @ ( mforall_di
              @ ^ [B: $i] :
                  ( mbox
                  @ ( mforall_di
                    @ ^ [C: $i] : ( mbox @ ( mimplies @ ( mbox @ ( in @ A @ B ) ) @ ( mor @ ( mand @ ( mbox @ ( in @ C @ B ) ) @ ( mbox @ ( mnot @ ( mbox @ ( qmltpeq @ A @ C ) ) ) ) ) @ ( mbox @ ( qmltpeq @ ( set_intersection2 @ ( unordered_pair @ A @ C ) @ B ) @ ( singleton @ A ) ) ) ) ) ) ) ) ) ) ) ) ) ).

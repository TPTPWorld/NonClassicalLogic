%------------------------------------------------------------------------------
% File     : GSV010^1.003 : TPTP v8.1.0. Released v8.1.0.
...
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   61 (  11 unt;  36 typ;  10 def)
%            Number of atoms       :  138 (  10 equ;   0 cnn)
%            Maximal formula atoms :   27 (   5 avg)
%            Number of connectives :  265 (   1   ~;   1   |;   2   &; 258   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   37 (   8 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :   92 (  92   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   36 (  35 usr;   7 con; 0-4 aty)
%            Number of variables   :   47 (  41   ^   3   !;   3   ?;  47   :)
% SPC      : TH0_CSA_EQU_NAR

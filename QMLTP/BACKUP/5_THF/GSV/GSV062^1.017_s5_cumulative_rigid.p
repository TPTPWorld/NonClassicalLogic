%------------------------------------------------------------------------------
% File     : GSV062^1.017 : TPTP v8.1.0. Released v8.1.0.
...
%            Number of connectives : 3158 (   1   ~;   1   |;   5   &;3145   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)
...
thf(cl5_nebula_array_0003,conjecture,
    mlocal @ ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ pv10 ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv41 ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv43 ) ) @ ( mand @ ( mbox @ ( leq @ pv10 @ ( minus @ n135300 @ n1 ) ) ) @ ( mand @ ( mbox @ ( leq @ pv41 @ ( minus @ n5 @ n1 ) ) ) @ ( mbox @ ( leq @ pv43 @ ( minus @ n5 @ n1 ) ) ) ) ) ) ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv10 ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv41 ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv43 ) ) @ ( mand @ ( mbox @ ( leq @ pv10 @ ( minus @ n135300 @ n1 ) ) ) @ ( mand @ ( mbox @ ( leq @ pv41 @ ( minus @ n5 @ n1 ) ) ) @ ( mbox @ ( leq @ pv43 @ ( minus @ n5 @ n1 ) ) ) ) ) ) ) ) ) ) ).

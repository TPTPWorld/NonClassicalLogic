%------------------------------------------------------------------------------
% File     : GSV063^1.004 : TPTP v8.1.0. Released v8.1.0.
...
thf(cl5_nebula_array_0004,conjecture,
    mlocal @ ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ pv10 ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv43 ) ) @ ( mand @ ( mbox @ ( leq @ pv10 @ ( minus @ n135300 @ n1 ) ) ) @ ( mbox @ ( leq @ pv43 @ ( minus @ n5 @ n1 ) ) ) ) ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv10 ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv43 ) ) @ ( mand @ ( mbox @ ( leq @ pv10 @ ( minus @ n135300 @ n1 ) ) ) @ ( mbox @ ( leq @ pv43 @ ( minus @ n5 @ n1 ) ) ) ) ) ) ) ) ).

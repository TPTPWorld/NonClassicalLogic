%------------------------------------------------------------------------------
% File     : GSV068^1.017 : TPTP v8.1.0. Released v8.1.0.
...
%            Number of connectives : 3101 (   1   ~;   1   |;   5   &;3088   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)
...
thf(cl5_nebula_array_0009,conjecture,
    mlocal @ ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ pv10 ) ) @ ( mbox @ ( leq @ pv10 @ ( minus @ n135300 @ n1 ) ) ) ) @ ( mbox @ true ) ) ) ).

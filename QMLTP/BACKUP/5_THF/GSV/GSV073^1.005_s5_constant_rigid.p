%------------------------------------------------------------------------------
% File     : GSV073^1.005 : TPTP v8.1.0. Released v8.1.0.
...
thf(cl5_nebula_array_0014,conjecture,
    mlocal @ ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ pv31 ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv35 ) ) @ ( mand @ ( mbox @ ( leq @ pv31 @ ( minus @ n5 @ n1 ) ) ) @ ( mbox @ ( leq @ pv35 @ ( minus @ n135300 @ n1 ) ) ) ) ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv31 ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv35 ) ) @ ( mand @ ( mbox @ ( leq @ pv31 @ ( minus @ n5 @ n1 ) ) ) @ ( mbox @ ( leq @ pv35 @ ( minus @ n135300 @ n1 ) ) ) ) ) ) ) ) ).

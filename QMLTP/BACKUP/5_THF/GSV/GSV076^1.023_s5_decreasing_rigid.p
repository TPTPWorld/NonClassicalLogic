%------------------------------------------------------------------------------
% File     : GSV076^1.023 : TPTP v8.1.0. Released v8.1.0.
...
thf(cl5_nebula_array_0017,conjecture,
    mlocal @ ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ pv31 ) ) @ ( mbox @ ( leq @ pv31 @ ( minus @ n5 @ n1 ) ) ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv31 ) ) @ ( mbox @ ( leq @ pv31 @ ( minus @ n5 @ n1 ) ) ) ) ) ) ).

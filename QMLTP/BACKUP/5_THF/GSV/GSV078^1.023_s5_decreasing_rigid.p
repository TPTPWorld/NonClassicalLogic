%------------------------------------------------------------------------------
% File     : GSV078^1.023 : TPTP v8.1.0. Released v8.1.0.
...
%            Number of atoms       : 1928 (  10 equ;   0 cnn)
%            Maximal formula atoms :   97 (  13 avg)
%            Number of connectives : 3099 (   1   ~;   1   |;   5   &;3086   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)
...
thf(cl5_nebula_array_0019,conjecture,
    mlocal @ ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ pv31 ) ) @ ( mbox @ ( leq @ pv31 @ ( minus @ n5 @ n1 ) ) ) ) @ ( mand @ ( mbox @ ( mimplies @ ( mbox @ ( mnot @ ( mbox @ ( customqmltpeq @ n0 @ pv70 ) ) ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv31 ) ) @ ( mbox @ ( leq @ pv31 @ ( minus @ n5 @ n1 ) ) ) ) ) ) @ ( mbox @ ( mimplies @ ( mbox @ ( customqmltpeq @ n0 @ pv70 ) ) @ ( mbox @ true ) ) ) ) ) ) ).

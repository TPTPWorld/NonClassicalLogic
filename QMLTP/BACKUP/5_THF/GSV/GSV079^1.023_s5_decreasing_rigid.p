%------------------------------------------------------------------------------
% File     : GSV079^1.023 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  205 (  12 unt;  50 typ;  10 def)
%            Number of atoms       : 1945 (  10 equ;   0 cnn)
%            Maximal formula atoms :   97 (  12 avg)
%            Number of connectives : 3139 (   1   ~;   1   |;   5   &;3126   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)
...
thf(cl5_nebula_array_0020,conjecture,
    mlocal @ ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ pv51 ) ) @ ( mbox @ ( leq @ pv51 @ ( minus @ n5 @ n1 ) ) ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ n0 ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv51 ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ ( uniform_int_rnd @ n1 @ ( minus @ ( minus @ n135300 @ n1 ) @ n0 ) ) ) ) @ ( mand @ ( mbox @ ( leq @ pv51 @ ( minus @ n5 @ n1 ) ) ) @ ( mbox @ ( leq @ ( uniform_int_rnd @ n1 @ ( minus @ ( minus @ n135300 @ n1 ) @ n0 ) ) @ ( minus @ n135300 @ n1 ) ) ) ) ) ) ) ) ) ).

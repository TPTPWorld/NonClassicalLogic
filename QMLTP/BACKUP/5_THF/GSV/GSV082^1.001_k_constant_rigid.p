%------------------------------------------------------------------------------
% File     : GSV082^1.001 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Theorem 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  192 (  10 unt;  48 typ;  10 def)
%            Number of atoms       : 1905 (  10 equ;   0 cnn)
%            Maximal formula atoms :   97 (  13 avg)
%            Number of connectives : 3056 (   1   ~;   1   |;   2   &;3049   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)

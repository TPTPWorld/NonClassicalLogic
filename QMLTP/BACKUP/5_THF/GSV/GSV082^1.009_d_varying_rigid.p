%------------------------------------------------------------------------------
% File     : GSV082^1.009 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Theorem 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  195 (  12 unt;  49 typ;  10 def)
%            Number of atoms       : 1909 (  10 equ;   0 cnn)
%            Maximal formula atoms :   97 (  13 avg)
%            Number of connectives : 3066 (   1   ~;   1   |;   3   &;3057   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)

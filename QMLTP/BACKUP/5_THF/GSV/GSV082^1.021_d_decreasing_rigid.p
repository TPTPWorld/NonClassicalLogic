%------------------------------------------------------------------------------
% File     : GSV082^1.021 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Theorem 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  196 (  12 unt;  49 typ;  10 def)
%            Number of atoms       : 1912 (  10 equ;   0 cnn)
%            Maximal formula atoms :   97 (  13 avg)
%            Number of connectives : 3074 (   1   ~;   1   |;   4   &;3063   @)
%                                         (   1 <=>;   4  =>;   0  <=;   0 <~>)

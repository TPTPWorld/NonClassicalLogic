%------------------------------------------------------------------------------
% File     : GSV082^1.022 : TPTP v8.1.0. Released v8.1.0.
...
thf(cl5_nebula_array_0023,conjecture,
    mlocal @ ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ pv58 ) ) @ ( mbox @ ( leq @ pv58 @ ( minus @ n5 @ n1 ) ) ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ pv58 ) ) @ ( mbox @ ( leq @ pv58 @ ( minus @ n5 @ n1 ) ) ) ) ) ) ).

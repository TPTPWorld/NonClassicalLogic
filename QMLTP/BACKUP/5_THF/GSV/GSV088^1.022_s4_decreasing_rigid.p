%------------------------------------------------------------------------------
% File     : GSV088^1.022 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Theorem 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  204 (  12 unt;  49 typ;  10 def)
%            Number of atoms       : 1930 (  10 equ;   0 cnn)
%            Maximal formula atoms :   97 (  12 avg)
%            Number of connectives : 3096 (   1   ~;   1   |;   5   &;3083   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)
...
thf(cl5_nebula_array_0029,conjecture,
    mlocal @ ( mbox @ ( mimplies @ ( mbox @ ( geq @ ( minus @ n135300 @ n1 ) @ n0 ) ) @ ( mbox @ true ) ) ) ).

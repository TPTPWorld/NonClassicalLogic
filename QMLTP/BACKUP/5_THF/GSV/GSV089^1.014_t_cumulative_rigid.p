%------------------------------------------------------------------------------
% File     : GSV089^1.014 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  197 (  12 unt;  50 typ;  10 def)
%            Number of atoms       : 1921 (  10 equ;   0 cnn)
%            Maximal formula atoms :   97 (  13 avg)
%            Number of connectives : 3224 (   1   ~;   1   |;   4   &;3213   @)
%                                         (   1 <=>;   4  =>;   0  <=;   0 <~>)

%------------------------------------------------------------------------------
% File     : GSV090^1.016 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  201 (  12 unt;  53 typ;  10 def)
%            Number of atoms       : 2011 (  10 equ;   0 cnn)
%            Maximal formula atoms :  109 (  13 avg)
%            Number of connectives : 3424 (   1   ~;   1   |;   5   &;3411   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   51 (  15 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :  113 ( 113   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   53 (  52 usr;  16 con; 0-4 aty)
%            Number of variables   :  364 ( 351   ^  10   !;   3   ?; 364   :)
% SPC      : TH0_UNK_EQU_NAR
...
thf(quaternion_ds1_inuse_0002,conjecture,
    mlocal @ ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ rho_defuse @ n0 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ rho_defuse @ n1 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ rho_defuse @ n2 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ sigma_defuse @ n0 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ sigma_defuse @ n1 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ sigma_defuse @ n2 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ sigma_defuse @ n3 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ sigma_defuse @ n4 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ sigma_defuse @ n5 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select3 @ u_defuse @ n0 @ n0 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select3 @ u_defuse @ n1 @ n0 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select3 @ u_defuse @ n2 @ n0 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_defuse @ n3 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_defuse @ n4 ) @ use ) ) @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_defuse @ n5 ) @ use ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ rho_defuse @ n0 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ rho_defuse @ n1 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ rho_defuse @ n2 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ sigma_defuse @ n0 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ sigma_defuse @ n1 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ sigma_defuse @ n2 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ sigma_defuse @ n3 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ sigma_defuse @ n4 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ sigma_defuse @ n5 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select3 @ u_defuse @ n0 @ n0 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select3 @ u_defuse @ n1 @ n0 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select3 @ u_defuse @ n2 @ n0 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_defuse @ n3 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_defuse @ n4 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_defuse @ n5 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ xinit_mean_defuse @ n0 @ use ) @ n1 @ use ) @ n2 @ use ) @ n3 @ use ) @ n4 @ use ) @ n5 @ use ) @ n0 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ xinit_mean_defuse @ n0 @ use ) @ n1 @ use ) @ n2 @ use ) @ n3 @ use ) @ n4 @ use ) @ n5 @ use ) @ n1 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ xinit_mean_defuse @ n0 @ use ) @ n1 @ use ) @ n2 @ use ) @ n3 @ use ) @ n4 @ use ) @ n5 @ use ) @ n2 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ xinit_mean_defuse @ n0 @ use ) @ n1 @ use ) @ n2 @ use ) @ n3 @ use ) @ n4 @ use ) @ n5 @ use ) @ n3 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ xinit_mean_defuse @ n0 @ use ) @ n1 @ use ) @ n2 @ use ) @ n3 @ use ) @ n4 @ use ) @ n5 @ use ) @ n4 ) @ use ) ) @ ( mbox @ ( customqmltpeq @ ( a_select2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ xinit_mean_defuse @ n0 @ use ) @ n1 @ use ) @ n2 @ use ) @ n3 @ use ) @ n4 @ use ) @ n5 @ use ) @ n5 ) @ use ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ).

%------------------------------------------------------------------------------
% File     : GSV092^1.023 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  203 (  12 unt;  55 typ;  10 def)
%            Number of atoms       : 2088 (  10 equ;   0 cnn)
%            Maximal formula atoms :  186 (  14 avg)
%            Number of connectives : 3485 (   1   ~;   1   |;   5   &;3472   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   51 (  15 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :  113 ( 113   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   55 (  54 usr;  18 con; 0-4 aty)
%            Number of variables   :  366 ( 353   ^  10   !;   3   ?; 366   :)
% SPC      : TH0_UNK_EQU_NAR
...
thf(quaternion_ds1_inuse_0004,conjecture,
    ( mlocal
    @ ( mbox
      @ ( mimplies @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ rho_defuse @ n0 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ rho_defuse @ n1 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ rho_defuse @ n2 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ sigma_defuse @ n0 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ sigma_defuse @ n1 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ sigma_defuse @ n2 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ sigma_defuse @ n3 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ sigma_defuse @ n4 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ sigma_defuse @ n5 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select3 @ u_defuse @ n0 @ n0 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select3 @ u_defuse @ n1 @ n0 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select3 @ u_defuse @ n2 @ n0 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_defuse @ n3 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_defuse @ n4 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_defuse @ n5 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_mean_defuse @ n0 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_mean_defuse @ n1 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_mean_defuse @ n2 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_mean_defuse @ n3 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_mean_defuse @ n4 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_mean_defuse @ n5 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_noise_defuse @ n0 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_noise_defuse @ n1 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_noise_defuse @ n2 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_noise_defuse @ n3 ) @ use ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_noise_defuse @ n4 ) @ use ) ) @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_noise_defuse @ n5 ) @ use ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )
                                                              ...
                                                              @ ( mbox
                                                                @ ( mforall_di
                                                                  @ ^ [A: $i] :
                                                                      ( mbox
                                                                      @ ( mforall_di
                                                                        @ ^ [B: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ A ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ B ) ) @ ( mand @ ( mbox @ ( leq @ A @ n2 ) ) @ ( mbox @ ( leq @ B @ ( minus @ n0 @ n1 ) ) ) ) ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select3 @ u_defuse @ A @ B ) @ use ) ) @ ( mbox @ ( customqmltpeq @ ( a_select3 @ z_defuse @ A @ B ) @ use ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ).

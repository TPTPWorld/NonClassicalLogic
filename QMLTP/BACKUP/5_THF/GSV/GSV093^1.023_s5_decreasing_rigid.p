%------------------------------------------------------------------------------
% File     : GSV093^1.023 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Theorem 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  224 (  12 unt;  59 typ;  10 def)
%            Number of atoms       : 2253 (  10 equ;   0 cnn)
%            Maximal formula atoms :  273 (  13 avg)
%            Number of connectives : 3763 (   1   ~;   1   |;   5   &;3750   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   54 (  14 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :  113 ( 113   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   59 (  58 usr;  22 con; 0-4 aty)
%            Number of variables   :  373 ( 360   ^  10   !;   3   ?; 373   :)
% SPC      : TH0_THM_EQU_NAR
...
thf(quaternion_ds1_inuse_0005,conjecture,
    ( mlocal
    @ ( mbox
      @ ( mimplies
                                                          ...
                                                          @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_noise_defuse @ n4 ) @ use ) )
                                                            @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_noise_defuse @ n5 ) @ use ) )
                                                              @ ( mand @ ( mbox @ ( leq @ n0 @ pv5 ) )
                                                                @ ( mand @ ( mbox @ ( leq @ n0 @ pv41 ) )
                                                                  @ ( mand @ ( mbox @ ( leq @ pv5 @ ( minus @ n999 @ n1 ) ) )
                                                                    @ ( mand @ ( mbox @ ( leq @ pv41 @ ( minus @ n6 @ n1 ) ) )
                                                                      @ ( mand
                                                                        @ ( mbox
                                                                          @ ( mforall_di
                                                                            @ ^ [A: $i] :
                                                                                ( mbox
                                                                                @ ( mforall_di
                                                                                  @ ^ [B: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ A ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ B ) ) @ ( mand @ ( mbox @ ( leq @ A @ n2 ) ) @ ( mbox @ ( leq @ B @ pv5 ) ) ) ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select3 @ u_defuse @ A @ B ) @ use ) ) @ ( mbox @ ( customqmltpeq @ ( a_select3 @ z_defuse @ A @ B ) @ use ) ) ) ) ) ) ) ) )
                                                                        @ ( mbox
                                                                          @ ( mforall_di
                                                                            @ ^ [C: $i] :
                                                                                ( mbox
                                                                                @ ( mforall_di
                                                                                  @ ^ [D: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ C ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ D ) ) @ ( mand @ ( mbox @ ( leq @ C @ n2 ) ) @ ( mbox @ ( leq @ D @ ( minus @ pv5 @ n1 ) ) ) ) ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select3 @ u_defuse @ C @ D ) @ use ) ) @ ( mbox @ ( customqmltpeq @ ( a_select3 @ z_defuse @ C @ D ) @ use ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )
        @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ rho_defuse @ n0 ) @ use ) )
          @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ rho_defuse @ n1 ) @ use ) )
            @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ rho_defuse @ n2 ) @ use ) )
              @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ sigma_defuse @ n0 ) @ use ) )
                                                                    ...
                                                                    @ ( mbox
                                                                      @ ( mforall_di
                                                                        @ ^ [E: $i] :
                                                                            ( mbox
                                                                            @ ( mforall_di
                                                                              @ ^ [F: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ E ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ F ) ) @ ( mand @ ( mbox @ ( leq @ E @ n2 ) ) @ ( mbox @ ( leq @ F @ pv5 ) ) ) ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select3 @ u_defuse @ E @ F ) @ use ) ) @ ( mbox @ ( customqmltpeq @ ( a_select3 @ z_defuse @ E @ F ) @ use ) ) ) ) ) ) ) ) )
                                                                    @ ( mbox
                                                                      @ ( mforall_di
                                                                        @ ^ [G: $i] :
                                                                            ( mbox
                                                                            @ ( mforall_di
                                                                              @ ^ [H: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ G ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ H ) ) @ ( mand @ ( mbox @ ( leq @ G @ n2 ) ) @ ( mbox @ ( leq @ H @ ( minus @ pv5 @ n1 ) ) ) ) ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select3 @ u_defuse @ G @ H ) @ use ) ) @ ( mbox @ ( customqmltpeq @ ( a_select3 @ z_defuse @ G @ H ) @ use ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ).

%------------------------------------------------------------------------------
% File     : GSV100^1.006 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Logic Calculi
% Problem  : Goedel translation of SWV100+1 (from TPTP-v5.0.0)
% Version  : [BP13] axioms.
% English  : 
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  208 (  11 unt;  56 typ;  10 def)
%            Number of atoms       : 2587 (  10 equ;   0 cnn)
%            Maximal formula atoms :  673 (  17 avg)
%            Number of connectives : 4839 (   1   ~;   1   |;   2   &;4832   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   81 (  15 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :  111 ( 111   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   56 (  55 usr;  20 con; 0-4 aty)
%            Number of variables   :  375 ( 369   ^   4   !;   2   ?; 375   :)
% SPC      : TH0_UNK_EQU_NAR
...
%%% Generated on Wed Apr 27 15:34:15 CEST 2022 using command 'downgrade(tff)'.
...
thf(xinit_defuse_decl,type,
    xinit_defuse: $i ).

thf(rho_defuse_decl,type,
    rho_defuse: $i ).

thf(sigma_defuse_decl,type,
    sigma_defuse: $i ).
...
thf(xinit_noise_defuse_decl,type,
    xinit_noise_defuse: $i ).

thf(u_defuse_decl,type,
    u_defuse: $i ).

thf(n999_decl,type,
    n999: $i ).

thf(z_defuse_decl,type,
    z_defuse: $i ).
...
thf(xinit_mean_defuse_decl,type,
    xinit_mean_defuse: $i ).
...
thf(quaternion_ds1_inuse_0012,conjecture,
    ( mlocal
    @ ( mbox
      @ ( mimplies
        @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ rho_defuse @ n0 ) @ use ) )
          @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ rho_defuse @ n1 ) @ use ) )
            @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ rho_defuse @ n2 ) @ use ) )
              @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ sigma_defuse @ n0 ) @ use ) )
                @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ sigma_defuse @ n1 ) @ use ) )
                  @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ sigma_defuse @ n2 ) @ use ) )
                    @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ sigma_defuse @ n3 ) @ use ) )
                      @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ sigma_defuse @ n4 ) @ use ) )
                        @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ sigma_defuse @ n5 ) @ use ) )
                          @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select3 @ u_defuse @ n0 @ n0 ) @ use ) )
                            @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select3 @ u_defuse @ n1 @ n0 ) @ use ) )
                              @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select3 @ u_defuse @ n2 @ n0 ) @ use ) )
                                @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_defuse @ n3 ) @ use ) )
                                  @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_defuse @ n4 ) @ use ) )
                                    @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_defuse @ n5 ) @ use ) )
                                      @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_mean_defuse @ n0 ) @ use ) )
                                        @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_mean_defuse @ n1 ) @ use ) )
                                          @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_mean_defuse @ n2 ) @ use ) )
                                            @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_mean_defuse @ n3 ) @ use ) )
                                              @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_mean_defuse @ n4 ) @ use ) )
                                                @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_mean_defuse @ n5 ) @ use ) )
                                                  @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_noise_defuse @ n0 ) @ use ) )
                                                    @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_noise_defuse @ n1 ) @ use ) )
                                                      @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_noise_defuse @ n2 ) @ use ) )
                                                        @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_noise_defuse @ n3 ) @ use ) )
                                                          @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_noise_defuse @ n4 ) @ use ) )
                                                            @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_noise_defuse @ n5 ) @ use ) )
                                                              @ ( mand @ ( mbox @ ( leq @ n0 @ pv5 ) )
                                                                @ ( mand @ ( mbox @ ( leq @ pv5 @ ( minus @ n999 @ n1 ) ) )
                                                                  @ ( mbox
                                                                    @ ( mforall_di
                                                                      @ ^ [A: $i] :
                                                                          ( mbox
                                                                          @ ( mforall_di
                                                                            @ ^ [B: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ A ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ B ) ) @ ( mand @ ( mbox @ ( leq @ A @ n2 ) ) @ ( mbox @ ( leq @ B @ ( minus @ pv5 @ n1 ) ) ) ) ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select3 @ u_defuse @ A @ B ) @ use ) ) @ ( mbox @ ( customqmltpeq @ ( a_select3 @ z_defuse @ A @ B ) @ use ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )
        @ ( mand
          @ ( mbox
            @ ( mimplies @ ( mbox @ ( mnot @ ( mbox @ ( gt @ pv5 @ n0 ) ) ) )
              @ ( mand
                @ ( mbox
                  @ ( mimplies @ ( mbox @ ( mnot @ ( mbox @ ( gt @ pv5 @ n0 ) ) ) )
                    @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ rho_defuse @ n0 ) @ use ) )
                                                                                ...
                                                                                @ ( mbox
                                                                                  @ ( mforall_di
                                                                                    @ ^ [C: $i] :
                                                                                        ( mbox
                                                                                        @ ( mforall_di
                                                                                          @ ^ [D: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ C ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ D ) ) @ ( mand @ ( mbox @ ( leq @ C @ n2 ) ) @ ( mbox @ ( leq @ D @ pv5 ) ) ) ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select3 @ u_defuse @ C @ D ) @ use ) ) @ ( mbox @ ( customqmltpeq @ ( a_select3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ z_defuse @ n0 @ pv5 @ use ) @ n1 @ pv5 @ use ) @ n2 @ pv5 @ use ) @ C @ D ) @ use ) ) ) ) ) ) ) ) )
                                                                                @ ( mbox
                                                                                  @ ( mforall_di
                                                                                    @ ^ [E: $i] :
                                                                                        ( mbox
                                                                                        @ ( mforall_di
                                                                                          @ ^ [F: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ E ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ F ) ) @ ( mand @ ( mbox @ ( leq @ E @ n2 ) ) @ ( mbox @ ( leq @ F @ ( minus @ pv5 @ n1 ) ) ) ) ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select3 @ u_defuse @ E @ F ) @ use ) ) @ ( mbox @ ( customqmltpeq @ ( a_select3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ z_defuse @ n0 @ pv5 @ use ) @ n1 @ pv5 @ use ) @ n2 @ pv5 @ use ) @ E @ F ) @ use ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )
                @ ( mbox
                  @ ( mimplies @ ( mbox @ ( gt @ pv5 @ n0 ) )
                    @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ rho_defuse @ n0 ) @ use ) )
                      @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ rho_defuse @ n1 ) @ use ) )
                        @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ rho_defuse @ n2 ) @ use ) )
                          @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ sigma_defuse @ n0 ) @ use ) )
                                                                                ...
                                                                                @ ( mbox
                                                                                  @ ( mforall_di
                                                                                    @ ^ [G: $i] :
                                                                                        ( mbox
                                                                                        @ ( mforall_di
                                                                                          @ ^ [H: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ G ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ H ) ) @ ( mand @ ( mbox @ ( leq @ G @ n2 ) ) @ ( mbox @ ( leq @ H @ pv5 ) ) ) ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select3 @ u_defuse @ G @ H ) @ use ) ) @ ( mbox @ ( customqmltpeq @ ( a_select3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ z_defuse @ n0 @ pv5 @ use ) @ n1 @ pv5 @ use ) @ n2 @ pv5 @ use ) @ G @ H ) @ use ) ) ) ) ) ) ) ) )
                                                                                @ ( mbox
                                                                                  @ ( mforall_di
                                                                                    @ ^ [I: $i] :
                                                                                        ( mbox
                                                                                        @ ( mforall_di
                                                                                          @ ^ [J: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ I ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ J ) ) @ ( mand @ ( mbox @ ( leq @ I @ n2 ) ) @ ( mbox @ ( leq @ J @ ( minus @ pv5 @ n1 ) ) ) ) ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select3 @ u_defuse @ I @ J ) @ use ) ) @ ( mbox @ ( customqmltpeq @ ( a_select3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ z_defuse @ n0 @ pv5 @ use ) @ n1 @ pv5 @ use ) @ n2 @ pv5 @ use ) @ I @ J ) @ use ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )
          @ ( mbox
            @ ( mimplies @ ( mbox @ ( gt @ pv5 @ n0 ) )
              @ ( mand
                @ ( mbox
                                                          ...
                                                          @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_noise_defuse @ n1 ) @ use ) )
                                                            @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_noise_defuse @ n2 ) @ use ) )
                                                              @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_noise_defuse @ n3 ) @ use ) )
                                                                @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_noise_defuse @ n4 ) @ use ) )
                                                                  @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_noise_defuse @ n5 ) @ use ) )
                                                                    @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ u_defuse @ n0 @ pv5 @ use ) @ n1 @ pv5 @ use ) @ n0 @ pv5 @ use ) @ n2 @ pv5 @ use ) @ n1 @ pv5 @ use ) @ n2 @ pv5 @ use ) @ n0 @ n0 ) @ use ) )
                                                                      @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ u_defuse @ n0 @ pv5 @ use ) @ n1 @ pv5 @ use ) @ n0 @ pv5 @ use ) @ n2 @ pv5 @ use ) @ n1 @ pv5 @ use ) @ n2 @ pv5 @ use ) @ n1 @ n0 ) @ use ) )
                                                                        @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ u_defuse @ n0 @ pv5 @ use ) @ n1 @ pv5 @ use ) @ n0 @ pv5 @ use ) @ n2 @ pv5 @ use ) @ n1 @ pv5 @ use ) @ n2 @ pv5 @ use ) @ n2 @ n0 ) @ use ) )
                                                                          @ ( mand @ ( mbox @ ( leq @ n0 @ pv5 ) )
                                                                            @ ( mand @ ( mbox @ ( leq @ pv5 @ ( minus @ n999 @ n1 ) ) )
                                                                              @ ( mand
                                                                                @ ( mbox
                                                                                  @ ( mforall_di
                                                                                    @ ^ [K: $i] :
                                                                                        ( mbox
                                                                                        @ ( mforall_di
                                                                                          @ ^ [L: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ K ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ L ) ) @ ( mand @ ( mbox @ ( leq @ K @ n2 ) ) @ ( mbox @ ( leq @ L @ pv5 ) ) ) ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ z_defuse @ n0 @ pv5 @ use ) @ n1 @ pv5 @ use ) @ n2 @ pv5 @ use ) @ K @ L ) @ use ) ) @ ( mbox @ ( customqmltpeq @ ( a_select3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ u_defuse @ n0 @ pv5 @ use ) @ n1 @ pv5 @ use ) @ n0 @ pv5 @ use ) @ n2 @ pv5 @ use ) @ n1 @ pv5 @ use ) @ n2 @ pv5 @ use ) @ K @ L ) @ use ) ) ) ) ) ) ) ) )
                                                                                @ ( mbox
                                                                                  @ ( mforall_di
                                                                                    @ ^ [M: $i] :
                                                                                        ( mbox
                                                                                        @ ( mforall_di
                                                                                          @ ^ [N: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ M ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ N ) ) @ ( mand @ ( mbox @ ( leq @ M @ n2 ) ) @ ( mbox @ ( leq @ N @ ( minus @ pv5 @ n1 ) ) ) ) ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ z_defuse @ n0 @ pv5 @ use ) @ n1 @ pv5 @ use ) @ n2 @ pv5 @ use ) @ M @ N ) @ use ) ) @ ( mbox @ ( customqmltpeq @ ( a_select3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ u_defuse @ n0 @ pv5 @ use ) @ n1 @ pv5 @ use ) @ n0 @ pv5 @ use ) @ n2 @ pv5 @ use ) @ n1 @ pv5 @ use ) @ n2 @ pv5 @ use ) @ M @ N ) @ use ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )
                @ ( mbox
                  @ ( mimplies @ ( mbox @ ( gt @ pv5 @ n0 ) )
                    @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ rho_defuse @ n0 ) @ use ) )
                      @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select2 @ rho_defuse @ n1 ) @ use ) )
                                                                                ...
                                                                                @ ( mbox
                                                                                  @ ( mforall_di
                                                                                    @ ^ [O: $i] :
                                                                                        ( mbox
                                                                                        @ ( mforall_di
                                                                                          @ ^ [P: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ O ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ P ) ) @ ( mand @ ( mbox @ ( leq @ O @ n2 ) ) @ ( mbox @ ( leq @ P @ pv5 ) ) ) ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ z_defuse @ n0 @ pv5 @ use ) @ n1 @ pv5 @ use ) @ n2 @ pv5 @ use ) @ O @ P ) @ use ) ) @ ( mbox @ ( customqmltpeq @ ( a_select3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ u_defuse @ n0 @ pv5 @ use ) @ n1 @ pv5 @ use ) @ n0 @ pv5 @ use ) @ n2 @ pv5 @ use ) @ n1 @ pv5 @ use ) @ n2 @ pv5 @ use ) @ O @ P ) @ use ) ) ) ) ) ) ) ) )
                                                                                @ ( mbox
                                                                                  @ ( mforall_di
                                                                                    @ ^ [Q: $i] :
                                                                                        ( mbox
                                                                                        @ ( mforall_di
                                                                                          @ ^ [R: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ Q ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ R ) ) @ ( mand @ ( mbox @ ( leq @ Q @ n2 ) ) @ ( mbox @ ( leq @ R @ ( minus @ pv5 @ n1 ) ) ) ) ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ z_defuse @ n0 @ pv5 @ use ) @ n1 @ pv5 @ use ) @ n2 @ pv5 @ use ) @ Q @ R ) @ use ) ) @ ( mbox @ ( customqmltpeq @ ( a_select3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ u_defuse @ n0 @ pv5 @ use ) @ n1 @ pv5 @ use ) @ n0 @ pv5 @ use ) @ n2 @ pv5 @ use ) @ n1 @ pv5 @ use ) @ n2 @ pv5 @ use ) @ Q @ R ) @ use ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ).

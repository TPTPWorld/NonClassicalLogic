%------------------------------------------------------------------------------
% File     : GSV101^1.017 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  222 (  12 unt;  57 typ;  10 def)
%            Number of atoms       : 2185 (  10 equ;   0 cnn)
%            Maximal formula atoms :  205 (  13 avg)
%            Number of connectives : 3596 (   1   ~;   1   |;   5   &;3583   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   51 (  14 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :  113 ( 113   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   57 (  56 usr;  20 con; 0-4 aty)
%            Number of variables   :  376 ( 363   ^  10   !;   3   ?; 376   :)
% SPC      : TH0_UNK_EQU_NAR
...
thf(quaternion_ds1_inuse_0013,conjecture,
    ( mlocal
    @ ( mbox
      @ ( mimplies
                                                              ...
                                                              @ ( mbox
                                                                @ ( mforall_di
                                                                  @ ^ [A: $i] :
                                                                      ( mbox
                                                                      @ ( mforall_di
                                                                        @ ^ [B: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ A ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ B ) ) @ ( mand @ ( mbox @ ( leq @ A @ n2 ) ) @ ( mbox @ ( leq @ B @ ( minus @ ( plus @ n1 @ ( minus @ n999 @ n1 ) ) @ n1 ) ) ) ) ) ) @ ( mand @ ( mbox @ ( customqmltpeq @ ( a_select3 @ u_defuse @ A @ B ) @ use ) ) @ ( mbox @ ( customqmltpeq @ ( a_select3 @ z_defuse @ A @ B ) @ use ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )
        @ ( mand
          @ ( mbox
            @ ( mforall_di
              @ ^ [C: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ C ) ) @ ( mbox @ ( leq @ C @ ( minus @ n3 @ n1 ) ) ) ) @ ( mbox @ ( customqmltpeq @ ( a_select2 @ rho_defuse @ C ) @ use ) ) ) ) ) )
          @ ( mand
            @ ( mbox
              @ ( mforall_di
                @ ^ [D: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ D ) ) @ ( mbox @ ( leq @ D @ ( minus @ n6 @ n1 ) ) ) ) @ ( mbox @ ( customqmltpeq @ ( a_select2 @ sigma_defuse @ D ) @ use ) ) ) ) ) )
            @ ( mand
              @ ( mbox
                @ ( mforall_di
                  @ ^ [E: $i] :
                      ( mbox
                      @ ( mforall_di
                        @ ^ [F: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ E ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ F ) ) @ ( mand @ ( mbox @ ( leq @ E @ n2 ) ) @ ( mbox @ ( leq @ F @ ( minus @ n999 @ n1 ) ) ) ) ) ) @ ( mbox @ ( customqmltpeq @ ( a_select3 @ u_defuse @ E @ F ) @ use ) ) ) ) ) ) ) )
              @ ( mand
                @ ( mbox
                  @ ( mforall_di
                    @ ^ [G: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ G ) ) @ ( mbox @ ( leq @ G @ ( minus @ n6 @ n1 ) ) ) ) @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_defuse @ G ) @ use ) ) ) ) ) )
                @ ( mand
                  @ ( mbox
                    @ ( mforall_di
                      @ ^ [H: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ H ) ) @ ( mbox @ ( leq @ H @ ( minus @ n6 @ n1 ) ) ) ) @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_mean_defuse @ H ) @ use ) ) ) ) ) )
                  @ ( mand
                    @ ( mbox
                      @ ( mforall_di
                        @ ^ [I: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ I ) ) @ ( mbox @ ( leq @ I @ ( minus @ n6 @ n1 ) ) ) ) @ ( mbox @ ( customqmltpeq @ ( a_select2 @ xinit_noise_defuse @ I ) @ use ) ) ) ) ) )
                    @ ( mbox
                      @ ( mforall_di
                        @ ^ [J: $i] :
                            ( mbox
                            @ ( mforall_di
                              @ ^ [K: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ J ) ) @ ( mand @ ( mbox @ ( leq @ n0 @ K ) ) @ ( mand @ ( mbox @ ( leq @ J @ ( minus @ n3 @ n1 ) ) ) @ ( mbox @ ( leq @ K @ ( minus @ n999 @ n1 ) ) ) ) ) ) @ ( mbox @ ( customqmltpeq @ ( a_select3 @ z_defuse @ J @ K ) @ use ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ).

%------------------------------------------------------------------------------
% File     : GSV102^1.016 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Theorem 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  200 (  12 unt;  52 typ;  10 def)
%            Number of atoms       : 1984 (  10 equ;   0 cnn)
%            Maximal formula atoms :   97 (  13 avg)
%            Number of connectives : 3280 (   1   ~;   1   |;   5   &;3267   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   51 (  15 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :  113 ( 113   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   52 (  51 usr;  15 con; 0-4 aty)

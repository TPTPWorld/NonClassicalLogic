%------------------------------------------------------------------------------
% File     : GSV102^1.018 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Theorem 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  199 (  12 unt;  52 typ;  10 def)
%            Number of atoms       : 1981 (  10 equ;   0 cnn)
%            Maximal formula atoms :   97 (  13 avg)
%            Number of connectives : 3272 (   1   ~;   1   |;   4   &;3261   @)
%                                         (   1 <=>;   4  =>;   0  <=;   0 <~>)

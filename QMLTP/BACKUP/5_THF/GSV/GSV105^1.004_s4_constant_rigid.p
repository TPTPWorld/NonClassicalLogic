%------------------------------------------------------------------------------
% File     : GSV105^1.004 : TPTP v8.1.0. Released v8.1.0.
...
thf(quaternion_ds1_inuse_0017,conjecture,
    mlocal @ ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( leq @ n0 @ pv43 ) ) @ ( mbox @ ( leq @ pv43 @ ( minus @ n6 @ n1 ) ) ) ) @ ( mbox @ ( mimplies @ ( mbox @ ( lt @ n0 @ ( a_select2 @ sigma @ pv43 ) ) ) @ ( mbox @ true ) ) ) ) ) ).

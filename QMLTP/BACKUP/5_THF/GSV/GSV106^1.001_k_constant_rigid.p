%------------------------------------------------------------------------------
% File     : GSV106^1.001 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  201 (  10 unt;  57 typ;  10 def)
%            Number of atoms       : 1996 (  10 equ;   0 cnn)
%            Maximal formula atoms :  104 (  13 avg)
%            Number of connectives : 3217 (   1   ~;   1   |;   2   &;3210   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)

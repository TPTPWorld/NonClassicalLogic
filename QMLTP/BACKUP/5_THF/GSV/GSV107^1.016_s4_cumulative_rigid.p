%------------------------------------------------------------------------------
% File     : GSV107^1.016 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Theorem 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :  215 (  12 unt;  50 typ;  10 def)
%            Number of atoms       : 2017 (  10 equ;   0 cnn)
%            Maximal formula atoms :   97 (  12 avg)
%            Number of connectives : 3245 (   1   ~;   1   |;   5   &;3232   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)

%------------------------------------------------------------------------------
% File     : GSY036^1.024 : TPTP v8.1.0. Released v8.1.0.
...
%            Maximal formula atoms :  306 (  23 avg)
%            Number of connectives :  414 (   1   ~;   1   |;   4   &; 403   @)
%                                         (   1 <=>;   4  =>;   0  <=;   0 <~>)
              ...
              @ ( mimplies
                @ ( mexists_di
                  @ ^ [X1: $i] :
                      ( mbox
                      @ ( mforall_di
                        @ ^ [Y1: $i] : ( mand @ ( mbox @ ( mimplies @ ( mbox @ ( big_q @ X1 ) ) @ ( mbox @ ( big_q @ Y1 ) ) ) ) @ ( mbox @ ( mimplies @ ( mbox @ ( big_q @ Y1 ) ) @ ( mbox @ ( big_q @ X1 ) ) ) ) ) ) ) )
                @ ( mand
                  @ ( mbox
                    @ ( mimplies
                      @ ( mexists_di

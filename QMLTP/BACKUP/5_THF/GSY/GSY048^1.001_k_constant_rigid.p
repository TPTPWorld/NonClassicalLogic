%------------------------------------------------------------------------------
% File     : GSY048^1.001 : TPTP v8.1.0. Released v8.1.0.
...
%            Number of atoms       :   32 (  10 equ;   0 cnn)
...
%            Number of variables   :   29 (  25   ^   2   !;   2   ?;  29   :)
% SPC      : TH0_UNK_EQU_NAR
...
thf(pel18,conjecture,
    ( mlocal
    @ ( mexists_di
      @ ^ [Y: $i] :
          ( mbox
          @ ( mforall_di
            @ ^ [X: $i] : ( mbox @ ( mimplies @ ( mbox @ ( big_f @ Y ) ) @ ( mbox @ ( big_f @ X ) ) ) ) ) ) ) ) ).

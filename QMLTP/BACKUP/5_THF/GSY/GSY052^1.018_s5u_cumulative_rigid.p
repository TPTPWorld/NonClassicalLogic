%------------------------------------------------------------------------------
% File     : GSY052^1.018 : TPTP v8.1.0. Released v8.1.0.
...
thf(pel22,conjecture,
    ...
    @ ( mbox
      @ ( mimplies
        @ ( mbox
          @ ( mforall_di
            @ ^ [X: $i] : ( mand @ ( mbox @ ( mimplies @ ( mbox @ p ) @ ( mbox @ ( big_f @ X ) ) ) ) @ ( mbox @ ( mimplies @ ( mbox @ ( big_f @ X ) ) @ ( mbox @ p ) ) ) ) ) )
        @ ( mand
          @ ( mbox
            @ ( mimplies @ ( mbox @ p )
              @ ( mbox

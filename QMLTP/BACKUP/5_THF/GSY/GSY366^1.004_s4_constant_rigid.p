%------------------------------------------------------------------------------
% File     : GSY366^1.004 : TPTP v8.1.0. Released v8.1.0.
...
%            Number of connectives :  103 (   1   ~;   1   |;   3   &;  94   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)
          ...
          @ ( mbox
            @ ( mforall_di
              @ ^ [U: $i] :
                  ( mbox
                  @ ( mforall_di
                    @ ^ [V: $i] : ( mand @ ( mbox @ ( mimplies @ ( mbox @ ( big_r @ U @ U ) ) @ ( mbox @ ( big_r @ U @ V ) ) ) ) @ ( mbox @ ( mimplies @ ( mbox @ ( big_r @ U @ V ) ) @ ( mbox @ ( big_r @ U @ U ) ) ) ) ) ) ) ) )
          @ ( mbox
            @ ( mforall_di
              @ ^ [W: $i] :
                  ( mbox
                  @ ( mforall_di
                    @ ^ [Z: $i] : ( mand @ ( mbox @ ( mimplies @ ( mbox @ ( big_r @ W @ W ) ) @ ( mbox @ ( big_r @ Z @ W ) ) ) ) @ ( mbox @ ( mimplies @ ( mbox @ ( big_r @ Z @ W ) ) @ ( mbox @ ( big_r @ W @ W ) ) ) ) ) ) ) ) ) )
        @ ( mbox
          @ ( mimplies
            @ ( mexists_di
              @ ^ [X: $i] : ( mbox @ ( big_r @ X @ X ) ) )

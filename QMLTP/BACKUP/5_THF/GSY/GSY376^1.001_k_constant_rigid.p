%------------------------------------------------------------------------------
% File     : GSY376^1.001 : TPTP v8.1.0. Released v8.1.0.
      ...
      @ ( mimplies
        @ ( mexists_di
          @ ^ [X: $i] :
              ( mbox
              @ ( mforall_di
                @ ^ [Y: $i] : ( mand @ ( mbox @ ( mimplies @ ( mbox @ ( big_p @ Y ) ) @ ( mbox @ ( big_p @ X ) ) ) ) @ ( mbox @ ( mimplies @ ( mbox @ ( big_p @ X ) ) @ ( mbox @ ( big_p @ Y ) ) ) ) ) ) ) )
        @ ( mor
          @ ( mbox
            @ ( mforall_di
              @ ^ [X: $i] : ( mbox @ ( big_p @ X ) ) ) )

%------------------------------------------------------------------------------
% File     : GSY379^1.002 : TPTP v8.1.0. Released v8.1.0.
...
%            Number of atoms       :   50 (  10 equ;   0 cnn)
%            Maximal formula atoms :   27 (   4 avg)
%            Number of connectives :   63 (   1   ~;   1   |;   2   &;  56   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   20 (   3 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :   63 (  63   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   15 (  14 usr;   1 con; 0-4 aty)
%            Number of variables   :   33 (  28   ^   3   !;   2   ?;  33   :)
% SPC      : TH0_THM_EQU_NAR
                ...
                @ ( mbox
                  @ ( mforall_di
                    @ ^ [X: $i] :
                        ( mbox
                        @ ( mforall_di
                          @ ^ [Z: $i] : ( mbox @ ( big_q @ X @ Y @ Z ) ) ) ) ) )
                @ ( mbox
                  @ ( mnot
                    @ ( mbox
                      @ ( mforall_di
                        @ ^ [Z: $i] : ( mand @ ( mbox @ ( big_p @ Z ) ) @ ( mbox @ ( mnot @ ( mbox @ ( big_q @ Y @ Y @ Z ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ).

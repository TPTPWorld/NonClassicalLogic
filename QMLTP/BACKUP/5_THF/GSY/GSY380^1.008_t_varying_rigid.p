%------------------------------------------------------------------------------
% File     : GSY380^1.008 : TPTP v8.1.0. Released v8.1.0.
...
%            Number of connectives :   68 (   1   ~;   1   |;   3   &;  59   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)
...
thf(x2132,conjecture,
    ...
    @ ( mbox
      @ ( mimplies
        @ ( mbox
          @ ( mforall_di
            @ ^ [W: $i] : ( mbox @ ( mnot @ ( mbox @ ( big_r @ W @ W ) ) ) ) ) )
        @ ( mexists_di
          @ ^ [X: $i] :
              ( mexists_di
              @ ^ [Y: $i] :
                  ( mand @ ( mbox @ ( mnot @ ( mbox @ ( big_r @ X @ Y ) ) ) )
                  @ ( mbox
                    @ ( mimplies @ ( mbox @ ( big_q @ Y @ X ) )
                      @ ( mbox
                        @ ( mforall_di
                          @ ^ [Z: $i] : ( mbox @ ( big_q @ Z @ Z ) ) ) ) ) ) ) ) ) ) ) ) ).

%------------------------------------------------------------------------------
% File     : GSY384^1.001 : TPTP v8.1.0. Released v8.1.0.
...
%            Number of connectives :   45 (   1   ~;   1   |;   2   &;  38   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   19 (   3 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :   61 (  61   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   14 (  13 usr;   1 con; 0-4 aty)
%            Number of variables   :   31 (  27   ^   2   !;   2   ?;  31   :)
% SPC      : TH0_UNK_EQU_NAR
        ...
        @ ^ [Z: $i] :
            ...
            @ ^ [X: $i] :
                ...
                @ ^ [Y: $i] :
                    ( mbox
                    @ ( mforall_di
                      @ ^ [U: $i] : ( mbox @ ( mimplies @ ( mbox @ ( big_p @ X @ Y @ Z ) ) @ ( mbox @ ( big_p @ U @ X @ X ) ) ) ) ) ) ) ) ) ) ) ).

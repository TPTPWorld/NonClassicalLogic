%------------------------------------------------------------------------------
% File     : GSY391^1.009 : TPTP v8.1.0. Released v8.1.0.
...
%            Number of connectives :   59 (   1   ~;   1   |;   2   &;  52   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)
...
thf(pel9,conjecture,
    mlocal @ ( mbox @ ( mimplies @ ( mand @ ( mor @ ( mbox @ p1 ) @ ( mbox @ p2 ) ) @ ( mand @ ( mor @ ( mbox @ ( mnot @ ( mbox @ p1 ) ) ) @ ( mbox @ p2 ) ) @ ( mor @ ( mbox @ p1 ) @ ( mbox @ ( mnot @ ( mbox @ p2 ) ) ) ) ) ) @ ( mbox @ ( mnot @ ( mor @ ( mbox @ ( mnot @ ( mbox @ p1 ) ) ) @ ( mbox @ ( mnot @ ( mbox @ p2 ) ) ) ) ) ) ) ) ).

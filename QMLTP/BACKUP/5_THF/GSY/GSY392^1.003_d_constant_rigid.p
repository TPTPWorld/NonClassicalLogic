%------------------------------------------------------------------------------
% File     : GSY392^1.003 : TPTP v8.1.0. Released v8.1.0.
...
%            Number of atoms       :   81 (   8 equ;   0 cnn)
%            Maximal formula atoms :   62 (   8 avg)
%            Number of connectives :   86 (   1   ~;   1   |;   2   &;  79   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)
...
thf(pel14,conjecture,
    mlocal @ ( mand @ ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( mimplies @ ( mbox @ p1 ) @ ( mbox @ p2 ) ) ) @ ( mbox @ ( mimplies @ ( mbox @ p2 ) @ ( mbox @ p1 ) ) ) ) @ ( mand @ ( mor @ ( mbox @ p2 ) @ ( mbox @ ( mnot @ ( mbox @ p1 ) ) ) ) @ ( mor @ ( mbox @ ( mnot @ ( mbox @ p2 ) ) ) @ ( mbox @ p1 ) ) ) ) ) @ ( mbox @ ( mimplies @ ( mand @ ( mor @ ( mbox @ p2 ) @ ( mbox @ ( mnot @ ( mbox @ p1 ) ) ) ) @ ( mor @ ( mbox @ ( mnot @ ( mbox @ p2 ) ) ) @ ( mbox @ p1 ) ) ) @ ( mand @ ( mbox @ ( mimplies @ ( mbox @ p1 ) @ ( mbox @ p2 ) ) ) @ ( mbox @ ( mimplies @ ( mbox @ p2 ) @ ( mbox @ p1 ) ) ) ) ) ) ) ).

%------------------------------------------------------------------------------
% File     : GSY403^1.003 : TPTP v8.1.0. Released v8.1.0.
...
%            Number of variables   :   30 (  24   ^   3   !;   3   ?;  30   :)
% SPC      : TH0_THM_EQU_NAR
...
thf(kalish234,conjecture,
    ( mlocal
    @ ( mbox
      @ ( mforall_di
        @ ^ [X: $i] : ( mbox @ ( mimplies @ ( mand @ ( mbox @ ( mimplies @ ( mbox @ ( f @ X ) ) @ ( mbox @ ( g @ X ) ) ) ) @ ( mbox @ ( mimplies @ ( mbox @ ( g @ X ) ) @ ( mbox @ ( h @ X ) ) ) ) ) @ ( mbox @ ( mimplies @ ( mbox @ ( f @ X ) ) @ ( mbox @ ( h @ X ) ) ) ) ) ) ) ) ) ).

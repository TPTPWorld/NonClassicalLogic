%------------------------------------------------------------------------------
% File     : GSY408^1.009 : TPTP v8.1.0. Released v8.1.0.
...
thf(kalish244,conjecture,
    ...
    @ ( mbox
      @ ( mimplies
        ...
        @ ( mbox
          @ ( mforall_di
            @ ^ [Y: $i] : ( mbox @ ( mimplies @ ( mbox @ ( f @ Y ) ) @ ( mbox @ ( g @ Y ) ) ) ) ) ) ) ) ) ).

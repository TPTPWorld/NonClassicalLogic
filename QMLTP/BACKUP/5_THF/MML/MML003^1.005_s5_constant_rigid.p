%------------------------------------------------------------------------------
% File     : MML003^1.005 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Puzzles
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   53 (  11 unt;  19 typ;   8 def)
%            Number of atoms       :  320 (   8 equ;   0 cnn)
%            Maximal formula atoms :  126 (   9 avg)
%            Number of connectives :  412 (   1   ~;   1   |;   5   &; 399   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)

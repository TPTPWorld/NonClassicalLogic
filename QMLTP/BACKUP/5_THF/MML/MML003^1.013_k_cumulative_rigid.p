%------------------------------------------------------------------------------
% File     : MML003^1.013 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Puzzles
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   47 (   8 unt;  19 typ;   8 def)
%            Number of atoms       :  308 (   8 equ;   0 cnn)
%            Maximal formula atoms :  126 (  11 avg)

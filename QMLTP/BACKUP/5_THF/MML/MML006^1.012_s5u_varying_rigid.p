%------------------------------------------------------------------------------
% File     : MML006^1.012 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Puzzles
...
thf('mrel_#pour_b_universal',axiom,
    ! [W: mworld,V: mworld] : ( mrel @ '#pour_b' @ W @ V ) ).

thf('mrel_#make_c_universal',axiom,
    ! [W: mworld,V: mworld] : ( mrel @ '#make_c' @ W @ V ) ).

thf('mrel_#pour_a_universal',axiom,
    ! [W: mworld,V: mworld] : ( mrel @ '#pour_a' @ W @ V ) ).

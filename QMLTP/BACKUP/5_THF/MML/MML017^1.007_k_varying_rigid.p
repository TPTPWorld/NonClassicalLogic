%------------------------------------------------------------------------------
% File     : MML017^1.007 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   57 (  11 unt;  32 typ;  10 def)
%            Number of atoms       :  317 (  10 equ;   0 cnn)
%            Maximal formula atoms :   87 (  12 avg)
%            Number of connectives :  500 (   1   ~;   1   |;   3   &; 491   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)

%------------------------------------------------------------------------------
% File     : MML017^1.012 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   60 (  14 unt;  32 typ;  10 def)
%            Number of atoms       :  320 (  10 equ;   0 cnn)
%            Maximal formula atoms :   87 (  11 avg)
%            Number of connectives :  509 (   1   ~;   1   |;   3   &; 500   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   21 (   9 avg)
%            Number of types       :    4 (   2 usr)
%            Number of type conns  :   89 (  89   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   31 (  30 usr;   6 con; 0-3 aty)
%            Number of variables   :   67 (  55   ^   9   !;   3   ?;  67   :)
% SPC      : TH0_UNK_EQU_NAR

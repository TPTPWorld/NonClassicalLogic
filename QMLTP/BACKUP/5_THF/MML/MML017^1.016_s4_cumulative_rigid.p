%------------------------------------------------------------------------------
% File     : MML017^1.016 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   64 (  14 unt;  32 typ;  10 def)
%            Number of atoms       :  332 (  10 equ;   0 cnn)
%            Maximal formula atoms :   87 (  10 avg)
%            Number of connectives :  551 (   1   ~;   1   |;   7   &; 534   @)
%                                         (   1 <=>;   7  =>;   0  <=;   0 <~>)

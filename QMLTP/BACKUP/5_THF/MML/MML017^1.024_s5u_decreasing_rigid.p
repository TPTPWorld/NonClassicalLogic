%------------------------------------------------------------------------------
% File     : MML017^1.024 : TPTP v8.1.0. Released v8.1.0.
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   61 (  14 unt;  32 typ;  10 def)
%            Number of atoms       :  323 (  10 equ;   0 cnn)
%            Maximal formula atoms :   87 (  11 avg)
%            Number of connectives :  518 (   1   ~;   1   |;   4   &; 507   @)
%                                         (   1 <=>;   4  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   21 (   9 avg)
%            Number of types       :    4 (   2 usr)
%            Number of type conns  :   89 (  89   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   31 (  30 usr;   6 con; 0-3 aty)
%            Number of variables   :   71 (  55   ^  13   !;   3   ?;  71   :)
% SPC      : TH0_UNK_EQU_NAR
...
thf('mrel_#s_universal',axiom,
    ! [W: mworld,V: mworld] : ( mrel @ '#s' @ W @ V ) ).

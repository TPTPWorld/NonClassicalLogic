%------------------------------------------------------------------------------
% File     : MML020^1.005 : TPTP v8.1.0. Released v8.1.0.
...
thf('mrel_#coffee_euclidean',axiom,
...
thf('mrel_#ticket_euclidean',axiom,
    ! [W: mworld,V: mworld,U: mworld] :
      ( ( ( mrel @ '#ticket' @ W @ U )
        & ( mrel @ '#ticket' @ W @ V ) )
     => ( mrel @ '#ticket' @ U @ V ) ) ).

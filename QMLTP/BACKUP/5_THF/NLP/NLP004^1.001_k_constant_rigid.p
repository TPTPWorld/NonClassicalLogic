%------------------------------------------------------------------------------
% File     : NLP004^1.001 : TPTP v8.1.0. Released v8.1.0.
...
%            Number of atoms       :  522 (  10 equ;   0 cnn)
%            Maximal formula atoms :  292 (  14 avg)
%            Number of connectives :  772 (   1   ~;   1   |;   2   &; 765   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   59 (  10 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :  103 ( 103   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   34 (  33 usr;   1 con; 0-3 aty)
%            Number of variables   :  125 ( 121   ^   2   !;   2   ?; 125   :)
% SPC      : TH0_THM_EQU_NAR

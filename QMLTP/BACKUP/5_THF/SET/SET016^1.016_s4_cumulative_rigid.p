%------------------------------------------------------------------------------
% File     : SET016^1.016 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Set Theory
% Problem  : TPTP problem SET016+1.p with axiomatized equality
% Version  : [BP13] axioms.
% English  : 
    ...
    @ ( mforall_di
      @ ^ [W: $i] :
          ...
          @ ^ [X: $i] :
              ...
              @ ^ [Y: $i] :
                  ( mforall_di
                  @ ^ [Z: $i] : ( mimplies @ ( mand @ ( qmltpeq @ ( ordered_pair @ W @ X ) @ ( ordered_pair @ Y @ Z ) ) @ ( member @ W @ universal_class ) ) @ ( qmltpeq @ W @ Y ) ) ) ) ) ) ) ).

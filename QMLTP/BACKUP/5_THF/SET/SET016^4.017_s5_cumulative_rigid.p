%------------------------------------------------------------------------------
% File     : SET016^4.017 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Set Theory
% Problem  : TPTP problem SET016+4.p with axiomatized equality
% Version  : [BP13] axioms.
% English  : 
    ...
    @ ( mforall_di
      @ ^ [A: $i] :
          ...
          @ ^ [B: $i] :
              ...
              @ ^ [U: $i] :
                  ( mforall_di
                  @ ^ [V: $i] : ( mimplies @ ( equal_set @ ( unordered_pair @ ( singleton @ A ) @ ( unordered_pair @ A @ B ) ) @ ( unordered_pair @ ( singleton @ U ) @ ( unordered_pair @ U @ V ) ) ) @ ( qmltpeq @ A @ U ) ) ) ) ) ) ) ).

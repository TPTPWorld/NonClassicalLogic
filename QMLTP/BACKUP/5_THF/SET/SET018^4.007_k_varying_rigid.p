%------------------------------------------------------------------------------
% File     : SET018^4.007 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Set Theory
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   71 (  11 unt;  27 typ;  10 def)
%            Number of atoms       :  273 (  10 equ;   0 cnn)
%            Maximal formula atoms :   10 (   6 avg)
%            Number of connectives :  470 (   1   ~;   1   |;   3   &; 461   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   17 (  10 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :   83 (  83   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   27 (  26 usr;   2 con; 0-3 aty)
%            Number of variables   :  117 ( 111   ^   3   !;   3   ?; 117   :)
% SPC      : TH0_UNK_EQU_NAR

%------------------------------------------------------------------------------
% File     : SET024^1.023 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Set Theory
% Problem  : TPTP problem SET024+1.p with axiomatized equality
% Version  : [BP13] axioms.
% English  : 
...
thf(set_in_its_singleton,conjecture,
    ( mlocal
    @ ( mforall_di
      @ ^ [X: $i] : ( mimplies @ ( member @ X @ universal_class ) @ ( member @ X @ ( singleton @ X ) ) ) ) ) ).

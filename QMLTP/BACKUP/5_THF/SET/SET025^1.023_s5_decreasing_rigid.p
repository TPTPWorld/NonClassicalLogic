%------------------------------------------------------------------------------
% File     : SET025^1.023 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Set Theory
% Problem  : TPTP problem SET025+1.p with axiomatized equality
% Version  : [BP13] axioms.
% English  : 
...
thf(ordered_pair_is_set,conjecture,
    ...
    @ ( mforall_di
      @ ^ [X: $i] :
          ( mforall_di
          @ ^ [Y: $i] : ( member @ ( ordered_pair @ X @ Y ) @ universal_class ) ) ) ) ).

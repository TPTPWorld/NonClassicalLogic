%------------------------------------------------------------------------------
% File     : SET056^1.018 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Set Theory
% Problem  : TPTP problem SET056+1.p with axiomatized equality
% Version  : [BP13] axioms.
% English  : 
    ...
    @ ( mforall_di
      @ ^ [X: $i] :
          ...
          @ ^ [Y: $i] :
              ...
              @ ( mor
                @ ( mexists_di
                  @ ^ [U: $i] : ( mand @ ( member @ U @ X ) @ ( mnot @ ( member @ U @ Y ) ) ) )
                @ ( mexists_di
                  @ ^ [W: $i] : ( mand @ ( member @ W @ Y ) @ ( mnot @ ( member @ W @ X ) ) ) ) ) ) ) ) ) ).

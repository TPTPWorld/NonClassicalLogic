%------------------------------------------------------------------------------
% File     : SET060^1.024 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Set Theory
% Problem  : TPTP problem SET060+1.p with axiomatized equality
% Version  : [BP13] axioms.
% English  : 
...
thf(special_classes_lemma,conjecture,
    ...
    @ ( mforall_di
      @ ^ [X: $i] :
          ( mforall_di
          @ ^ [Y: $i] : ( mnot @ ( member @ Y @ ( intersection @ ( complement @ X ) @ X ) ) ) ) ) ) ).

%------------------------------------------------------------------------------
% File     : SET573^3.001 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Set Theory
% Problem  : TPTP problem SET573+3.p with axiomatized equality
% Version  : [BP13] axioms.
% English  : 
...
% Status   : Theorem 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   30 (  10 unt;  16 typ;  10 def)
%            Number of atoms       :   54 (  10 equ;   0 cnn)
%            Maximal formula atoms :   10 (   3 avg)
%            Number of connectives :   75 (   1   ~;   1   |;   2   &;  68   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)
...
thf(disjoint_defn,axiom,
    ...
    @ ( mforall_di
      @ ^ [B: $i] :
          ( mforall_di
          @ ^ [C: $i] : ( mequiv @ ( disjoint @ B @ C ) @ ( mnot @ ( intersect @ B @ C ) ) ) ) ) ) ).
...
thf(prove_th12,conjecture,
    ...
    @ ( mforall_di
      @ ^ [B: $i] :
          ...
          @ ^ [C: $i] :
              ( mforall_di
              @ ^ [D: $i] : ( mimplies @ ( mand @ ( member @ B @ C ) @ ( disjoint @ C @ D ) ) @ ( mnot @ ( member @ B @ D ) ) ) ) ) ) ) ).

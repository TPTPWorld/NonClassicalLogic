%------------------------------------------------------------------------------
% File     : SET577^3.013 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Set Theory
% Problem  : TPTP problem SET577+3.p with axiomatized equality
% Version  : [BP13] axioms.
% English  : 
...
%            Number of connectives :  245 (   1   ~;   1   |;   4   &; 234   @)
%                                         (   1 <=>;   4  =>;   0  <=;   0 <~>)
      ...
      @ ^ [B: $i] :
          ...
          @ ^ [C: $i] :
              ...
              @ ^ [D: $i] :
                  ( mimplies
                  @ ( mforall_di
                    @ ^ [E: $i] : ( mequiv @ ( member @ E @ B ) @ ( mor @ ( member @ E @ C ) @ ( member @ E @ D ) ) ) )
                  @ ( qmltpeq @ B @ ( union @ C @ D ) ) ) ) ) ) ) ).

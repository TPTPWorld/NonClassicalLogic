%------------------------------------------------------------------------------
% File     : SET901^1.003 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Set Theory
% Problem  : TPTP problem SET901+1.p with axiomatized equality
% Version  : [BP13] axioms.
% English  : 
...
%            Number of connectives :  223 (   1   ~;   1   |;   2   &; 216   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)
...
thf(t42_zfmisc_1,conjecture,
    ...
    @ ( mforall_di
      @ ^ [A: $i] :
          ...
          @ ^ [B: $i] :
              ( mforall_di
              @ ^ [C: $i] : ( mequiv @ ( subset @ A @ ( unordered_pair @ B @ C ) ) @ ( mnot @ ( mand @ ( mnot @ ( qmltpeq @ A @ empty_set ) ) @ ( mand @ ( mnot @ ( qmltpeq @ A @ ( singleton @ B ) ) ) @ ( mand @ ( mnot @ ( qmltpeq @ A @ ( singleton @ C ) ) ) @ ( mnot @ ( qmltpeq @ A @ ( unordered_pair @ B @ C ) ) ) ) ) ) ) ) ) ) ) ) ).

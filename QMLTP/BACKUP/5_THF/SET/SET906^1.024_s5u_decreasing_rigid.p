%------------------------------------------------------------------------------
% File     : SET906^1.024 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Set Theory
% Problem  : TPTP problem SET906+1.p with axiomatized equality
% Version  : [BP13] axioms.
% English  : 
...
%            Number of connectives :  334 (   1   ~;   1   |;   4   &; 323   @)
%                                         (   1 <=>;   4  =>;   0  <=;   0 <~>)
    ...
    @ ( mforall_di
      @ ^ [A: $i] :
          ...
          @ ^ [B: $i] :
              ( mforall_di
              @ ^ [C: $i] :
                  ( mequiv @ ( qmltpeq @ C @ ( set_union2 @ A @ B ) )
                  @ ( mforall_di
                    @ ^ [D: $i] : ( mequiv @ ( in @ D @ C ) @ ( mor @ ( in @ D @ A ) @ ( in @ D @ B ) ) ) ) ) ) ) ) ) ).
...
thf(t47_zfmisc_1,conjecture,
    ...
    @ ( mforall_di
      @ ^ [A: $i] :
          ...
          @ ^ [B: $i] :
              ( mforall_di
              @ ^ [C: $i] : ( mimplies @ ( subset @ ( set_union2 @ ( unordered_pair @ A @ B ) @ C ) @ C ) @ ( in @ A @ C ) ) ) ) ) ) ).

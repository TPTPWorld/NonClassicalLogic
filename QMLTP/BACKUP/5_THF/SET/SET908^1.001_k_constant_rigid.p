%------------------------------------------------------------------------------
% File     : SET908^1.001 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Set Theory
% Problem  : TPTP problem SET908+1.p with axiomatized equality
% Version  : [BP13] axioms.
% English  : 
...
%            Number of atoms       :  159 (  10 equ;   0 cnn)
%            Maximal formula atoms :   12 (   5 avg)
%            Number of connectives :  244 (   1   ~;   1   |;   2   &; 237   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   16 (   8 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :   68 (  68   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   19 (  18 usr;   2 con; 0-3 aty)
%            Number of variables   :   72 (  68   ^   2   !;   2   ?;  72   :)
% SPC      : TH0_THM_EQU_NAR
...
thf(t49_zfmisc_1,conjecture,
    ...
    @ ( mforall_di
      @ ^ [A: $i] :
          ( mforall_di
          @ ^ [B: $i] : ( mnot @ ( qmltpeq @ ( set_union2 @ ( singleton @ A ) @ B ) @ empty_set ) ) ) ) ) ).

%------------------------------------------------------------------------------
% File     : SET909^1.023 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Set Theory
% Problem  : TPTP problem SET909+1.p with axiomatized equality
% Version  : [BP13] axioms.
% English  : 
...
%            Number of atoms       :  185 (  10 equ;   0 cnn)
%            Maximal formula atoms :   12 (   5 avg)
%            Number of connectives :  304 (   1   ~;   1   |;   5   &; 291   @)
%                                         (   1 <=>;   5  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   16 (   8 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :   71 (  71   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   20 (  19 usr;   2 con; 0-3 aty)
%            Number of variables   :   89 (  76   ^  10   !;   3   ?;  89   :)
% SPC      : TH0_UNK_EQU_NAR
...
thf(t50_zfmisc_1,conjecture,
    ...
    @ ( mforall_di
      @ ^ [A: $i] :
          ...
          @ ^ [B: $i] :
              ( mforall_di
              @ ^ [C: $i] : ( mnot @ ( qmltpeq @ ( set_union2 @ ( unordered_pair @ A @ B ) @ C ) @ empty_set ) ) ) ) ) ) ).

%------------------------------------------------------------------------------
% File     : SET912^1.018 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Set Theory
% Problem  : TPTP problem SET912+1.p with axiomatized equality
% Version  : [BP13] axioms.
% English  : 
...
%            Number of atoms       :  173 (  10 equ;   0 cnn)
%            Maximal formula atoms :    9 (   4 avg)
%            Number of connectives :  289 (   1   ~;   1   |;   4   &; 278   @)
%                                         (   1 <=>;   4  =>;   0  <=;   0 <~>)
...
thf(t28_xboole_1,axiom,
    ...
    @ ( mforall_di
      @ ^ [A: $i] :
          ( mforall_di
          @ ^ [B: $i] : ( mimplies @ ( subset @ A @ B ) @ ( qmltpeq @ ( set_intersection2 @ A @ B ) @ A ) ) ) ) ) ).
...
thf(t53_zfmisc_1,conjecture,
    ...
    @ ( mforall_di
      @ ^ [A: $i] :
          ...
          @ ^ [B: $i] :
              ( mforall_di
              @ ^ [C: $i] : ( mimplies @ ( mand @ ( in @ A @ B ) @ ( in @ C @ B ) ) @ ( qmltpeq @ ( set_intersection2 @ ( unordered_pair @ A @ C ) @ B ) @ ( unordered_pair @ A @ C ) ) ) ) ) ) ) ).

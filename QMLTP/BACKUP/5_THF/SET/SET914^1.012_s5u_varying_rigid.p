%------------------------------------------------------------------------------
% File     : SET914^1.012 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Set Theory
% Problem  : TPTP problem SET914+1.p with axiomatized equality
% Version  : [BP13] axioms.
% English  : 
...
%            Number of atoms       :  195 (  10 equ;   0 cnn)
%            Maximal formula atoms :   12 (   5 avg)
%            Number of connectives :  316 (   1   ~;   1   |;   3   &; 307   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   16 (   8 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :   74 (  74   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   21 (  20 usr;   2 con; 0-3 aty)
%            Number of variables   :   90 (  82   ^   5   !;   3   ?;  90   :)
% SPC      : TH0_THM_EQU_NAR
...
thf(d7_xboole_0,axiom,
    ...
    @ ( mforall_di
      @ ^ [A: $i] :
          ( mforall_di
          @ ^ [B: $i] : ( mequiv @ ( disjoint @ A @ B ) @ ( qmltpeq @ ( set_intersection2 @ A @ B ) @ empty_set ) ) ) ) ) ).
...
thf(t55_zfmisc_1,conjecture,
    ...
    @ ( mforall_di
      @ ^ [A: $i] :
          ...
          @ ^ [B: $i] :
              ( mforall_di
              @ ^ [C: $i] : ( mnot @ ( mand @ ( disjoint @ ( unordered_pair @ A @ B ) @ C ) @ ( in @ A @ C ) ) ) ) ) ) ) ).

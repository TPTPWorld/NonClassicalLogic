%------------------------------------------------------------------------------
% File     : SET916^1.006 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Set Theory
% Problem  : TPTP problem SET916+1.p with axiomatized equality
% Version  : [BP13] axioms.
% English  : 
...
thf(symmetry_r1_xboole_0,axiom,
    ...
    @ ( mforall_di
      @ ^ [A: $i] :
          ( mforall_di
          @ ^ [B: $i] : ( mimplies @ ( disjoint @ A @ B ) @ ( disjoint @ B @ A ) ) ) ) ) ).
    ...
    @ ( mforall_di
      @ ^ [A: $i] :
          ...
          @ ^ [B: $i] :
              ( mand
              @ ( mnot
                @ ( mand @ ( mnot @ ( disjoint @ A @ B ) )
                  @ ( mforall_di
                    @ ^ [C: $i] : ( mnot @ ( in @ C @ ( set_intersection2 @ A @ B ) ) ) ) ) )
              @ ( mnot
                @ ( mand
                  @ ( mexists_di
...
thf(t57_zfmisc_1,conjecture,
    ...
    @ ( mforall_di
      @ ^ [A: $i] :
          ...
          @ ^ [B: $i] :
              ( mforall_di
              @ ^ [C: $i] : ( mnot @ ( mand @ ( mnot @ ( in @ A @ B ) ) @ ( mand @ ( mnot @ ( in @ C @ B ) ) @ ( mnot @ ( disjoint @ ( unordered_pair @ A @ C ) @ B ) ) ) ) ) ) ) ) ) ).

%------------------------------------------------------------------------------
% File     : SET917^1.012 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Set Theory
% Problem  : TPTP problem SET917+1.p with axiomatized equality
% Version  : [BP13] axioms.
% English  : 
...
thf(l28_zfmisc_1,axiom,
    ...
    @ ( mforall_di
      @ ^ [A: $i] :
          ( mforall_di
          @ ^ [B: $i] : ( mimplies @ ( mnot @ ( in @ A @ B ) ) @ ( disjoint @ ( singleton @ A ) @ B ) ) ) ) ) ).
...
thf(t58_zfmisc_1,conjecture,
    ...
    @ ( mforall_di
      @ ^ [A: $i] :
          ( mforall_di
          @ ^ [B: $i] : ( mor @ ( disjoint @ ( singleton @ A ) @ B ) @ ( qmltpeq @ ( set_intersection2 @ ( singleton @ A ) @ B ) @ ( singleton @ A ) ) ) ) ) ) ).

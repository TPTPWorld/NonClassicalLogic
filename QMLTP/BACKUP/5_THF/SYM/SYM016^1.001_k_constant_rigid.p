%------------------------------------------------------------------------------
% File     : SYM016^1.001 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Syntactic
...
%            Number of connectives :   46 (   1   ~;   1   |;   2   &;  39   @)
%                                         (   1 <=>;   2  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   10 (   2 avg)
%            Number of types       :    3 (   1 usr)
%            Number of type conns  :   60 (  60   >;   0   *;   0   +;   0  <<)
%            Number of symbols     :   16 (  15 usr;   2 con; 0-3 aty)
%            Number of variables   :   28 (  24   ^   2   !;   2   ?;  28   :)
% SPC      : TH0_CSA_EQU_NAR
...
thf(con,conjecture,
    ...
    @ ( mimplies
      @ ( mforall_di
        @ ^ [X: $i] : ( mor @ ( mdia @ ( f @ X ) ) @ ( mdia @ ( mnot @ ( f @ X ) ) ) ) )
      @ ( mbox @ ( mequiv @ ( mbox @ ( f @ a ) ) @ ( mor @ p @ ( mnot @ p ) ) ) ) ) ) ).

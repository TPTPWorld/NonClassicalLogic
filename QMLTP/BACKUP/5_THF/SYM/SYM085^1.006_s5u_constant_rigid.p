%------------------------------------------------------------------------------
% File     : SYM085^1.006 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Syntactic
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   33 (  11 unt;  16 typ;  10 def)
%            Number of atoms       :   79 (  10 equ;   0 cnn)
...
thf(n_substitution_1,axiom,
    ( mlocal
    @ ( mforall_di
      @ ^ [A: $i] :
          ( mforall_di
          @ ^ [B: $i] : ( mimplies @ ( mand @ ( qmltpeq @ A @ B ) @ ( n @ A ) ) @ ( n @ B ) ) ) ) ) ).

thf(o_substitution_1,axiom,
    ( mlocal
    @ ( mforall_di
      @ ^ [A: $i] :
          ( mforall_di
          @ ^ [B: $i] : ( mimplies @ ( mand @ ( qmltpeq @ A @ B ) @ ( o @ A ) ) @ ( o @ B ) ) ) ) ) ).

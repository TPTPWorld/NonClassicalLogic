%------------------------------------------------------------------------------
% File     : SYM123^1.017 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Syntactic
...
%            Number of atoms       :   41 (   8 equ;   0 cnn)
...
thf(con,conjecture,
    mlocal @ ( mimplies @ ( mdia @ ( mimplies @ p @ ( mand @ q @ r ) ) ) @ ( mand @ ( mimplies @ ( mbox @ p ) @ ( mdia @ q ) ) @ ( mimplies @ ( mbox @ p ) @ ( mdia @ r ) ) ) ) ).

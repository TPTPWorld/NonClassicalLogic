%------------------------------------------------------------------------------
% File     : SYM339^1.023 : TPTP v8.1.0. Released v8.1.0.
% Domain   : Syntactic
...
% Status   : Unknown 
% Rating   : ? v8.1.0
% Syntax   : Number of formulae    :   62 (   9 unt;  30 typ;   8 def)
%            Number of atoms       :  658 (   8 equ;   0 cnn)
%            Maximal formula atoms :  111 (  20 avg)
%            Number of connectives :  647 (   1   ~;   1   |;   3   &; 638   @)
%                                         (   1 <=>;   3  =>;   0  <=;   0 <~>)
